...
#
# vAPI stub file for package vmware.sddc_manager.v1.personalities.
#---------------------------------------------------------------------------
...
class Files(VapiInterface):
    ...
    * /v1/personalities/files PUT
    
    
    """

    _VAPI_SERVICE_ID = 'vmware.sddc_manager.v1.personalities.files'
    """
...
class _FilesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='vmware.sddc_manager.v1.personalities.files',
