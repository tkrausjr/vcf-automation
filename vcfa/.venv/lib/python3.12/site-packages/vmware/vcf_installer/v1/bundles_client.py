...
#
# vAPI stub file for package vmware.vcf_installer.v1.bundles.
#---------------------------------------------------------------------------
...
class DownloadStatus(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'vmware.vcf_installer.v1.bundles.download_status'
    """
    ...
    def get_bundle_download_status(self,
        ...
        :rtype: :class:`vmware.vcf_installer.model_client.PageOfBundleDownloadStatusInfo` or ``None``
        :return: OK
...
class Domains(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'vmware.vcf_installer.v1.bundles.domains'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def __init__(self, config):
        ...
        operations = {
            'get_bundle_download_status': {
                ...
                'output_type': type.OptionalType(type.ReferenceType('vmware.vcf_installer.model_client', 'PageOfBundleDownloadStatusInfo')),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='vmware.vcf_installer.v1.bundles.download_status',
...
class _DomainsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='vmware.vcf_installer.v1.bundles.domains',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=False)
