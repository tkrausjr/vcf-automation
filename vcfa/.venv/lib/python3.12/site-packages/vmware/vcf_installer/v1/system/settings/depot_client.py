...
#
# vAPI stub file for package vmware.vcf_installer.v1.system.settings.depot.
#---------------------------------------------------------------------------
...
class DepotSyncInfo(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'vmware.vcf_installer.v1.system.settings.depot.depot_sync_info'
    """
    ...
    def get_depot_sync_info(self):
        ...
        :rtype: :class:`vmware.vcf_installer.model_client.DepotSyncInfo` or ``None``
        :return: OK
    ...
    def __init__(self, config):
        ...
        operations = {
            'get_depot_sync_info': {
                ...
                'output_type': type.OptionalType(type.ReferenceType('vmware.vcf_installer.model_client', 'DepotSyncInfo')),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='vmware.vcf_installer.v1.system.settings.depot.depot_sync_info',
