...
from vmware.vapi.rest.validator import HttpResponseValidator
...
class RestClientProvider(ApiProvider):
    ...
    def _invoke(self, service_id, operation_id, input_value, ctx, rest_metadata,  # pylint: disable=W0613
        ...
        HttpResponseValidator.validate_content_type(http_response)
        ...
        return RestSerializer.deserialize_response(http_response, is_vapi_rest, rest_metadata)
