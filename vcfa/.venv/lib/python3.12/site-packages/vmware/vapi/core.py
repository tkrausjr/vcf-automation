...
class ResultRuntimeData:
    """
    Infrastructure information about the result of the API invocation. For
    example HTTP/TLS/TCP details.

    The information may differ depending on the wire protocol and whether the
    code is running on the client side or the server side.
    """
    ...
    def http_response(self):
        """
        Returns the HTTP response of a REST API invocation.

        Available only for REST wire protocol and only on the client side of
        the API infrastructure.

        :rtype: :class:`vmware.vapi.protocol.client.http_lib.HTTPResponse`
        :return: HTTP response of the API call; None if the wire protocol
                 is not REST or the code is running on the server side.
        """
...
class MethodResult(object):
    ...
    The runtime data contains infrastructure information about the API
    response such as the HTTP response status code.
    ...
    :ivar runtime_data: Infrastructure info about the API response
    """
    def __init__(self, output=None, error=None, runtime_data=None):
        """
    ...
    def runtime_data(self):
        """
        Returns infrastructure information related to the API response, e.g. HTTP
        response status code.

        :rtype: :class:`vmware.vapi.core.ResultRuntimeData`
        :return: Infrastructure info about the API response
        """
