...
class AutoRollbackState(Enum):
    """
    The ``AutoRollbackState`` class defines the sub status that can be reported
    for the auto rollback state during failed operation.
    ...
    """
    ROLLBACK_NOT_STARTED = None
    """
    The auto rollback is not started yet.

    """
    ROLLBACK_IN_PROGRESS = None
    """
    The auto rollback is in progress.

    """
    ROLLBACK_SUCCEEDED = None
    """
    The auto rollback is successful.
    ...
    def __init__(self, string):
        ...
        :param string: String value for the :class:`AutoRollbackState` instance.
        """
        Enum.__init__(string)

AutoRollbackState._set_values({
    'ROLLBACK_NOT_STARTED': AutoRollbackState('ROLLBACK_NOT_STARTED'),
    'ROLLBACK_IN_PROGRESS': AutoRollbackState('ROLLBACK_IN_PROGRESS'),
    'ROLLBACK_SUCCEEDED': AutoRollbackState('ROLLBACK_SUCCEEDED'),
    'ROLLBACK_FAILED': AutoRollbackState('ROLLBACK_FAILED'),
})
AutoRollbackState._set_binding_type(type.EnumType(
    'com.vmware.appliance.auto_rollback_state',
    AutoRollbackState))
...
class SubtaskInfo(VapiStruct):
    ...
    _validator_list = [
        UnionValidator(
            'status',
            {
                ...
                'FAILED' : [('progress', True), ('result', False), ('auto_rollback_state', False), ('error', False), ('start_time', True), ('end_time', True)],
                'PENDING' : [],
            }
        ),
    ]
    ...
    def __init__(self,
        ...
        :type  auto_rollback_state: :class:`AutoRollbackState` or ``None``
        :param auto_rollback_state: State of the auto-rollback operation if task failed.
            This attribute was added in **vSphere API 9.0.0.0**.
            Only :class:`set` if task has failed.
        ...
        self.result = result
        self.auto_rollback_state = auto_rollback_state
...
SubtaskInfo._set_binding_type(type.StructType(
    'com.vmware.appliance.subtask_info', {
        ...
        'auto_rollback_state': type.OptionalType(type.ReferenceType(__name__, 'AutoRollbackState')),
    ...
    _validator_list = [
        UnionValidator(
            'status',
            {
                ...
                'FAILED' : [('progress', True), ('auto_rollback_state', False), ('error', False), ('start_time', True), ('end_time', True)],
                'PENDING' : [],
            }
        ),
    ]
...
class HealthCheckSettings(VapiInterface):
    ...
    check settings in vCenter Server.
    This class was added in **vSphere API 7.0.0.1**.
    """
    ...
    class SettingSpec(VapiStruct):
        ...
        Server health and its corresponding state
        This class was added in **vSphere API 7.0.0.1**.
    ...
    def get(self):
        ...
        This method was added in **vSphere API 7.0.0.1**.
...
class LocalAccounts(VapiInterface):
    ...
    class Info(VapiStruct):
        """
        The ``LocalAccounts.Info`` class defines the local account properties.
        This class was added in **vSphere API 6.7**.
    ...
    class Config(VapiStruct):
        ...
        def __init__(self,
            ...
            :param password_expires: Flag indicating if the account password expires
                This attribute was added in **vSphere API 6.7**.
                If None, defaults to True.
            :type  password_expires_at: :class:`datetime.datetime` or ``None``
            :param password_expires_at: Date when the account's password will expire
...
class Networking(VapiInterface):
    """
    The ``Networking`` class provides methods Get Network configurations.
    This class was added in **vSphere API 6.7**.
    """
    ...
    class DNSInfo(VapiStruct):
        ...
        configuration of a virtual appliance.
        This class was added in **vSphere API 6.7**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param interfaces: Interface configuration as a key-value map where key is a network
                interface name, for example, "nic0".
                This attribute was added in **vSphere API 6.7**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ipv6_enabled: IPv6 Enabled or not
                This attribute was added in **vSphere API 6.7**.
    ...
    class ChangeSpec(VapiStruct):
        """
        This class was added in **vSphere API 6.7.3**.
        ...
        def __init__(self,
            ...
            :param hostname: New hostname to assign to the management network of vCenter
                appliance
                This attribute was added in **vSphere API 6.7.3**.
            :type  sso_user: :class:`str`
            :param sso_user: vCenter Server SSO administrator username
                This attribute was added in **vSphere API 6.7.3**.
            :type  sso_password: :class:`str`
            :param sso_password: vCenter Server SSO administrator Password
                This attribute was added in **vSphere API 6.7.3**.
            :type  dns: :class:`com.vmware.appliance.networking.dns_client.Servers.DNSServerConfig` or ``None``
            :param dns: DNS Configuration to set for the machine
                This attribute was added in **vSphere API 6.7.3**.
            ...
            :param ipv4: IPv4 Configuration to set for the machine
                This attribute was added in **vSphere API 6.7.3**.
            ...
            :param ipv6: IPv6 Configuration to set for the machine
                This attribute was added in **vSphere API 6.7.3**.
    ...
    def change_task(self,
        ...
        expected to be down for few minutes during these changes
        This method was added in **vSphere API 6.7.3**.
...
class Ntp(VapiInterface):
    ...
    class ServerStatus(Enum):
        """
        ``Ntp.ServerStatus`` class Status of server during test
        This enumeration was added in **vSphere API 6.7**.
    ...
    class LocalizableMessage(VapiStruct):
        """
        ``Ntp.LocalizableMessage`` class Structure representing message
        This class was added in **vSphere API 6.7**.
    ...
    class TestRunStatus(VapiStruct):
        """
        ``Ntp.TestRunStatus`` class Status of the test
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param server: Server name associated with the test run.
                This attribute was added in **vSphere API 6.7**.
            :type  status: :class:`Ntp.ServerStatus`
            :param status: Server status
                This attribute was added in **vSphere API 6.7**.
            :type  message: :class:`Ntp.LocalizableMessage`
            :param message: Message associated with status
                This attribute was added in **vSphere API 6.7**.
            """
            self.server = server
            self.status = status
...
class Recovery(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supported: Is recovery supported in this appliance.
                This attribute was added in **vSphere API 6.7**.
            """
...
class Services(VapiInterface):
    ...
    class State(Enum):
        """
        The ``Services.State`` class defines valid Run State for services.
        This enumeration was added in **vSphere API 6.7**.
    ...
    class Info(VapiStruct):
        """
        The ``Services.Info`` class contains information about a service.
        This class was added in **vSphere API 6.7**.
...
class Shutdown(VapiInterface):
    ...
    class ShutdownConfig(VapiStruct):
        ...
        configuration returned by the Shutdown.get operation
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param action: The pending shutdown operation. The string values for pending
                operations can be 'poweroff', 'reboot' or ''.
                This attribute was added in **vSphere API 6.7**.
            :type  reason: :class:`str`
            :param reason: The reason behind the shutdown action
                This attribute was added in **vSphere API 6.7**.
            """
...
class Cores(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: Identifier of the core file.
            ...
            :param size: Size of core file.
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  creation_time: :class:`datetime.datetime`
            :param creation_time: Creation time of core file.
                This attribute was added in **vSphere API 8.0.2.0**.
            """
            self.name = name
            self.size = size
...
class SupportBundle(VapiInterface):
    ...
    and delete generated support bundle.
    ...
    class CreationStatus(Enum):
        ...
        SUCCEEDED = None
        """
        Support bundle creation task succeeded.

        """
        FAILED = None
        """
        Support bundle creation task Failed.

        """
        CANCELLED = None
        """
        Support bundle creation task Cancelled.
    ...
    class ContentType(Enum):
        ...
        LOGS = None
        """
        Support bundle will contain only logs.

        """
        CORES = None
        """
        Support bundle will contain only core files.
    ...
    class IterationSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param size: Size specifies the maximum number of results to return.
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param available: Filter only downloadable details.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  creation_status: :class:`SupportBundle.CreationStatus` or ``None``
            :param creation_status: Filter by task status.
                This attribute was added in **vSphere API 7.0.1.0**.
            """
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'status',
                {
                    'SUCCEEDED' : [('generation_time', True), ('url', True), ('expiration_time', True), ('downloadable', True), ('size', True), ('checksum_value', False), ('content_type', False)],
        ...
        def __init__(self,
            ...
            """
            :type  description: :class:`str`
            :param description: Support bundle creation description.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  status: :class:`SupportBundle.CreationStatus`
            :param status: Status of the task
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  generation_time: :class:`datetime.datetime`
            :param generation_time: Support bundle generation time.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            :type  url: :class:`str`
            :param url: Support bundle downlooad URL.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            :type  expiration_time: :class:`datetime.datetime`
            :param expiration_time: Download expiration time.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            :type  downloadable: :class:`bool`
            :param downloadable: Support bundle availability for download.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            :type  size: :class:`long`
            :param size: Support bundle file size in KBs.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            ...
            :param checksum_value: Support bundle SHA256 checksum value.
                This attribute was added in **vSphere API 8.0.2.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is :attr:`SupportBundle.CreationStatus.SUCCEEDED`.
            :type  id: :class:`str`
            :param id: Identifier of the support bundle.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    class ListResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supportbundle_operations: Information about all support bundle requests.
                This attribute was added in **vSphere API 7.0.1.0**.
            """
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param components: Support bundle components to be included. Map with groupName as key
                and list of components in that group as the value.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  content_type: :class:`SupportBundle.ContentType` or ``None``
            :param content_type: Describes the content type to be collected in support bundle.
                This attribute was added in **vSphere API 8.0.2.0**.
            ...
            :param partition: Partition to be used for saving the support bundle. Available
                partitions can be retrieved using storage.list API.
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            self.description = description
    ...
    def delete(self,
        ...
        :type  id: :class:`str`
        :param id:             The parameter must be an identifier for the resource type:
            ``com.vmware.appliance.supportbundle``.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
...
class Update(VapiInterface):
    ...
    class Info(VapiStruct):
        """
        The ``Update.Info`` class describes the state of the appliance update.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param state: State of the appliance update.
                This attribute was added in **vSphere API 6.7**.
            :type  task: :class:`TaskInfo` or ``None``
            :param task: The running or completed update task.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param latest_query_time: Timestamp of latest query to update repository.
                This attribute was added in **vSphere API 6.7**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'messages': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'change$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'start': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'stop': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'restart': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create$task': {
                ...
                'output_type': type.IdType(resource_types='com.vmware.cis.TASK'),
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': [],
                'task_type': TaskType.TASK_ONLY,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'cancel': {
                ...
                'output_type': type.VoidType(),
                'errors': cancel_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': cancel_input_value_validator_list,
                'output_validator_list': cancel_output_validator_list,
                'task_type': TaskType.NONE,
            },
