...
class SecurityRuleType(Enum):
    ...
    applied to different item types.
...
class ConfigurationModel(VapiStruct):
    ...
    def __init__(self,
        ...
        :param automatic_sync_enabled: Whether automatic synchronization is enabled. 
            ...
            :attr:`ConfigurationModel.automatic_sync_enabled` flag turned on
            will be synchronized every hour between
        ...
        :param maximum_concurrent_item_syncs: The maximum allowed number of library items to synchronize
            ...
            This setting is global across all subscribed libraries. The default
            value is 5.
            This attribute is not used for the ``create`` method. It will
            always be present in the return value of the ``get`` or ``list``
            methods. It is optional for the ``update`` method.
...
class LibraryModel(VapiStruct):
    ...
    def __init__(self,
        ...
        :param unset_security_policy_id: This represents the intent of the change to
            ...
            specified in :attr:`LibraryModel.security_policy_id`, if any.
            This attribute was added in **vSphere API 7.0.3.0**.
        ...
        :type  state_info: :class:`com.vmware.content.library_client.StateInfo`
        :param state_info: The :class:`com.vmware.content.library_client.StateInfo` provides
            the state information of this library. 
...
LibraryModel._set_binding_type(type.StructType(
    'com.vmware.content.library_model', {
        ...
        'state_info': type.OptionalType(type.ReferenceType('com.vmware.content.library_client', 'StateInfo')),
    },
    LibraryModel,
    True,
    ["id"]))
...
class Library(VapiInterface):
    """
    The ``Library`` class manages general library functionalities. 
    ...
    class FindSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  storage_backing: :class:`com.vmware.content.library_client.StorageBacking` or ``None``
            :param storage_backing: Library StorageBacking to search. See
                :class:`com.vmware.content.library_client.StorageBacking`.
                This attribute was added in **vSphere API 9.0.0.0**.
    ...
    FindSpec._set_binding_type(type.StructType(
        'com.vmware.content.library.find_spec', {
            'name': type.OptionalType(type.StringType()),
            'type': type.OptionalType(type.ReferenceType(__name__, 'LibraryModel.LibraryType')),
            'storage_backing': type.OptionalType(type.ReferenceType('com.vmware.content.library_client', 'StorageBacking')),
        },
        FindSpec,
        False,
        None))
    ...
    class MigrateSpec(VapiStruct):
        """
        The ``Library.MigrateSpec`` class defines target storage backing library to
        migrate the library content to. 
        ...
        def __init__(self,
            ...
            """
            :type  storage_backings: :class:`list` of :class:`com.vmware.content.library_client.StorageBacking`
            :param storage_backings: This value can be used to set the
                :attr:`LibraryModel.storage_backings` property as the storage
                backing target to migrate the library to. 
    ...
    MigrateSpec._set_binding_type(type.StructType(
        'com.vmware.content.library.migrate_spec', {
            'storage_backings': type.ListType(type.ReferenceType('com.vmware.content.library_client', 'StorageBacking')),
        },
        MigrateSpec,
        False,
        None))
    ...
    def migrate(self,
        ...
        """
        Migrates the library content from current storage backing to specified
        storage backing. 
        
        The only supported
        :attr:`com.vmware.content.library_client.StorageBacking.type` is
        DATASTORE for both source and target storage backing. Migrating Virtual
        machine template items is not supported. 
        
        This will trigger a migration task which goes through phases of
        migration. 
        ...
        * 3. Post Migration
        ...
        There will be set of pre-checks before starting content migration that
        prepares the library for migration, any failures in pre-checks phase
        will stop the task, failure will be returned. 
        
        On successful pre-checks, Library would be put in to MAINTENANCE state
        and actual content migration phase starts. Content migration involve
        copying contents from source datastore to target datastore. During the
        content migration phase, any operations that alter the Library content
        or its use are restricted to avoid conflicts. On successfully copying
        contents to target datastore, library metadata in the database will be
        updated to repoint to the target datastore. 
        
        Post migration, Library is transitioned back to ACTIVE state. Any
        failures in Migration will be reported. Cleanup of library content on
        datastore happens in this phase. This would be source datastore on
        successful migration, target datastore on failure case. 
        
        In case of published library with PublishInfo#persistJsonEnabled flag,
        publisher metadata json files will also be migrated to target
        datastore. 
        This method was added in **vSphere API 9.0.0.0**.

        :type  library_id: :class:`str`
        :param library_id: Identifier of the local, published or subscribed content library.
            The parameter must be an identifier for the resource type:
            ``com.vmware.content.Library``.
        :type  migrate_spec: :class:`Library.MigrateSpec`
        :param migrate_spec: Specificaton containing storage backing to migrate this library to.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If the library specified by ``library_id`` does not exist.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            If one or more :attr:`Library.MigrateSpec.storage_backings`
            specifed in ``migrate_spec`` is not valid.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            If the library specified by ``library_id`` already being migrated
            or blocked by condition that do not allow start of migration.
        :raise: :class:`com.vmware.vapi.std.errors_client.AlreadyInDesiredState` 
            If the storage backing of library specified by ``library_id`` is
            same as specified in ``migrate_spec`` target storage backing.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            If the storage backing type of library specified by ``library_id``
            or storage backing type of
            :attr:`Library.MigrateSpec.storage_backings` specifed in
            ``migrate_spec`` are not supported for migration.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            if you do not have all of the privileges described as follows: 
            
            * The resource ``com.vmware.content.Library`` referenced by the
              parameter ``library_id`` requires
              ``ContentLibrary.MigrateLibrary``.
        """
        return self._invoke('migrate',
                            {
                            'library_id': library_id,
                            'migrate_spec': migrate_spec,
                            })
class LocalLibrary(VapiInterface):
    ...
    class DestinationSpec(VapiStruct):
        ...
        publish the library to a specific subscription.
    ...
    def publish(self,
        ...
        :param subscriptions: The list of subscriptions to publish this library to.
            If not specified, the library is published to all its
            subscriptions.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
...
class SecurityPolicies(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param policy: Identifier of the security policy
                This attribute was added in **vSphere API 7.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    def list(self):
        """
        Returns the list of security policies.
...
class SubscribedLibrary(VapiInterface):
    ...
    class ProbeResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ssl_certificate: The SSL certificate for the remote endpoint.
                This attribute was added in **vSphere API 9.0.0.0**.
                A SSL certificate is only returned if the host is secured with
                SSL/TLS and if the {SubscribedLibrary#sslCertificate} is also
                :class:`set`.
...
class TrustedCertificates(VapiInterface):
    ...
    class Info(VapiStruct):
        """
        The ``TrustedCertificates.Info`` class contains a trusted certificate.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param cert_text: A certificate in Base64 encoding
                This attribute was added in **vSphere API 7.0.3.0**.
            """
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  cert_text: :class:`str`
            :param cert_text: Certificate in Base64 encoded PEM format..
                This attribute was added in **vSphere API 7.0.3.0**.
            """
    ...
    class ListResult(VapiStruct):
        ...
        the trusted certificates, see :func:`TrustedCertificates.list`.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class CreateSpec(VapiStruct):
        ...
        create a trusted certificate, see :func:`TrustedCertificates.create`.
        This class was added in **vSphere API 7.0.3.0**.
...
class Type(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supported_rules: List of security rules which can be applied to this item type.
                This attribute was added in **vSphere API 7.0.3.0**.
...
class _LibraryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        find_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library?action=find',
        ...
        # properties for migrate operation
        migrate_input_type = type.StructType('operation-input', {
            'library_id': type.IdType(resource_types='com.vmware.content.Library'),
            'migrate_spec': type.ReferenceType(__name__, 'Library.MigrateSpec'),
        })
        migrate_error_dict = {
        ...
        migrate_input_value_validator_list = [
        ]
        migrate_output_validator_list = [
        ]
        migrate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/{libraryId}?action=migrate',
            request_body_parameter='migrate_spec',
            path_variables={
                'library_id': 'libraryId',
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'migrate': {
                'input_type': migrate_input_type,
                'output_type': type.VoidType(),
                'errors': migrate_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': migrate_input_value_validator_list,
                'output_validator_list': migrate_output_validator_list,
                'task_type': TaskType.NONE,
            },
        }
        rest_metadata = {
...
class _LocalLibraryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        publish_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/local-library/{libraryId}?action=publish',
            path_variables={
                'library_id': 'libraryId',
            },
            query_parameters={
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'get': {
                ...
                'output_type': type.ReferenceType(__name__, 'LibraryModel'),
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ConcurrentChange'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'publish': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
...
class _SubscribedLibraryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        evict_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/subscribed-library/{libraryId}?action=evict',
            path_variables={
                'library_id': 'libraryId',
            },
            query_parameters={
        ...
        sync_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/subscribed-library/{libraryId}?action=sync',
            path_variables={
                'library_id': 'libraryId',
            },
            query_parameters={
        ...
        probe_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/subscribed-library?action=probe',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            'create': {
                ...
                'output_type': type.IdType(resource_types='com.vmware.content.Library'),
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'delete': {
                ...
                'output_type': type.VoidType(),
                'errors': delete_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
                'input_value_validator_list': delete_input_value_validator_list,
                'output_validator_list': delete_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'evict': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'sync': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ConcurrentChange'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
