...
#
# vAPI stub file for package com.vmware.snapservice.tasks.
#---------------------------------------------------------------------------
...
class Status(Enum):
    ...
    The operation could be blocked if the system is waiting for resources to be
...
Status._set_binding_type(type.EnumType(
    'com.vmware.snapservice.tasks.status',
    Status))
...
Progress._set_binding_type(type.StructType(
    'com.vmware.snapservice.tasks.progress', {
...
class CommonInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param service: Identifier of the service containing the operation.
            ...
            for the resource type: ``com.vmware.snapservice.service``.
...
CommonInfo._set_binding_type(type.StructType(
    'com.vmware.snapservice.tasks.common_info', {
        'description': type.ReferenceType('com.vmware.vapi.std_client', 'LocalizableMessage'),
        'service': type.IdType(resource_types='com.vmware.snapservice.service'),
        'operation': type.IdType(resource_types='com.vmware.snapservice.operation'),
...
class Info(VapiStruct):
    ...
    def __init__(self,
        ...
        :param result: Result of the operation. 
            ...
            operation.
        :type  vc_task: :class:`str` or ``None``
        :param vc_task: Associated vCenter task for the given task.
            This attribute will be None if there is no corresponding VC task
            created.
        :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
        :param description: Description of the operation associated with the task.
        :type  service: :class:`str`
