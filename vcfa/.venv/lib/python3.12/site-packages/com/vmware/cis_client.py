    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param services: Identifiers of services. Tasks created by operations in these
                ...
                :attr:`com.vmware.cis.task_client.CommonInfo.service`).
                This attribute was added in **vSphere API 6.7.1**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
            ...
            :param status: Status that a task must have to match the filter (see
                :attr:`com.vmware.cis.task_client.CommonInfo.status`).
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param targets: Identifiers of the targets the operation for the associated task
                ...
                :attr:`com.vmware.cis.task_client.CommonInfo.target`).
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param users: Users who must have initiated the operation for the associated task
                ...
                :attr:`com.vmware.cis.task_client.CommonInfo.user`).
                This attribute was added in **vSphere API 6.7.1**.
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'cancel': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
