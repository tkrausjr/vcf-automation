...
class Credentials(VapiStruct):
    ...
    def __init__(self,
        ...
        :param saml_token: SAML Bearer Token
            This attribute was added in **vSphere API 7.0.2.0**.
            This attribute is optional and it is only relevant when the value
...
class DnsAssignedValues(VapiStruct):
    ...
    assigned by a Domain Name Server (DNS).
...
class DhcpConfigInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ipv4_enabled: True if IPv4 DHCP is enabled, false otherwise.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  ipv6_enabled: :class:`bool`
        :param ipv6_enabled: True if IPv6 DHCP is enabled, false otherwise.
            This attribute was added in **vSphere API 7.0.0.0**.
        """
...
class Customization(VapiInterface):
    ...
    class SetSpec(VapiStruct):
        ...
        has to be applied to a virtual machine.
        This class was added in **vSphere API 7.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        operation applied to a virtual machine.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param status: The status of the customization operation.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param error: Description of the error if the :attr:`Customization.Info.status`
                ...
                :attr:`Customization.Info.Status.FAILED`.
                This attribute was added in **vSphere API 7.0.0.0**.
        ...
        class Status(Enum):
            ...
            be reported for the customization operation.
            ...
            IDLE = None
            """
            No customization spec is applied to the guest operating system.
            ...
            FAILED = None
            """
            The customizatio process has failed inside the guest operating system.
    ...
    class CheckInfo(VapiStruct):
        """
        The ``Customization.CheckInfo`` class contains the status of a
        customization check operation applied to a virtual machine.
        ...
        def __init__(self,
                     check_status=None,
                     supported_guest_os=None,
                     supported_power_state=None,
                    ):
            """
            :type  check_status: :class:`Customization.CheckInfo.CheckStatus`
            :param check_status: The status of the customization check operation.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  supported_guest_os: :class:`bool` or ``None``
            :param supported_guest_os: Whether or not the guest OS is supported by customization
                operation. If ``supportedGuestOs`` is false in the status of a
                customization check operation, the virtual machine is not
                customizable due to the guest OS is not supported by customization
                operation.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute will be None if the customization check operation
                has not reached the step of checking guest OS.
            :type  supported_power_state: :class:`bool` or ``None``
            :param supported_power_state: Whether or not customization operation is supported in the current
                power state. If ``supportedPowerState`` is false in the status of a
                customization check operation, the virtual machine is not
                customizable due to customization operation is not supported in the
                current power state.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute will be None if the customization check operation
                has not reached the step of checking power state.
            """
            self.check_status = check_status
            self.supported_guest_os = supported_guest_os
            self.supported_power_state = supported_power_state
            VapiStruct.__init__(self)


        class CheckStatus(Enum):
            """
            The ``Customization.CheckInfo.CheckStatus`` class defines the status values
            that can be reported for the customization check operation.
            ...
            SUPPORTED = None
            """
            Applying customization operation on a virtual machine is supported, a
            virtual machine is customizable.

            """
            NOT_SUPPORTED = None
            """
            Applying customization operation on a virtual machine is not supported, a
            virtual machine is not customizable.
        ...
        CheckStatus._set_values({
            'SUPPORTED': CheckStatus('SUPPORTED'),
            'NOT_SUPPORTED': CheckStatus('NOT_SUPPORTED'),
        })
        CheckStatus._set_binding_type(type.EnumType(
            'com.vmware.vcenter.vm.guest.customization.check_info.check_status',
            CheckStatus))

    CheckInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.guest.customization.check_info', {
            'check_status': type.ReferenceType(__name__, 'Customization.CheckInfo.CheckStatus'),
            'supported_guest_os': type.OptionalType(type.BooleanType()),
            'supported_power_state': type.OptionalType(type.BooleanType()),
        },
        CheckInfo,
        False,
        None))
    ...
    def check(self,
        ...
        """
        Returns the status of the customization check operation for the virtual
        machine in ``vm``. This method checks whether the virtual machine is
        customizable or not.
        ...
        :param vm: The unique identifier of the virtual machine that needs to be
            ...
            The parameter must be an identifier for the resource type:
            ``VirtualMachine``.
        :rtype: :class:`Customization.CheckInfo`
        :return: CheckInfo contains the status of the customization check operation.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If the virtual machine ``vm`` is not found.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            if the system is unable to communicate with a service to complete
...
class CustomizationLive(VapiInterface):
    """
    The ``CustomizationLive`` class provides methods to apply a customization
    specification to a virtual machine in powered-on status. If it needs to
    apply a customization specification to a powered-off virtual machine,
    please use :class:`Customization`. 
    
    Live customization only supports the
    :class:`com.vmware.vcenter.guest_client.ConfigurationSpec` in ``RunSpec``
    being configured as
    :attr:`com.vmware.vcenter.guest_client.ConfigurationSpec.linux_config`,
    also the
    :attr:`com.vmware.vcenter.guest_client.LinuxConfiguration.script_text` is
    not supported yet. If it needs to support other configurations please use
    :class:`Customization`. 
    
    Before using the ``CustomizationLive`` class, the Guest Customization
    Engine needs to be installed in the virtual machine. For the steps to
    install please see: ` Guest Customization Engine
    <https://developer.vmware.com/docs/11721/vmware-vsphere-web-services-sdk-programming-guide/GUID-27783049-22E4-4F6E-9F0C-ED6A2135A398.html>`_
    This class was added in **vSphere API 9.0.0.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.vcenter.vm.guest.customization_live'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _CustomizationLiveStub)
        self._VAPI_OPERATION_IDS = {}
        self._VAPI_OPERATION_IDS.update({'run_task': 'run$task'})

    class GuestAuthentication(VapiStruct):
        """
        The ``CustomizationLive.GuestAuthentication`` class contains the
        information necessary to authenticate within a guest using a userName and
        password.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param user_name: The guest username
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  password: :class:`str`
    ...
    GuestAuthentication._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.guest.customization_live.guest_authentication', {
    ...
    class RunSpec(VapiStruct):
        """
        The ``CustomizationLive.RunSpec`` class contains specification information
        and authentication that have to be applied to a running virtual machine in
        the :func:`CustomizationLive.run` method 
        
        ``name`` or ``spec`` only supports to be configured as
        :attr:`com.vmware.vcenter.guest_client.ConfigurationSpec.linux_config`,
        also the
        :attr:`com.vmware.vcenter.guest_client.LinuxConfiguration.script_text` is
        not supported yet.
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str` or ``None``
            :param name: The name of the customization specification that has been retrieved
                from the virtual center inventory and applied for the virtual
                machine. Either ``name`` or ``spec`` should be specified, ``name``
                and ``spec`` can not be None at the same time. If both ``name`` and
                ``spec`` are specified, ``name`` will be used by default.
                This attribute was added in **vSphere API 9.0.0.0**.
                ...
                if ``spec`` is None when executing :func:`CustomizationLive.run`
                method, then ``name`` should be specified.
            :type  spec: :class:`com.vmware.vcenter.guest_client.CustomizationSpec` or ``None``
            :param spec: The customization specification that has to be applied for the
                virtual machine. Either ``name`` or ``spec`` should be specified.
                ``name`` and ``spec`` can not be None at the same time. If ``name``
                and ``spec`` are specified, ``name`` will be used by default.
                This attribute was added in **vSphere API 9.0.0.0**.
                if ``name`` is None when executing :func:`CustomizationLive.run`
                method, then ``spec`` should be specified.
            :type  auth: :class:`CustomizationLive.GuestAuthentication`
    ...
    RunSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.guest.customization_live.run_spec', {
            'name': type.OptionalType(type.IdType()),
            'spec': type.OptionalType(type.ReferenceType('com.vmware.vcenter.guest_client', 'CustomizationSpec')),
            'auth': type.ReferenceType(__name__, 'CustomizationLive.GuestAuthentication'),
        },
        RunSpec,
        False,
        None))
    ...
    class Info(VapiStruct):
        """
        The ``CustomizationLive.Info`` class contains the status of a customization
        operation applied to a virtual machine.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  status: :class:`CustomizationLive.Info.Status`
            :param status: The status of the customization operation.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  error: :class:`com.vmware.vapi.std_client.LocalizableMessage` or ``None``
            :param error: Description of the error if the
                :attr:`CustomizationLive.Info.status` of customization operation is
                :attr:`CustomizationLive.Info.Status.FAILED`.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute will be None if the status is not FAILED or there is
                no information available for the error.
            :type  start_time: :class:`datetime.datetime` or ``None``
            :param start_time: Time when the customization process has started inside the guest
                operating system.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute will be None if the status is NOT_AVAILABLE .
            :type  end_time: :class:`datetime.datetime` or ``None``
            :param end_time: Time when the customization process has completed inside the guest
                operating system.
                This attribute was added in **vSphere API 9.0.0.0**.
        ...
        class Status(Enum):
            """
            The ``CustomizationLive.Info.Status`` class defines the status values that
            can be reported for the customization operation.
            This enumeration was added in **vSphere API 9.0.0.0**.
            ...
            NOT_AVAILABLE = None
            """
            No customization spec has ever been applied to the guest operating system.
            ...
            FAILED = None
            """
            The customization process has failed inside the guest operating system.
        ...
        Status._set_binding_type(type.EnumType(
            'com.vmware.vcenter.vm.guest.customization_live.info.status',
            Status))

    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.guest.customization_live.info', {
            'status': type.ReferenceType(__name__, 'CustomizationLive.Info.Status'),
    ...
    def run_task(self,
        ...
        """
        Customizes a running virtual machine. Before using the method, the
        Guest Customization Engine needs to be installed in the virtual
        machine. For the steps to install, please see ` Guest Customization
        Engine
        <https://developer.vmware.com/docs/11721/vmware-vsphere-web-services-sdk-programming-guide/GUID-27783049-22E4-4F6E-9F0C-ED6A2135A398.html>`_
        
        If there is a pending customization for the virtual machine and
        ``spec`` has valid content, then the existing customization setting
        will be overwritten with the new settings.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param vm: The unique identifier of the virtual machine that needs to be
            ...
            The parameter must be an identifier for the resource type:
            ``VirtualMachine``.
        :type  spec: :class:`CustomizationLive.RunSpec`
        :param spec: The customization settings to be applied to the guest operating
            system and the guest authentication data. The specification only
            supports to be configured as
            :attr:`com.vmware.vcenter.guest_client.ConfigurationSpec.linux_config`,
            also the
            :attr:`com.vmware.vcenter.guest_client.LinuxConfiguration.script_text`
            is not supported yet.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if the customization settings in ``spec`` are not valid or ``spec``
            and ``name`` do not exist at the same time.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the operation cannot be performed because of the virtual
            machine's current state. For example, if the virtual machine ``vm``
            is not in a powered-on state.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If the virtual machine ``vm`` is not found.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            if the system is unable to communicate with a service to complete
    ...
    def get(self,
        ...
        """
        Returns the status of the last customization operation that has been
        applied for the virtual machine in ``vm``.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param vm: The unique identifier of the virtual machine that needs to be
            ...
            The parameter must be an identifier for the resource type:
            ``VirtualMachine``.
        :rtype: :class:`CustomizationLive.Info`
        :return: The status of the customization operation applied for the virtual
            machine.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If the virtual machine ``vm`` is not found.
...
class Identity(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param name: Guest operating system identifier (short name).
                This attribute was added in **vSphere API 6.7**.
            :type  family: :class:`com.vmware.vcenter.vm_client.GuestOSFamily`
            :param family: Guest operating system family.
                This attribute was added in **vSphere API 6.7**.
            :type  full_name: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param full_name: Guest operating system full name.
                This attribute was added in **vSphere API 6.7**.
            :type  host_name: :class:`str`
            :param host_name: Hostname of the guest operating system.
                This attribute was added in **vSphere API 6.7**.
            :type  ip_address: :class:`str` or ``None``
            :param ip_address: IP address assigned by the guest operating system.
                This attribute was added in **vSphere API 6.7**.
...
class LocalFilesystem(VapiInterface):
    ...
    about the guest operating system local file systems.
    This class was added in **vSphere API 6.7**.
    """
    ...
    class Info(VapiStruct):
        ...
        system configured in the guest operating system.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param capacity: Total capacity of the file system, in bytes.
                This attribute was added in **vSphere API 6.7**.
            :type  free_space: :class:`long`
            :param free_space: Free space on the file system, in bytes.
                This attribute was added in **vSphere API 6.7**.
            :type  filesystem: :class:`str` or ``None``
            :param filesystem: Filesystem type, if known. For example, ext3 or NTFS.
                This attribute was added in **vSphere API 7.0.0.0**.
                :class:`set` if VMware Tools reports a value.
            :type  mappings: :class:`list` of :class:`LocalFilesystem.VirtualDiskMapping`
            :param mappings: VirtualDisks backing the guest partition, if known.
                This attribute was added in **vSphere API 7.0.0.0**.
...
class Networking(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param dns_values: Client DNS values. Data assigned by DNS.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None no DNS assigned value exists.
            :type  dns: :class:`DnsConfigInfo` or ``None``
            :param dns: Client DNS configuration. How DNS queries are resolved.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None no DNS assigned value exists.
            """
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param guest_operations_ready: Guest operations availability. Whether or not the virtual machine
                is ready to process guest operations.
                This attribute was added in **vSphere API 7.0.2.0**.
...
class Power(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param state: The power state of the guest operating system.
                This attribute was added in **vSphere API 6.7**.
...
class Processes(VapiInterface):
    ...
    class ProcessErrorDetails(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  pid: :class:`long`
            :param pid: The process associated with the error.
                This attribute was added in **vSphere API 7.0.2.0**.
            """
            self.pid = pid
            VapiStruct.__init__(self)
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param path: The absolute path to the program to start. 
                ...
                redirection to work if passed in the ``arguments`` parameter.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param arguments: The arguments to the program. 
                ...
                ``path`` is prefixed with ``c:\windows\system32\cmd.exe /c``.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class Info(VapiStruct):
        """
        The ``Processes.Info`` class describes the state of a guest process.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param command: The full command line of the process.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  started: :class:`datetime.datetime`
            :param started: The start time of the process.
                This attribute was added in **vSphere API 7.0.2.0**.
...
class _CustomizationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/customization?action=check',
            path_variables={
                'vm': 'vm',
            },
             header_parameters={
        ...
        operations = {
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'check': {
                ...
                'output_type': type.ReferenceType(__name__, 'Customization.CheckInfo'),
...
class _CustomizationLiveStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for run operation
        run_input_type = type.StructType('operation-input', {
            'vm': type.IdType(resource_types='VirtualMachine'),
            'spec': type.ReferenceType(__name__, 'CustomizationLive.RunSpec'),
        })
        run_error_dict = {
            'com.vmware.vapi.std.errors.invalid_argument':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'),
        ...
        run_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/customization-live?action=run',
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vcenter/vm/{vm}/guest/customization-live',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType(__name__, 'CustomizationLive.Info'),
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.vcenter.vm.guest.customization_live',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _EnvironmentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/environment/{name}?action=get',
            path_variables={
                'vm': 'vm',
                'name': 'name',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/environment?action=list',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'shutdown': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'reboot': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'standby': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _ProcessesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/processes?action=create',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/processes/{pid}?action=get',
            path_variables={
                'vm': 'vm',
                'pid': 'pid',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/processes?action=list',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/processes/{pid}?action=delete',
            path_variables={
                'vm': 'vm',
                'pid': 'pid',
            },
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'CustomizationLive': CustomizationLive,
