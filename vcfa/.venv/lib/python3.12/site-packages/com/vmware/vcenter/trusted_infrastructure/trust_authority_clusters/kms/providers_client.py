...
class ClientCertificate(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.ClientCertificate is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        by the hosts in a cluster for authenticating with the Provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param certificate: Public certificate
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.ClientCertificate.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class UpdateSpec(VapiStruct):
        ...
        describe the client certificate update for a Key Provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  certificate: :class:`str`
            :param certificate: Public certificate used by every host in the cluster.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  private_key: :class:`str` or ``None``
            :param private_key: Private part of the certificate.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, the update request is for a public/private client
                certificate pair, not for a signed CSR.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.ClientCertificate.UpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.certificate = certificate
...
class Credential(VapiInterface):
    ...
    external key management service(s).
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.Credential is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class CurrentPeerCertificates(VapiInterface):
    ...
    trusted certificates in the :class:`TrustedPeerCertificates` class
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.CurrentPeerCertificates is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        current key server certificates.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param trusted: whether server certificate is already trusted .
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.CurrentPeerCertificates.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class FilterSpec(VapiStruct):
        ...
        to filter the results when listing remote server certificates.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param server_names: Names that key server must have to match the filter (see
                :attr:`CurrentPeerCertificates.Summary.server_name`).
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param trusted: Trust status that server certificates must have to match the filter
                (see :attr:`CurrentPeerCertificates.Summary.trusted`).
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, trusted and untrusted server certificates match the
                filter.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.CurrentPeerCertificates.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class TrustedPeerCertificates(VapiInterface):
    ...
    :class:`CurrentPeerCertificates` class
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.TrustedPeerCertificates is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param certificates: List of certificate strings, PEM format
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.TrustedPeerCertificates.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class UpdateSpec(VapiStruct):
        ...
        describe the server certificate update for a Key Provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param certificates: Public certificates of key server to trust.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, the trusted server certificates will not be updated.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.TrustedPeerCertificates.UpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.certificates = certificates
            VapiStruct.__init__(self)
