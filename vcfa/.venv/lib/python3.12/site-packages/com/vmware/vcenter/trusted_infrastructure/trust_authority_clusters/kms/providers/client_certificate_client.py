...
class Csr(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.client_certificate.Csr is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        """
        The ``Csr.Info`` class contains the certificate signing request.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.providers.client_certificate.Csr.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.csr = csr
