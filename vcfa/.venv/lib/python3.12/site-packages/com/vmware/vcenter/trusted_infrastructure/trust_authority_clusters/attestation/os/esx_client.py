...
class BaseImages(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImages is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImages.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param version: A unique ESX version number.
            ...
            :param display_name: A unique ESX version formatted for display.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  health: :class:`BaseImages.Health`
            :param health: A health indicator which indicates whether each host in the cluster
                has this version of the ESX base image.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImages.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param display_name: A unique ESX version formatted for display.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  last_attested_time: :class:`datetime.datetime` or ``None``
            :param last_attested_time: The last time that an attestation completed successfully using this
                ESX base image.
                This attribute was added in **vSphere API 8.0.1.0**.
                If None, then there is no known last attestation time using this
                ESX base image.
            :type  health: :class:`BaseImages.Health`
            :param health: A health indicator which indicates whether each host in the cluster
                has this version of the ESX base image.
            ...
            :param details: Details regarding the health. 
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImages.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.display_name = display_name
            self.last_attested_time = last_attested_time
            self.health = health
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.base_images.info', {
            'display_name': type.StringType(),
            'last_attested_time': type.OptionalType(type.DateTimeType()),
            'health': type.ReferenceType(__name__, 'BaseImages.Health'),
    ...
    class FilterSpec(VapiStruct):
        ...
        identifying a Trust Authority Host in a cluster.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param version: Search criteria by ESX base image version numbers.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
                ...
                ``com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImage``.
                version if None return all ESX version numbers.
            :type  display_name: :class:`set` of :class:`str` or ``None``
            :param display_name: Search criteria by ESX base image version version numbers.
                This attribute was added in **vSphere API 7.0.0.0**.
                displayName if None return all ESX display version numbers.
            :type  health: :class:`set` of :class:`BaseImages.Health` or ``None``
            :param health: Search criteria by health indicator.
                This attribute was added in **vSphere API 7.0.0.0**.
                health if None return all health indicators.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.os.esx.BaseImages.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.version = version
            self.display_name = display_name
            self.health = health
            VapiStruct.__init__(self)
    ...
    def import_from_imgdb_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ConfigureHostMetadata``.
    ...
    def list_task(self,
        ...
        :param spec: The search specification.
            if None return all information.
        :rtype: :class:  `vmware.vapi.stdlib.client.task.Task`
        :return: Task instance
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if there is a generic error.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.RetrieveHostMetadata``.
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``System.View``.
        """
...
class _BaseImagesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        import_from_imgdb_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/attestation/os/esx/base-images?action=import-from-imgdb',
