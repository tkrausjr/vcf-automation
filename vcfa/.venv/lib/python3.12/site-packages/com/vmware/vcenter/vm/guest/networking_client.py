...
class Interfaces(VapiInterface):
    ...
    class IpAddressOrigin(Enum):
        ...
        obtained for an interface. See RFC 4293 IpAddressOriginTC.
        ...
        for the link local address falls under this type.
    ...
    class IpAddressStatus(Enum):
        ...
        address on an interface. See RFC 4293 IpAddressStatusTC.
        This enumeration was added in **vSphere API 7.0.0.0**.
        ...
        this address will not be reachable.
    ...
    class IpConfigInfo(VapiStruct):
        ...
        independent address reporting data object for network interfaces.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param ip_addresses: IP addresses configured on the interface.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  dhcp: :class:`com.vmware.vcenter.vm.guest_client.DhcpConfigInfo` or ``None``
            :param dhcp: Client side DHCP for an interface.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param mac_address: MAC address of the adapter.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param ip: IP configuration settings of the adapter
                This attribute was added in **vSphere API 7.0.0.0**.
                If None then not supported by the Guest OS.
            :type  wins_servers: :class:`list` of :class:`str` or ``None``
            :param wins_servers: The IP addresses of any WINS name servers for the adapter.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None then not supported by the Guest OS.
            :type  nic: :class:`str` or ``None``
            :param nic: Link to the corresponding virtual device.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param prefix_length: The prefix length. For IPv4 the value range is 0-32. For IPv6
                ...
                address that make up the network portion of the IP address.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param interface_index: The network interface associated with this route. This is an index
                ...
                an index of 1 refers to the second element.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
