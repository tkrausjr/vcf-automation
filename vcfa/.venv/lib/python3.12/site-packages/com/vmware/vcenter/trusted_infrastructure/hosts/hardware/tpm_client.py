...
class HashAlgorithm(Enum):
    """
    The ``HashAlgorithm`` class defines the possible hash algorithms.
...
class PcrBank(VapiStruct):
    ...
    def __init__(self,
        ...
        :param pcrs: The index of PCR and corresponding TPM digest value.
            This attribute was added in **vSphere API 8.0.0.1**.
        """
...
class EndorsementKeys(VapiInterface):
    ...
    """
    Resource type for TPM endorsement Key.
    ...
    class Type(Enum):
        ...
        RSA_2048 = None
        """
        The RSA 2048 bit key.

        """
        ECC_NIST_P_256 = None
        """
        The ECC NISTP-256 bit key.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  key: :class:`str`
            :param key: A unique identifier for the TPM endorsement key.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param type: The TPM endorsement key type.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.key = key
            self.type = type
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param public_key: The TPM public endorsement key in PEM format.
                This attribute was added in **vSphere API 8.0.0.1**.
                if None, the PEM format public key could not be determined.
            :type  certificate: :class:`str` or ``None``
            :param certificate: The TPM endorsement key certificate in PEM format.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class PolicyPcrSpec(VapiStruct):
        ...
        :func:`EndorsementKeys.unseal` operation.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    class UnsealSpec(VapiStruct):
        ...
        describes the structures required to unseal a secret.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param public_area: The public area which corresponding to the
                ...
                Level 00 Revision 01.59, November 8, 2019, Section 13.3 TPM2_Import
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class FilterSpec(VapiStruct):
        ...
        the results when listing the endorsement key.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param types: Type of the endorsement key.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    def list(self,
        ...
        """
        Return a list of configured endorsement keys on a host.
    ...
    def get(self,
        ...
        00 Revision 01.59, November 8, 2019, Section 12.4 TPM2_ReadPublic
        This method was added in **vSphere API 8.0.0.1**.
    ...
    def unseal(self,
        ...
        Trusted Platform Module Library Part 3: Commands, Family "2.0", Level
        00 Revision 01.59, November 8, 2019, Section 12.7 TPM2_Unseal
        This method was added in **vSphere API 8.0.0.1**.
...
class EventLog(VapiInterface):
    ...
    class Type(Enum):
        """
        The ``EventLog.Type`` class lists the event log types.
        This enumeration was added in **vSphere API 8.0.0.1**.
        ...
        March 30, 2016, Section 5.2 Crypto Agile Log Entry Format.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param truncated: Indicates if the event log is truncated. 
                ...
                store one or more event entries.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  banks: :class:`list` of :class:`PcrBank`
            :param banks: The resulting PCR banks from event log replay.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.type = type
            self.data = data
...
class _EndorsementKeysStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        unseal_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/hosts/{host}/hardware/tpm/{tpm}/endorsement-keys/{key}?action=unseal',
