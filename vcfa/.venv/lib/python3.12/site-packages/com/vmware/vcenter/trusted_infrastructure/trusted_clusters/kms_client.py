...
class Services(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param group: The group determines the Attestation Service instances this Key
                Provider Service can accept reports from.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Key Provider
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Key Provider
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.type = type
            self.service = service
            self.trust_authority_cluster = trust_authority_cluster
            VapiStruct.__init__(self)
        ...
        class SourceType(Enum):
            ...
            Key Provider Service will use for its configuration.
            ...
            def __init__(self, string):
                ...
                """
                warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.CreateSpec.SourceType is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class FilterSpec(VapiStruct):
        ...
        identifying a Key Provider service instance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        instance used by the given cluster.
        This method was added in **vSphere API 7.0.0.0**.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``System.View``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.Services.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class ServicesAppliedConfig(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.ServicesAppliedConfig is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.ServicesAppliedConfig.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param service: The unique identifier of a Key Provider Service configuration from
                ...
                desired state.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.ServicesAppliedConfig.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            self.service = service
            VapiStruct.__init__(self)
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: The health of the applied Key Provider Service configuration.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.ServicesAppliedConfig.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            VapiStruct.__init__(self)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param details: Details regarding the health. When the
                ...
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.kms.ServicesAppliedConfig.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            self.service = service
            self.groups = groups
    ...
    def delete_task(self,
        ...
        Trusted Hosts within the given cluster.
        This method was added in **vSphere API 7.0.1.0**.
...
class _ServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trusted-clusters/{cluster}/kms/services?action=query',
...
class _ServicesAppliedConfigStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trusted-clusters/{cluster}/kms/services-applied-config?action=query',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
