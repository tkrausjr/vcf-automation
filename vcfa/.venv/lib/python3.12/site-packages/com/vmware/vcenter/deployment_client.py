...
class ApplianceType(Enum):
    """
    The ``ApplianceType`` class defines the vCenter appliance types.
...
class VerificationMode(Enum):
    ...
    certificates or SSH connections.
    This enumeration was added in **vSphere API 6.7**.
...
class CheckStatus(Enum):
    """
    The ``CheckStatus`` class defines the status of the checks.
    This enumeration was added in **vSphere API 6.7**.
...
class StandaloneSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param sso_admin_password: The SSO administrator account password.
            This attribute was added in **vSphere API 6.7**.
        :type  sso_domain_name: :class:`str` or ``None``
        :param sso_domain_name: The SSO domain name to be used to configure this appliance.
            This attribute was added in **vSphere API 6.7**.
...
class StandalonePscSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param sso_site_name: The SSO site name used for this PSC.
            This attribute was added in **vSphere API 6.7**.
...
class ReplicatedSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ssl_certificate: The SSL Certificate of the server that will be used for
            verification. The value should be a single x509 certificate encoded
            in PEM format. Note: ``sslThumbprint`` and ``sslCertificate``
            parameters are mutually exclusive, and should never be used
            simultaneously.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is only relevant if ``sslVerify`` is None or has the
            value true.
        :type  ssl_verify: :class:`bool` or ``None``
        :param ssl_verify: SSL verification should be enabled or disabled.
            This attribute was added in **vSphere API 6.7**.
...
class ReplicatedPscSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  sso_site_name: :class:`str` or ``None``
        :param sso_site_name: The SSO sitename that will be used in PSC replication.
            This attribute was added in **vSphere API 6.7**.
            If None, default-first-site will be used.
        :type  partner_hostname: :class:`str`
        :param partner_hostname: The IP address or DNS resolvable name of the partner PSC appliance.
...
class RemotePscSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param psc_hostname: The IP address or DNS resolvable name of the remote PSC to which
            this configuring vCenter Server will be registered to.
            This attribute was added in **vSphere API 6.7**.
        :type  https_port: :class:`long` or ``None``
        :param https_port: The HTTPS port of the external PSC appliance.
            This attribute was added in **vSphere API 6.7**.
        ...
        :type  ssl_thumbprint: :class:`str` or ``None``
        :param ssl_thumbprint: SHA1 thumbprint of the server SSL certificate will be used for
            verification when ssl_verify field is set to true.
            This attribute was added in **vSphere API 6.7**.
            This attribute is only relevant if ``sslVerify`` is None or has the
            value true.
        :type  ssl_certificate: :class:`str` or ``None``
...
class DataMigrationEstimate(VapiStruct):
    ...
    required for the vCenter Server database migration.
    ...
    def __init__(self,
        ...
        :param required_free_disk_space_on_source: The extra free space required on source vCenter Server.
            This attribute was added in **vSphere API 7.0.0.0**.
        """
...
class DataMigrationInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param core: Migrate only core data and configuration from vCenter Server.
            Events, tasks, and stats will not be migrated.
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :param all: Migrate all data from vCenter Server.
            This attribute was added in **vSphere API 7.0.0.0**.
...
class DiskInfo(VapiStruct):
    """
    The ``DiskInfo`` {class contains information about used space, free space,
    total size, and mount point of the disk.
    ...
    def __init__(self,
        ...
        """
        :type  used: :class:`float`
        :param used: Used disk space in GB
            This attribute was added in **vSphere API 8.0.3.0**.
        :type  free: :class:`float`
        :param free: Free disk space in GB
            This attribute was added in **vSphere API 8.0.3.0**.
        :type  size: :class:`float`
        :param size: Size of the disk in GB
            This attribute was added in **vSphere API 8.0.3.0**.
        :type  mount_point: :class:`str`
        :param mount_point: Mount point of the disk
            This attribute was added in **vSphere API 8.0.3.0**.
        """
        self.used = used
        self.free = free
...
DiskInfo._set_binding_type(type.StructType(
    'com.vmware.vcenter.deployment.disk_info', {
        'used': type.DoubleType(),
        'free': type.DoubleType(),
        'size': type.DoubleType(),
        'mount_point': type.StringType(),
    },
    DiskInfo,
    False,
    None))
...
class SourceInfo(VapiStruct):
    ...
    Server system and the database migration options.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self,
        ...
        :param version: Source vCenter Server version.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  deployment_type: :class:`ApplianceType`
        :param deployment_type: Deployment type of the source vCenter Server.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  deployment_size: :class:`ApplianceSize`
        :param deployment_size: Deployment size of the source vCenter Server.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  sso_domain_name: :class:`str`
        :param sso_domain_name: The SSO domain name of the source vCenter Server.
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :param data_migration_info: Contains all the available migrate options, estimated export and
            import time and the space required to migrate the data.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute will be available if estimate data is available for
            the appliance.
        :type  disk_info: :class:`list` of :class:`DiskInfo` or ``None``
        :param disk_info: Contains information about the list of available disks
            This attribute was added in **vSphere API 8.0.3.0**.
            If None disk info was not fetched for the vCenter Server
            filesystem.
        :type  replicated_partners: :class:`list` of :class:`str` or ``None``
        :param replicated_partners: Contains information about the list of replicated partner nodes
            This attribute was added in **vSphere API 8.0.3.0**.
            If None replicated partners information is not available for the
            current vCenter Server.
        """
        ...
        self.replicated_partners = replicated_partners
        VapiStruct.__init__(self)
...
SourceInfo._set_binding_type(type.StructType(
    'com.vmware.vcenter.deployment.source_info', {
        ...
        'disk_info': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'DiskInfo'))),
        'replicated_partners': type.OptionalType(type.ListType(type.StringType())),
    },
    SourceInfo,
    False,
    None))
...
class CheckInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param source_info: Information collected from the source machine.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is used only for upgrade.
        """
        self.status = status
        self.result = result
...
class LocationSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  hostname: :class:`str`
        :param hostname: The IP address or DNS resolvable name of the container.
            This attribute was added in **vSphere API 6.7**.
        :type  https_port: :class:`long` or ``None``
        :param https_port: The HTTPS port of the container.
            This attribute was added in **vSphere API 6.7**.
            If None, port 443 will be used.
        :type  ssl_thumbprint: :class:`str` or ``None``
        :param ssl_thumbprint: SHA1 thumbprint of the server SSL certificate will be used for
        ...
        :param username: The administrator account on the host.
            This attribute was added in **vSphere API 6.7**.
        :type  password: :class:`str`
        :param password: The administrator account password.
            This attribute was added in **vSphere API 6.7**.
        """
        self.hostname = hostname
        self.https_port = https_port
...
class Install(VapiInterface):
    ...
    class VcsaEmbeddedSpec(VapiStruct):
        ...
        configure an embedded standalone or replicated vCenter Server.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param ceip_enabled: Whether CEIP should be enabled or disabled.
                This attribute was added in **vSphere API 6.7**.
            """
...
class Upgrade(VapiInterface):
    ...
    .. deprecated:: vSphere API 9.0.0.0
        This class is deprecated as of **vSphere API 9.0.0.0**. Deprecated
        since the Reduced Downtime Upgrade (RDU) will be used for upgrading
        vCenter Server. The RDU endpoint for vCenter Server upgrade is the
        following vcenter/lcm/deployment/migration-upgrade.
    """
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.deployment.Upgrade is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class VcsaEmbeddedSpec(VapiStruct):
        ...
        a Embedded vCenter Server appliance.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param ceip_enabled: Customer experience improvement program should be enabled or
                disabled for this embedded vCenter Server upgrade.
                This attribute was added in **vSphere API 6.7**.
            """
            warn('com.vmware.vcenter.deployment.Upgrade.VcsaEmbeddedSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.ceip_enabled = ceip_enabled
            VapiStruct.__init__(self)
    ...
    class PscSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  ceip_enabled: :class:`bool`
            :param ceip_enabled: Customer experience improvement program should be enabled or
                disabled for this Platform Services Controller upgrade.
                This attribute was added in **vSphere API 6.7**.
            """
            warn('com.vmware.vcenter.deployment.Upgrade.PscSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.ceip_enabled = ceip_enabled
            VapiStruct.__init__(self)
    ...
    class SourceApplianceSpec(VapiStruct):
        ...
        connect to the appliance used as the source for an upgrade.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            """
            :type  hostname: :class:`str`
            :param hostname: The IP address or DNS resolvable name of the source appliance.
                This attribute was added in **vSphere API 6.7**.
            :type  https_port: :class:`long` or ``None``
            :param https_port: The HTTPS port of the source appliance.
                This attribute was added in **vSphere API 6.7**.
                If None, port 443 will be used.
            :type  ssl_thumbprint: :class:`str` or ``None``
            :param ssl_thumbprint: SHA1 thumbprint of the server SSL certificate will be used for
            ...
            :param ssl_verify: SSL verification should be enabled or disabled for the source
                ...
                thumbprint for the verification.
                This attribute was added in **vSphere API 6.7**.
                If None, ssl_verify true will be used.
            :type  sso_admin_username: :class:`str`
            :param sso_admin_username: The SSO administrator account on the source appliance.
                This attribute was added in **vSphere API 6.7**.
            :type  sso_admin_password: :class:`str`
            :param sso_admin_password: The SSO administrator account password.
                This attribute was added in **vSphere API 6.7**.
            :type  root_password: :class:`str`
            :param root_password: The password of the root user on the source appliance.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param ssh_thumbprint: MD5 thumbprint of the server SSH key will be used for verification.
                ...
                value true.
            """
            warn('com.vmware.vcenter.deployment.Upgrade.SourceApplianceSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.hostname = hostname
            self.https_port = https_port
            self.ssl_thumbprint = ssl_thumbprint
            self.ssl_certificate = ssl_certificate
    ...
    class UpgradeSpec(VapiStruct):
        ...
        def __init__(self,
                     ...
                     vcsa_embedded=None,
                     psc=None,
                     replicated_partner_hostname=None,
            ...
            :param source_appliance: Source appliance spec.
                This attribute was added in **vSphere API 6.7**.
            :type  source_location: :class:`LocationSpec`
            :param source_location: Source location spec.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param history: Determines how vCenter history will be migrated during the upgrade
                ...
                * Tasks
                ...
                which part of vCenter history data will be migrated and when.
                This attribute was added in **vSphere API 6.7**.
                If None, only core database content will be migrated.
            :type  vcsa_embedded: :class:`Upgrade.VcsaEmbeddedSpec` or ``None``
            :param vcsa_embedded: Information that are specific to this embedded vCenter Server.
                This attribute was added in **vSphere API 6.7**.
            ...
            :type  replicated_partner_hostname: :class:`str` or ``None``
            :param replicated_partner_hostname: Applicable only if the convergence is in progress and at least one
                of the nodes is already upgraded. Set the replication partner for
                the currently upgraded node and provide the value of any previously
                converged upgraded node host name as either IP address or FQDN. If
                None, when the upgrade finishes, the vCenter Server external
                Platform Services Controller are converged into the vCenter Server
                appliance.
                This attribute was added in **vSphere API 8.0.3.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  export_directory: :class:`str` or ``None``
            :param export_directory: Use the option to provide export directory information during
                vCenter Server upgrade.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None, will default to seat directory.
            :type  auto_answer: :class:`bool` or ``None``
            :param auto_answer: Use the default option for any questions that may come up during
                appliance configuration.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param skip_products_prechecks: Use the option to skip products interoperability checks during
                ...
                If None, will default to false.
            """
            warn('com.vmware.vcenter.deployment.Upgrade.UpgradeSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.source_appliance = source_appliance
            self.source_location = source_location
            self.history = history
            self.vcsa_embedded = vcsa_embedded
            self.psc = psc
            self.replicated_partner_hostname = replicated_partner_hostname
    ...
    UpgradeSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.deployment.upgrade.upgrade_spec', {
            ...
            'replicated_partner_hostname': type.OptionalType(type.StringType()),
            'export_directory': type.OptionalType(type.StringType()),
            'auto_answer': type.OptionalType(type.BooleanType()),
    ...
    def get(self):
        ...
        """
        warn('com.vmware.vcenter.deployment.Upgrade.get is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        return self._invoke('get', None)
    ...
    def check(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the appliance is not in INITIALIZED state.
        """
        warn('com.vmware.vcenter.deployment.Upgrade.check is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        return self._invoke('check',
                            {
                            'spec': spec,
                            })
    ...
    def start(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the appliance is not in INITIALIZED state.
        """
        warn('com.vmware.vcenter.deployment.Upgrade.start is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        return self._invoke('start',
                            {
                            'spec': spec,
                            })
    ...
    def cancel(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            ...
            operation is not INSTALL.
        """
        warn('com.vmware.vcenter.deployment.Upgrade.cancel is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        return self._invoke('cancel', None)
class Migrate(VapiInterface):
    """
    The ``Migrate`` class provides methods to configure the migration of this
    appliance from an existing vCenter for Windows.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.deployment.Migrate is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class VcsaEmbeddedSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  ceip_enabled: :class:`bool`
            :param ceip_enabled: Customer experience improvement program should be enabled or
                disabled for this embedded vCenter Server migration.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.deployment.Migrate.VcsaEmbeddedSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.ceip_enabled = ceip_enabled
            VapiStruct.__init__(self)
    ...
    class PscSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  ceip_enabled: :class:`bool`
            :param ceip_enabled: Customer experience improvement program should be enabled or
                disabled for this Platform Services Controller migration.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.deployment.Migrate.PscSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.ceip_enabled = ceip_enabled
            VapiStruct.__init__(self)
    ...
    class SourceVcWindows(VapiStruct):
        ...
        windows vCenter Server that is going to be migrated.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param username: The SSO account with administrative privilege to perform the
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  password: :class:`str`
            :param password: The SSO administrator account password.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.deployment.Migrate.SourceVcWindows is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.hostname = hostname
            self.username = username
            self.password = password
            VapiStruct.__init__(self)
    ...
    class MigrationAssistantSpec(VapiStruct):
        ...
        windows vCenter Server machine.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  https_port: :class:`long` or ``None``
            :param https_port: The HTTPS port being used by Migration Assistant.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param ssl_certificate: The SSL Certificate of the server that will be used for
                ...
                in PEM format.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is only relevant if ``#sslVerify`` is None or has
                the value true.
            """
            warn('com.vmware.vcenter.deployment.Migrate.MigrationAssistantSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.https_port = https_port
            self.ssl_thumbprint = ssl_thumbprint
            self.ssl_certificate = ssl_certificate
            VapiStruct.__init__(self)
    ...
    class MigrateSpec(VapiStruct):
        ...
        existing vCenter Server for Windows to an appliance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param source_vc_windows: Information specific to the Windows vCenter Server.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param vcsa_embedded: Information specific to an embedded vCenter Server.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param psc: Information specific to a Platform Services Controller.
                This attribute was added in **vSphere API 7.0.0.0**.
                Only required if the vCenter Server that is going to be migrated is
            ...
            :param active_directory: Information specific to the Active Directory server to which the
                source windows vCenter Server is joined.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :type  replicated_partner_hostname: :class:`str` or ``None``
            :param replicated_partner_hostname: Applicable only if the convergence is in progress and at least one
                of the nodes is already migrated. Set the replication partner for
                the currently migrated node and provide the value of any previously
                converged migrated node host name as either IP address or FQDN. If
                None, when the migration finishes, the vCenter Server external
                Platform Services Controller are converged into the vCenter Server
                appliance.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  export_directory: :class:`str` or ``None``
            :param export_directory: Use the option to provide export directory information during
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, will default to root directory.
            """
            warn('com.vmware.vcenter.deployment.Migrate.MigrateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self):
        ...
        """
        warn('com.vmware.vcenter.deployment.Migrate.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('get', None)
    ...
    def check(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the appliance is not in INITIALIZED state.
        """
        warn('com.vmware.vcenter.deployment.Migrate.check is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('check',
                            {
                            'spec': spec,
                            })
    ...
    def start(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the appliance is not in INITIALIZED state.
        """
        warn('com.vmware.vcenter.deployment.Migrate.start is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('start',
                            {
                            'spec': spec,
                            })
    ...
    def cancel(self):
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            ...
            operation is not INSTALL.
        """
        warn('com.vmware.vcenter.deployment.Migrate.cancel is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('cancel', None)
class Question(VapiInterface):
    """
    The ``Question`` class provides methods to get the question raised during
    deployment and to answer them.
    This class was added in **vSphere API 6.7**.
    """
    ...
    class Question(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  id: :class:`str`
            :param id: Id of the question raised.
                This attribute was added in **vSphere API 6.7**.
            :type  question: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param question: Message describing the question.
                This attribute was added in **vSphere API 6.7**.
            :type  type: :class:`Question.QuestionType`
            :param type: Type of the question raised.
                This attribute was added in **vSphere API 6.7**.
            :type  default_answer: :class:`str`
            :param default_answer: Default answer value.
                This attribute was added in **vSphere API 6.7**.
            :type  possible_answers: :class:`list` of :class:`str`
            :param possible_answers: Possible answers values.
                This attribute was added in **vSphere API 6.7**.
            """
            self.id = id
    ...
    class Info(VapiStruct):
        ...
        raised during the deployment process.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param questions: One or more questions raised during the deployment.
                This attribute was added in **vSphere API 6.7**.
            """
    ...
    class AnswerSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param answer_val: The answer value.
                This attribute was added in **vSphere API 6.7**.
            """
...
class ImportHistory(VapiInterface):
    ...
    imported separately from the upgrade.
    This class was added in **vSphere API 6.7**.
    """
    ...
    class Info(VapiStruct):
        ...
        of vCenter history import task.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param progress: The progress info of this task.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param result: Result of the operation. If an operation reports partial results
                ...
                value could change as the operation progresses.
                This attribute was added in **vSphere API 6.7**.
                This attribute will be None if result is not available at the
    ...
    class CreateSpec(VapiStruct):
        ...
        start vCenter historical data deferred import
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: Name of the vCenter history import task
                This attribute was added in **vSphere API 6.7**.
            :type  description: :class:`str`
            :param description: Description of the vCenter history import task.
                This attribute was added in **vSphere API 6.7**.
            """
            self.name = name
            self.description = description
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'check': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InternalServerError'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'answer': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InternalServerError'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'start': {
                ...
                'output_type': type.VoidType(),
                'errors': start_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': start_input_value_validator_list,
                'output_validator_list': start_output_validator_list,
                'task_type': TaskType.NONE,
            },
