...
class ConsumerPrincipals(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param certificates: The certificates used by the vCenter STS to sign tokens.
            ...
            :param principal: The principal used by the vCenter to retrieve tokens.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class FilterSpec(VapiStruct):
        ...
        a connection profile on the trusted vCenter.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param id: The unqiue identifier of a connection profile.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
            ...
            :param principals: The principal used by the vCenter to retrieve tokens.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.id = id
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param principal: The principal used by the vCenter to retrieve tokens. Currently
                this is the vCenter solution user.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  issuer_alias: :class:`str`
            :param issuer_alias: A user-friendly alias of the service which created and signed the
                security token.
            ...
            :param message: A localizable message describing the health of the profile.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, the certificates won't be updated.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.id = id
            self.principal = principal
            self.issuer_alias = issuer_alias
            self.issuer = issuer
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param issuer: The service which created and signed the security token.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.ConsumerPrincipals.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.id = id
            self.principal = principal
            self.issuer_alias = issuer_alias
            self.issuer = issuer
    ...
    def create_task(self,
        ...
        hosts from a Trust Authority Cluster.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ManageAttestingSSO``.
    ...
    def get_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ReadAttestingSSO``.
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``System.View``.
        """
...
class _ConsumerPrincipalsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trust-authority-clusters/{cluster}/consumer-principals?action=query',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        operations = {
            'create$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
