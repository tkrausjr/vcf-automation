...
#
# vAPI stub file for package com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.
#---------------------------------------------------------------------------
...
CreateSpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.create_spec', {
...
class Info(VapiStruct):
    """
    The ``Info`` class contains information about a VM-VM anti-affinity policy,
    see :func:`com.vmware.vcenter.compute_client.Policies.get`. All virtual
    machines that share the tag indicated by :attr:`Info.vm_tag` are
    anti-affine to each other in VMware Cloud on AWS. Usage beyond VMware Cloud
    on AWS is not supported.
    **Warning:** this class is available as Technology Preview. These are early
    access APIs provided to test, automate and provide feedback on the feature.
...
Info._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm_vm_anti_affinity.info', {
        'vm_tag': type.IdType(resource_types='com.vmware.cis.tagging.Tag:VirtualMachine'),
        'name': type.StringType(),
        'description': type.StringType(),
        'capability': type.IdType(resource_types='com.vmware.vcenter.compute.policies.Capability'),
