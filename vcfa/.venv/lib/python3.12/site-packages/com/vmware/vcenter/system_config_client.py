...
class DeploymentType(VapiInterface):
    ...
    class ReconfigureSpec(VapiStruct):
        ...
        get and set the appliance type.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param remote_psc: External PSC to register with when reconfiguring a VCSA_EMBEDDED
                appliance to a VCSA_EXTERNAL appliance.
                This attribute was added in **vSphere API 6.7**.
...
class PscRegistration(VapiInterface):
    ...
    PSC_EXTERNAL appliance a VCSA_EXTERNAL appliance is registered with.
    This class was added in **vSphere API 6.7**.
    """
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param https_port: The HTTPs port used by the external PSC.
                This attribute was added in **vSphere API 6.7**.
            :type  sso_domain: :class:`str`
            :param sso_domain: The Single Sign-On domain name of the external PSC.
                This attribute was added in **vSphere API 6.7**.
            """
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'repoint': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
