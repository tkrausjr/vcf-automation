...
class HostnameGenerator(VapiStruct):
    ...
    def __init__(self,
        ...
        :param type: The type of the Name Generator
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  fixed_name: :class:`str`
        :param fixed_name: The virtual machine name specified by the client.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is :attr:`HostnameGenerator.Type.FIXED`.
        :type  prefix: :class:`str`
        :param prefix: Base prefix, to which a unique number is appended.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
    ...
    class Type(Enum):
        ...
        machine during the customization.
        ...
        guest operating system and reports information to VirtualCenter.
...
class UserData(VapiStruct):
    ...
    def __init__(self,
        ...
        :param full_name: Full name of the end user. Note that this is not the username but
            full name specified in "Firstname Lastname" format.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  organization: :class:`str`
        :param organization: Name of the organization that owns the computer.
            This attribute was added in **vSphere API 7.0.0.0**.
...
class Domain(VapiStruct):
    ...
    _validator_list = [
        UnionValidator(
            'type',
            {
                ...
                'DOMAIN' : [('domain', True), ('domain_username', True), ('domain_password', True), ('domain_OU', False)],
            }
        ),
    ]
    ...
    def __init__(self,
        ...
        :param type: The type of network to join after the customization.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  workgroup: :class:`str`
        :param workgroup: The workgroup that the virtual machine should join.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is :attr:`Domain.Type.WORKGROUP`.
        :type  domain: :class:`str`
        :param domain: The domain to which the virtual machine should be joined.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
        ...
        :param domain_username: The domain user that has permission to join the domain after
            virtual machine is joined.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is :attr:`Domain.Type.DOMAIN`.
        :type  domain_password: :class:`str`
        :param domain_password: The domain user password that has permission to join the
            :attr:`Domain.domain_username` after customization.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is :attr:`Domain.Type.DOMAIN`.
        :type  domain_ou: :class:`str` or ``None``
        :param domain_ou: The MachineObjectOU which specifies the full LDAP path name of the
            OU to which the virtual machine belongs. Refer to:
    ...
    class Type(Enum):
        ...
        should join to after the customization is completed.
        This enumeration was added in **vSphere API 7.0.0.0**.
...
Domain._set_binding_type(type.StructType(
    'com.vmware.vcenter.guest.domain', {
        ...
        'domain_OU': type.OptionalType(type.StringType()),
    },
    Domain,
    False,
    None))
...
class WindowsSysprep(VapiStruct):
    ...
    operating system during customization.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self,
        ...
        :param gui_run_once_commands: A list of commands to run at first user logon, after customizing
            ...
            directly mapped to the GuiRunOnce key in the
            This attribute was added in **vSphere API 7.0.0.0**.
            If None, no commands are run.
        :type  user_data: :class:`UserData`
        :param user_data: Personal data pertaining to the owner of the virtual machine.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  domain: :class:`Domain` or ``None``
        :param domain: Information needed to join a workgroup or domain.
            This attribute was added in **vSphere API 7.0.0.0**.
            If None, the guest will not be joined to any workgroup or a domain.
        :type  gui_unattended: :class:`GuiUnattended`
        :param gui_unattended: Information related to unattended installation.
            This attribute was added in **vSphere API 7.0.0.0**.
        """
...
class WindowsConfiguration(VapiStruct):
    ...
    def __init__(self,
        ...
        :param sysprep: Customization settings like user details, administrator details,
            ...
            ``sysprep`` or ``sysprepXml`` must be specified.
            This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class RebootOption(Enum):
        ...
        done to the guest after the customization.
        This enumeration was added in **vSphere API 7.0.0.0**.
        ...
        can be used to look at values for debugging purposes.
...
class LinuxConfiguration(VapiStruct):
    ...
    def __init__(self,
        ...
        :param hostname: The network host name of the Linux virtual machine.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  domain: :class:`str`
        ...
        :param time_zone: The case-sensitive time zone, such as Europe/Sofia. Valid time zone
            ...
            time zones for different versions in Linux.
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :type  compatible_customization_method: :class:`str` or ``None``
        :param compatible_customization_method: The compatible customization method is an identifier of a
            customization strategy which is implementable in a group of Linux
            operating systems. This value does not need to be set if your
            operating system is officially supported by VMware guest operating
            system customization. When using a Linux operating system which
            hasn't been officially supported and it is designed to be 100%
            bug-for-bug compatible with an officially supported Linux operating
            system, it can be customized by an existing customization method.
            
            Please set the compatible customization method to a supported
            string value e.g. "GOSC_METHOD_1".
            See all the supported compatible customization methods in
            https://kb.vmware.com/s/article/95903
            This attribute was added in **vSphere API 8.0.3.0**.
            If None, the customization may fail in a Linux operating systems
            which hasn't been officially supported.
        """
        self.hostname = hostname
        self.domain = domain
        self.time_zone = time_zone
        self.script_text = script_text
        self.compatible_customization_method = compatible_customization_method
        VapiStruct.__init__(self)
...
LinuxConfiguration._set_binding_type(type.StructType(
    'com.vmware.vcenter.guest.linux_configuration', {
        ...
        'compatible_customization_method': type.OptionalType(type.StringType()),
    },
    LinuxConfiguration,
    False,
    None))
...
class CloudinitConfiguration(VapiStruct):
    ...
    https://cloudinit.readthedocs.io/en/latest about cloud-init.
    ...
    def __init__(self,
        ...
        :param metadata: Metadata includes the network, instance id and hostname that
            ...
            about supported meta data formats.
...
class CloudConfiguration(VapiStruct):
    ...
    and the settings of that cloud configuration.
    This class was added in **vSphere API 7.0.3.0**.
    ...
    def __init__(self,
        ...
        :param type: The type of the cloud configuration.
            This attribute was added in **vSphere API 7.0.3.0**.
...
class ConfigurationSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param cloud_config: Guest customization specification with cloud configuration.
            This attribute was added in **vSphere API 7.0.3.0**.
            If None, :attr:`ConfigurationSpec.windows_config` or
...
class GlobalDNSSettings(VapiStruct):
    ...
    def __init__(self,
        ...
        :param dns_suffix_list: List of name resolution suffixes for the virtual network adapter.
            ...
            is listed on a per-adapter basis.
            This attribute was added in **vSphere API 7.0.0.0**.
...
class Ipv4(VapiStruct):
    ...
    def __init__(self,
        ...
        :param type: The type of the IPv4 configuration.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  ip_address: :class:`str`
        :param ip_address: The static IPv4 address
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is optional and it is only relevant when the value
        ...
        :param gateways: Gateways for the IPv4 address.
            This attribute was added in **vSphere API 7.0.0.0**.
...
class Ipv6Address(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  ip_address: :class:`str`
        :param ip_address: Static IPv6 Address.
            This attribute was added in **vSphere API 7.0.0.0**.
        :type  prefix: :class:`long`
...
class Ipv6(VapiStruct):
    ...
    def __init__(self,
        ...
        :param type: The IPv6 configuration type
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :type  gateways: :class:`list` of :class:`str` or ``None``
        :param gateways: gateways for the IPv6 address.
            This attribute was added in **vSphere API 7.0.0.0**.
            If None, no gateways are set.
        """
        self.type = type
...
class WindowsNetworkAdapterSettings(VapiStruct):
    ...
    def __init__(self,
        ...
        :param dns_servers: A list of server IP addresses to use for DNS lookup in a Windows
            ...
            these settings override the DHCP settings.
            This attribute was added in **vSphere API 7.0.0.0**.
            If None, no DNS servers are set.
        :type  dns_domain: :class:`str` or ``None``
        :param dns_domain: A DNS domain suffix such as vmware.com.
            This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class NetBIOSMode(Enum):
        ...
        NetBIOS settings for Windows guest operating systems.
        This enumeration was added in **vSphere API 7.0.0.0**.
...
class IPSettings(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ipv4: Specification to configure IPv4 address, subnet mask and gateway
            info for this virtual network adapter.
            This attribute was added in **vSphere API 7.0.0.0**.
            This attribute is currently required. If None, the specification
...
class AdapterMapping(VapiStruct):
    ...
    def __init__(self,
        ...
        :param adapter: The IP settings for the associated virtual network adapter.
            This attribute was added in **vSphere API 7.0.0.0**.
        """
...
class CustomizationSpec(VapiStruct):
    ...
    a virtual machine when deploying it or migrating it to a new host.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self,
        ...
        :param configuration_spec: Settings to be applied to the guest during the customization.
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :param global_dns_settings: Global DNS settings constitute the DNS settings that are not
            specific to a particular virtual network adapter.
            This attribute was added in **vSphere API 7.0.0.0**.
...
class CustomizationSpecs(VapiInterface):
    ...
    class OsType(Enum):
        ...
        operating systems for which guest customization is supported.
    ...
    class Format(Enum):
        ...
        customization specification can be exported to.
        This enumeration was added in **vSphere API 7.0.0.0**.
    ...
    class Metadata(VapiStruct):
        ...
        description related to a customization specification.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param description: Description of the specification.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  name: :class:`str`
    ...
    class CreateSpec(VapiStruct):
        ...
        :func:`CustomizationSpecs.create` method.
        This class was added in **vSphere API 7.0.0.0**.
    ...
    class Spec(VapiStruct):
        ...
        :func:`CustomizationSpecs.set` method.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param fingerprint: The fingerprint is a unique identifier for a given version of the
                ...
                specification content was read and until it is applied.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  spec: :class:`CustomizationSpec`
            :param spec: The specification object.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        by the :func:`CustomizationSpecs.get` method.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param last_modified: Time when the specification was last modified.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param names: Names that guest customization specifications must have to match
                the filter (see :attr:`CustomizationSpecs.Summary.name`).
            ...
            :param os_type: Guest operating system type that guest customization specifications
                ...
                :attr:`CustomizationSpecs.Summary.os_type`).
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class Summary(VapiStruct):
        ...
        about a guest customization specification.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: Name of the guest customization specification.
                This attribute was added in **vSphere API 6.7.1**.
                When clients pass a value of this class as a parameter, the
                ...
                ``com.vmware.vcenter.guest.CustomizationSpec``.
            :type  description: :class:`str`
            :param description: Description of the guest customization specification.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    def set(self,
        ...
        :func:`CustomizationSpecs.get`) and editing it.
        This method was added in **vSphere API 7.0.0.0**.
    ...
    def export(self,
        ...
        be set to blank values during the export method.
        This method was added in **vSphere API 7.0.0.0**.
    ...
    def import_specification(self,
        ...
        passed to :func:`CustomizationSpecs.create` method.
        This method was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'import_specification': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
