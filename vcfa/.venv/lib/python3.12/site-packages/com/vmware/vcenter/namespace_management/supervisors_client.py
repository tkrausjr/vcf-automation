...
class ImageSourceType(Enum):
    """
    The ``ImageSourceType`` class represents the entity hosting the Supervisor
    images.
    ...
    EMBEDDED = None
    """
    The Supervisor image is packaged with vCenter Server.

    """
    CONTENT_LIBRARY = None
    """
    The Supervisor image is hosted in a Content Library configured with vSphere
    Namespaces.
    ...
    def __init__(self, string):
        ...
        :param string: String value for the :class:`ImageSourceType` instance.
        """
        Enum.__init__(string)

ImageSourceType._set_values({
    'EMBEDDED': ImageSourceType('EMBEDDED'),
    'CONTENT_LIBRARY': ImageSourceType('CONTENT_LIBRARY'),
})
ImageSourceType._set_binding_type(type.EnumType(
    'com.vmware.vcenter.namespace_management.supervisors.image_source_type',
    ImageSourceType))
...
class ResourceNamingStrategy(Enum):
    """
    The ``ResourceNamingStrategy`` class represents the strategy to generate
    the Kubernetes resource names in a Supervisor for items in a Content
    Library associated with the Supervisor. The relevant Kubernetes resources
    include cluster scoped ClusterContentLibraryItem, and
...
ResourceNamingStrategy._set_binding_type(type.EnumType(
    'com.vmware.vcenter.namespace_management.supervisors.resource_naming_strategy',
...
class SizingHint(Enum):
    ...
    to get information associated with a ``SizingHint``.
...
class ControlPlane(VapiStruct):
    ...
    support the control plane runtime.
    ...
    def __init__(self,
        ...
        :param network: 
            ...
            routable from workload network traffic.
        ...
        :param login_banner: 
            ...
            to login via the Kubectl plugin.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param size: 
            ...
            to the Kubernetes API server and the worker nodes.
            This attribute was added in **vSphere API 8.0.0.1**.
            Defaults to SMALL.
        ...
        :param storage_policy: 
            ...
            backing the Supervisor Kubernetes API server.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param count: Number of control plane VMs requested during Supervisor enablement.
...
class ImageSourceSpec(VapiStruct):
    """
    The ``ImageSourceSpec`` class contains the specification about the
    configuration of a Supervisor image.
    ...
    def __init__(self,
        ...
        """
        :type  source_type: :class:`ImageSourceType`
        :param source_type: Represents the source of the Supervisor images.
            This attribute was added in **vSphere API 9.0.0.0**.
        :type  library: :class:`str` or ``None``
        :param library: If a Supervisor image is hosted in CONTENT_LIBRARY,
            :attr:`ImageSourceSpec.library` represents the identifier of that
            Content Library.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ...
            of ``sourceType`` is :attr:`ImageSourceType.CONTENT_LIBRARY`.
        """
...
ImageSourceSpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.namespace_management.supervisors.image_source_spec', {
        'source_type': type.ReferenceType(__name__, 'ImageSourceType'),
        'library': type.OptionalType(type.IdType()),
    },
    ImageSourceSpec,
    False,
    None))
...
class ImageSyncConfig(VapiStruct):
    ...
    def __init__(self,
        ...
        :param kubernetes_content_library: 
            ...
            the Content Library which holds the VM Images for vSphere
            Kubernetes Service. 
            ...
            .. deprecated:: vSphere API 9.0.0.0
                ...
                :attr:`ImageSyncConfig.content_libraries` instead.
        ...
        :param content_libraries: 
            ...
            If :attr:`ImageSyncConfig.kubernetes_content_library` is
...
class ContentLibrarySpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param content_library: 
            ...
            should exist in the vSphere inventory.
            This attribute was added in **vSphere API 8.0.2.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ``com.vmware.content.Library``. When methods return a value of this
        ...
        :param supervisor_services: List of Supervisor Service IDs that are currently making use of the
            ...
            Supervisor Services. :attr:`ContentLibrarySpec.supervisor_services`
            holds a list of
            :attr:`com.vmware.vcenter.namespace_management_client.SupervisorServices.Summary.supervisor_service`
            which is used to identify the Supervisor Services that are making
            use of this Content Library. 
        ...
        :type  resource_naming_strategy: :class:`ResourceNamingStrategy` or ``None``
        :param resource_naming_strategy: The resource naming strategy that is used to generate the
            ...
            :func:`com.vmware.vcenter.namespace_management_client.Supervisors.enable_on_compute_cluster`
            method and
            :func:`com.vmware.vcenter.namespace_management_client.Supervisors.enable_on_zones`
            method if this ``resourceNamingStrategy`` is set to
            :attr:`ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID` on a
            ...
            :attr:`ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID`.
            This attribute was added in **vSphere API 9.0.0.0**.
            ...
            :attr:`ResourceNamingStrategy.FROM_ITEM_ID`.
        """
...
ContentLibrarySpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.namespace_management.supervisors.content_library_spec', {
        ...
        'resource_naming_strategy': type.OptionalType(type.ReferenceType(__name__, 'ResourceNamingStrategy')),
    },
    ContentLibrarySpec,
    False,
    None))
...
class Workloads(VapiStruct):
    ...
    lifecycle of Kubernetes workloads.
    This class was added in **vSphere API 8.0.0.1**.
    ...
    def __init__(self,
        ...
        :param edge: 
            ...
            Supervisor and the load balancer.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param kube_api_server_options: 
            ...
            options for the Kubernetes API Server.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param storage: 
            ...
            configure policies for both images and volumes.
            This attribute was added in **vSphere API 8.0.0.1**.
...
class KubeAPIServerOptions(VapiStruct):
    ...
    def __init__(self,
        ...
        :param security: 
            ...
            configuration options for the API server security.
            This attribute was added in **vSphere API 8.0.0.1**.
...
class Conditions(VapiInterface):
    ...
    class Condition(VapiStruct):
        ...
        def __init__(self,
            ...
            :param severity: Provides an explicit classification of the reason identifier. Can
                be set when the value of status is not TRUE.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class ConditionGroup(VapiStruct):
        ...
        of related configuration states of Supervisor.
        ...
        def __init__(self,
            ...
            :param description: Description of the condition group type in a human readable format.
                This attribute was added in **vSphere API 8.0.3.0**.
            :type  status: :class:`Conditions.ConditionGroup.Status`
            ...
            :param conditions: Information about all the conditions constituting condition group,
                each condition represents the configuration stage.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
            self.type = type
            self.description = description
        ...
        class Status(Enum):
            """
            The ``Conditions.ConditionGroup.Status`` class represents the overall
            status of the condition group.
            ...
            SUCCEEDED = None
            """
            All conditions executed successfully.

            """
            RUNNING = None
            """
            One or more conditions part of this condition group are in the running
            state and none of the other conditions are in
            :attr:`Conditions.ConditionGroup.Status.ERROR` or
            :attr:`Conditions.ConditionGroup.Status.WARNING` state.

            """
            WARNING = None
            """
            One or more conditions part of this condition group are in warning state
            and none of the other conditions are in
            :attr:`Conditions.ConditionGroup.Status.ERROR` state.

            """
            ERROR = None
            """
            One or more conditions are in the error state.

            """
            UNKNOWN = None
            """
            Indicates the status of one or more conditions part of this condition group
            can not be determined. Condition group status will be set to {#member
            UNKNOWN}, if all conditions are in unknown state or there is at least one
            condition in unknown state and all others are in
            :attr:`Conditions.ConditionGroup.Status.SUCCEEDED` state.
        ...
        Status._set_binding_type(type.EnumType(
            'com.vmware.vcenter.namespace_management.supervisors.conditions.condition_group.status',
            Status))
    ...
    ConditionGroup._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.conditions.condition_group', {
            'type': type.StringType(),
            'description': type.ReferenceType('com.vmware.vapi.std_client', 'LocalizableMessage'),
            'status': type.OptionalType(type.ReferenceType(__name__, 'Conditions.ConditionGroup.Status')),
...
class ContainerImageRegistries(VapiInterface):
    ...
    class CreateSpec(VapiStruct):
        ...
        required to create a container image registry.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param name: Name of the container image registry. This name is unique across
                all container image registries in one Supervisor.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param default_registry: Indicates if this container image registry serves as the default
                ...
                default, Docker Hub will be treated as the default.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        specification required to update a container image registry.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param name: Name of the container image registry.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None then no update will be made.
            :type  hostname: :class:`str` or ``None``
            :param hostname: IP address or the hostname of the container image registry.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None then no update will be made.
            :type  port: :class:`long` or ``None``
            :param port: Port number of the container image registry.
            ...
            :param certificate_chain: certificateChain contains PEM-encoded CA chain which is used to
                verify x509 certificates received from the server.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None then no update will be made.
            :type  default_registry: :class:`bool` or ``None``
            :param default_registry: Indicates if this registry is used as default.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None then no update will be made.
            """
            self.name = name
    ...
    class Info(VapiStruct):
        ...
        information about the container image registry.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            """
            :type  id: :class:`str`
            :param id: Identifier of the container image registry.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
...
class Summary(VapiInterface):
    ...
    class ConfigStatus(Enum):
        ...
        CONFIGURING = None
        """
        The Namespace configuration is being applied to the Supervisor.

        """
        REMOVING = None
        """
        The Namespace configuration is being removed from the Supervisor.
    ...
    class KubernetesStatus(Enum):
        ...
        READY = None
        """
        The Supervisor is able to accept pods.

        """
        WARNING = None
        """
        The Supervisor may be able to accept pods, but has warning messages.

        """
        ERROR = None
        """
        The Supervisor may not be able to accept pods and has error messages.
    ...
    class Stats(VapiStruct):
        """
        The ``Summary.Stats`` class contains the basic Supervisor runtime
        statistics.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    class Info(VapiStruct):
        ...
        statistics and status related to the Supervisor.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param stats: Basic runtime statistics for the Supervisor.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param kubernetes_status: Current Status of the Supervisor's ability to deploy pods.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.name = name
            self.stats = stats
    ...
    class ListItem(VapiStruct):
        ...
        returned by :func:`Summary.list` method
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param info: The current state of the Supervisor.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
...
class SupervisorServices(VapiInterface):
    ...
    running instances of Supervisor Services on a vSphere Supervisor.
    This class was added in **vSphere API 8.0.3.0**.
    """
    ...
    class ConfigStatus(Enum):
        """
        The ``SupervisorServices.ConfigStatus`` class describes the progress of a
        Supervisor Service toward reaching its desired configuration state.
        This enumeration was added in **vSphere API 9.0.0.0**.
        ...
        CONFIGURING = None
        """
        The Supervisor Service is being installed.

        """
        REMOVING = None
        """
        The Supervisor Service is being deleted.

        """
        CONFIGURED = None
        """
        The Supervisor Service has been configured correctly (i.e. the provided
        YAML content has been applied successfully to the Supervisor)

        """
        ERROR = None
        """
        A failure occurred while reconciling the Supervisor Service. User
    ...
    ConfigStatus._set_binding_type(type.EnumType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.config_status',
        ConfigStatus))
    ...
    class CreateSpec(VapiStruct):
        ...
        required to install a Supervisor Service on a vSphere Supervisor.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param yaml_service_config: A set of additional configuration parameters to be applied during
                ...
                encoded YAML document. Complex data types with nested properties
                are supported.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, no additional configuration parameters will be applied
                when installing the Supervisor Service in the vSphere Supervisor.
            """
    ...
    CreateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.create_spec', {
            ...
            'yaml_service_config': type.OptionalType(type.SecretType()),
        },
        CreateSpec,
        False,
        None))
    ...
    class SetSpec(VapiStruct):
        """
        The ``SupervisorServices.SetSpec`` class provides a specification required
        to set a new configuration on a Supervisor Service in a vSphere Supervisor.
        This class is applied in entirety, replacing the current specification
        fully.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param yaml_service_config: A set of additional configuration parameters to be applied during
                ...
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, no additional configuration parameters will be applied
                when upgrading the Supervisor Service in the vSphere Supervisor.
            """
            self.version = version
            self.yaml_service_config = yaml_service_config
            VapiStruct.__init__(self)
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.set_spec', {
            'version': type.IdType(resource_types='com.vmware.vcenter.namespace_management.supervisor_services.Version'),
            'yaml_service_config': type.OptionalType(type.SecretType()),
        },
        SetSpec,
    ...
    class Message(VapiStruct):
        """
        The ``SupervisorServices.Message`` class contains information about the
        Supervisor Service on a Supervisor, and can include details about
        compatibility, Service status, and more.
        This class was added in **vSphere API 8.0.3.0**.
    ...
    class Info(VapiStruct):
        """
        The ``SupervisorServices.Info`` class contains the detailed information
        about a Supervisor Service on the vSphere Supervisor.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param desired_version: The desired version of this Supervisor Service.
                This attribute was added in **vSphere API 9.0.0.0**.
            ...
            :param service_namespace: Identifier of the namespace to allocate the Supervisor Service's
                ...
                If None, there may have been an error while installing the
                Supervisor Service or the namespace has not been created yet.
            :type  config_status: :class:`SupervisorServices.ConfigStatus`
            :param config_status: Current setting for ``SupervisorServices.ConfigStatus``.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  messages: :class:`list` of :class:`SupervisorServices.Message`
            :param messages: Current set of messages associated with the Supervisor Service on
                the vSphere Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  current_version: :class:`str` or ``None``
            :param current_version: The current version for the Supervisor Service.
                This attribute was added in **vSphere API 9.0.0.0**.
            ...
            :param prefix: The prefix that will be added to the names of the Supervisor
                Service's Kubernetes resources.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, no prefix is set for this Service, or the prefix is not
                assigned yet.
            :type  yaml_service_config: :class:`str` or ``None``
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.info', {
            'desired_version': type.StringType(),
            'service_namespace': type.OptionalType(type.IdType()),
            'config_status': type.ReferenceType(__name__, 'SupervisorServices.ConfigStatus'),
            'messages': type.ListType(type.ReferenceType(__name__, 'SupervisorServices.Message')),
    ...
    Summary._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.summary', {
            'supervisor_service': type.IdType(resource_types='com.vmware.vcenter.namespace_management.SupervisorService'),
            'desired_version': type.StringType(),
            'config_status': type.ReferenceType(__name__, 'SupervisorServices.ConfigStatus'),
            'current_version': type.OptionalType(type.StringType()),
    ...
    class ListResult(VapiStruct):
        """
        The ``SupervisorServices.ListResult`` class represents the result of
        :func:`SupervisorServices.list` method.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  supervisor_services: :class:`list` of :class:`SupervisorServices.Summary`
            :param supervisor_services: List of Summary.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.supervisor_services = supervisor_services
            VapiStruct.__init__(self)
    ...
    ListResult._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.supervisor_services.list_result', {
            'supervisor_services': type.ListType(type.ReferenceType(__name__, 'SupervisorServices.Summary')),
        },
        ListResult,
        False,
        None))
    ...
    class PrecheckResult(VapiStruct):
        ...
        Supervisor Service version on a specific Supervisor.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param precheck_finish_time: The timestamp at which the compatibility pre-check finished
                This attribute was added in **vSphere API 8.0.3.0**.
            """
            self.target_version = target_version
        ...
        class Status(Enum):
            ...
            INCOMPATIBLE = None
            """
            The target version is incompatible with the Supervisor.
    ...
    def precheck(self,
        ...
        :func:`SupervisorServices.get_precheck_result` method.
        This method was added in **vSphere API 8.0.3.0**.
    ...
    def get_precheck_result(self,
        ...
        If the Supervisor Service on the Supervisor has been installed,
        upgraded or deleted since the last :func:`SupervisorServices.precheck`
        method, the stale result will be purged and the user should re-initiate
        a :func:`SupervisorServices.precheck` method.
        This method was added in **vSphere API 8.0.3.0**.
    ...
    def create(self,
        ...
        """
        Install a Supervisor Service on the specified vSphere Supervisor. This
        method will apply the Supervisor Service version's Service definition
        on the Supervisor. This method is possible only when the Supervisor
        ...
        :param spec: Specification for the Supervisor Service.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if ``spec`` contains any errors.
        :raise: :class:`com.vmware.vapi.std.errors_client.AlreadyExists` 
            if a Supervisor Service ID defined in ``spec`` is already installed
            on the Supervisor
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if Supervisor with the ID ``supervisor`` could not be located.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
    ...
    def list(self,
        ...
        """
        Return the summaries about all Supervisor Services installed on the
        specified vSphere Supervisor.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param supervisor: Identifier for the Supervisor.
            The parameter must be an identifier for the resource type:
            ``com.vmware.vcenter.namespace_management.supervisor.Supervisor``.
        :rtype: :class:`SupervisorServices.ListResult`
        :return: The list of summaries for all Supervisor Services installed on the
            Supervisor.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if Supervisor with the ID ``supervisor`` could not be located or
            the Supervisor Service is not installed on the Supervisor.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if the Supervisor doesn't support Supervisor Services.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user cannot be authenticated.
    ...
    def delete(self,
        ...
        """
        Uninstall a Supervisor Service from the specified vSphere Supervisor.
        This method will remove the Supervisor Service with the specified
        identifier by removing the corresponding namespace and deleting the
        operator(s) associated with the Supervisor Service. Note that this
        ...
        be orphaned if they have not been cleaned up or migrated.
        This method was added in **vSphere API 9.0.0.0**.
    ...
    def set(self,
        ...
        on the Supervisor. This method requires that the specified Supervisor
        ...
        :param supervisor_service: Identifier for the Supervisor Service.
            The parameter must be an identifier for the resource type:
            ``com.vmware.vcenter.namespace_management.SupervisorService``.
        :type  spec: :class:`SupervisorServices.SetSpec`
        :param spec: Specification for the Supervisor Service.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if the system reports an error while responding to the request.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
...
class Topology(VapiInterface):
    ...
    the infrastructure a Supervisor is running on.
    This class was added in **vSphere API 8.0.0.1**.
    """
    ...
    class Info(VapiStruct):
        ...
        association between vSphere Zones and vSphere Clusters.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _SupervisorServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        precheck_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/supervisors/{supervisor}/supervisor-services/{supervisorService}?action=precheck',
            request_body_parameter='spec',
            path_variables={
                'supervisor': 'supervisor',
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/supervisors/{supervisor}/supervisor-services',
            request_body_parameter='spec',
            path_variables={
                'supervisor': 'supervisor',
            },
        ...
        set_input_type = type.StructType('operation-input', {
            'supervisor': type.IdType(resource_types='com.vmware.vcenter.namespace_management.supervisor.Supervisor'),
            'supervisor_service': type.IdType(resource_types='com.vmware.vcenter.namespace_management.SupervisorService'),
            'spec': type.ReferenceType(__name__, 'SupervisorServices.SetSpec'),
        })
        set_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
        ...
        operations = {
            'precheck': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'get_precheck_result': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'create': {
                ...
                'output_type': type.VoidType(),
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'list': {
                'input_type': list_input_type,
                'output_type': type.ReferenceType(__name__, 'SupervisorServices.ListResult'),
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'metrics': 'com.vmware.vcenter.namespace_management.supervisors.metrics_client.StubFactory',
        ...
        'zones': 'com.vmware.vcenter.namespace_management.supervisors.zones_client.StubFactory',
    }
