...
class ExternalPool(VapiInterface):
    ...
    class Status(Enum):
        ...
        ENABLED = None
        """
        External entropy is enabled for the ESX host.

        """
        DISABLED = None
        """
        External entropy is disabled for the ESX host.
    ...
    class AddResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param capacity: Capacity of external entropy pool in bytes.
                This attribute was added in **vSphere API 8.0.1.0**.
    ...
    class Info(VapiStruct):
        ...
        by calling :func:`ExternalPool.add` method.
        This class was added in **vSphere API 8.0.1.0**.
    ...
    def add(self,
        ...
        entropy data sent will be discarded.
        This method was added in **vSphere API 8.0.1.0**.
...
class _ExternalPoolStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        add_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/host/{host}/entropy/external-pool?action=add',
