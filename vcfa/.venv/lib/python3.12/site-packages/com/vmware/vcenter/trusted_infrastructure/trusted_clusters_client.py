...
class ServicesAppliedConfig(VapiInterface):
    ...
    diverged from the desired state.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.ServicesAppliedConfig is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        cluster with respect to the desired state.
        ...
        NONE = None
        """
        The consistency of some applied configurations is unknown.
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.ServicesAppliedConfig.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: The health value which indicates whether the configuration applied
                to the cluster differs from the desired state.
            ...
            :param details: Details regarding the health. When the
                ...
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.ServicesAppliedConfig.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
    ...
    def get_task(self,
        ...
        Authority Component configurations in the given cluster.
    ...
    def update_task(self,
        ...
        Trusted Hosts in the cluster, if such hosts are found.
        This method was added in **vSphere API 7.0.1.0**.
    ...
    def delete_task(self,
        ...
        from any Trusted Hosts within the given cluster.
        This method was added in **vSphere API 7.0.1.0**.
