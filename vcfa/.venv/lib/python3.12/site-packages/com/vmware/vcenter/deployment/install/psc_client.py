...
class Replicated(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.deployment.install.psc.replicated'
    """
...
class Standalone(VapiInterface):
    ...
    for the standalone PSC satisfies the requirements.
    This class was added in **vSphere API 6.7**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.vcenter.deployment.install.psc.standalone'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
