...
class Compliance(VapiInterface):
    ...
    that specify storage policy requirements.
    ...
    class Status(Enum):
        ...
        virtual machine and its applicable entities.
        ...
        out-of-date until the edited policy is applied to the entity.
    ...
    class VmComplianceInfo(VapiStruct):
        ...
        storage policy compliance associated with a virtual machine.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param status: Status of the compliance operation.
                This attribute was added in **vSphere API 6.7**.
            :type  check_time: :class:`datetime.datetime`
            :param check_time: Date and time of the most recent compliance check.
                This attribute was added in **vSphere API 6.7**.
    ...
    class Info(VapiStruct):
        ...
        directory and/or it's virtual disks.
        This class was added in **vSphere API 6.7**.
