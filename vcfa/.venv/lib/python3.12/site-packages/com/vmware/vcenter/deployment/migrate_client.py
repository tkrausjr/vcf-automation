...
class ActiveDirectorySpec(VapiStruct):
    ...
    migrated vCenter Server appliance to the Active Directory.
    ...
    def __init__(self,
        ...
        :param domain: The domain name of the Active Directory server to which the
            migrated vCenter Server appliance should be joined.
        ...
        :param username: Active Directory user that has permission to join the Active
            Directory after the vCenter Server is migrated to appliance.
            This attribute was added in **vSphere API 7.0.0.0**.
        ...
        :param password: Active Directory user password that has permission to join the
            ...
            This attribute was added in **vSphere API 7.0.0.0**.
        """
        warn('com.vmware.vcenter.deployment.migrate.ActiveDirectorySpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        self.domain = domain
...
class ActiveDirectory(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.deployment.migrate.ActiveDirectory is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class CheckSpec(VapiStruct):
        ...
        the migrated vCenter Server appliance to the Active Directory.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param password: Active Directory user password that has permission to join the
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.deployment.migrate.ActiveDirectory.CheckSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def check(self,
        ...
        join the migrated vCenter Server appliance to the domain.
        ...
        """
        warn('com.vmware.vcenter.deployment.migrate.ActiveDirectory.check is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
