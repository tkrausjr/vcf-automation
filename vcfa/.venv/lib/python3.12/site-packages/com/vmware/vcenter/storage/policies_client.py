...
class Compliance(VapiInterface):
    ...
    entities of given compliance statuses.
    ...
    class Status(Enum):
        ...
        date until the latest policy is applied to the entity.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  vm: :class:`str`
            :param vm: Identifier of virtual machine
            ...
            :param disks: List of the virtual hard disk.
                This attribute was added in **vSphere API 6.7**.
...
class VM(VapiInterface):
    ...
    for a virtual machine and its virtual disks.
    This class was added in **vSphere API 6.7**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.vcenter.storage.policies.VM'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def list(self,
        ...
        disks that are associated with the given storage policy.
        This method was added in **vSphere API 6.7**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
            },
