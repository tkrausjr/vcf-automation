...
#
# vAPI stub file for package com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.
#---------------------------------------------------------------------------
...
class CreateSpec(VapiStruct):
    ...
    that have the tag indicated by :attr:`CreateSpec.vm_tag` will be
    anti-affine to hosts that have the tag indicated by
    :attr:`CreateSpec.host_tag` in VMware Cloud on AWS. Usage beyond VMware
    ...
    **Warning:** this class is available as Technology Preview. These are early
    ...
    def __init__(self,
        ...
        :param vm_tag: Identifier of a tag that can be associated with a virtual machine.
            ...
            indicated by :attr:`CreateSpec.host_tag`.
        ...
        :param host_tag: Identifier of a tag that can be associated with a host. Virtual
            machines indicated by :attr:`CreateSpec.vm_tag` will be anti-affine
            to hosts with this tag.
            **Warning:** this attribute is available as Technology Preview.
            These are early access APIs provided to test, automate and provide
            feedback on the feature. Since this can change based on feedback,
            VMware does not guarantee backwards compatibility and recommends
...
CreateSpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.create_spec', {
...
class Info(VapiStruct):
    ...
    that have the tag indicated by :attr:`Info.vm_tag` will be anti-affine to
    hosts that have the tag indicated by :attr:`Info.host_tag` in VMware Cloud
    on AWS. Usage beyond VMware Cloud on AWS is not supported.
    **Warning:** this class is available as Technology Preview. These are early
    access APIs provided to test, automate and provide feedback on the feature.
    Since this can change based on feedback, VMware does not guarantee
    backwards compatibility and recommends against using them in production
    ...
    def __init__(self,
        ...
        :param vm_tag: Identifier of a tag that can be associated with a virtual machine.
            Virtual machines with this tag will be anti-affine to the hosts
            indicated by :attr:`Info.host_tag`.
            **Warning:** this attribute is available as Technology Preview.
            These are early access APIs provided to test, automate and provide
            feedback on the feature. Since this can change based on feedback,
            VMware does not guarantee backwards compatibility and recommends
        ...
        :type  host_tag: :class:`str`
        :param host_tag: Identifier of a tag that can be associated with a host. Virtual
            machines indicated by :attr:`Info.vm_tag` will be anti-affine to
            hosts with this tag.
            **Warning:** this attribute is available as Technology Preview.
            These are early access APIs provided to test, automate and provide
            feedback on the feature. Since this can change based on feedback,
...
Info._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm_host_anti_affinity.info', {
        'vm_tag': type.IdType(resource_types='com.vmware.cis.tagging.Tag:VirtualMachine'),
        'host_tag': type.IdType(resource_types='com.vmware.cis.tagging.Tag:HostSystem'),
        'name': type.StringType(),
        'description': type.StringType(),
