...
class Profiles(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param profile_name: Human-readable identifier of the storage profile.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class Item(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  zone: :class:`str`
            :param zone: The vSphere Zones the datastore are in.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param datastores: The datastores in the zone.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
...
class _ProfilesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/storage/profiles?action=check_compatibility',
