...
class Access(VapiInterface):
    ...
    class Role(Enum):
        ...
        OWNER = None
        """
        This role allows modification and deletion of the namespace.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param inherited: Flag to indicate if the :attr:`Access.Info.role` is direct or
                ...
                :attr:`Access.Info.role` is inherited from group membership
...
class NamespaceSelfService(VapiInterface):
    ...
    class Capability(Enum):
        ...
        the cluster's self-service namespace capability.

        """
        SUPPORTED = None
        """
        The value that indicates the cluster supports self-service namespace
        capability. The expected transition UNKNOWN --> SUPPORTED
    ...
    class Status(Enum):
        ...
        on which vSphere Namespaces enabled.
        This enumeration was added in **vSphere API 7.0.2.00100**.
        ...
        CONFIGURING = None
        """
        The configuration is being applied to the service.
        ...
        reconcile the state of the cluster after the cluster upgrade.
        ...
        DEACTIVATED 2. CONFIGURING --> REMOVING --> DEACTIVATED
        ...
        captures the relevant error messages explaining this ERROR status.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: The current status of the namespace-self-service.
                This attribute was added in **vSphere API 7.0.2.00100**.
    ...
    class ActivateTemplateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param template: Identifier of the namespace template that is being activated.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param permissions: Namespace Self Service permission to subjects.
                This attribute was added in **vSphere API 7.0.2.00100**.
            ...
            :param storage_specs: Storage associated with the self service namespace.
                This attribute was added in **vSphere API 7.0.2.00100**.
            ...
            :param networks: vSphere Namespaces network objects to be associated with the
                ...
                network(s) for this namespace will be managed by NSX Container
            ...
            :param vm_service_spec: VM Service specification to be associated with the namespace
                ...
                this {ActivateTemplateSpec#vmServiceSpec} by default.
                This attribute was added in **vSphere API 7.0.3.2**.
            ...
            :param content_libraries: Content Library specifications to be associated with the namespace
                ...
                {ActivateTemplateSpec#contentLibraries} by default.
    ...
    def activate(self,
        ...
        from the list returned can be used as the input of this API.
...
class NamespaceTemplates(VapiInterface):
    ...
    ``NamespaceSelfService`` is enabled on a Supervisor.
    This class was added in **vSphere API 7.0.2.00100**.
    """
    RESOURCE_TYPE = "com.vmware.vcenter.namespaces.NamespaceTemplate"
    """
    The resource type for namespace template.
    ...
    class Subject(VapiStruct):
        ...
        information granted for namespace self service.
        This class was added in **vSphere API 7.0.2.00100**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param storage_specs: Storage that this template defines and will be associated with a
                namespace after namespace realization.
                This attribute was added in **vSphere API 7.0.2.00100**.
            :type  networks: :class:`list` of :class:`str` or ``None``
            :param networks: vSphere Networks that this template captures and are associated
                with the namespace after namespace realization.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ...
                NSXT_CONTAINER_PLUGIN or NSX_VPC as its network provider.
            :type  permissions: :class:`list` of :class:`NamespaceTemplates.Subject` or ``None``
            :param permissions: Permissions associated with namespace template.
                This attribute was added in **vSphere API 7.0.2.00100**.
    ...
    class InfoV2(VapiStruct):
        ...
        about the namespace template on a Supervisor.
    ...
    class CreateSpec(VapiStruct):
        ...
        required to create namespace template.
        This class was added in **vSphere API 7.0.2.00100**.
        ...
        def __init__(self,
            ...
            :param template: Identifier of the namespace template. This has DNS_LABEL
                ...
                all namespaces templates in this vCenter server.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``ClusterComputeResource``. When methods return a value of this
            ...
            :param networks: vSphere Networks that this template captures and are associated
                ...
                ``com.vmware.vcenter.namespace_management.Network``.
                The field must be left None if the cluster hosting the namespace
                uses NSXT_CONTAINER_PLUGIN or NSX_VPC as the network provider,
                since the network(s) for this namespace will be managed by NSX
            ...
            :param vm_service_spec: VM Service specification to be associated with the namespace
                template. Namespaces created using this template will have access
                to the virtual machine classes and Content Libraries specified in
                this {CreateSpec#vmServiceSpec} by default.
                This attribute was added in **vSphere API 7.0.3.2**.
                If None, the namespaces created using this template will not have
            ...
            :param content_libraries: Content Library specifications to be associated with the namespace
                template. Namespaces created using this template will have access
                to the Content Libraries specified in this
                {CreateSpec#contentLibraries} by default.
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, the namespaces created using this template will not have
                access to any Content Libraries by default unless Content Libraries
    ...
    class UpdateSpec(VapiStruct):
        ...
        required to update a namespace namespace template.
        This class was added in **vSphere API 7.0.2.00100**.
        ...
        def __init__(self,
            ...
            :param content_libraries: Content Library specifications to be associated with the namespace
                template. Namespaces created using this template will have access
                to the Content Libraries specified in this
                {UpdateSpec#contentLibraries} by default.
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, the namespaces created using this template will not have
                access to any Content Libraries by default unless Content Libraries
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            NSX_VPC as its network provider.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
    ...
    def update_v2(self,
        ...
        ``spec`` will leave those parts of configuration as-is.
        This method was added in **vSphere API 8.0.0.1**.
...
class Instances(VapiInterface):
    ...
    class ResourceNamingStrategy(Enum):
        """
        The ``Instances.ResourceNamingStrategy`` class represents the strategy to
        generate the Kubernetes resource names in a Supervisor namespace for items
        in a Content Library associated with the namespace. The relevant Kubernetes
        resources include namespace scoped ContentLibraryItem, and
        VirtualMachineImage resources in the namespace.
        ...
        same names across Supervisor namespaces with such subscribed Content
        Library associated. 
        ...
        same resource names in the namespace for VM images originated from that
    ...
    ResourceNamingStrategy._set_binding_type(type.EnumType(
        'com.vmware.vcenter.namespaces.instances.resource_naming_strategy',
    ...
    class NetworkProvider(Enum):
        ...
        """
        Network provider is NSX Container Plugin.

        """
        VSPHERE_NETWORK = None
        """
        Network provider is vSphere Networking.

        """
        NSX_VPC = None
        """
        Network provider is NSX VPC.
    ...
    class LoadBalancerSize(Enum):
        ...
        servers depending on NSX version. Medium load balancer can host 100 virtual
        servers. Large load balancer can host 1000 virtual servers.
        This enumeration was added in **vSphere API 7.0.2.00100**.
    ...
    class VpcSubnetAccessMode(Enum):
        """
        The ``Instances.VpcSubnetAccessMode`` enumerates the default access modes
        of NSX VPC subnets hosting resources created in namespaces.
        This enumeration was added in **vSphere API 9.0.0.0**.
        ...
        PUBLIC = None
        """
        :attr:`Instances.VpcSubnetAccessMode.PUBLIC` indicates new subnets are
        allocated from
        com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#vpcConnectivityProfile
        external IP blocks and are routable from external networks.

        """
        PRIVATE_TGW = None
        """
        :attr:`Instances.VpcSubnetAccessMode.PRIVATE_TGW` indicates new subnets are
        allocated from
        com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#vpcConnectivityProfile
        project IP blocks and are routable within other VPCs from the same project.

        """
        PRIVATE = None
        """
        :attr:`Instances.VpcSubnetAccessMode.PRIVATE` indicates new subnets are
        allocated from :attr:`Instances.VpcConfig.private_cidrs` and are routable
        only within the same VPC.
    ...
    VpcSubnetAccessMode._set_binding_type(type.EnumType(
        'com.vmware.vcenter.namespaces.instances.vpc_subnet_access_mode',
        VpcSubnetAccessMode))
        ...
        def __init__(self,
            ...
            :param vm_classes: Set of VirtualMachineClasses for use by the VM Service. The class
                ...
                **NOTE:** Any change in virtual machine classes associated with the
                namespace will not impact existing VMs.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
    ...
    class ContentLibrarySpec(VapiStruct):
        ...
        required to configure Content Libraries in the VM Image Service.
        ...
        def __init__(self,
            ...
            :param content_library: Content Library ID used by the VM Image Service. The Content
                Library specified should exist in vSphere inventory.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.content.Library``. When methods return a value of this
            ...
            :param writable: Flag to indicate if the Content Library is writable. When
                ...
                has the ``writable`` flag set to ``true``.
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, the value defaults to ``false`` and the Content Library is
                read-only to users.
            :type  allow_import: :class:`bool` or ``None``
            :param allow_import: Flag to indicate if users can import an OVF/OVA template from a
                remote HTTPS URL into a Content Library that has the ``writable``
                field set to ``true``. When :class:`set` to ``true``, users with
                :attr:`Access.Info.role` of type OWNER or EDIT on a Supervisor
                namespace can add new Content Library items in vSphere from this
                Supervisor namespace, by importing OVF/OVA templates from remote
                HTTPS URLs. 
                
                An InvalidArgument error will be thrown from
                :func:`Instances.create` method, :func:`Instances.update` method
                and :func:`Instances.set` method if a subscribed Content Library
                has the ``allowImport`` flag set to ``true`` or if a Content
                Library has the ``allowImport`` flag set to ``true`` but the
                ``writable`` flag is set to ``false``.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the value defaults to ``false`` and the users will not be
                able to import an OVF/OVA template from remote HTTPs URLS into the
                Content Library.
            :type  resource_naming_strategy: :class:`Instances.ResourceNamingStrategy` or ``None``
            :param resource_naming_strategy: The resource naming strategy that is used to generate the
                ...
                An InvalidArgument error will be thrown from
                :func:`Instances.create` method, :func:`Instances.update` method
                and :func:`Instances.set` method if this ``resourceNamingStrategy``
                is changed on an existing Content Library associated with the
                namespace, or set to
                :attr:`Instances.ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID` on a
                subscribed Content Library from a published Content Library that is
                either also associated with the namespace or has another subscribed
                Content Library associated to the namespace with the
                ``resourceNamingStrategy`` also set to
                :attr:`Instances.ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID`.
                This attribute was added in **vSphere API 9.0.0.0**.
                ...
                :attr:`Instances.ResourceNamingStrategy.FROM_ITEM_ID`.
            """
    ...
    ContentLibrarySpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.content_library_spec', {
            ...
            'allow_import': type.OptionalType(type.BooleanType()),
            'resource_naming_strategy': type.OptionalType(type.ReferenceType(__name__, 'Instances.ResourceNamingStrategy')),
        },
        ContentLibrarySpec,
        False,
        None))
    ...
    class NetworkCreateSpec(VapiStruct):
        ...
        required to create a vSphere Namespaces network object.
        This class was added in **vSphere API 7.0.2.00100**.
    ...
    class NetworkConfigCreateSpec(VapiStruct):
        """
        The ``Instances.NetworkConfigCreateSpec`` class contains network
        specification when creating a vSphere Namespaces object.
        ...
        def __init__(self,
            ...
            :param network_provider: The network provider that will manage the vSphere Namespaces
                ...
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_network: :class:`Instances.VpcNetworkCreateSpec`
            :param vpc_network: The network configuration for VPC Namespaces, supported by
                :attr:`Instances.NetworkProvider.NSX_VPC` network provider.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
                :attr:`Instances.NetworkProvider.NSX_VPC`.
            """
            self.network_provider = network_provider
    ...
    NetworkConfigCreateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.network_config_create_spec', {
            'network_provider': type.ReferenceType(__name__, 'Instances.NetworkProvider'),
            'vpc_network': type.OptionalType(type.ReferenceType(__name__, 'Instances.VpcNetworkCreateSpec')),
        },
    ...
    class VpcConfig(VapiStruct):
        """
        The ``Instances.VpcConfig`` class describes the specification of a VPC for
        Namespaces Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  private_cidrs: :class:`list` of :class:`Instances.Ipv4Cidr` or ``None``
            :param private_cidrs: :attr:`Instances.VpcConfig.private_cidrs` specifies CIDR blocks
                from which private subnets are allocated. This range should not
                overlap with those in
                com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#vpcConnectivityProfile,
                com.vmware.vcenter.namespace_management.Clusters.EnableSpec#serviceCidr,
                or other services running in the datacenter.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, use Supervisor default private CIDRs. This field must be
                (\\\\@term set) when Avi load balancer is used or when workloads
                are to be deployed on private subnets.
            """
    ...
    VpcConfig._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.vpc_config', {
            'private_cidrs': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.Ipv4Cidr'))),
        },
        VpcConfig,
        False,
        None))
    ...
    class VpcNetworkCreateSpec(VapiStruct):
        """
        The ``Instances.VpcNetworkCreateSpec`` class describes the specification of
        a NSX VPC namespace Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
                     vpc_config=None,
                     vpc=None,
                     default_subnet_size=None,
                    ):
            """
            :type  vpc_config: :class:`Instances.VpcConfig` or ``None``
            :param vpc_config: NSX VPC properties. If :class:`set`, and
                :attr:`Instances.VpcNetworkCreateSpec.vpc` is None, a VPC will be
                automatically created by Supervisor. The VPC will be scoped to this
                particular namespace (cannot be consumed by other namespaces). The
                VPC will be created with
                com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#nsxProject
                and
                com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#vpcConnectivityProfile,
                and NSX Load Balancer size of SMALL if NSX LB provider is used.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, a pre-created VPC can be used.
            :type  vpc: :class:`str` or ``None``
            :param vpc: NSX path of the pre-created VPC. If :class:`set`, values set in
                :attr:`Instances.VpcNetworkCreateSpec.vpc_config` will be ignored.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, a VPC will be created automatically using properties in
                :attr:`Instances.VpcNetworkCreateSpec.vpc_config`.
            :type  default_subnet_size: :class:`long` or ``None``
            :param default_subnet_size: Default size of namespace subnets.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, a default subnet size of /27 (or 32 addresses) is set.
            """
            self.vpc_config = vpc_config
            self.vpc = vpc
            self.default_subnet_size = default_subnet_size
            VapiStruct.__init__(self)


    VpcNetworkCreateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.vpc_network_create_spec', {
            'vpc_config': type.OptionalType(type.ReferenceType(__name__, 'Instances.VpcConfig')),
            'vpc': type.OptionalType(type.StringType()),
            'default_subnet_size': type.OptionalType(type.IntegerType()),
        },
    ...
    class NetworkConfigInfo(VapiStruct):
        """
        The ``Instances.NetworkConfigInfo`` class contains info of network
        specification for a vSphere Namespaces object.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  network_provider: :class:`Instances.NetworkProvider`
            :param network_provider: The network provider that manages the vSphere Namespaces network
                configuration.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_network: :class:`Instances.VpcNetworkInfo`
            :param vpc_network: The network configuration for NSX VPC Namespaces, supported by
                :attr:`Instances.NetworkProvider.NSX_VPC` network provider.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
    ...
    NetworkConfigInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.network_config_info', {
            'network_provider': type.ReferenceType(__name__, 'Instances.NetworkProvider'),
            'vpc_network': type.OptionalType(type.ReferenceType(__name__, 'Instances.VpcNetworkInfo')),
        },
        NetworkConfigInfo,
        False,
        None))
    ...
    class VpcNetworkInfo(VapiStruct):
        """
        The ``Instances.VpcNetworkInfo`` class describes the specification of a VPC
        Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  vpc_config: :class:`Instances.VpcConfig`
            :param vpc_config: VPC configuration used for this namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc: :class:`str`
            :param vpc: NSX path of the VPC associated with the namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  auto_created: :class:`bool`
            :param auto_created: Whether the VPC is automatically created for the namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  default_subnet_size: :class:`long`
            :param default_subnet_size: Default size of namespace subnets.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.vpc_config = vpc_config
    ...
    VpcNetworkInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.vpc_network_info', {
            'vpc_config': type.ReferenceType(__name__, 'Instances.VpcConfig'),
            'vpc': type.StringType(),
            'auto_created': type.BooleanType(),
            'default_subnet_size': type.IntegerType(),
        },
        VpcNetworkInfo,
        False,
        None))
    ...
    class NetworkConfigUpdateSpec(VapiStruct):
        """
        The ``Instances.NetworkConfigUpdateSpec`` class contains specifications
        required when updating the network configuration of a vSphere Namespaces
        object.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param network_provider: The network provider that manages the vSphere Namespaces network
                configuration.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_config: :class:`Instances.VpcNetworkUpdateSpec`
            :param vpc_config: The network configuration for NSX VPC Namespaces, supported by
                :attr:`Instances.NetworkProvider.NSX_VPC` network provider.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
    ...
    NetworkConfigUpdateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.network_config_update_spec', {
            'network_provider': type.ReferenceType(__name__, 'Instances.NetworkProvider'),
            'vpc_config': type.OptionalType(type.ReferenceType(__name__, 'Instances.VpcNetworkUpdateSpec')),
        },
    ...
    class VpcNetworkUpdateSpec(VapiStruct):
        """
        The ``Instances.VpcNetworkUpdateSpec`` class contains specifications to
        update on an existing NSX VPC Namespace Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  default_subnet_size: :class:`long` or ``None``
            :param default_subnet_size: Default size of namespace subnets. Changing the default will only
                affect new Subnets being created.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, a default subnet size of /27 (or 32 addresses) is set.
            :type  private_cidrs: :class:`list` of :class:`Instances.Ipv4Cidr` or ``None``
            :param private_cidrs: CIDR blocks from which private subnets are allocated. This range
                should not overlap with those in
                com.vmware.vcenter.namespace_management.supervisors.networks.workload.VpcNetwork#vpcConnectivityProfile,
                com.vmware.vcenter.namespace_management.supervisors.networks.workload.Network#ipManagement,
                or other services running in the datacenter. 
                
                Only appending additional CIDRs is allowed for auto-created VPC.
    ...
    VpcNetworkUpdateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.vpc_network_update_spec', {
            'default_subnet_size': type.OptionalType(type.IntegerType()),
            'private_cidrs': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.Ipv4Cidr'))),
        },
    ...
    class NetworkConfigSetSpec(VapiStruct):
        """
        The ``Instances.NetworkConfigSetSpec`` class contains specifications
        required when setting the network configuration of a vSphere Namespaces
        object.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param network_provider: The network provider that manages the vSphere Namespaces network
                configuration.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_config: :class:`Instances.VpcNetworkSetSpec`
            :param vpc_config: The network configuration for VPC namespaces, supported by
                :attr:`Instances.NetworkProvider.NSX_VPC` network provider.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
    ...
    NetworkConfigSetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.network_config_set_spec', {
            'network_provider': type.ReferenceType(__name__, 'Instances.NetworkProvider'),
            'vpc_config': type.OptionalType(type.ReferenceType(__name__, 'Instances.VpcNetworkSetSpec')),
        },
        NetworkConfigSetSpec,
        False,
        None))


    class VpcNetworkSetSpec(VapiStruct):
        """
        The ``Instances.VpcNetworkSetSpec`` class contains specifications to set on
        an existing VPC Namespace Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param private_cidrs: CIDR blocks from which private subnets are allocated. This range
                ...
                Only appending additional CIDRs is allowed. Modification to
                existing CIDR ranges will result in the operation failing with a
    ...
    VpcNetworkSetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.vpc_network_set_spec', {
            'default_subnet_size': type.OptionalType(type.IntegerType()),
            'private_cidrs': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.Ipv4Cidr'))),
        },
        VpcNetworkSetSpec,
    ...
    class Stats(VapiStruct):
        ...
        def __init__(self,
            ...
            :param cpu_used: CPU reservation consumed by the pods in the namespace in megahertz
                (MHz) across all resource pools backing the namespace. This is the
                sum of CPU requested by pods in the Kubernetes namespace.
            :type  memory_used: :class:`long`
            :param memory_used: Memory reservation consumed by the pods in the namespace in
                mebibytes (MiB) across all resource pools backing the namespace.
                This is the sum of memory requested by pods in the Kubernetes
                namespace.
            :type  storage_used: :class:`long`
            :param storage_used: Storage reservation consumed by the pods in the namespace in
                mebibytes (MiB) across all datastores backed by storage policies
                assigned to the namespace. This is the sum of storage requested by
                the pods in the Kubernetes namespace.
            """
    ...
    class VirtualMachineClassAllocationSpec(VapiStruct):
        """
        The ``Instances.VirtualMachineClassAllocationSpec`` class describes the
        definition of allocations for Virtual Machines of a given class.
        This class was added in **vSphere API 9.0.0.0**.
    ...
    VirtualMachineClassAllocationSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.virtual_machine_class_allocation_spec', {
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param self_service_namespace: Flag to indicate the self service namespace.
                This attribute was added in **vSphere API 7.0.2.00100**.
    ...
    class ZoneInfo(VapiStruct):
        """
        The ``Instances.ZoneInfo`` class contains the information for a vSphere
        Zone related to a Supervisor
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :type  type: :class:`str`
            :param type: Identifier of the Type of the vSphere Zone
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param marked_for_removal: ``True`` if the vSphere Zone has been marked for removal
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.zone = zone
            self.type = type
    ...
    ZoneInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.zone_info', {
            'zone': type.IdType(resource_types='com.vmware.vcenter.consumption_domains.Zone'),
            'type': type.IdType(resource_types='com.vmware.vcenter.namespace_management.supervisors.zones.Bindings.Type'),
    ...
    class SummaryV2(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  supervisor: :class:`str`
            :param supervisor: Identifier for the Supervisor hosting the namespace.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.supervisor.Supervisor``.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  networks: :class:`list` of :class:`str` or ``None``
            :param networks: The vSphere Networks associated with the namespace.
            ...
            :param creator: Creator of the namespace. Namespace self-service uses this field to
                populate the user who created this namespace.
                This attribute was added in **vSphere API 7.0.2.00100**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  self_service_namespace: :class:`bool` or ``None``
    ...
    class InfoV2(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supervisor: Identifier for the Supervisor hosting the namespace.
                ...
                attribute will be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.supervisor.Supervisor``.
            :type  zones: :class:`list` of :class:`Instances.ZoneInfo`
            :param zones: Configuration of vSphere Zones associated with this namespace on
                which workloads are created.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  network_spec: :class:`Instances.NetworkConfigInfo` or ``None``
            :param network_spec: Network related configurations associated with this namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  config_status: :class:`Instances.ConfigStatus`
    ...
    InfoV2._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.info_v2', {
            'supervisor': type.IdType(resource_types='com.vmware.vcenter.namespace_management.supervisor.Supervisor'),
            'zones': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.ZoneInfo'))),
            'network_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.NetworkConfigInfo')),
            'config_status': type.ReferenceType(__name__, 'Instances.ConfigStatus'),
            'messages': type.ListType(type.ReferenceType(__name__, 'Instances.Message')),
            'stats': type.ReferenceType(__name__, 'Instances.Stats'),
            'description': type.StringType(),
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  network_spec: :class:`Instances.NetworkConfigUpdateSpec` or ``None``
            :param network_spec: Network related configurations to be updated with this namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  zones: :class:`list` of :class:`Instances.ZoneSpec` or ``None``
            :param zones: List of ``Instances.ZoneSpec`` to configure vSphere Zones for this
                namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the existing vSphere Zones on the namespace will not be
                modified.
            """
            self.description = description
            self.resource_spec = resource_spec
    ...
    UpdateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.update_spec', {
            ...
            'vm_service_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.VMServiceSpec')),
            'content_libraries': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.ContentLibrarySpec'))),
            'network_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.NetworkConfigUpdateSpec')),
            'zones': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.ZoneSpec'))),
        },
        UpdateSpec,
        False,
        None))
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  network_spec: :class:`Instances.NetworkConfigSetSpec` or ``None``
            :param network_spec: Network related configurations to be set with this namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.set_spec', {
            ...
            'vm_service_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.VMServiceSpec')),
            'content_libraries': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.ContentLibrarySpec'))),
            'network_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.NetworkConfigSetSpec')),
        },
        SetSpec,
        False,
        None))
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param networks: The vSphere Namespaces network objects to be associated with the
                ...
                The field must be left None if the cluster hosting the namespace
                uses NSXT_CONTAINER_PLUGIN or NSX_VPC as the network provider,
                since the network(s) for this namespace will be managed on NSX. 
                ...
                When using NSX_VPC as network provider, any additional network
                configuration needs to be specified with
                ``Instances.VpcNetworkCreateSpec``. 
            ...
            :param namespace_network: This field that accepts parameters to define a vSphere Namespace
                ...
                autogenerated ID and cannot be referenced by other Namespaces.
                This attribute was added in **vSphere API 7.0.2.00100**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
    ...
    class CreateSpecV2(VapiStruct):
        ...
        set up a namespace on a Supervisor cluster.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param zones: List of ``Instances.ZoneSpec`` to configure vSphere Zones for this
                namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, workloads created in this namespace will be placed on the
                same vSphere Zone(s) as the Supervisor.
            :type  network_spec: :class:`Instances.NetworkConfigCreateSpec` or ``None``
            :param network_spec: Network related configurations to be associated with this
                namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
    ...
    CreateSpecV2._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.create_spec_v2', {
            'supervisor': type.IdType(resource_types='com.vmware.vcenter.namespace_management.supervisor.Supervisor'),
            'zones': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.ZoneSpec'))),
            'network_spec': type.OptionalType(type.ReferenceType(__name__, 'Instances.NetworkConfigCreateSpec')),
            'namespace': type.IdType(resource_types='com.vmware.vcenter.namespaces.Instance'),
            'description': type.OptionalType(type.StringType()),
            'resource_spec': type.OptionalType(type.DynamicStructType('vmware.vapi.dynamic_struct', {}, VapiStruct)),
            'access_list': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.Access'))),
    ...
    class ZoneSpec(VapiStruct):
        """
        The ``Instances.ZoneSpec`` class contains the specification required to
        configure vSphere Zones associated with a Supervisor Namespace.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
                     ...
                     disallow_unreserved_direct_path_usage=None,
                    ):
            """
            :type  name: :class:`str`
            :param name: Identifier for the vSphere Zone associated with the Supervisor
                namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ...
                be an identifier for the resource type:
                ``com.vmware.vcenter.consumption_domains.Zone``.
            :type  vm_reservations: :class:`list` of :class:`Instances.VirtualMachineClassAllocationSpec` or ``None``
            :param vm_reservations: Guaranteed number of reserved Virtual Machine class instances that
                are available for the namespace in this zone.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then no reserved Virtual Machine class instances are
                guaranteed available for the namespace in this zone.
            :type  cpu_limit_mhz: :class:`long` or ``None``
            :param cpu_limit_mhz: CPU limit (in megahertz) for the namespace in this zone in addition
                to the limits specified as part of reserved Virtual Machine
                classes.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then the limit on CPU usage for the namespace in this
                zone is determined by the CPU limit of the namespace.
            :type  cpu_reservation_mhz: :class:`long` or ``None``
            :param cpu_reservation_mhz: CPU reservation (in megahertz) for the namespace in this zone, for
                VMs that are not using reserved Virtual Machine class instances.
                The allocation of CPU reservation to VMs that are not using
                reserved Virtual Machine class instances cannot exceed this value.
                If this value is set, then a VM with CPU reservation will fail to
                power-on in this zone of this namespace, if the remaining
                unreserved CPU is less than the configured CPU reservation of this
                VM.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then there is no CPU reserved for the namespace in this
                zone, and the allocation of CPU reservation to the namespace in
                this zone depends on namespace demand and available unreserved CPU
                in this zone.
            :type  memory_limit_mib: :class:`long` or ``None``
            :param memory_limit_mib: Memory limit (in mebibytes) for the namespace in this zone in
                addition to the limits specified as part of reserved Virtual
                Machine classes.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then the limit on memory usage for workloads running in
                the namespace in this zone is determined by the memory limit of the
                namespace.
            :type  memory_reservation_mib: :class:`long` or ``None``
            :param memory_reservation_mib: Memory reservation (in mebibytes) for the namespace in this zone,
                for VMs that are not using reserved Virtual Machine class
                instances. The allocation of memory reservation to VMs that are not
                using reserved Virtual Machine class instances cannot exceed this
                value. This includes the allocation of overhead memory reservation
                to VMs. If this value is set, then a VM will fail to power-on in
                this zone of this namespace, if the remaining unreserved memory is
                less than the sum of (1) any configured memory reservation of this
                VM and (2) the overhead memory requirements of this VM.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then there is no memory reserved for the namespace in
                this zone, and the allocation of memory reservation to the
                namespace in this zone depends on namespace demand and available
                unreserved memory in this zone.
            :type  disallow_unreserved_direct_path_usage: :class:`bool` or ``None``
            :param disallow_unreserved_direct_path_usage: Determines whether workloads that don't use a reserved Virtual
                Machine class instance can use a DirectPath device.
                This attribute was added in **vSphere API 9.0.0.0**.
                If unset, then any workload in the namespace in this zone can use a
                DirectPath device.
            """
            self.name = name
            ...
            self.memory_reservation_mib = memory_reservation_mib
            self.disallow_unreserved_direct_path_usage = disallow_unreserved_direct_path_usage
            VapiStruct.__init__(self)


    ZoneSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespaces.instances.zone_spec', {
            'name': type.IdType(resource_types='com.vmware.vcenter.consumption_domains.Zone'),
            'vm_reservations': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Instances.VirtualMachineClassAllocationSpec'))),
            'cpu_limit_MHz': type.OptionalType(type.IntegerType()),
            'cpu_reservation_MHz': type.OptionalType(type.IntegerType()),
            'memory_limit_MiB': type.OptionalType(type.IntegerType()),
            'memory_reservation_MiB': type.OptionalType(type.IntegerType()),
            'disallow_unreserved_direct_path_usage': type.OptionalType(type.BooleanType()),
        },
        ZoneSpec,
        False,
        None))
    ...
    class RegisterVMSpec(VapiStruct):
        ...
        to register a virtual machine with Supervisor.
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            ...
            NSXT_CONTAINER_PLUGIN or NSX_VPC as its network provider, or if the
    ...
    def create_v2(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            ...
            NSXT_CONTAINER_PLUGIN or NSX_VPC as its network provider, or if the
            Supervisor does not support customizable VM classes.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user can not be authenticated.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            if the user does not have Namespaces.Configure privilege or the
    ...
    def list_v2(self):
        """
        Returns the information about all namespaces in this vCenter Server.
        The information is tied to a Supervisor.
        This method was added in **vSphere API 8.0.0.1**.
    ...
    def register_vm(self,
        ...
        Additionally, after a restore operation by a VADP based data protection
        vendor, or a failover/failback by a disaster recovery solution, this
        API can be invoked to re-sync the state of the Kubernetes resources on
        Supervisor with the configuration of the restored VM. Typically, this
        involves a new volume (backed by a PersistentVolumeClaim) being created
        for each of the restored disks of a VM. Finally, the VirtualMachine
        custom resource on Supervisor is updated with the configuration from
        the restored virtual machine and the new volume references. 
        
        This API can also be invoked after a subset of a VM Service virtual
        machine's virtual disks are directly restored from a backup vendor. In
        which case, the API detects which disks have been restored and creates
        new volumes (backed by a PersistentVolumeClaim) for each restored disk.
        Finally, the VirtualMachine custom resource on Supervisor is updated
        with the new volume references. 
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.AlreadyInDesiredState` 
            if the Supervisor only supports registering new virtual machines
            and the requested virtual machine already exists on Supervisor.
        """
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
...
class _NamespaceSelfServiceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        activate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespaces/namespace-self-service/{cluster}?action=activate',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        deactivate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespaces/namespace-self-service/{cluster}?action=deactivate',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        activate_with_template_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespaces/namespace-self-service/{cluster}?action=activateWithTemplate',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        operations = {
            'activate': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'activate_with_template': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'output_type': type.VoidType(),
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'register_VM': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).build(),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'Instances': Instances,
        'instances': 'com.vmware.vcenter.namespaces.instances_client.StubFactory',
