...
class TokenInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param access_token: Tenant client access token issued by the authorization server.
            This attribute was added in **vSphere API 8.0.1.0**.
...
class AdminClient(VapiInterface):
    ...
    invocations within a tenant entity.
    This class was added in **vSphere API 8.0.1.0**.
    """
    ...
    def get(self,
        ...
        pre-configured tenant(s) owned by vcenter trustmanagment service.
...
class OperatorClient(VapiInterface):
    ...
    get and delete of tenant entity.
    This class was added in **vSphere API 8.0.1.0**.
    """
    ...
    def get(self):
        ...
        used to manage tenant entity APIs.
        This method was added in **vSphere API 8.0.1.0**.
