    ...
    def __init__(self, config):
        ...
        operations = {
            'issue': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.oauth2.errors_client', 'InvalidRequest'), []).add(type.ReferenceType('com.vmware.oauth2.errors_client', 'InvalidGrant'), []).add(type.ReferenceType('com.vmware.oauth2.errors_client', 'InvalidScope'), []).build(),
