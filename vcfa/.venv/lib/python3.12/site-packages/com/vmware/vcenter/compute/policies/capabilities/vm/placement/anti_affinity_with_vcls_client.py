...
class CreateSpec(VapiStruct):
    ...
    .. deprecated:: vSphere API 9.0.0.0
        This class is deprecated as of **vSphere API 9.0.0.0**. In a future
        release of vSphere, the vCLS functionality will be disabled, vCLS
    ...
    def __init__(self,
        ...
        """
        warn('com.vmware.vcenter.compute.policies.capabilities.vm.placement.anti_affinity_with_vcls.CreateSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        self.vm_tag = vm_tag
...
class Info(VapiStruct):
    ...
    def __init__(self,
        ...
        :param capability: Identifier of the capability this policy is based on.
            ...
            ``com.vmware.vcenter.compute.policies.Capability``.
        """
        warn('com.vmware.vcenter.compute.policies.capabilities.vm.placement.anti_affinity_with_vcls.Info is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        self.vm_tag = vm_tag
        self.name = name
        self.description = description
        self._capability = capability
