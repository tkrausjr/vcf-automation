...
class Nodes(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param replication_partners: List of replication partners' node identifiers. Identifiers can be
                either IP address or DNS resolvable name of the partner node.
                This attribute was added in **vSphere API 6.7.2**.
    ...
    class Summary(VapiStruct):
        ...
        or Platform Services Controller node.
        This class was added in **vSphere API 6.7.2**.
    ...
    def list(self,
        ...
        nodes matching the :class:`Nodes.FilterSpec`.
...
class ReplicationStatus(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        VCSA_EMBEDDED/PSC_EXTERNAL (see :attr:`Nodes.Info.type`).
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param replication_partner: Identifier for the vCenter or Platform Services Controller
                ...
                resolvable name of the replication partner.
                This attribute was added in **vSphere API 6.7.2**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.VCenter.name``. When methods return a value of
            ...
            :param status_available: Indicates if the replication status for the node with respect to
                replication partner can be retrieved or not.
                This attribute was added in **vSphere API 6.7.2**.
    ...
    class FilterSpec(VapiStruct):
        ...
        type VCSA_EMBEDDED/PSC_EXTERNAL (see :attr:`Nodes.Info.type`).
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param nodes: Identifier that a vCenter and Platform Services Controller node
                ...
                :attr:`ReplicationStatus.Summary.node`).
                This attribute was added in **vSphere API 6.7.2**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``com.vmware.vcenter.VCenter.name``. When methods return a value of
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
