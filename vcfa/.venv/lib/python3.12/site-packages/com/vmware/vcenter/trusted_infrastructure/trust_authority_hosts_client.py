...
class Attestation(VapiInterface):
    ...
    hosts running Attestation Service.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class SummaryType(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.SummaryType is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)

    SummaryType._set_values({
        'FULL': SummaryType('FULL'),
        'NORMAL': SummaryType('NORMAL'),
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param summary_type: Defines the verbosity of the summary.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  host: :class:`str`
            :param host: The trusted ESX on which the service runs.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param group: The group ID determines which Attestation Service instances this
                Attestation Service can communicate with.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
            ...
            :param cluster: The opaque string identifier of the cluster in which the
                Attestation Service is part of.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``summaryType`` is one of :attr:`Attestation.SummaryType.NORMAL`
                or :attr:`Attestation.SummaryType.FULL`.
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trusted_ca: The service's TLS certificate chain.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.host = host
            self.address = address
            self.group = group
            self.cluster = cluster
    ...
    class FilterSpec(VapiStruct):
        ...
        identifying a Attestation Service
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param hosts: A set of host IDs by which to filter the services.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
            ...
            :param clusters: A set of cluster IDs by which to filter the services.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.hosts = hosts
    ...
    def get(self,
        ...
        :type  host: :class:`str`
        :param host: :class:`com.vmware.vcenter_client.Host` id.
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        specified :class:`Attestation.FilterSpec`.
        This method was added in **vSphere API 7.0.0.0**.
        ...
        :param spec: Return details about Attestation Services matching the filter.
            If None return all registered Attestation Services.
        ...
        :param projection: The type of the returned summary - brief, normal, or full.
            If None a normal projection will be used.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``ClusterComputeResource`` referenced by the
              ...
              ``System.View``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Attestation.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class Kms(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class SummaryType(Enum):
        ...
        def __init__(self, string):
            ...
            :param string: String value for the :class:`SummaryType` instance.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.SummaryType is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  group: :class:`str`
            :param group: The group ID determines which Attestation Service instances this
                Key Provider Service can communicate with.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.summary_type = summary_type
            self.host = host
            self.address = address
            self.group = group
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trusted_ca: The service's TLS certificate chain.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.host = host
            self.address = address
            self.group = group
            self.cluster = cluster
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param groups: The group determines reports issued by which Attestation Service
                instances this Key Provider Service can accept.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, the services will not be filtered by groupId.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.hosts = hosts
            self.clusters = clusters
            self.address = address
            self.groups = groups
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``HostSystem`` referenced by the parameter ``host``
              requires ``System.View``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('get',
                            {
                            'host': host,
                            })
    ...
    def list(self,
        ...
        specified :class:`Kms.FilterSpec`.
        This method was added in **vSphere API 7.0.0.0**.
        ...
        :param spec: Return details about Key Provider Services matching the filter.
            If None return all registered Key Provider Services.
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_hosts.Kms.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
        return self._invoke('list',
                            {
                            'spec': spec,
                            'projection': projection,
...
class _KmsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trust-authority-hosts/kms?action=query',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
