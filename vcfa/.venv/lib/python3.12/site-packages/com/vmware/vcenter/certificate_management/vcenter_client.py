...
class TrustedRootChains(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param cert_chain: A certificate chain in base64 encoding
    ...
    class Summary(VapiStruct):
        ...
        chain summary suitable for UI presentation.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param chain: Unique identifier for chain.
                This attribute was added in **vSphere API 6.7.2**.
            """
            self.chain = chain
            VapiStruct.__init__(self)
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  cert_chain: :class:`com.vmware.vcenter.certificate_management_client.X509CertChain`
            :param cert_chain: Certificate chain in base64 encoding
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param chain: Unique identifier for this trusted root. Client can specify at
                ...
                identifier would be the domain id.
                This attribute was added in **vSphere API 6.7.2**.
...
class SigningCertificate(VapiInterface):
    ...
    com.vmware.vcenter package. 1.23 - vSphere 7.0 U3
...
class Tls(VapiInterface):
    ...
    class Info(VapiStruct):
        """
        The ``Tls.Info`` class contains information from a TLS certificate.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param version: Version (version number) value from the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            :type  serial_number: :class:`str`
            :param serial_number: SerialNumber value from the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            :type  signature_algorithm: :class:`str`
            :param signature_algorithm: Signature algorithm name from the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            :type  issuer_dn: :class:`str`
            :param issuer_dn: Issuer (issuer distinguished name) value from the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            :type  valid_from: :class:`datetime.datetime`
            :param valid_from: validFrom specify the start date of the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            :type  valid_to: :class:`datetime.datetime`
            :param valid_to: validTo specify the end date of the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param thumbprint: Thumbprint value from the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param key_usage: Collection of keyusage contained in the certificate.
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param subject_alternative_name: Collection of subject alternative names.
                This attribute was added in **vSphere API 6.7.2**.
            :type  authority_information_access_uri: :class:`list` of :class:`str`
            :param authority_information_access_uri: Collection of authority information access URI.
                This attribute was added in **vSphere API 6.7.2**.
            :type  cert: :class:`str`
            :param cert: TLS certificate in PEM format.
                This attribute was added in **vSphere API 6.7.2**.
            """
    ...
    class Spec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  cert: :class:`str`
            :param cert: Certificate string in PEM format.
                This attribute was added in **vSphere API 6.7.2**.
            :type  key: :class:`str` or ``None``
            :param key: Private key string in PEM format.
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param root_cert: Third party Root CA certificate in PEM format.
    ...
    class ReplaceSpec(VapiStruct):
        ...
        Key , CSR and hence VMCA signed machine SSL.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param organization: Organization field in certificate subject
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param organization_unit: Organization unit field in certificate subject. 
                ...
                empty string should be used to leave it unset.
                This attribute was added in **vSphere API 6.7.2**.
            :type  locality: :class:`str`
            :param locality: Locality field in certificate subject
                This attribute was added in **vSphere API 6.7.2**.
            :type  state_or_province: :class:`str`
            :param state_or_province: State field in certificate subject
                This attribute was added in **vSphere API 6.7.2**.
            :type  country: :class:`str`
            :param country: Country field in certificate subject
                This attribute was added in **vSphere API 6.7.2**.
            :type  email_address: :class:`str`
            :param email_address: Email field in Certificate extensions
                This attribute was added in **vSphere API 6.7.2**.
            :type  subject_alt_name: :class:`list` of :class:`str` or ``None``
            :param subject_alt_name: SubjectAltName is list of Dns Names and Ip addresses
                This attribute was added in **vSphere API 6.7.2**.
...
class TlsCsr(VapiInterface):
    ...
    class Spec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  common_name: :class:`str` or ``None``
            :param common_name: Common name field in certificate subject.
                This attribute was added in **vSphere API 6.7.2**.
...
class VmcaRoot(VapiInterface):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            ...
            supported.
            This exception was added in **vSphere API 8.0.2.0**.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            if you do not have all of the privileges described as follows: 
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
...
class _SigningCertificateStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        refresh_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/certificate-management/vcenter/signing-certificate?action=refresh',
            path_variables={
            },
            query_parameters={
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'set': {
                ...
                'output_type': type.VoidType(),
                'errors': set_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': set_input_value_validator_list,
                'output_validator_list': set_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'renew': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'replace_vmca_signed': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'output_type': type.VoidType(),
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
