...
#
# vAPI stub file for package com.vmware.vcenter.compute.policies.capabilities.vm.evacuation.vmotion.
#---------------------------------------------------------------------------
...
class CreateSpec(VapiStruct):
    """
    The ``CreateSpec`` class contains information used to create a new vMotion
...
CreateSpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm.evacuation.vmotion.create_spec', {
...
class Info(VapiStruct):
    """
    The ``Info`` class contains information about a vMotion policy that applies
    when a host is evacuated, see
    :func:`com.vmware.vcenter.compute_client.Policies.get`, in VMware Cloud on
    AWS. Usage beyond VMware Cloud on AWS is not supported. All virtual
    machines that share the tag indicated by :attr:`Info.vm_tag` will be
    vMotioned from a host whenever the host is evacuated by vCenter. If vCenter
    cannot migrate a virtual machine, then it will remain running on its
    current host.
    **Warning:** this class is available as Technology Preview. These are early
...
Info._set_binding_type(type.StructType(
    'com.vmware.vcenter.compute.policies.capabilities.vm.evacuation.vmotion.info', {
        'vm_tag': type.IdType(resource_types='com.vmware.cis.tagging.Tag:VirtualMachine'),
        'name': type.StringType(),
        'description': type.StringType(),
        'capability': type.IdType(resource_types='com.vmware.vcenter.compute.policies.Capability'),
