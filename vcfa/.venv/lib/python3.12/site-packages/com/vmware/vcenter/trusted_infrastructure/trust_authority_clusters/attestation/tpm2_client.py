...
class CaCertificates(VapiInterface):
    ...
    certificates when presented at attestation time.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.CaCertificates is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.CaCertificates.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: A unique name for the TPM CA certificate.
            ...
            :param health: A health indicator which indicates whether each host in the cluster
                has the same CA certs.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.CaCertificates.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.name = name
            self.health = health
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param details: Details regarding the health. 
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.CaCertificates.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.CaCertificates.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.name = name
            self.cert_chain = cert_chain
            VapiStruct.__init__(self)
...
class EndorsementKeys(VapiInterface):
    ...
    Module (TPM) Endorsement Keys (EK) on a cluster level.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.EndorsementKeys is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        the hosts status in the cluster.
        This enumeration was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self, string):
            ...
            :param string: String value for the :class:`Health` instance.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.EndorsementKeys.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: A health indicator which indicates whether each host in the cluster
                has the same endorsement key.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.EndorsementKeys.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.name = name
            self.health = health
            VapiStruct.__init__(self)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param public_key: TPM public endorsement key in PEM format.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  health: :class:`EndorsementKeys.Health`
            :param health: A health indicator which indicates whether each host in the cluster
                has the same endorsement key.
            ...
            :param details: Details regarding the health. 
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.EndorsementKeys.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class CreateSpec(VapiStruct):
        ...
        :attr:`EndorsementKeys.CreateSpec.certificate` must be specified.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param certificate: TPM endorsement key certificate in PEM format. 
                ...
                configuration rather than later during attestation.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None :attr:`EndorsementKeys.CreateSpec.public_key` must be
                :class:`set`.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.EndorsementKeys.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.name = name
            self.public_key = public_key
...
class Settings(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.Settings is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            :param string: String value for the :class:`Health` instance.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.Settings.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: A health indicator which indicates whether each host in the cluster
                has the same attestation settings.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  details: :class:`list` of :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param details: Details regarding the health. 
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.Settings.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class UpdateSpec(VapiStruct):
        ...
        changes to the TPM 2.0 protocol settings.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param require_certificate_validation: Require TPM endorsement key certificate validation.
                ...
                If None the current state will remain unchanged.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.attestation.tpm2.Settings.UpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.require_endorsement_keys = require_endorsement_keys
            self.require_certificate_validation = require_certificate_validation
            VapiStruct.__init__(self)
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
