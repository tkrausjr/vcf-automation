...
class Archives(VapiInterface):
    ...
    class FilterSpec(VapiStruct):
        ...
        result when listing Backup archives (see :func:`Archives.list`).
        This class was added in **vSphere API 8.0.3.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param archive: Backup archive identifier.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.supervisor.backup.Archive``.
            ...
            :param supervisor: Identifier of the Supervisor captured in the backup.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param timestamp: Time when the Supervisor backup method was completed.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param supervisor_version: Version of the Supervisor captured in the backup. This is a
                ...
                version (vsc0.1.1-20805373).
                This attribute was added in **vSphere API 8.0.3.0**.
            :type  namespaces: :class:`list` of :class:`str`
            :param namespaces: A list of Supervisor Namespaces captured in the backup.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
            ...
            :param comment: Comment provided when invoking :func:`Jobs.create` method.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param usable: Backup archive usability for
                ...
                * Invalid format.
                ...
                given in the ``unusableReasons`` field.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    def list(self,
        ...
        the criteria in the {#link FilterSpec}.
...
class Jobs(VapiInterface):
    """
    The ``Jobs`` class provides methods to create Supervisor backup jobs.
    This class was added in **vSphere API 8.0.3.0**.
    """
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param comment: Comment to help identify resulting Backup archive.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
