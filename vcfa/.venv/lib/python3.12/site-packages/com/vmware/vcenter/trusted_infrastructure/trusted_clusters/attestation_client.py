...
class Services(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param service: The service's unique identifier.
            ...
            :param group: The group specifies the Key Provider Service instances can accept
                reports issued by this Attestation Service instance.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Attestation
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trusted_ca: The service's TLS certificate chain.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  group: :class:`str`
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Attestation
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param type: Source of truth for the configuration of the Attestation Service.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  service: :class:`str`
            :param service: The service's unique ID.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.trusted_infrastructure.attestation.Service``.
            ...
            :type  trust_authority_cluster: :class:`str`
            :param trust_authority_cluster: The attestation cluster's unique ID.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``type`` is :attr:`Services.CreateSpec.SourceType.CLUSTER`.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.type = type
            self.service = service
            self.trust_authority_cluster = trust_authority_cluster
            VapiStruct.__init__(self)
        ...
        class SourceType(Enum):
            ...
            the Attestation Service will use for its configuration.
            ...
            def __init__(self, string):
                ...
                """
                warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.CreateSpec.SourceType is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class FilterSpec(VapiStruct):
        ...
        identifying a Attestation service instance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param services: A set of IDs by which to filter the services.
                This attribute was added in **vSphere API 7.0.0.0**.
                When clients pass a value of this class as a parameter, the
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``System.View``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.Services.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class ServicesAppliedConfig(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.ServicesAppliedConfig is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        NONE = None
        """
        The consistency of the applied configuration is unknown.
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.ServicesAppliedConfig.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Summary(VapiStruct):
        ...
        about the aggregated health status for a service.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param health: The health value indicates whether the configuration applied to the
                cluster differs from the desired state.
            ...
            :param service: The unique identifier of an Attestation Service configuration from
                ...
                desired state.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.ServicesAppliedConfig.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            self.service = service
            VapiStruct.__init__(self)
    ...
    class FilterSpec(VapiStruct):
        ...
        result to be filtered out and returned.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param health: The health of the applied Attestation Service configuration.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.ServicesAppliedConfig.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            VapiStruct.__init__(self)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: A health value which indicates whether the configuration applied to
                the cluster differs from the desired state.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  address: :class:`com.vmware.vcenter.trusted_infrastructure_client.NetworkAddress`
            :param address: The network address of the Attestation Service configured for use
                in the Trusted Cluster.
            ...
            :param trustedc_as: A list of distinct trusted CA chains found on the hosts in the
                cluster which differ from the desired state.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param details: Details regarding the health. When the
                ...
                detailed description of the issues present.
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trusted_clusters.attestation.ServicesAppliedConfig.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.address = address
            self.service = service
            self.groups = groups
    ...
    def update_task(self,
        ...
        reference point for the remediation.
        This method was added in **vSphere API 7.0.1.0**.
    ...
    def delete_task(self,
        ...
        Hosts within the given cluster.
        This method was added in **vSphere API 7.0.1.0**.
...
class _ServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trusted-clusters/{cluster}/attestation/services?action=query',
        ...
        operations = {
            ...
            'create$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
...
class _ServicesAppliedConfigStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/trusted-clusters/{cluster}/attestation/services-applied-config?action=query',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        operations = {
            'list$task': {
                ...
                'output_type': type.IdType(resource_types='com.vmware.cis.TASK'),
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': [],
                'task_type': TaskType.TASK_ONLY,
            },
