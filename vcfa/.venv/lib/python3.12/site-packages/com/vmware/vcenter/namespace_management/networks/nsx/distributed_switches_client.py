...
class Compatibility(VapiInterface):
    ...
    compatibility information of Distributed Switches.
    ...
    class Summary(VapiStruct):
        ...
        information of a Distributed Switch.
        This class was added in **vSphere API 8.0.0.1**.
...
class _CompatibilityStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/networks/nsx/distributed-switches?action=check_compatibility',
            path_variables={
            },
            query_parameters={
            },
