...
ConnectionState._set_values({
    ...
    'RECOVERABLE_ERROR': ConnectionState('RECOVERABLE_ERROR'),
    'UNRECOVERABLE_ERROR': ConnectionState('UNRECOVERABLE_ERROR'),
...
NvmeAddressInfo._set_binding_type(type.StructType(
    'com.vmware.vcenter.vm.hardware.nvme_address_info', {
        'bus': type.IntegerType(),
        'unit': type.IntegerType(),
    },
    NvmeAddressInfo,
...
NvmeAddressSpec._set_binding_type(type.StructType(
    'com.vmware.vcenter.vm.hardware.nvme_address_spec', {
        'bus': type.IntegerType(),
        'unit': type.OptionalType(type.IntegerType()),
    },
    NvmeAddressSpec,
...
class Cdrom(VapiInterface):
    ...
    HostBusAdapterType._set_values({
        'IDE': HostBusAdapterType('IDE'),
        'SATA': HostBusAdapterType('SATA'),
    })
    ...
    BackingType._set_values({
        'ISO_FILE': BackingType('ISO_FILE'),
        'HOST_DEVICE': BackingType('HOST_DEVICE'),
        'CLIENT_DEVICE': BackingType('CLIENT_DEVICE'),
    })
    ...
    DeviceAccessType._set_values({
        'EMULATION': DeviceAccessType('EMULATION'),
        'PASSTHRU': DeviceAccessType('PASSTHRU'),
        'PASSTHRU_EXCLUSIVE': DeviceAccessType('PASSTHRU_EXCLUSIVE'),
    })
...
class Disk(VapiInterface):
    ...
    class HostBusAdapterType(Enum):
        ...
        This class attribute was added in **vSphere API 7.0.0.1**.
    ...
    HostBusAdapterType._set_values({
        'IDE': HostBusAdapterType('IDE'),
        'SCSI': HostBusAdapterType('SCSI'),
        'SATA': HostBusAdapterType('SATA'),
        'NVME': HostBusAdapterType('NVME'),
    })
    HostBusAdapterType._set_binding_type(type.EnumType(
    ...
    BackingType._set_values({
        'VMDK_FILE': BackingType('VMDK_FILE'),
    })
    BackingType._set_binding_type(type.EnumType(
    ...
    class VmdkCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param storage_policy: The ``Disk.StoragePolicySpec`` class contains information about the
                storage policy that is to be associated the with VMDK file.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nvme: Address of device attached to a virtual NVMe adapter.
                This attribute was added in **vSphere API 7.0.0.1**.
                This attribute is optional and it is only relevant when the value
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.hardware.disk.info', {
            ...
            'sata': type.OptionalType(type.ReferenceType(__name__, 'SataAddressInfo')),
            'nvme': type.OptionalType(type.ReferenceType(__name__, 'NvmeAddressInfo')),
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nvme: Address for attaching the device to a virtual NVMe adapter.
                This attribute was added in **vSphere API 7.0.0.1**.
                If None, the server will choose an available address; if none is
                available, the request will fail.
    ...
    CreateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.hardware.disk.create_spec', {
            ...
            'sata': type.OptionalType(type.ReferenceType(__name__, 'SataAddressSpec')),
            'nvme': type.OptionalType(type.ReferenceType(__name__, 'NvmeAddressSpec')),
...
class Ethernet(VapiInterface):
    ...
    EmulationType._set_values({
        'E1000': EmulationType('E1000'),
        'E1000E': EmulationType('E1000E'),
        'PCNET32': EmulationType('PCNET32'),
        'VMXNET': EmulationType('VMXNET'),
        'VMXNET2': EmulationType('VMXNET2'),
        'VMXNET3': EmulationType('VMXNET3'),
    })
    ...
    MacAddressType._set_values({
        'MANUAL': MacAddressType('MANUAL'),
        'GENERATED': MacAddressType('GENERATED'),
        'ASSIGNED': MacAddressType('ASSIGNED'),
    })
    ...
    BackingType._set_values({
        'STANDARD_PORTGROUP': BackingType('STANDARD_PORTGROUP'),
        'HOST_DEVICE': BackingType('HOST_DEVICE'),
        'DISTRIBUTED_PORTGROUP': BackingType('DISTRIBUTED_PORTGROUP'),
        'OPAQUE_NETWORK': BackingType('OPAQUE_NETWORK'),
    })
    BackingType._set_binding_type(type.EnumType(
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'type',
                {
                    'VMXNET3' : [('upt_compatibility_enabled', True), ('upt_v2_compatibility_enabled', False)],
                    'E1000' : [],
                    'E1000E' : [],
                    'PCNET32' : [],
                    'VMXNET' : [],
        ...
        def __init__(self,
                     ...
                     upt_v2_compatibility_enabled=None,
                     mac_type=None,
                     mac_address=None,
            ...
            :type  upt_v2_compatibility_enabled: :class:`bool`
            :param upt_v2_compatibility_enabled: Flag indicates whether Uniform Pass-through version 2(UPTv2)
            ...
            self.upt_v2_compatibility_enabled = upt_v2_compatibility_enabled
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.hardware.ethernet.info', {
            ...
            'upt_v2_compatibility_enabled': type.OptionalType(type.BooleanType()),
    ...
    class CreateSpec(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'type',
                {
                    'VMXNET3' : [('upt_compatibility_enabled', False), ('upt_v2_compatibility_enabled', False)],
                    'E1000' : [],
                    'E1000E' : [],
                    'PCNET32' : [],
                    'VMXNET' : [],
        ...
        def __init__(self,
            ...
            :param upt_compatibility_enabled: Flag indicating whether Universal Pass-Through (UPT) compatibility
                ...
                Ethernet adapter.
            :type  upt_v2_compatibility_enabled: :class:`bool` or ``None``
            :param upt_v2_compatibility_enabled: Flag indicating whether Uniform Pass-through version 2(UPTv2)
...
class Floppy(VapiInterface):
    ...
    BackingType._set_values({
        'IMAGE_FILE': BackingType('IMAGE_FILE'),
        'HOST_DEVICE': BackingType('HOST_DEVICE'),
        'CLIENT_DEVICE': BackingType('CLIENT_DEVICE'),
    })
    BackingType._set_binding_type(type.EnumType(
...
class Memory(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param hot_add_increment_size_mib:             Only set when :attr:`Memory.Info.hot_add_enabled` is true and the
...
class Serial(VapiInterface):
    ...
    BackingType._set_values({
        'FILE': BackingType('FILE'),
        'HOST_DEVICE': BackingType('HOST_DEVICE'),
        'PIPE_SERVER': BackingType('PIPE_SERVER'),
        'PIPE_CLIENT': BackingType('PIPE_CLIENT'),
        'NETWORK_SERVER': BackingType('NETWORK_SERVER'),
        'NETWORK_CLIENT': BackingType('NETWORK_CLIENT'),
    })
    BackingType._set_binding_type(type.EnumType(
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'connect': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'delete': {
                ...
                'output_type': type.VoidType(),
                'errors': delete_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': delete_input_value_validator_list,
                'output_validator_list': delete_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
