...
class ConfigOptionDescriptors(VapiInterface):
    ...
    :func:`ConfigOptionDescriptors.list` method.
    This class was added in **vSphere API 8.0.2.00300**.
    """
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param config_option: A unique key used to identify a ConfigOption object.
            ...
            :param default_config_option: Indicates whether the associated set of virtual machine
                ...
                explicitly specified in the vim.vm.ConfigSpec. 
                This attribute was added in **vSphere API 8.0.2.00300**.
            ...
            :param upgrade_supported: Indicates whether the associated set of configuration options can
                be used as a virtual hardware upgrade target.
                This attribute was added in **vSphere API 8.0.2.00300**.
            """
    ...
    class ListParams(VapiStruct):
        ...
        def __init__(self,
            ...
            :param clusters: A set of Cluster IDs that specify for which Clusters the
                configuration option descriptors are requested.
                This attribute was added in **vSphere API 8.0.2.00300**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
    ...
    class ListResult(VapiStruct):
        ...
        :func:`ConfigOptionDescriptors.list` operation.
        This class was added in **vSphere API 8.0.2.00300**.
        ...
        def __init__(self,
            ...
            :param config_options_descriptors: List of configuration options matching the specified hardware.
                This attribute was added in **vSphere API 8.0.2.00300**.
            """
    ...
    def list(self,
        ...
        filter.
        This method was added in **vSphere API 8.0.2.00300**.
...
class ConfigOptions(VapiInterface):
    ...
    class GetParams(VapiStruct):
        ...
        :func:`ConfigOptions.get` method, such as which clusters to query.
        This class was added in **vSphere API 8.0.2.00300**.
        ...
        def __init__(self,
            ...
            """
            :type  clusters: :class:`set` of :class:`str` or ``None``
            :param clusters: The clusters whose config option are requested.
                This attribute was added in **vSphere API 8.0.2.00300**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``ClusterComputeResource``. When methods return a value of this
            ...
            :param config_option: Query for a specific config option with the key obtained from
                :func:`ConfigOptionDescriptors.list`.
                This attribute was added in **vSphere API 8.0.2.00300**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.config_option``. When methods return a value
    ...
    class Info(VapiStruct):
        ...
        The result is contained in a vim.vm.ConfigOption data structure.
        This class was added in **vSphere API 8.0.2.00300**.
        ...
        def __init__(self,
            ...
            :param config_option: A vim.vm.ConfigOption data structure.
                This attribute was added in **vSphere API 8.0.2.00300**.
    ...
    def get(self,
        ...
        :return:         :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
...
class ConfigTargets(VapiInterface):
    ...
    class ConfigTargetSpec(Enum):
        ...
        * Disks: scsiDisk, ideDisk
        ...
        requested via the projection parameter. 
        This enumeration was added in **vSphere API 8.0.2.00300**.
        ...
        sharedGpuPassthroughTypes within a vim.vm.ConfigTarget.
    ...
    class GetParams(VapiStruct):
        ...
        :func:`ConfigTargets.get` method, such as which clusters to query.
        This class was added in **vSphere API 8.0.2.00300**.
        ...
        def __init__(self,
            ...
            :type  clusters: :class:`set` of :class:`str` or ``None``
            :param clusters: A set of Cluster IDs that specify for which Clusters the
                configuration target is requested.
                This attribute was added in **vSphere API 8.0.2.00300**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``ClusterComputeResource``. When methods return a value of this
            ...
            :param filter: Specify a filter to narrow the results.
                This attribute was added in **vSphere API 8.0.2.00300**.
    ...
    class Info(VapiStruct):
        ...
        vim.vm.ConfigTarget matching the supplied filter.
        This class was added in **vSphere API 8.0.2.00300**.
        ...
        def __init__(self,
            ...
            :param config_target: A vim.vm.ConfigTarget matching the filter.
                This attribute was added in **vSphere API 8.0.2.00300**.
            """
