...
class Image(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.iso.image'
    """
...
class _ImageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        mount_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/iso/image?action=mount',
            path_variables={
            },
            query_parameters={
            },
        ...
        unmount_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/iso/image?action=unmount',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            'mount': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
