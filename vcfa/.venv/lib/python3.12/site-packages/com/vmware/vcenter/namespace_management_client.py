...
class ProxySettingsSource(Enum):
    ...
    cluster level, or the cluster can be configured not to use a proxy.
    This enumeration was added in **vSphere API 7.0.3.00100**.
    ...
    cluster settings will be kept in sync.
...
class ProxyConfiguration(VapiStruct):
    ...
    the Supervisor.
    This class was added in **vSphere API 7.0.3.00100**.
    ...
    def __init__(self,
        ...
        :param proxy_settings_source: The source of the proxy settings. If
            ...
            configuration in ``ProxyConfiguration`` will be ignored.
            This attribute was added in **vSphere API 7.0.3.00100**.
        ...
        :param https_proxy_config: HTTPS proxy configuration. Examples: 
            ...
            * https://proxy.vmware.com:4443
            ...
            is used for the source, otherwise this will be ignored.
            This attribute was added in **vSphere API 7.0.3.00100**.
        ...
        :param no_proxy_config: List of addresses that should be accessed directly. This will be
            ...
            the source, otherwise this will be ignored.
            This attribute was added in **vSphere API 7.0.3.00100**.
        ...
        :param tls_root_ca_bundle: Proxy TLS root CA bundle which will be used to verify the proxy's
            ...
            source, otherwise this will be ignored.
            This attribute was added in **vSphere API 7.0.3.00100**.
...
class Clusters(VapiInterface):
    ...
    class ResourceNamingStrategy(Enum):
        """
        The ``Clusters.ResourceNamingStrategy`` class represents the strategy to
        generate the Kubernetes resource names in a Supervisor for items in a
        Content Library associated with the Supervisor. The relevant Kubernetes
        resources include cluster scoped ClusterContentLibraryItem, and
        ClusterVirtualMachineImage resources in the Supervisor.
        ...
        FROM_ITEM_ID = None
        """
        The naming strategy to generate the Kubernetes resource name based on the
        corresponding Content Library item identifier.

        """
        PREFER_ITEM_SOURCE_ID = None
        """
        The naming strategy to generate the Kubernetes resource name based on the
        source identifier of the corresponding Content Library item if the Content
        Library is a subscribed Content Library, otherwise still based on the
        corresponding Content Library item identifer. With this naming strategy,
        the Kubernetes resources for images from different subscribed Content
        Libraries subscribing to the same published Content Library can have the
        same names across Supervisors with such subscribed Content Library
        associated. 
        
        Use this strategy if you have multiple Content Libraries that are
        subscribing to the same published Content Library, and want to consume the
        same resource names in the Supervisor for VM images originated from that
        published Content Library, regardless which Content Library is associated
        with the Supervisor.
        ...
        def __init__(self, string):
            """
            :type  string: :class:`str`
            :param string: String value for the :class:`ResourceNamingStrategy` instance.
            """
            Enum.__init__(string)

    ResourceNamingStrategy._set_values({
        'FROM_ITEM_ID': ResourceNamingStrategy('FROM_ITEM_ID'),
        'PREFER_ITEM_SOURCE_ID': ResourceNamingStrategy('PREFER_ITEM_SOURCE_ID'),
    })
    ResourceNamingStrategy._set_binding_type(type.EnumType(
        'com.vmware.vcenter.namespace_management.clusters.resource_naming_strategy',
    ...
    class NetworkProvider(Enum):
        ...
        """
        vSphere Networking.
        This class attribute was added in **vSphere API 7.0.1.0**.
    ...
    NetworkProvider._set_values({
        ...
        'NSX_VPC': NetworkProvider('NSX_VPC'),
    })
    ...
    class Stats(VapiStruct):
        """
        The ``Clusters.Stats`` class contains the basic Supervisor runtime
        statistics.
        ...
        def __init__(self,
            ...
            :param cpu_used: CPU consumed by the Supervisor and its workloads across all hosts
                in megahertz (MHz).
            :type  cpu_capacity: :class:`long`
            :param cpu_capacity: Maximum reservable CPU capacity for a Supervisor and its workloads
                in megahertz (MHz). This value is capped by the maximum physical
                CPU capacity of all hosts participating in the Supervisor or any
                limits present on Supervisor resource pools.
            :type  memory_used: :class:`long`
            :param memory_used: Host memory consumed by a Supervisor and its workloads in mebibytes
                (MiB).
            :type  memory_capacity: :class:`long`
            :param memory_capacity: Maximum reservable memory capacity for a Supervisor and its
                workloads in mebibytes (MiB). This value is capped by the maximum
                physical memory capacity of all hosts participating in the
                Supervisor or any limits present on Supervisor resource pools.
            :type  storage_used: :class:`long`
            :param storage_used: Storage committed by all participating Supervisor storage policies
                in mebibytes (MiB).
            :type  storage_capacity: :class:`long`
            :param storage_capacity: Capacity of all datastores backing all participating Supervisor
                storage policies in mebibytes (MiB).
            """
    ...
    class Condition(VapiStruct):
        ...
        configuration state of a Supervisor.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param type: The type of the condition is a CamelCase, machine readable
                ...
                ControlPlaneVMsConfigured are examples of such identifiers.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param description: Description of the condition type in a human readable format.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param reason: A brief CamelCase message indicating details about the reason for
                ...
                WaitForNodeUpgrade are examples of such messages.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param severity: Provides an explicit classification of the reason identifier. Set
                when the value of status is FALSE.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'network_provider',
                {
                    ...
                    'NSX_VPC' : [('vpc_network', False)],
                    'VSPHERE_NETWORK' : [('workload_networks', False), ('load_balancers', False)],
                }
            ),
        ]
        ...
        _canonical_to_pep_names = {
                                ...
                                'max_concurrent_DNS_forwards': 'max_concurrent_dns_forwards',
                                }
        ...
        def __init__(self,
                     ...
                     count=None,
                     supervisor_image_source=None,
                     vsphere_pods_enabled=None,
                     supervisor_services_enabled=None,
                     max_concurrent_dns_forwards=None,
                    ):
            """
            :type  size_hint: :class:`SizingHint`
            :param size_hint: Current setting for ``SizingHint``. This affects the size and
                resources allocated to the Kubernetes API server.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :type  vpc_network: :class:`Clusters.VpcNetworkSummary`
            :param vpc_network: Specification for the NSX VPC network.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is :attr:`Clusters.NetworkProvider.NSX_VPC`.
            ...
            :type  supervisor_primary_workload_network: :class:`str` or ``None``
            :param supervisor_primary_workload_network: Identifier of the Supervisor Primary workload network
                configuration. The Supervisor Primary workload network
                configuration refers to a network configuration used by Supervisor
                Kubernetes control plane VMs to expose Kubernetes API server to
                users and other workloads.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ...
                This attribute will always be :class:`set`. It is marked optional
            ...
            :param workload_ntp_servers: Information about NTP server DNS names or IP addresses to use for
                workloads such as Kubernetes Cluster VMs, specified in order of
                preference.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param load_balancers: Information related to the Load balancer used for provisioning
                virtual servers in the namespace.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is
                :attr:`Clusters.NetworkProvider.VSPHERE_NETWORK`.
            ...
            :param default_kubernetes_service_content_library: Identifier of the Content Library which holds the VM Images for
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**. Use
                    :attr:`Clusters.Info.content_libraries` instead.
            ...
            :param cluster_proxy_config: Proxy configuration that is applied to the Supervisor. The proxy
                ...
                Section 3.2.1 of RFC3986 security recommendation.
                This attribute was added in **vSphere API 7.0.3.00100**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            ...
            :param content_libraries: List of Content Libraries associated with a Supervisor. This list
                ...
                them are read-only across all vSphere Namespaces. If
                :attr:`Clusters.Info.default_kubernetes_service_content_library` is
                :class:`set`, the Content Library identifier will be migrated to
                this attribute.
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, no Content Libraries will be set for the Supervisor.
            :type  count: :class:`long` or ``None``
            :param count: Number of control planes associated with the Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, defaults to 3.
            :type  supervisor_image_source: :class:`com.vmware.vcenter.namespace_management.supervisors_client.ImageSourceSpec` or ``None``
            :param supervisor_image_source: Information about the source of this Supervisor image.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  vsphere_pods_enabled: :class:`bool` or ``None``
            :param vsphere_pods_enabled: Information about whether vSphere Pod support is enabled.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, defaults to False.
            :type  supervisor_services_enabled: :class:`bool` or ``None``
            :param supervisor_services_enabled: Information about whether Supervisor Service support is enabled.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, defaults to False.
            :type  max_concurrent_dns_forwards: :class:`long`
            :param max_concurrent_dns_forwards: Limit of concurrent DNS requests the DNS forwarder on each
                Supervisor control planes will forward to the upstream
                :attr:`Clusters.Info.worker_dns`. The maximum number of concurrent
                DNS requests that can be sent to upstream worker DNS servers from
                the Supervisor is calculated by multiplying this value by the
                :attr:`Clusters.Info.count` value. A value of 0 indicates there is
                no limit on the maximum number of concurrent requests that can be
                forwarded.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            ...
            self.count = count
            self.supervisor_image_source = supervisor_image_source
            self.vsphere_pods_enabled = vsphere_pods_enabled
            self.supervisor_services_enabled = supervisor_services_enabled
            self.max_concurrent_dns_forwards = max_concurrent_dns_forwards
            VapiStruct.__init__(self)
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.info', {
            ...
            'vpc_network': type.OptionalType(type.ReferenceType(__name__, 'Clusters.VpcNetworkSummary')),
            'workload_networks': type.OptionalType(type.ReferenceType(__name__, 'Clusters.WorkloadNetworksInfo')),
            'supervisor_primary_workload_network': type.OptionalType(type.IdType()),
            ...
            'supervisor_image_source': type.OptionalType(type.ReferenceType('com.vmware.vcenter.namespace_management.supervisors_client', 'ImageSourceSpec')),
            'vsphere_pods_enabled': type.OptionalType(type.BooleanType()),
            'supervisor_services_enabled': type.OptionalType(type.BooleanType()),
            'max_concurrent_DNS_forwards': type.OptionalType(type.IntegerType()),
        },
        Info,
        False,
        None))
    ...
    class ContentLibrarySpec(VapiStruct):
        ...
        required to configure Content Libraries with a Supervisor.
        ...
        def __init__(self,
            ...
            :param content_library: Content Library ID associated with a Supervisor. The Content
                ...
                class as a return value, the attribute will be an identifier for
                the resource type: ``com.vmware.content.Library``.
            :type  supervisor_services: :class:`list` of :class:`str`
            :param supervisor_services: List of Supervisor Service IDs that are currently making use of the
                Content Library. A Content Library can be used by one or more
                Supervisor Services.
                :attr:`Clusters.ContentLibrarySpec.supervisor_services` holds a
                list of :attr:`SupervisorServices.Summary.supervisor_service` which
                is used to identify the Supervisor Services that are making use of
                this Content Library. 
                
                If a Supervisor Service is specified, the Supervisor Service ID
                will be added as a label with key
                services.supervisor.vmware.com/Service-ID to the Content Library
                resources on the supervisor. For example, the label for vSphere
                Kubernetes Service with ID as kubernetes.vmware.com will be
                services.supervisor.vmware.com/kubernetes.vmware.com: "" .
                Supervisor Services can use this label to identify the images in
                the Content Library. 
                
                Note: When associating content libraries with vSphere Kubernetes
                Service (VKS), use Service ID kubernetes.vmware.com instead of the
                installed Service ID tkg.vsphere.vmware.com to ensure successful
                association of content libraries with VKS. 
                
                Note that linking a Content Library to a Supervisor Service does
                not limit the Content Library from being used by other services on
                the supervisor. This label will be applied on the following
                kubernetes resources on the Supervisor 
                
                * clustercontentlibrary(cclib) resource managed by WCP service
                * clustercontentlibraryitem(cclitem) resource managed by Image
                  Registry Operator
                * clustervirtualmachineimage(cvmi) resource managed by VM Operator
                
                If None, no labels as described above will be added to the Content
                Library resources on the supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ...
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  resource_naming_strategy: :class:`Clusters.ResourceNamingStrategy` or ``None``
            :param resource_naming_strategy: The resource naming strategy that is used to generate the
                Kubernetes resource names for images from this Content Library. 
                
                An InvalidArgument error will be thrown from
                :func:`Clusters.enable` method, :func:`Clusters.update` method, and
                :func:`Clusters.set` method if this ``resourceNamingStrategy`` is
                changed on an existing Content Library associated with the
                Supervisor, or set to
                :attr:`Clusters.ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID` on a
                subscribed Content Library from a published Content Library that is
                either also associated with the Supervisor or has another
                subscribed Content Library associated to the Superivsor with the
                ``resourceNamingStrategy`` also set to
                :attr:`Clusters.ResourceNamingStrategy.PREFER_ITEM_SOURCE_ID`.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, Kubernetes resource names for images from this Content
                Library will be generated based on the default naming strategy
                :attr:`Clusters.ResourceNamingStrategy.FROM_ITEM_ID`.
            """
            self.content_library = content_library
            self.supervisor_services = supervisor_services
            self.resource_naming_strategy = resource_naming_strategy
            VapiStruct.__init__(self)
    ...
    ContentLibrarySpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.content_library_spec', {
            ...
            'supervisor_services': type.OptionalType(type.ListType(type.IdType())),
            'resource_naming_strategy': type.OptionalType(type.ReferenceType(__name__, 'Clusters.ResourceNamingStrategy')),
        },
        ContentLibrarySpec,
        False,
        None))
    ...
    class VpcNetworkSummary(VapiStruct):
        """
        The ``Clusters.VpcNetworkSummary`` class describes the the VPC settings for
        a Supervisor.
        ...
        def __init__(self,
                     ...
                     default_private_cidrs=None,
                     auto_created=None,
                    ):
            """
            :type  nsx_project: :class:`str`
            :param nsx_project: NsxProject is the NSX path of an NSX Project.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_connectivity_profile: :class:`str`
            :param vpc_connectivity_profile: VpcConnectivityProfile is the path of a VpcConnectivityProfile.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  default_private_cidrs: :class:`list` of :class:`Ipv4Cidr`
            :param default_private_cidrs: Default CIDR blocks from which private subnets and private pod IPs
                are allocated.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  auto_created: :class:`bool`
            :param auto_created: Whether the VPC has been automatically created for the namespace.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.nsx_project = nsx_project
            self.vpc_connectivity_profile = vpc_connectivity_profile
            self.default_private_cidrs = default_private_cidrs
            self.auto_created = auto_created
            VapiStruct.__init__(self)


    VpcNetworkSummary._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.vpc_network_summary', {
            'nsx_project': type.StringType(),
            'vpc_connectivity_profile': type.StringType(),
            'default_private_cidrs': type.ListType(type.ReferenceType(__name__, 'Ipv4Cidr')),
            'auto_created': type.BooleanType(),
        },
        VpcNetworkSummary,
        False,
        None))
    ...
    class VpcNetworkInfo(VapiStruct):
        """
        The ``Clusters.VpcNetworkInfo`` class describes the detailed VPC settings
        for a Supervisor.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  vpc_config: :class:`Clusters.VpcConfig`
            :param vpc_config: Specification for the NSX VPC network.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
    ...
    VpcNetworkInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.vpc_network_info', {
            'vpc_config': type.ReferenceType(__name__, 'Clusters.VpcConfig'),
        },
        VpcNetworkInfo,
        False,
        None))
    ...
    class ProjectInfo(VapiStruct):
        """
        The ``Clusters.ProjectInfo`` class contains information about an NSX
        Project.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param project: Identifier of the NSX Project.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    ProjectInfo._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.project_info', {
    ...
    class VpcConfig(VapiStruct):
        """
        The ``Clusters.VpcConfig`` class describes the specification of an NSX VPC
        for Supervisor Network configuration.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  nsx_project_info: :class:`Clusters.ProjectInfo`
            :param nsx_project_info: The default NSX Project for VPCs created in the Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  vpc_connectivity_profile_info: :class:`com.vmware.vcenter.namespace_management.networks.nsx.projects_client.VpcConnectivityProfiles.Info`
            :param vpc_connectivity_profile_info: Default VPC Connectivity Profile used for all VPCs created in the
                Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  default_private_cidrs: :class:`list` of :class:`Ipv4Cidr`
            :param default_private_cidrs: Default CIDR blocks from which private subnets and private pod IPs
                are allocated for all VPCs created in the Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
    ...
    VpcConfig._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.vpc_config', {
            'nsx_project_info': type.ReferenceType(__name__, 'Clusters.ProjectInfo'),
            'vpc_connectivity_profile_info': type.ReferenceType('com.vmware.vcenter.namespace_management.networks.nsx.projects_client', 'VpcConnectivityProfiles.Info'),
            'default_private_cidrs': type.ListType(type.ReferenceType(__name__, 'Ipv4Cidr')),
        },
        VpcConfig,
        False,
    ...
    class WorkloadNetworksEnableSpec(VapiStruct):
        ...
        network for Kubernetes Cluster VMs and Kubernetes control plane VMs.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param supervisor_primary_workload_network: The  of the vSphere Namespaces network that will be used by
                ...
                network for Kubernetes Cluster VMs.
                This attribute was added in **vSphere API 7.0.1.0**.
    ...
    class WorkloadNetworksInfo(VapiStruct):
        ...
        configuration of vSphere Namespaces Network objects.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param network: Identifier for the network.
                ...
                .. deprecated:: vSphere API 8.0.3.0
                    This attribute is deprecated as of **vSphere API 8.0.3.0**. 
            ...
            :param network_segment: Backing Network segment.
    ...
    class NCPClusterNetworkInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nsx_tier0_gateway: NSX Tier0 Gateway used for this Supervisor.
                ...
                This is :class:`set` when the cluster uses NSX.
            :type  namespace_subnet_prefix: :class:`long` or ``None``
            :param namespace_subnet_prefix: Size of the subnet reserved for namespaces segments.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None, defaults to 28.
            :type  routed_mode: :class:`bool` or ``None``
            :param routed_mode: Routed mode for this Supervisor.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None, defaults to False.
            """
    ...
    class NCPClusterNetworkEnableSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param cluster_distributed_switch: vSphere Distributed Switch used to connect this cluster.
                ...
                class as a return value, the attribute will be an identifier for
                the resource type: ``vSphereDistributedSwitch``.
                This field is required when configuring a cluster that uses NSX. If
                None and using NSXe, the system will choose a suitable vSphere
                Distributed Switch.
            ...
            :param nsx_edge_cluster: NSX Edge cluster to be used for Kubernetes Services of type
                ...
                type: ``NSXEdgeCluster``.
                This field is required when configuring a cluster that uses NSX. If
                None and using NSXe, the system will choose a suitable NSX Edge
                cluster.
            :type  nsx_tier0_gateway: :class:`str` or ``None``
            :param nsx_tier0_gateway: NSX Tier0 Gateway used for this Supervisor.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param namespace_subnet_prefix: Size of the subnet reserved for namespaces segments.
                ...
                If None, defaults to 28.
            :type  routed_mode: :class:`bool` or ``None``
            :param routed_mode: Routed mode for this Supervisor. When set to True, the traffic in
                the cluster is not NATed. When this field is set to True,
    ...
    class NCPClusterNetworkUpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param default_ingress_tls_certificate: PEM-encoded x509 certificate used by NSX as a default fallback
                ...
                2. By creating a certificate using public key cryptography. In such
                case the certificate
                :attr:`Clusters.NCPClusterNetworkUpdateSpec.default_ingress_tls_certificate`
                should be specified along with the private key
                :attr:`Clusters.NCPClusterNetworkUpdateSpec.default_ingress_tls_private_key`
    ...
    class VpcClusterNetworkUpdateSpec(VapiStruct):
        """
        The ``Clusters.VpcClusterNetworkUpdateSpec`` class encapsulates the NSX VPC
        cluster networking configuration parameters for the vSphere Namespaces
        ...
        def __init__(self,
            ...
            """
            :type  default_private_cidrs: :class:`list` of :class:`Ipv4Cidr` or ``None``
            :param default_private_cidrs: Default CIDR blocks from which private subnets are allocated for
                new VPCs. Updating does not affect existing VPCs, but rather
                establishes the default for all new namespaces. This range should
                not overlap with the IP blocks defined in
                :attr:`com.vmware.vcenter.namespace_management.supervisors.networks.workload_client.VpcNetwork.vpc_connectivity_profile`,
                :attr:`com.vmware.vcenter.namespace_management.supervisors.networks.workload_client.Network.ip_management`,
                or other services running in the datacenter. 
                
                Changing to use invalid CIDR e.g. overlapping or broadcast or
    ...
    VpcClusterNetworkUpdateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.vpc_cluster_network_update_spec', {
            'default_private_cidrs': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Ipv4Cidr'))),
        },
        VpcClusterNetworkUpdateSpec,
        False,
        None))
    ...
    class VpcClusterNetworkSetSpec(VapiStruct):
        """
        The ``Clusters.VpcClusterNetworkSetSpec`` class encapsulates the NSX VPC
        cluster networking configuration parameters for the vSphere Namespaces
        ...
        def __init__(self,
            ...
            :type  default_private_cidrs: :class:`list` of :class:`Ipv4Cidr` or ``None``
            :param default_private_cidrs: Default CIDR blocks from which private subnets are allocated for
                new VPCs. Setting does not affect existing VPCs, but rather
                establishes the default for all new namespaces. This range should
                not overlap with those in
                :attr:`com.vmware.vcenter.namespace_management.supervisors.networks.workload_client.VpcNetwork.vpc_connectivity_profile`,
                :attr:`com.vmware.vcenter.namespace_management.supervisors.networks.workload_client.Network.ip_management`,
                or other services running in the datacenter. Changing to use
                invalid CIDR e.g. overlapping or broadcast or reserved CIDR will
                result in the operation failing with a
                ``com.vmware.vapi.std.errors_client.InvalidArgument`` exception.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the current value will be retained.
            """
    ...
    VpcClusterNetworkSetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.vpc_cluster_network_set_spec', {
            'default_private_cidrs': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Ipv4Cidr'))),
        },
        VpcClusterNetworkSetSpec,
        False,
        None))
    ...
    class EnableSpec(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'network_provider',
                {
                    ...
                    'VSPHERE_NETWORK' : [('workload_networks_spec', False), ('load_balancer_config_spec', False)],
                    'NSX_VPC' : [],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            :param default_kubernetes_service_content_library: Identifier of the Content Library which holds the VM Images for
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**. Use
                    :attr:`Clusters.EnableSpec.content_libraries` instead.
            ...
            :param content_libraries: List of Content Libraries that will be associated with a
                ...
                vSphere Namespaces. If
                :attr:`Clusters.EnableSpec.default_kubernetes_service_content_library`
                is :class:`set`, the Content Library identifier will be migrated to
                this attribute.
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, a subscribed Content Library, subscribed to VMware's
                hosted vSphere Kubernetes Service Repository, will be automatically
                created and configured to the Supervisor.
            :type  count: :class:`long` or ``None``
            :param count: Number of control planes requested during Supervisor enablement.
                The allowed values are either 1 or 3.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, defaults to 3.
            """
            self.size_hint = size_hint
    ...
    class UpdateSpec(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'network_provider',
                {
                    ...
                    'NSX_VPC' : [('vpc_cluster_network_spec', False)],
                    'VSPHERE_NETWORK' : [],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            """
            :type  vsphere_pods_enabled: :class:`bool` or ``None``
            :param vsphere_pods_enabled: A boolean indicating whether vSphere Pods support should be
                enabled. It is currently only possible to enable vSphere Pod
                support post Supervisor enablement, not disable it.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, defaults to False.
            :type  supervisor_services_enabled: :class:`bool` or ``None``
            :param supervisor_services_enabled: A boolean indicating whether Supervisor Service support should be
                enabled. It is currently only possible to enable Supervisor Service
                support post Supervisor enablement, not disable it. Supervisor
                Services that rely on vSphere Pod support will not be installed
            ...
            :param floating_ip: Optionally, you can edit the floating IP address that is assigned
                ...
                support DHCP client identifiers.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, the existing effective management network floating IP will
                not be modified.
            ...
            :param ncp_cluster_network_spec: Updated specification for the cluster network configuration.
                If None, the existing effective cluster network specification will
                not be modified.
            :type  vpc_cluster_network_spec: :class:`Clusters.VpcClusterNetworkUpdateSpec` or ``None``
            :param vpc_cluster_network_spec: Updated specification for the cluster network configuration.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the existing effective cluster network specification will
                not be modified.
            :type  supervisor_primary_workload_network: :class:`str` or ``None``
            :param supervisor_primary_workload_network: Identifier of the Supervisor Primary workload network
                ...
                be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.Network``.
                If None, the current value remains unchanged.
            :type  master_dns: :class:`list` of :class:`str` or ``None``
            :param master_dns: List of DNS server IP addresses to use on Kubernetes API server,
                specified in order of preference.
            ...
            :param tls_endpoint_certificate: PEM-encoded x509 certificate(s) issued for Kubernetes API Server.  
                ...
                2. By creating a certificate using public key cryptography. In such
                case the certificate
                :attr:`Clusters.UpdateSpec.tls_endpoint_certificate` should be
                specified along with the private key
                :attr:`Clusters.UpdateSpec.tls_endpoint_private_key` used to
            ...
            :type  tls_endpoint_private_key: :class:`str` or ``None``
            :param tls_endpoint_private_key: Private Key matching
                :attr:`Clusters.UpdateSpec.tls_endpoint_certificate` 
                ...
                public key certificates and key pairs.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None and :attr:`Clusters.UpdateSpec.tls_endpoint_certificate` is
                specified then the Supervisor will attempt to find a matching key
                that was generated with Certificate Signing Request. Otherwise,
                :attr:`Clusters.UpdateSpec.tls_endpoint_private_key` will not be
                modified.
            :type  default_kubernetes_service_content_library: :class:`str` or ``None``
            :param default_kubernetes_service_content_library: Identifier of the Content Library which holds the VM Images for
                vSphere Kubernetes Service. 
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**. Use
                    :attr:`Clusters.UpdateSpec.content_libraries` instead.
            :type  workload_ntp_servers: :class:`list` of :class:`str` or ``None``
            :param workload_ntp_servers: List of NTP server DNS names or IP addresses to use for workloads
                such as Kubernetes Cluster VMs, specified in order of preference.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param content_libraries: List of Content Libraries that will be associated with a
                ...
                If None, no Content Libraries will be set for the Supervisor.
            :type  count: :class:`long` or ``None``
            :param count: Total number of control planes associated with a Supervisor. If the
                existing count is 1, the allowed values are either 1 or 3.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None or the existing count is 3, no change will be made to the
                Supervisor.
            :type  max_concurrent_dns_forwards: :class:`long` or ``None``
            :param max_concurrent_dns_forwards: This configuration setting applies to the DNS forwarder running on
                each Supervisor control plane VM. It determines the maximum number
                of concurrent DNS requests that can be sent to upstream
                :attr:`Clusters.UpdateSpec.worker_dns` servers from the Supervisor,
                which is calculated by multiplying this value by the
                :attr:`Clusters.UpdateSpec.count` value. This value must be greater
                than or equal to 0. If set to 0, no limit will be imposed on the
                maximum number of concurrent requests that can be forwarded.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the existing value will not be modified.
            """
            self.vsphere_pods_enabled = vsphere_pods_enabled
            self.supervisor_services_enabled = supervisor_services_enabled
            self.size_hint = size_hint
            ...
            self.network_provider = network_provider
            self.ncp_cluster_network_spec = ncp_cluster_network_spec
            self.vpc_cluster_network_spec = vpc_cluster_network_spec
            self.supervisor_primary_workload_network = supervisor_primary_workload_network
            self.master_dns = master_dns
            self.worker_dns = worker_dns
            self.master_dns_search_domains = master_dns_search_domains
            ...
            self.default_image_repository = default_image_repository
            self.tls_endpoint_certificate = tls_endpoint_certificate
            self.tls_endpoint_private_key = tls_endpoint_private_key
            self.default_kubernetes_service_content_library = default_kubernetes_service_content_library
            self.workload_ntp_servers = workload_ntp_servers
            self.cluster_proxy_config = cluster_proxy_config
            self.content_libraries = content_libraries
    ...
    UpdateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.update_spec', {
            ...
            'vpc_cluster_network_spec': type.OptionalType(type.ReferenceType(__name__, 'Clusters.VpcClusterNetworkUpdateSpec')),
            'supervisor_primary_workload_network': type.OptionalType(type.IdType()),
            'master_DNS': type.OptionalType(type.ListType(type.StringType())),
            'worker_DNS': type.OptionalType(type.ListType(type.StringType())),
            'master_DNS_search_domains': type.OptionalType(type.ListType(type.StringType())),
            ...
            'default_image_repository': type.OptionalType(type.StringType()),
            'tls_endpoint_certificate': type.OptionalType(type.StringType()),
            'tls_endpoint_private_key': type.OptionalType(type.SecretType()),
            'default_kubernetes_service_content_library': type.OptionalType(type.IdType()),
            'workload_ntp_servers': type.OptionalType(type.ListType(type.StringType())),
            'cluster_proxy_config': type.OptionalType(type.ReferenceType(__name__, 'ProxyConfiguration')),
            'content_libraries': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'Clusters.ContentLibrarySpec'))),
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param floating_ip: Optionally, you can edit the floating IP address that is assigned
                ...
                not support DHCP client identifiers.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, the existing effective management network floating IP will
                not be modified.
            :type  network_provider: :class:`Clusters.NetworkProvider`
            ...
            :param ncp_cluster_network_spec: Specification for the NSX Container Plugin cluster network.
                ...
                of ``networkProvider`` is
                :attr:`Clusters.NetworkProvider.NSXT_CONTAINER_PLUGIN`.
            :type  vpc_cluster_network_spec: :class:`Clusters.VpcClusterNetworkSetSpec`
            :param vpc_cluster_network_spec: Specification for the NSX VPC network.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``networkProvider`` is :attr:`Clusters.NetworkProvider.NSX_VPC`.
            :type  supervisor_primary_workload_network: :class:`str` or ``None``
            ...
            :param default_kubernetes_service_content_library: 
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**. Use
                    :attr:`Clusters.SetSpec.content_libraries` instead.
            :type  workload_ntp_servers: :class:`list` of :class:`str` or ``None``
            :param workload_ntp_servers: List of NTP server DNS names or IP addresses to use for workloads
                such as Kubernetes Cluster VMs, specified in order of preference.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param content_libraries: List of Content Libraries that will be associated a the Supervisor.
                ...
                If None, no Content Libraries will be set for the Supervisor.
            :type  count: :class:`long` or ``None``
            :param count: Total number of control planes associated with a Supervisor.
                Permitted values are 1 or 3. Attempting to scale in by reducing the
                desired count is not supported.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, no change will be made to the Supervisor.
            :type  vsphere_pods_enabled: :class:`bool` or ``None``
            :param vsphere_pods_enabled: A boolean indicating whether vSphere Pods support should be
                enabled. It is currently only possible to enable vSphere Pod
                support post Supervisor enablement, not disable it.
            ...
            :param max_concurrent_dns_forwards: This configuration setting applies to the DNS forwarder running on
                each Supervisor control plane VM. It determines the maximum number
                of concurrent DNS requests that can be sent to upstream
                :attr:`Clusters.SetSpec.worker_dns` servers from the Supervisor,
                which is calculated by multiplying this value by the
                :attr:`Clusters.SetSpec.count` value. This value must be greater
                than or equal to 0. If set to 0, no limit will be imposed on the
                maximum number of concurrent requests that can be forwarded.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the existing value will not be modified.
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.clusters.set_spec', {
            ...
            'vpc_cluster_network_spec': type.OptionalType(type.ReferenceType(__name__, 'Clusters.VpcClusterNetworkSetSpec')),
            'supervisor_primary_workload_network': type.OptionalType(type.IdType()),
            'master_DNS': type.OptionalType(type.ListType(type.StringType())),
            'worker_DNS': type.OptionalType(type.ListType(type.StringType())),
            'master_DNS_search_domains': type.OptionalType(type.ListType(type.StringType())),
    ...
    def enable(self,
        ...
        .. deprecated:: vSphere API 9.0.0.0
            This method is deprecated as of **vSphere API 9.0.0.0**. Use
            :func:`Supervisors.enable_on_compute_cluster` method or
            :func:`Supervisors.enable_on_zones` method instead.
        ...
        """
        warn('com.vmware.vcenter.namespace_management.Clusters.enable is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
...
class LoadBalancers(VapiInterface):
    ...
    Namespaces Cluster and Kubernetes Clusters. Note: The lifecycle of these
    load balancers is not managed by vSphere.
    This class was added in **vSphere API 7.0.1.0**.
    """
    ...
    class Provider(Enum):
        ...
        supported by vSphere Namespaces.
        ...
        .. deprecated:: vSphere API 9.0.0.0
            ...
            :attr:`com.vmware.vcenter.namespace_management.networks.edges_client.EdgeProvider.VSPHERE_FOUNDATION`
            instead.
    ...
    class ConfigSpec(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'provider',
                {
                    ...
                    'AVI' : [('avi_config_create_spec', False)],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            :param address_ranges: List of address ranges that will be used to derive frontend IP
                ...
                provider, at least one range must be provided.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param ha_proxy_config_create_spec: The ``LoadBalancers.HAProxyConfigCreateSpec`` is a conditional
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    ...
                    Instead, use
                    :class:`com.vmware.vcenter.namespace_management.supervisors.networks_client.Edges.FoundationLoadBalancerCreateSpec`
                    with provider
                    :attr:`com.vmware.vcenter.namespace_management.networks.edges_client.EdgeProvider.VSPHERE_FOUNDATION`.
    ...
    class SetSpec(VapiStruct):
        ...
        setting a new configuration for a load balancer.
    ...
    class UpdateSpec(VapiStruct):
        ...
        when updating configuration for load balancers.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param ha_proxy_config_update_spec: The ``LoadBalancers.HAProxyConfigUpdateSpec`` is a conditional
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**.
                    Instead, use
                    :class:`com.vmware.vcenter.namespace_management.supervisors.networks_client.Edges.FoundationLoadBalancerUpdateSpec`
                    with provider
                    :attr:`com.vmware.vcenter.namespace_management.networks.edges_client.EdgeProvider.VSPHERE_FOUNDATION`.
    ...
    class HAProxyConfigCreateSpec(VapiStruct):
        ...
        balancer be created via HAProxy.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param servers: Servers is a list of the addresses for the data plane API servers
                used to configure Virtual Servers.
                This attribute was added in **vSphere API 7.0.1.0**.
            ...
            :param certificate_authority_chain: CertificateAuthorityChain contains PEM-encoded CA chain which is
                ...
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            warn('com.vmware.vcenter.namespace_management.LoadBalancers.HAProxyConfigCreateSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class HAProxyConfigSetSpec(VapiStruct):
        ...
        required for Supervisor Service Type:LoadBalancer to have an external load
        balancer be created via HA Proxy.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param servers: Servers is a list of the addresses for the data plane API servers
                ...
                should match existing list of servers.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  username: :class:`str`
            :param username: An administrator user name for accessing the HAProxy Data Plane API
                server.
            ...
            :param certificate_authority_chain: CertificateAuthorityChain contains PEM-encoded CA chain which is
                ...
                This attribute was added in **vSphere API 7.0.3.0**.
            """
            warn('com.vmware.vcenter.namespace_management.LoadBalancers.HAProxyConfigSetSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.servers = servers
            self.username = username
            self.password = password
            self.certificate_authority_chain = certificate_authority_chain
    ...
    class HAProxyConfigUpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.namespace_management.LoadBalancers.HAProxyConfigUpdateSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.username = username
            self.password = password
            self.certificate_authority_chain = certificate_authority_chain
            VapiStruct.__init__(self)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param id: An DNS compliant identifier for a load balancer, which can be used
                to query or configure the load balancer properties.
                This attribute was added in **vSphere API 7.0.1.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.LoadBalancerConfig``.
                ...
                ``com.vmware.vcenter.namespace_management.LoadBalancerConfig``.
            :type  provider: :class:`LoadBalancers.Provider`
            :param provider: Load balancer provider for the namespace.
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            self.id = id
            self.provider = provider
        ...
        def __init__(self,
            ...
            :param ha_proxy_info: The ``LoadBalancers.HAProxyInfo`` is a conditional configuration
                ...
                .. deprecated:: vSphere API 9.0.0.0
                    This attribute is deprecated as of **vSphere API 9.0.0.0**.
                    Instead, use
                    :class:`com.vmware.vcenter.namespace_management.supervisors.networks_client.Edges.FoundationLoadBalancerInfo`
                    with provider
                    :attr:`com.vmware.vcenter.namespace_management.networks.edges_client.EdgeProvider.VSPHERE_FOUNDATION`.
    ...
    class HAProxyInfo(VapiStruct):
        ...
        HAProxy load balancer in the namespace.
        This class was added in **vSphere API 7.0.1.0**.
        ...
        def __init__(self,
            ...
            :param certificate_authority_chain: PEM-encoded CA certificate chain which is used to verify x509
                ...
                This attribute was added in **vSphere API 7.0.1.0**.
            """
            warn('com.vmware.vcenter.namespace_management.LoadBalancers.HAProxyInfo is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.servers = servers
            self.username = username
            self.certificate_authority_chain = certificate_authority_chain
            VapiStruct.__init__(self)
    ...
    class AviConfigCreateSpec(VapiStruct):
        ...
        required for integration with the Avi Software Load Balancer.
    ...
    class AviConfigSetSpec(VapiStruct):
        ...
        for integration with the Avi Software Load Balancer.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class AviInfo(VapiStruct):
        ...
        software load balancer in the namespace.
        This class was added in **vSphere API 7.0.2.0**.
...
class NSXTier0Gateway(VapiInterface):
    ...
    class Summary(VapiStruct):
        """
        The ``NSXTier0Gateway.Summary`` class contains information about an NSX
        Tier0 Gateway.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
                     ...
                     description=None,
                     path=None,
                     parent_tier0_gateway=None,
                    ):
            """
            :type  tier0_gateway: :class:`str`
            :param tier0_gateway: Identifier of the NSX Tier0 or Tier0-VRF Gateway.
                This attribute was added in **vSphere API 7.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``NSXTier0Gateway``. When methods return a value of this class as a
            ...
            :param display_name: Display name of the NSX Gateway.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  description: :class:`str` or ``None``
            :param description: Description of the NSX Gateway.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, the gateway has no description set.
            :type  path: :class:`str`
            :param path: NSX Policy path of the NSX Gateway.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  parent_tier0_gateway: :class:`str` or ``None``
            :param parent_tier0_gateway: Parent Tier0 of the NSX Tier0-VRF Gateway.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``NSXTier0Gateway``. When methods return a value of this class as a
                return value, the attribute will be an identifier for the resource
                type: ``NSXTier0Gateway``.
                If None, the gateway is not Tier0-VRF.
            """
            self.tier0_gateway = tier0_gateway
            self.display_name = display_name
            self.description = description
            self.path = path
            self.parent_tier0_gateway = parent_tier0_gateway
            VapiStruct.__init__(self)
    ...
    Summary._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.NSX_tier0_gateway.summary', {
            ...
            'parent_tier0_gateway': type.OptionalType(type.IdType()),
        },
        Summary,
        False,
        None))
    ...
    class FilterSpec(VapiStruct):
        """
        The ``NSXTier0Gateway.FilterSpec`` class contains additional attributes
        used to filter the results when listing NSXTier0Gateway (see
        :func:`NSXTier0Gateway.list`).
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  include_vrf: :class:`bool` or ``None``
            :param include_vrf: Criteria of if Tier0-VRF gateways should be included as part of
                result.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, only non-VRF Tier0 Gateways will be returned.
            """
            self.include_vrf = include_vrf
            VapiStruct.__init__(self)


    FilterSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.NSX_tier0_gateway.filter_spec', {
            'include_VRF': type.OptionalType(type.BooleanType()),
        },
        FilterSpec,
        False,
        None))
    ...
    def list(self,
        ...
        """
        Returns information of NSX Tier0 Gateways associated with a Distributed
        Switch.
        ...
        :type  filter: :class:`NSXTier0Gateway.FilterSpec` or ``None``
        :param filter: Additional specification of matching NSXTier0Gateway for which
            information should be returned.
            This parameter was added in **vSphere API 9.0.0.0**.
            If None, the behavior is equivalent to a  with all attributes None
            which means Tier0-VRF gateways won't be returned.
...
class Networks(VapiInterface):
    ...
    class IPAssignmentMode(Enum):
        ...
        STATICRANGE = None
        """
        The address is assigned from a static range.
    ...
    class Mode(Enum):
        """
        The ``Networks.Mode`` class describes the intended use of a network.
        This enumeration was added in **vSphere API 7.0.1.0**.
        ...
        MANAGEMENT = None
        """
        Indicates the infrastructure supports connectivity between this network and
        the Supervisor management network. Entities on this network are capable of
        communicating with management entities like the Supervisor and vCenter
        Server. 
        
        Networks can only be associated to :attr:`Networks.Mode.MANAGEMENT`
        networks when the Supervisor management network is configured to be the
        Primary Workload Network.

        """
        WORKLOAD = None
        """
        Indicates the network is intended for general workload consumption. This
        network should generally not be routable to networks with the
        :attr:`Networks.Mode.MANAGEMENT` mode :class:`set`.
    ...
    Mode._set_binding_type(type.EnumType(
        'com.vmware.vcenter.namespace_management.networks.mode',
        Mode))
    ...
    class LoadBalancerSize(Enum):
        ...
        virtual servers. Large load balancer can host 1000 virtual servers.
        ...
        SMALL = None
        """
        Load balancer size of 'small'.

        """
        MEDIUM = None
        """
        Load balancer size of 'medium'.

        """
        LARGE = None
        """
        Load balancer size of 'large'.
    ...
    class VsphereDVPGNetworkCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  address_ranges: :class:`list` of :class:`IPRange`
            :param address_ranges: Usable IP pools on this network.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  gateway: :class:`str`
            ...
            :param subnet_mask: Subnet mask of the network.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  mode: :class:`Networks.Mode` or ``None``
            :param mode: Assigns a mode to a network. A mode describes the intended use of
                the network.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None this network defaults to the :attr:`Networks.Mode.WORKLOAD`
                mode.
            """
    ...
    VsphereDVPGNetworkCreateSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.networks.vsphere_DVPG_network_create_spec', {
            ...
            'gateway': type.StringType(),
            'subnet_mask': type.StringType(),
            'mode': type.OptionalType(type.ReferenceType(__name__, 'Networks.Mode')),
        },
    ...
    class NsxNetworkCreateSpec(VapiStruct):
        ...
        specification of a NSXT-backed Namespaces Network configuration.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param subnet_prefix_length: Size of the subnet reserved for namespace segments.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param load_balancer_size: The size of the NSX Load Balancer used by the namespace. This field
                does not allow update once applied.
                This attribute was added in **vSphere API 7.0.2.0**.
        ...
        _validator_list = [
            UnionValidator(
                'network_provider',
                {
                    ...
                    'NSXT_CONTAINER_PLUGIN' : [('nsx_network', False)],
                    'NSX_VPC' : [],
                }
            ),
        ]
    ...
    class VsphereDVPGNetworkSetSpec(VapiStruct):
        ...
        to set on an existing a vSphere DVPG-backed Namespaces Network object.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param address_ranges: Usable IP pools on this network. If the network object is
                ...
                be passed in without modifications.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  gateway: :class:`str`
    ...
    class NsxNetworkSetSpec(VapiStruct):
        ...
        on an existing NSXT-backed Namespaces Network configuration.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class VsphereDVPGNetworkUpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param mode: Assigns a mode to a network. A mode describes the intended use of
                ...
                Modes cannot be changed when a network is associated with a
                Namespace, a load balancer, or is the
                :attr:`Clusters.WorkloadNetworksEnableSpec.supervisor_primary_workload_network`.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None the current value will be retained.
            """
    ...
    class NsxNetworkUpdateSpec(VapiStruct):
        ...
        update on an existing a NSXT-backed Namespaces Network configuration.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class VsphereDVPGNetworkInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param portgroup: Identifier of the vSphere Distributed Portgroup backing the vSphere
                ...
                attribute will be an identifier for the resource type: ``Network``.
            :type  ip_assignment_mode: :class:`Networks.IPAssignmentMode` or ``None``
            :param ip_assignment_mode: IP address assignment mode.
                This attribute was added in **vSphere API 7.0.3.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  address_ranges: :class:`list` of :class:`IPRange`
            ...
            :param subnet_mask: Subnet mask of the network.
                This attribute was added in **vSphere API 7.0.1.0**.
            :type  mode: :class:`Networks.Mode`
            :param mode: Displays the intended use of the network.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
    ...
    class NsxNetworkInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param egress_cidrs: CIDR blocks from which NSX assigns IP addresses used for performing
                ...
                applied.
            :type  nsx_tier0_gateway: :class:`str` or ``None``
            :param nsx_tier0_gateway: NSX Tier0 Gateway used for this namespace.
                This attribute was added in **vSphere API 7.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``NSXTier0Gateway``. When methods return a value of this class as a
            ...
            :param routed_mode: Routed mode for this namespace. When set to True, the traffic in
                the namespace is not NATed.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None, cluster level settings specified in
                :attr:`Clusters.NCPClusterNetworkInfo.routed_mode` will be applied.
            :type  load_balancer_size: :class:`Networks.LoadBalancerSize` or ``None``
            :param load_balancer_size: The size of the NSX Load Balancer used by the namespace.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param namespaces: A list of Supervisor Namespaces associated with this network.
                This attribute was added in **vSphere API 7.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
...
class SupervisorServices(VapiInterface):
    ...
    Supervisor. They are often provided by 3rd party vendors.
    This class was added in **vSphere API 7.0.3.0**.
    """
    ...
    class State(Enum):
        ...
        state, at least one version of the Supervisor Service is activated.
    ...
    class ValidationStatus(Enum):
        ...
        status for validating content of a Supervisor Service version.
        This enumeration was added in **vSphere API 7.0.3.0**.
        ...
        VALID = None
        """
        Indicates the content is valid for a Supervisor Service version.
        ...
        case the reasons can be found in ``errorMessages``.
    ...
    class CustomCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param supervisor_service: The identifier of the Supervisor Service. This has DNS_LABEL
                ...
                'namespaces' is reserved and must not be used.
                This attribute was added in **vSphere API 7.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.SupervisorService``. When
                ...
                ``com.vmware.vcenter.namespace_management.SupervisorService``.
            :type  display_name: :class:`str`
            :param display_name: A human readable name of the Supervisor Service.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  description: :class:`str` or ``None``
            :param description: A human readable description of the Supervisor Service.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param version_spec: Supervisor service version specification that provides the service
                definition for one Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
            """
    ...
    class VsphereCreateSpec(VapiStruct):
        ...
        display name and description information.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param version_spec: Supervisor service version specification that provides the service
                definitions for one Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
            """
            self.version_spec = version_spec
            VapiStruct.__init__(self)
    ...
    class UpdateSpec(VapiStruct):
        ...
        required to update a Supervisor Service.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class Summary(VapiStruct):
        ...
        about a Supervisor Service version.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            """
            :type  supervisor_service: :class:`str`
            :param supervisor_service: The identifier of the Supervisor Service.
                This attribute was added in **vSphere API 7.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.SupervisorService``. When
                ...
                ``com.vmware.vcenter.namespace_management.SupervisorService``.
            :type  display_name: :class:`str`
            :param display_name: The human readable name of the Supervisor Service.
                This attribute was added in **vSphere API 7.0.3.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param must_be_installed: If ``true``, this Supervisor Service will be installed by default
                ...
                installed by default on Supervisors.
                This attribute was added in **vSphere API 8.0.3.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
    ...
    class VsphereAppsCheckResult(VapiStruct):
        ...
        :func:`SupervisorServices.check_content` method.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param version: The identifier of the Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ...
                ``com.vmware.vcenter.namespace_management.supervisor_services.Version``.
            :type  display_name: :class:`str`
            :param display_name: A human readable name of the Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  description: :class:`str` or ``None``
    ...
    class CheckResult(VapiStruct):
        ...
        validation checks on the content of a Supervisor Service version.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param status: Indicates if the provided content is valid.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param vsphere_apps_check_result: The information about the Supervisor Service version retrieved from
                ...
                content is in the vSphere application format.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param carvel_apps_check_result: The information about the Supervisor Service version retrieved from
                the provided content as a result of validation checks if the
                content is in the Carvel application format.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param warning_messages: A list of messages indicating why the content was considered valid
                but contains information that should be reviewed closely.
                This attribute was added in **vSphere API 7.0.3.0**.
                This attribute is optional and it is only relevant when the value
                of ``status`` is
...
class Supervisors(VapiInterface):
    ...
    interface replaces the :class:`Clusters` service.
    This class was added in **vSphere API 8.0.0.1**.
    """
    ...
    class EnableSpec(VapiStruct):
        ...
        workload networks after the cluster has been enabled.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param control_plane: :attr:`Supervisors.EnableSpec.control_plane` specifies
                configuration for the Supervisor control plane.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param workloads: :attr:`Supervisors.EnableSpec.workloads` specifies configuration
                for compute, network, and storage for workloads.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.name = name
    ...
    class EnableOnZonesSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param zones: :attr:`Supervisors.EnableOnZonesSpec.zones` describe consumption
                ...
                Only one or three zones are supported.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``com.vmware.vcenter.consumption_domains.Zone``. When methods
    ...
    def enable_on_zones(self,
        ...
        :func:`ClusterCompatibility.list`.
...
class VirtualMachineClasses(VapiInterface):
    ...
    class InstanceStorage(VapiStruct):
        ...
        information about storage policy and instance storage volumes.
        This class was added in **vSphere API 8.0.0.0**.
        ...
        def __init__(self,
            ...
            :param policy: Policy corresponding to the instance storage. To use VM class with
                ...
                com.vmware.vcenter.namespaces.Instances.StorageSpec.
                This attribute was added in **vSphere API 8.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``SpsStorageProfile``. When methods return a value of this class as
            ...
            :param volumes: List of instance storage volumes. At least one volume is required
                when configuring a VM class with instance storage.
                This attribute was added in **vSphere API 8.0.0.0**.
            """
            self.policy = policy
    ...
    class VGPUDevice(VapiStruct):
        ...
        corresponding to a vGPU device.
        This class was added in **vSphere API 7.0.3.0**.

        .. deprecated:: vSphere API 8.0.2.0
            This class is deprecated as of **vSphere API 8.0.2.0**.  Use device
            changes in VirtualMachineConfigSpec associated with the VM class to add
            vGPU devices. 
        ...
        def __init__(self,
            ...
            :param profile_name: Profile name corresponding to the device.
                This attribute was added in **vSphere API 7.0.3.0**.
            """
    ...
    class DynamicDirectPathIODevice(VapiStruct):
        ...
        configuration corresponding to a Dynamic DirectPath I/O device.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class VirtualDevices(VapiStruct):
        ...
        about the virtual devices associated with a VM class.
        This class was added in **vSphere API 7.0.3.0**.

        .. deprecated:: vSphere API 8.0.2.0
            This class is deprecated as of **vSphere API 8.0.2.0**.  Use device
            changes in VirtualMachineConfigSpec associated with the VM class to add
            vGPU and Dynamic DirectPath I/O virtual devices. 
        ...
        def __init__(self,
            ...
            :param vgpu_devices: List of vGPU devices.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param dynamic_direct_path_io_devices: List of Dynamic DirectPath I/O devices.
                This attribute was added in **vSphere API 7.0.3.0**.
    ...
    class CreateSpec(VapiStruct):
        ...
        required to create a VM class object.
        This class was added in **vSphere API 7.0.2.00100**.
        ...
        def __init__(self,
            ...
            :param cpu_reservation: The percentage of total available CPUs reserved for a virtual
                ...
                specified to vSphere in MHz.
                This attribute was added in **vSphere API 7.0.2.00100**.
                If None, no CPU reservation is requested for the virtual machine.

                .. deprecated:: vSphere API 8.0.2.0
                    This attribute is deprecated as of **vSphere API 8.0.2.0**. 
            ...
            :param memory_reservation: The percentage of available memory reserved for a virtual machine
                ...
                with vGPU or Dynamic DirectPath I/O devices.
                This attribute was added in **vSphere API 7.0.2.00100**.
            ...
            :type  description: :class:`str` or ``None``
            :param description: Description for the VM class.
                This attribute was added in **vSphere API 7.0.2.00100**.
            ...
            :param config_spec: A VirtualMachineConfigSpec associated with the VM class.
                This attribute was added in **vSphere API 8.0.2.0**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        required to update a VM class object.
        This class was added in **vSphere API 7.0.2.00100**.
        ...
        def __init__(self,
            ...
            :type  devices: :class:`VirtualMachineClasses.VirtualDevices` or ``None``
            :param devices: Virtual devices corresponding to the VM class.
                This attribute was added in **vSphere API 7.0.3.0**.
                ...
                .. deprecated:: vSphere API 8.0.2.0
                    ...
                    add vGPU and Dynamic DirectPath I/O virtual devices. 
            :type  instance_storage: :class:`VirtualMachineClasses.InstanceStorage` or ``None``
            :param instance_storage: Instance storage associated with the VM class.
                This attribute was added in **vSphere API 8.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        about the virtual machine class.
        This class was added in **vSphere API 7.0.2.00100**.
        ...
        def __init__(self,
            ...
            """
            :type  id: :class:`str`
            :param id: Identifier for the VM class.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.VirtualMachineClass``.
            ...
            :param description: Description of the VM class.
                This attribute was added in **vSphere API 7.0.2.00100**.
            :type  namespaces: :class:`set` of :class:`str`
            :param namespaces: Set of Namespaces associated with this VM class.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``com.vmware.vcenter.namespaces.Instance``. When methods return a
            ...
            :param vms: Set of virtual machines deployed for VM class.
                This attribute was added in **vSphere API 7.0.2.00100**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
            ...
            :param config_status: Configstatus of VM class
                This attribute was added in **vSphere API 7.0.2.00100**.
    ...
    def update(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            internally consistent with the input ``spec``. 
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if ``vm_class`` is marked for deletion or is used for defining
            cluster capacity.  
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            if the user does not have VirtualMachineClasses.Manage privilege.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotAllowedInCurrentState` 
            if ``vm_class`` is used for defining cluster capacity. 
            This exception was added in **vSphere API 9.0.0.0**.
        """
        return self._invoke('delete',
                            {
                            'vm_class': vm_class,
...
class ClusterCompatibility(VapiInterface):
    ...
    class ZoneSummary(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  zone: :class:`str`
            :param zone: Identifier of this vSphere Zone.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.consumption_domains.Zone``. When methods
            ...
            :param compatible: Flag to indicate whether the current Zone can be used to enable a
                ...
                will be given in the ``clusterSummaries`` field.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param cluster_summaries: A list of information about the compatibility of vSphere clusters
                associated with this vSphere Zone.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.zone = zone
            self.compatible = compatible
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param compatible: Set this flag to true to only list vSphere clusters that are
                ...
                listed.
            :type  network_provider: :class:`Clusters.NetworkProvider` or ``None``
            :param network_provider: The network provider whose networks will be considered.
                This attribute was added in **vSphere API 7.0.1.0**.
    ...
    class ZoneCompatibilityInfo(VapiStruct):
        ...
        information about the compatibility between a list of vSphere Zones.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param compatible: Flag to indicate whether the vSphere Zones are compatible with each
                ...
                in the ``incompatibilityReasons`` field.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param zone_summaries: Information about the compatibility of a list of vSphere Zones and
                the vSphere clusters associated with them.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  incompatibility_reasons: :class:`list` of :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param incompatibility_reasons: Reasons for incompatibility between the vSphere Zones.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.compatible = compatible
    ...
    def list(self,
        ...
        :param filter: Specification of matching clusters for which information should be
            ...
            which means all NSX clusters the user is authorized to view will be
            returned.
    ...
    def list_v2(self,
        ...
        (subject to permission checks) clusters.
        This method was added in **vSphere API 8.0.0.1**.
...
class DistributedSwitchCompatibility(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  network_provider: :class:`Clusters.NetworkProvider` or ``None``
            :param network_provider: The network provider whose networks were considered.
                This attribute was added in **vSphere API 7.0.1.0**.
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param network_provider: The network provider whose networks will be considered. If unset,
                this will default to NSXT_CONTAINER_PLUGIN.
                This attribute was added in **vSphere API 7.0.1.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
...
class EdgeClusterCompatibility(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        an NSX Edge Cluster, including its compatibility with the vCenter
        Namespaces feature.
    ...
    def list(self,
        ...
        """
        Returns Namespaces compatibility information of NSX Edge Clusters
...
class _ClustersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        enable_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/clusters/{cluster}?action=enable',
        ...
        disable_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/clusters/{cluster}?action=disable',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        rotate_password_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/clusters/{cluster}?action=rotate_password',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        operations = {
            'enable': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'rotate_password': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
...
class _NSXTier0GatewayStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            'distributed_switch': type.IdType(resource_types='vSphereDistributedSwitch'),
            'filter': type.OptionalType(type.ReferenceType(__name__, 'NSXTier0Gateway.FilterSpec')),
        })
        list_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
        ...
        operations = {
            'list': {
                ...
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InternalServerError'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'set': {
                ...
                'output_type': type.VoidType(),
                'errors': set_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': set_input_value_validator_list,
                'output_validator_list': set_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
...
class _SupervisorServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_content_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/supervisor-services?action=checkContent',
            path_variables={
            },
            query_parameters={
            },
        ...
        deactivate_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/vcenter/namespace-management/supervisor-services/{supervisorService}?action=deactivate',
            path_variables={
                'supervisor_service': 'supervisorService',
            },
            query_parameters={
        ...
        activate_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/vcenter/namespace-management/supervisor-services/{supervisorService}?action=activate',
            path_variables={
                'supervisor_service': 'supervisorService',
            },
            query_parameters={
...
class _SupervisorsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        enable_on_zones_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/supervisors?action=enable_on_zones',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        enable_on_compute_cluster_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/supervisors/{cluster}?action=enable_on_compute_cluster',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'delete': {
                ...
                'output_type': type.VoidType(),
                'errors': delete_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
                'input_value_validator_list': delete_input_value_validator_list,
                'output_validator_list': delete_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
