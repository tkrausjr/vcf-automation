...
class Network(VapiStruct):
    ...
    def __init__(self,
        ...
        :param network: 
            ...
            which can be referenced later for updates or queries.
        ...
        :param network_type: 
            ...
            :attr:`Network.network_type` describes the type of network.
            This attribute was added in **vSphere API 8.0.0.1**.
        :type  nsx: :class:`NsxNetwork`
        :param nsx: 
            
            :attr:`Network.nsx` specifies network configuration that is
            specific to NSX-T networks.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param vsphere: 
            ...
            specific to vSphere networks.
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute is optional and it is only relevant when the value
            of ``networkType`` is :attr:`NetworkType.VSPHERE`.
        :type  nsx_vpc: :class:`VpcNetwork`
        :param nsx_vpc: 
            
            :attr:`Network.nsx_vpc` specifies network configuration that is
            specific to NSX VPC networks.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is optional and it is only relevant when the value
            of ``networkType`` is :attr:`NetworkType.NSX_VPC`.
...
Network._set_binding_type(type.StructType(
    'com.vmware.vcenter.namespace_management.supervisors.networks.workload.network', {
        ...
        'nsx_vpc': type.OptionalType(type.ReferenceType(__name__, 'VpcNetwork')),
...
class NsxNetwork(VapiStruct):
    ...
    def __init__(self,
        ...
        :param dvs: 
            ...
            Distributed Virtual Switch. You can use it to connect to an NSX
            Network.
            This attribute was added in **vSphere API 8.0.0.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param namespace_subnet_prefix: 
            ...
            the subnet reserved for namespace segments.
            This attribute was added in **vSphere API 8.0.0.1**.
            Defaults to /28.
        """
        self.dvs = dvs
...
class VpcNetwork(VapiStruct):
    """
    ``VpcNetwork`` specifies network backing configuration that is specific to
    the workload network. It is used for configuring the Supervisor default
    settings.
    ...
    def __init__(self,
        ...
        :param nsx_project: :attr:`VpcNetwork.nsx_project` is the default Project for VPCs in
            the Supervisor, including the System VPC, and Supervisor Services
            VPC. It needs to be NSX path of Project. 
            
            :func:`com.vmware.vcenter.namespace_management.networks.nsx_client.Projects.list`
            can be used to list projects.
            This attribute was added in **vSphere API 9.0.0.0**.
            If None, use the default Project on NSX.
        :type  vpc_connectivity_profile: :class:`str` or ``None``
        :param vpc_connectivity_profile: :attr:`VpcNetwork.vpc_connectivity_profile` describes the
            configuration for how a VPC is constructed, including it's Transit
            Gateway Attachments, IP blocks, and other settings on NSX. It needs
            to be NSX path of VPC Connectivity Profile. 
            
            :func:`com.vmware.vcenter.namespace_management.networks.nsx.projects_client.VpcConnectivityProfiles.list`
            can be used to list VPCConnectivityProfiles for a Project.
            This attribute was added in **vSphere API 9.0.0.0**.
            If None, use the default VPC Connectivity Profile as defined in
            :attr:`VpcNetwork.nsx_project`.
        :type  default_private_cidrs: :class:`list` of :class:`com.vmware.vcenter.namespace_management.networks_client.Ipv4Cidr`
        :param default_private_cidrs: :attr:`VpcNetwork.default_private_cidrs` specifies CIDR blocks from
            which private subnets are allocated. This range must not overlap
            with those in :attr:`VpcNetwork.vpc_connectivity_profile`,
            :attr:`com.vmware.vcenter.namespace_management_client.Clusters.EnableSpec.service_cidr`,
            or other services running in the datacenter. You must :class:`set`
            at least one CIDR of size 16 or larger to enable a Supervisor with
            VPC networking. If Avi is used, another CIDR of size 64 is needed.
            This attribute was added in **vSphere API 9.0.0.0**.
        """
...
VpcNetwork._set_binding_type(type.StructType(
    'com.vmware.vcenter.namespace_management.supervisors.networks.workload.vpc_network', {
        'nsx_project': type.OptionalType(type.StringType()),
        'vpc_connectivity_profile': type.OptionalType(type.StringType()),
        'default_private_cidrs': type.ListType(type.ReferenceType('com.vmware.vcenter.namespace_management.networks_client', 'Ipv4Cidr')),
    },
    VpcNetwork,
    False,
    None))
