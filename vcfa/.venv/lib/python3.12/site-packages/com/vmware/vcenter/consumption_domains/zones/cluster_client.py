...
class Associations(VapiInterface):
    ...
    single consumption-domain zone to multiple vSphere clusters.
    ...
    class Status(VapiStruct):
        ...
        def __init__(self,
            ...
            :param success: This is true if the complete method succeeded without any errors.
                Otherwise, it is false if all or some methods have failed.
            ...
            :param failed_clusters: Associations between the identifiers of the clusters for which the
                operation failed and the reason of the failure.
                This attribute was added in **vSphere API 8.0.0.1**.
...
class _AssociationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        add_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/consumption-domains/zones/cluster/{zone}/associations?action=add',
        ...
        remove_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/consumption-domains/zones/cluster/{zone}/associations?action=remove',
            request_body_parameter='clusters',
            path_variables={
                'zone': 'zone',
            },
        ...
        operations = {
            'add': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
