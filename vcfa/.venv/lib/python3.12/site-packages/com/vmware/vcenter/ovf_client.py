...
class WarningType(Enum):
    ...
    """
    The certificate used for signing the OVF package content is self-signed.

    """
    EXPIRED_CERTIFICATE = None
    """
    The certificate used for signing the OVF package content is expired.

    """
    NOT_YET_VALID_CERTIFICATE = None
    """
    The certificate used for signing the OVF package content is not yet valid.

    """
    UNTRUSTED_CERTIFICATE = None
    """
    The certificate used for signing the OVF package content is not trusted.
...
WarningType._set_values({
    'SELF_SIGNED_CERTIFICATE': WarningType('SELF_SIGNED_CERTIFICATE'),
    'EXPIRED_CERTIFICATE': WarningType('EXPIRED_CERTIFICATE'),
    'NOT_YET_VALID_CERTIFICATE': WarningType('NOT_YET_VALID_CERTIFICATE'),
    'UNTRUSTED_CERTIFICATE': WarningType('UNTRUSTED_CERTIFICATE'),
})
WarningType._set_binding_type(type.EnumType(
    'com.vmware.vcenter.ovf.warning_type',
    WarningType))
...
DiskProvisioningType._set_values({
    ...
    'eagerZeroedThick': DiskProvisioningType('eagerZeroedThick'),
})
...
class CertificateParams(VapiStruct):
    ...
    def __init__(self,
        ...
        :param warnings: The list of warnings raised for the OVF certificate used in this
            ...
            client will cause the OVF package deployment to fail.
...
CertificateParams._set_binding_type(type.StructType(
    'com.vmware.vcenter.ovf.certificate_params', {
        ...
        'warnings': type.OptionalType(type.ListType(type.ReferenceType(__name__, 'WarningInfo'))),
...
class WarningInfo(VapiStruct):
    ...
    raised during the OVF package deployment.
    ...
    def __init__(self,
        ...
        :param type: The warning type raised during the OVF package deployment.
            This attribute was added in **vSphere API 7.0.2.0**.
        :type  message: :class:`com.vmware.vapi.std_client.LocalizableMessage`
        :param message: The message specifying more details about the warning.
            This attribute was added in **vSphere API 7.0.2.0**.
        ...
        :param ignored: Indicates if this warning will be ignored when deploying the OVF
            ...
            ignored, otherwise the OVF package deployment will fail.
            This attribute was added in **vSphere API 7.0.2.0**.
        """
        self.type = type
...
WarningInfo._set_binding_type(type.StructType(
    'com.vmware.vcenter.ovf.warning_info', {
...
class IpAllocationParams(VapiStruct):
    ...
    IpAllocationPolicy._set_values({
        'DHCP': IpAllocationPolicy('DHCP'),
        'TRANSIENT_IPPOOL': IpAllocationPolicy('TRANSIENT_IPPOOL'),
        'STATIC_MANUAL': IpAllocationPolicy('STATIC_MANUAL'),
        'STATIC_IPPOOL': IpAllocationPolicy('STATIC_IPPOOL'),
    })
    ...
    IpAllocationScheme._set_values({
        'DHCP': IpAllocationScheme('DHCP'),
        'OVF_ENVIRONMENT': IpAllocationScheme('OVF_ENVIRONMENT'),
    })
...
class ParseIssue(VapiStruct):
    ...
    * Unexpected server error.
    ...
    Category._set_values({
        'VALUE_ILLEGAL': Category('VALUE_ILLEGAL'),
        'ATTRIBUTE_REQUIRED': Category('ATTRIBUTE_REQUIRED'),
        'ATTRIBUTE_ILLEGAL': Category('ATTRIBUTE_ILLEGAL'),
        'ELEMENT_REQUIRED': Category('ELEMENT_REQUIRED'),
        'ELEMENT_ILLEGAL': Category('ELEMENT_ILLEGAL'),
        'ELEMENT_UNKNOWN': Category('ELEMENT_UNKNOWN'),
        'SECTION_UNKNOWN': Category('SECTION_UNKNOWN'),
        'SECTION_RESTRICTION': Category('SECTION_RESTRICTION'),
        'PARSE_ERROR': Category('PARSE_ERROR'),
        'GENERATE_ERROR': Category('GENERATE_ERROR'),
        'VALIDATION_ERROR': Category('VALIDATION_ERROR'),
        'EXPORT_ERROR': Category('EXPORT_ERROR'),
        'INTERNAL_ERROR': Category('INTERNAL_ERROR'),
    })
    Category._set_binding_type(type.EnumType(
...
class ExportFlag(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.ovf.export_flag'
    """
...
class ImportFlag(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.ovf.import_flag'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class LibraryItem(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.ovf.library_item'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class VmConfigSpecProvider(Enum):
        """
        The ``LibraryItem.VmConfigSpecProvider`` is used to provide the optional
        ``LibraryItem.VmConfigSpec`` used when deploying an OVF template.
        ...
        XML = None
        """
        A vim.vm.ConfigSpec that has been serialized to XML and base64 encoded.
        ...
        def __init__(self, string):
            """
            :type  string: :class:`str`
            :param string: String value for the :class:`VmConfigSpecProvider` instance.
            """
            Enum.__init__(string)

    VmConfigSpecProvider._set_values({
        'XML': VmConfigSpecProvider('XML'),
    })
    VmConfigSpecProvider._set_binding_type(type.EnumType(
        'com.vmware.vcenter.ovf.library_item.vm_config_spec_provider',
        VmConfigSpecProvider))
    ...
    class DeployableIdentity(VapiStruct):
        ...
        def __init__(self,
            ...
            :param id: Identifier of the deployable resource.
                ...
                ``VirtualMachine`` or ``VirtualApp``. When methods return a value
                of this class as a return value, the attribute will be an
                identifier for one of these resource types: ``VirtualMachine`` or
                ``VirtualApp``.
            """
            self.type = type
            self.id = id
    ...
    DeployableIdentity._set_binding_type(type.StructType(
        'com.vmware.vcenter.ovf.library_item.deployable_identity', {
            ...
            'id': type.IdType(resource_types=["VirtualMachine", "VirtualApp"], resource_type_field_name="type"),
        },
        DeployableIdentity,
        False,
        None))
    ...
    class VmConfigSpec(VapiStruct):
        """
        The ``LibraryItem.VmConfigSpec`` defines the optional virtual machine
        configuration settings used when deploying an OVF template. When used, the
        OVF descriptor acts as a disk descriptor.
        ...
        def __init__(self,
            ...
            """
            :type  provider: :class:`LibraryItem.VmConfigSpecProvider`
            :param provider: The :attr:`LibraryItem.VmConfigSpec.provider` selects a provider
                from the list of available providers.
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  xml: :class:`str`
            :param xml: The :attr:`LibraryItem.VmConfigSpec.xml` is a conditional
                configuration made available upon selecting the
                :attr:`LibraryItem.VmConfigSpecProvider.XML`. It is used to pass in
                a vim.vm.ConfigSpec for a virtual machine that has been serialized
                to XML and base64 encoded.
                This attribute was added in **vSphere API 8.0.2.0**.
                This attribute is optional and it is only relevant when the value
                of ``provider`` is :attr:`LibraryItem.VmConfigSpecProvider.XML`.
            """
    ...
    VmConfigSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.ovf.library_item.vm_config_spec', {
            'provider': type.ReferenceType(__name__, 'LibraryItem.VmConfigSpecProvider'),
            'xml': type.OptionalType(type.StringType()),
        },
        VmConfigSpec,
        False,
        None))
    ...
    class ResourcePoolDeploymentSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  vm_config_spec: :class:`LibraryItem.VmConfigSpec` or ``None``
            :param vm_config_spec: The :attr:`LibraryItem.ResourcePoolDeploymentSpec.vm_config_spec`
                is used for virtual machine configuration settings including
                hardware specifications to use in place of the OVF descriptor. If
                set, the OVF descriptor acts as a disk descriptor. Fields in the
                ``LibraryItem.ResourcePoolDeploymentSpec`` parameters such as
                :attr:`LibraryItem.ResourcePoolDeploymentSpec.name` that overlap
                with settings in the
                :attr:`LibraryItem.ResourcePoolDeploymentSpec.vm_config_spec` are
                not overridden and will continue to be used. Similarly, storage
                settings in the ``LibraryItem.ResourcePoolDeploymentSpec`` that
                affect the disks on the virtual machine namely
                ...
                This attribute was added in **vSphere API 8.0.2.0**.
                If None, the relevant virtual machine specifications in the OVF
                descriptor of the OVF template will be used.
            """
            self.name = name
            ...
            self.vm_config_spec = vm_config_spec
            VapiStruct.__init__(self)
    ...
    ResourcePoolDeploymentSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.ovf.library_item.resource_pool_deployment_spec', {
            ...
            'vm_config_spec': type.OptionalType(type.ReferenceType(__name__, 'LibraryItem.VmConfigSpec')),
        },
    ...
    class StorageGroupMapping(VapiStruct):
        ...
        Type._set_values({
            ...
            'STORAGE_PROFILE': Type('STORAGE_PROFILE'),
        })
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``System.Read``.
            * The resource ``VirtualMachine`` or ``VirtualApp`` referenced by
...
class _ExportFlagStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vcenter/ovf/export-flag',
            path_variables={
            },
            query_parameters={
            },
...
class _ImportFlagStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vcenter/ovf/import-flag',
            path_variables={
            },
            query_parameters={
                'rp': 'resource_pool',
...
class _LibraryItemStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        deploy_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/ovf/library-item/{ovfLibraryItemId}?action=deploy',
            path_variables={
                'ovf_library_item_id': 'ovfLibraryItemId',
            },
            query_parameters={
            },
            dispatch_parameters={
        ...
        filter_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/ovf/library-item/{ovfLibraryItemId}?action=filter',
            path_variables={
                'ovf_library_item_id': 'ovfLibraryItemId',
            },
            query_parameters={
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/ovf/library-item',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            'deploy': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'filter': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).build(),
