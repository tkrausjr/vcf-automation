...
class LibraryItems(VapiInterface):
    ...
    about the template contained in the library item.
    ...
    class CreateSpec(VapiStruct):
        ...
        create a library item containing a virtual machine template.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param source_vm: Identifier of the source virtual machine to create the library item
                ...
                type: ``VirtualMachine``.
            :type  name: :class:`str`
            :param name: Name of the library item.
                This attribute was added in **vSphere API 6.8**.
            :type  description: :class:`str` or ``None``
            :param description: Description of the library item.
                This attribute was added in **vSphere API 6.8**.
            ...
            :param placement: Information used to place the virtual machine template.
                This attribute was added in **vSphere API 6.8**.
    ...
    class CreateSpecVmHomeStoragePolicy(VapiStruct):
        ...
        def __init__(self,
            ...
            :param policy: Identifier for the storage policy to use.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
        ...
        Type._set_values({
            'USE_SPECIFIED_POLICY': Type('USE_SPECIFIED_POLICY'),
        })
    ...
    class CreateSpecVmHomeStorage(VapiStruct):
        ...
        def __init__(self,
            ...
            :param datastore: Identifier of the datastore for the virtual machine template's
                ...
                When ``storagePolicy`` is also specified and is incompatible with
                the ``datastore``, then the virtual machine template will be
    ...
    class CreateSpecDiskStoragePolicy(VapiStruct):
        ...
        policy specification for a virtual machine template's disks.
        This class was added in **vSphere API 6.8**.
    ...
    class CreateSpecDiskStorage(VapiStruct):
        ...
        def __init__(self,
            ...
            :param datastore: Identifier for the datastore associated with a virtual machine
                ...
                If ``storagePolicy`` is also specified and is incompatible with the
                ``datastore``, then the disk will be flagged as being out of
                compliance with the specified storage policy.
            :type  storage_policy: :class:`LibraryItems.CreateSpecDiskStoragePolicy` or ``None``
            :param storage_policy: Storage policy for a virtual machine template's disk.
                This attribute was added in **vSphere API 6.8**.
                If None, ``datastore`` must be specified and the virtual machine
    ...
    class DeploySpec(VapiStruct):
        ...
        that can be specified for the ``deploy`` method.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: Name of the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
            :type  description: :class:`str` or ``None``
            :param description: Description of the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
            ...
            :param disk_storage_overrides: Storage specification for individual disks in the deployed virtual
                ...
                and their storage specifications.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``com.vmware.vcenter.vm.hardware.Disk``. When methods return
            ...
            :param placement: Information used to place the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
                This attribute is currently required. In the future, if this
    ...
    class HardwareCustomizationSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param nics: Map of Ethernet network adapters to update.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
            ...
            :param cpu_update: CPU update specification for the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
                If None, the deployed virtual machine has the same CPU settings as
                the source virtual machine template contained in the library item.
            :type  memory_update: :class:`LibraryItems.MemoryUpdateSpec` or ``None``
            :param memory_update: Memory update specification for the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
                If None, the deployed virtual machine has the same memory settings
                as the source virtual machine template contained in the library
                item.
            """
            self.nics = nics
    ...
    class DiskUpdateSpec(VapiStruct):
        ...
        configuration of a virtual disk in the deployed virtual machine.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param capacity: Updated capacity of the virtual disk backing in bytes. This value
                has to be larger than the original capacity of the disk.
                This attribute was added in **vSphere API 6.8**.
            """
    ...
    class CpuUpdateSpec(VapiStruct):
        ...
        configuration of the deployed virtual machine.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param num_cpus: Number of virtual processors in the deployed virtual machine.
                This attribute was added in **vSphere API 6.8**.
                If None, the deployed virtual machine has the same CPU count as the
                source virtual machine template contained in the library item.
            ...
            :param num_cores_per_socket: Number of cores among which to distribute CPUs in the deployed
                virtual machine.
                This attribute was added in **vSphere API 6.8**.
                If None, the deployed virtual machine has the same number of cores
                per socket as the source virtual machine template contained in the
                library item.
            """
    ...
    class MemoryUpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param memory: Size of a virtual machine's memory in MB.
                This attribute was added in **vSphere API 6.8**.
                If None, the deployed virtual machine has the same memory size as
    ...
    class DeployPlacementSpec(VapiStruct):
        ...
        place a virtual machine onto resources within the vCenter inventory.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param host: Host onto which the virtual machine should be placed. If ``host``
                ...
                ``host`` must be a member of ``cluster``.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``HostSystem``. When methods return a value of this class as a
    ...
    class DeploySpecVmHomeStoragePolicy(VapiStruct):
        ...
        Type._set_values({
            'USE_SPECIFIED_POLICY': Type('USE_SPECIFIED_POLICY'),
            'USE_SOURCE_POLICY': Type('USE_SOURCE_POLICY'),
        })
        Type._set_binding_type(type.EnumType(
    ...
    class DeploySpecVmHomeStorage(VapiStruct):
        ...
        def __init__(self,
            ...
            :param datastore: Identifier of the datastore for the deployed virtual machine's
                ...
                When ``storagePolicy`` is also specified and is incompatible with
                the ``datastore``, then the deployed virtual machine will be
                flagged as being out of compliance with the specified storage
                policy.
    ...
    class DeploySpecDiskStoragePolicy(VapiStruct):
        ...
        storage policy specification for the deployed virtual machine's disks.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param type: Policy type to be used when creating the deployed virtual machine's
                ...
                This attribute was added in **vSphere API 6.8**.
            :type  policy: :class:`str`
            :param policy: Identifier of the storage policy to use.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.spbm.StorageProfile``. When methods return a value of
    ...
    class DeploySpecDiskStorage(VapiStruct):
        ...
        specification for disks in the virtual machine.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param storage_policy: Storage policy for the deployed virtual machine's disk.
                This attribute was added in **vSphere API 6.8**.
                If None, ``datastore`` must be specified and the deployed virtual
    ...
    class GuestCustomizationSpec(VapiStruct):
        ...
        required to customize the deployed virtual machine.
        This class was added in **vSphere API 6.8**.
    ...
    class Info(VapiStruct):
        ...
        machine template item in content library.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param cpu: CPU configuration of the virtual machine template.
                This attribute was added in **vSphere API 6.8**.
            :type  memory: :class:`LibraryItems.MemoryInfo`
            :param memory: Memory configuration of the virtual machine template.
                This attribute was added in **vSphere API 6.8**.
    ...
    class DiskInfo(VapiStruct):
        ...
        machine template's virtual disk.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param disk_storage: Disk storage related information.
                This attribute was added in **vSphere API 6.8**.
            """
            self.capacity = capacity
            self.disk_storage = disk_storage
    ...
    class DiskStorageInfo(VapiStruct):
        ...
        information about a virtual machine template's virtual disk.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            """
            :type  datastore: :class:`str`
            :param datastore: Identifier of the datastore where the disk is stored.
                This attribute was added in **vSphere API 6.8**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``Datastore``. When methods return a value of this class as a
    ...
    class EthernetInfo(VapiStruct):
        ...
        virtual machine template's virtual Ethernet adapter.
        This class was added in **vSphere API 6.8**.
        ...
        def __init__(self,
            ...
            :param backing_type: Network backing type for the virtual Ethernet adapter.
                This attribute was added in **vSphere API 6.8**.
            :type  mac_type: :class:`LibraryItems.EthernetInfo.MacAddressType`
            :param mac_type: MAC address type of the ethernet adapter.
                This attribute was added in **vSphere API 6.8**.
            :type  network: :class:`str` or ``None``
            :param network: Identifier of the network backing the virtual Ethernet adapter.
                This attribute was added in **vSphere API 6.8**.
        ...
        class NetworkBackingType(Enum):
            ...
            network backing types for a virtual Ethernet adapter.
            This enumeration was added in **vSphere API 6.8**.
        ...
        NetworkBackingType._set_values({
            'STANDARD_PORTGROUP': NetworkBackingType('STANDARD_PORTGROUP'),
            'HOST_DEVICE': NetworkBackingType('HOST_DEVICE'),
            'DISTRIBUTED_PORTGROUP': NetworkBackingType('DISTRIBUTED_PORTGROUP'),
            'OPAQUE_NETWORK': NetworkBackingType('OPAQUE_NETWORK'),
        })
        ...
        class MacAddressType(Enum):
            ...
            MAC address origins for a virtual Ethernet adapter.
            This enumeration was added in **vSphere API 6.8**.
    ...
    def create(self,
        ...
        stored in a newly created library item.
    ...
    def deploy(self,
        ...
        which are executed asynchronously.
        This method was added in **vSphere API 6.8**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'library_items': 'com.vmware.vcenter.vm_template.library_items_client.StubFactory',
    }
