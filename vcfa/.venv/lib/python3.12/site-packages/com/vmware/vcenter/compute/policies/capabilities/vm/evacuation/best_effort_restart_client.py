...
class CreateSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param vm_tag: Identifier of a tag that can be associated with a virtual machine.
            ...
            different than the host where the VM was initially running.
...
class Info(VapiStruct):
    ...
    the host where the VM was initially running.
    This class was added in **vSphere API 8.0.3.0**.
    ...
    def __init__(self,
        ...
        :param vm_tag: Identifier of a tag that can be associated with a virtual machine.
            ...
            where the VM was initially running.
            This attribute was added in **vSphere API 8.0.3.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ``com.vmware.cis.tagging.Tag:VirtualMachine``. When methods return
