...
GuestOS._set_values({
    ...
    'FREEBSD_15_64': GuestOS('FREEBSD_15_64'),
    ...
    'ORACLE_LINUX_10_64': GuestOS('ORACLE_LINUX_10_64'),
    'SUSE': GuestOS('SUSE'),
    ...
    'DEBIAN_13': GuestOS('DEBIAN_13'),
    'DEBIAN_13_64': GuestOS('DEBIAN_13_64'),
    ...
    'MIRACLELINUX_64': GuestOS('MIRACLELINUX_64'),
    'PARDUS_64': GuestOS('PARDUS_64'),
    ...
    'OTHER_7X_LINUX': GuestOS('OTHER_7X_LINUX'),
    'OTHER_7X_LINUX_64': GuestOS('OTHER_7X_LINUX_64'),
    ...
    'FUSIONOS_64': GuestOS('FUSIONOS_64'),
    'PROLINUX_64': GuestOS('PROLINUX_64'),
    'KYLINLINUX_64': GuestOS('KYLINLINUX_64'),
    'OS2': GuestOS('OS2'),
...
class GuestOSFamily(Enum):
    ...
    types reported by a virtual machine.
...
class DataSets(VapiInterface):
    ...
    Otherwise the application may stop working.
    ...
    class Access(Enum):
        ...
        This enumeration was added in **vSphere API 8.0.0.0**.
        ...
        NONE = None
        """
        No access is allowed for data set Entries.

        """
        READ_ONLY = None
        """
        Only read access is allowed for data set Entries.

        """
        READ_WRITE = None
        """
        Full read, write and delete access is allowed on data set Entries.
    ...
    class Info(VapiStruct):
        """
        The ``DataSets.Info`` class describes a data set.
        This class was added in **vSphere API 8.0.0.0**.
        ...
        def __init__(self,
            ...
            :param description: A description of how the data set is used by its creator.
                This attribute was added in **vSphere API 8.0.0.0**.
    ...
    class CreateSpec(VapiStruct):
        """
        The ``DataSets.CreateSpec`` class describes a data set to be created.
        This class was added in **vSphere API 8.0.0.0**.
        ...
        def __init__(self,
            ...
            :param name: The name of the data set. **It is recommended that this value take
                the form "com.company.project" to avoid conflict with other uses.**
                This attribute was added in **vSphere API 8.0.0.0**.
            :type  description: :class:`str`
            :param description: A description of how the data set is used by its creator. This
                field can contain up to 1024 bytes.
                This attribute was added in **vSphere API 8.0.0.0**.
            :type  host: :class:`DataSets.Access`
            :param host: Host access control. 
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param host: The access control from the host.
                This attribute was added in **vSphere API 8.0.0.0**.
                If set, the value is changed.
            :type  guest: :class:`DataSets.Access` or ``None``
            :param guest: The access control from the guest.
                This attribute was added in **vSphere API 8.0.0.0**.
                If set, the value is changed.
            :type  omit_from_snapshot_and_clone: :class:`bool` or ``None``
            :param omit_from_snapshot_and_clone: If :class:`set`, the data set is considered a property of the
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param data_set: The identifier of the data set.
                This attribute was added in **vSphere API 8.0.0.0**.
...
class EvcMode(VapiInterface):
    """
    The ``EvcMode`` class provides methods to manage the
    ``com.vmware.evc_mode.EvcMode`` settings of a virtual machine.
    This class was added in **vSphere API 9.0.0.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.vcenter.vm.evc_mode'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param evc_mode: The EvcMode to configure on the VM.
                This attribute was added in **vSphere API 9.0.0.0**.
                If the field is None, EvcMode is reset for the VM.
            """
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.evc_mode.set_spec', {
    ...
    class Info(VapiStruct):
        """
        The ``EvcMode.Info`` {term structure} contains information about the
        EvcMode configured for the VM.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param evc_mode: The EvcMode configured on the cluster.
                This attribute was added in **vSphere API 9.0.0.0**.
                if None, then the VM's EvcMode is unset.
            """
            self.evc_mode = evc_mode
            VapiStruct.__init__(self)
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.vm.evc_mode.info', {
            'evc_mode': type.OptionalType(type.ReferenceType('com.vmware.vcenter.evc_mode_client', 'EvcMode')),
        },
        Info,
        False,
    ...
    def set_task(self,
        ...
        """
        Set the EvcMode for a VM.
        This method was added in **vSphere API 9.0.0.0**.

        :type  vm: :class:`str`
        :param vm: The identifier for the VM.
            The parameter must be an identifier for the resource type:
            ``VirtualMachine``.
        :type  set_spec: :class:`EvcMode.SetSpec`
        :param set_spec: Information about how to enable EvcMode for the VM.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if there is a generic error.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if there are any errors in the input.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the specified VM is not found.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the user is not authenticated.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            if the user does not have the correct privileges.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            if you do not have all of the privileges described as follows: 
            
            * The resource ``VirtualMachine`` referenced by the parameter
              ``vm`` requires ``VirtualMachine.Config.Settings``.
        """
    ...
    def get(self,
        ...
        """
        Get the EvcMode set for a VM.
        This method was added in **vSphere API 9.0.0.0**.

        :type  vm: :class:`str`
        :param vm: The identifier of the VM.
            The parameter must be an identifier for the resource type:
            ``VirtualMachine``.
        :rtype: :class:`EvcMode.Info`
        :return: The EvcMode of the VM.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            if there is a generic error.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the specified VM is not found.
...
class Hardware(VapiInterface):
    ...
    class Version(Enum):
        ...
        VMX_15 = None
        """
        Hardware version 15, first supported in ESXi 6.7 Update 2.
        ...
        VMX_17 = None
        """
        Hardware version 17, first supported in ESXi 7.0.0-0.
        This class attribute was added in **vSphere API 7.0.0.0**.

        """
        VMX_18 = None
        """
        Hardware version 18, first supported in ESXi 7.0 U1.
        This class attribute was added in **vSphere API 7.0.1.0**.

        """
        VMX_19 = None
        """
        Hardware version 19, first supported in ESXi 7.0 U2.
        This class attribute was added in **vSphere API 7.0.2.0**.

        """
        VMX_20 = None
        """
        Hardware version 20, first supported in ESXi 8.0.0.1.
        This class attribute was added in **vSphere API 8.0.0.1**.

        """
        VMX_21 = None
        """
        Hardware version 21, first supported in ESXi 8.0 U2.
        This class attribute was added in **vSphere API 8.0.2.0**.

        """
        VMX_22 = None
        """
        Hardware version 22, first supported in ESXi 9.0.
        This class attribute was added in **vSphere API 9.0.0.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param instance_uuid: VirtualCenter-specific 128-bit UUID of a virtual machine,
                ...
                including those that may share the same SMBIOS UUID.
                This attribute was added in **vSphere API 6.7.1**.
            """
            self.name = name
...
class LibraryItem(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param check_out: Information about the checked out virtual machine.
    ...
    class CheckOutInfo(VapiStruct):
        ...
        machine checked out of a content library item.
        This class was added in **vSphere API 6.9.1**.
...
class Tools(VapiInterface):
    ...
    class UpgradePolicy(Enum):
        ...
        machine and it is rebooted if necessary.
    ...
    class VersionStatus(Enum):
        ...
        grave bug and should be immediately upgraded.
    ...
    class ToolsInstallType(Enum):
        ...
        Tools in the guest operating system.
        This enumeration was added in **vSphere API 7.0.0.0**.
        ...
        or an install type that we do not recognize.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param install_attempt_count: Number of attempts that have been made to install or upgrade the
                version of Tools installed on this virtual machine.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param version: Version of VMware Tools installed on the guest operating system.
                This is a human-readable value that should not be parsed.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        virtual machine that can be updated.
        This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _EvcModeStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        set_rest_metadata = OperationRestMetadata(
            http_method='PUT',
            url_template='/vcenter/vm/{vm}/evc-mode',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.vcenter.vm.evc_mode',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'upgrade': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'start': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'stop': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'suspend': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'reset': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'upgrade': {
                ...
                'output_type': type.VoidType(),
                'errors': upgrade_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': upgrade_input_value_validator_list,
                'output_validator_list': upgrade_output_validator_list,
                'task_type': TaskType.NONE,
            },
