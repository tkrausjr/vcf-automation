...
class Compatibility(VapiInterface):
    ...
    Namespaces compatibility information of Edges.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param edge_cluster: Identifier of the Edge.
                ...
                type: ``NSXEdgeCluster``.
            :type  name: :class:`str`
            :param name: User-friendly identifier of the Edge.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  compatible: :class:`bool`
            :param compatible: Compatibility of this Edge with vSphere Namespaces.
                This attribute was added in **vSphere API 8.0.0.1**.
...
class _CompatibilityStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/networks/nsx/edges?action=check_compatibility',
            path_variables={
            },
            query_parameters={
            },
