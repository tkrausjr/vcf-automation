...
class Active(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        the active node of a VCHA Cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param management: IP specification for the Management network.
                This attribute was added in **vSphere API 6.7.1**.
            :type  ha: :class:`com.vmware.vcenter.vcha_client.IpSpec` or ``None``
            :param ha: IP specification for the HA network.
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param placement: Contains the placement information of the active node.
                This attribute was added in **vSphere API 6.7.1**.
...
class DeploymentType(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param deployment_type: Identifies the deployment type of the VCHA cluster.
                This attribute was added in **vSphere API 6.7.1**.
            """
...
class Mode(VapiInterface):
    ...
    class ClusterMode(Enum):
        ...
        Passive node is enabled but automatic failover is not allowed.
    ...
    class Info(VapiStruct):
        """
        The ``Mode.Info`` class contains the mode of the VCHA Cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param mode: Identifies the mode of the VCHA cluster.
                This attribute was added in **vSphere API 6.7.1**.
            """
            self.mode = mode
            VapiStruct.__init__(self)
...
class Passive(VapiInterface):
    ...
    class CheckSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param placement: Contains the node's placement information for validation.
                This attribute was added in **vSphere API 6.7.1**.
            """
    ...
    class CheckResult(VapiStruct):
        ...
        will occur during the clone operation.
        This class was added in **vSphere API 6.7.1**.
    ...
    class RedeploySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param vc_spec: Contains the active node's management vCenter server credentials.
                ...
                a linked vCenter Server instance.
            :type  placement: :class:`com.vmware.vcenter.vcha_client.PlacementSpec`
            :param placement: Contains the node's placement information.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnverifiedPeer'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementConfiguration'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
    ...
    def __init__(self, config):
        ...
        operations = {
            'check': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnverifiedPeer'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementConfiguration'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
