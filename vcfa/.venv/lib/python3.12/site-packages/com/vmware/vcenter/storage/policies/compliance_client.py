...
class VM(VapiInterface):
    ...
    class Status(Enum):
        ...
        object-based datastore on which the entity is placed.
        ...
        will remain out of date until the latest policy is applied.
    ...
    Status._set_values({
        ...
        'UNKNOWN_COMPLIANCE': Status('UNKNOWN_COMPLIANCE'),
    ...
    class Info(VapiStruct):
        ...
        entities which match the given compliance statuses.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param vm_home: Compliance status of the virtual machine home.
    ...
    class FilterSpec(VapiStruct):
        ...
        listing virtual machines (see :func:`VM.list`).
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param status: Compliance Status that a virtual machine must have to match the
                filter. Atleast one status must be specified.
                This attribute was added in **vSphere API 6.7**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).build(),
