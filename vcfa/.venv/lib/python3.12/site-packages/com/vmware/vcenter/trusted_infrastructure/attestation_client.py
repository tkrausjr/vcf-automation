...
class Services(VapiInterface):
    ...
    of the Attestation Service in vCenter.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        registered Attestation Service instance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param group: The group specifies the Key Provider Service instances that can
                accept reports issued by this Attestation Service instance.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Attestation
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Attestation
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
    ...
    class CreateSpec(VapiStruct):
        ...
        registering an Attestation Service instance to the environment
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Attestation
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
            self.trusted_ca = trusted_ca
            self.group = group
            self.trust_authority_cluster = trust_authority_cluster
    ...
    class FilterSpec(VapiStruct):
        ...
        identifying an Attestation Service instance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param address: A set of address by which to filter.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ReadTrustedHosts``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def create(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.create is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ManageTrustedHosts``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.attestation.Services.delete is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class _ServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/attestation/services?action=query',
        ...
        operations = {
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
