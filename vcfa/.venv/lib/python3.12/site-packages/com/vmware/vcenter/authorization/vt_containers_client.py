...
class Mappings(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param vtcontainer: Identifier of the vTContainer instance.
            ...
            :param object: Identifier of the containerized object.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
    ...
    class ListItem(VapiStruct):
        ...
        def __init__(self,
            ...
            :param mapping: Identifier of the vTContainer mapping.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param info: Information about the vTContainer mapping.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
    ...
    class ListResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param items: List of vTContainer mappings.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class IterationSpec(VapiStruct):
        ...
        number of items returned from the :func:`Mappings.list` method.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param size: Maximum number of items to return in a single call.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class FilterSpec(VapiStruct):
        ...
        items returned from a :func:`Mappings.list` method.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param vtcontainers: A set of vTContainers.
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
            ...
            :param types: A set of object resource types.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class CreateSpec(VapiStruct):
        ...
        associating an object with a vTContainer instance.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param vtcontainer: Identifier of the vTContainer instance.
                ...
                ``com.vmware.vcenter.authorization.VtContainer``.
            :type  object: :class:`com.vmware.vapi.std_client.DynamicID`
            :param object: Identifier of the object that will be containerized.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
            self.vtcontainer = vtcontainer
            self.object = object
    ...
    def list(self,
        ...
        their associated vTContainer instances.
        This method was added in **vSphere API 8.0.3.0**.
    ...
    def get(self,
        ...
        object and its associated vTContainer instance.
        This method was added in **vSphere API 8.0.3.0**.
