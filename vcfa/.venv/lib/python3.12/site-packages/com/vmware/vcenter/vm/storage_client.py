...
class Policy(VapiInterface):
    ...
    class VmHomePolicySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param type: Policy type to be used while performing update operation on the
                virtual machine home's directory.
                This attribute was added in **vSphere API 6.7**.
            :type  policy: :class:`str`
            :param policy: Storage Policy identification.
                This attribute was added in **vSphere API 6.7**.
        ...
        class PolicyType(Enum):
            ...
            """
            Use the specified policy (see :attr:`Policy.VmHomePolicySpec.policy`).
        ...
        PolicyType._set_values({
            'USE_SPECIFIED_POLICY': PolicyType('USE_SPECIFIED_POLICY'),
            'USE_DEFAULT_POLICY': PolicyType('USE_DEFAULT_POLICY'),
        })
    ...
    class DiskPolicySpec(VapiStruct):
        ...
        storage policy to be associated with the virtual disks.
        This class was added in **vSphere API 6.7**.
        ...
        class PolicyType(Enum):
            ...
            the policy to be associated with a virtual disk.
            This enumeration was added in **vSphere API 6.7**.
            ...
            USE_SPECIFIED_POLICY = None
            """
            Use the specified policy (see :attr:`Policy.DiskPolicySpec.policy`).
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param vm_home: Storage Policy associated with virtual machine home.
                This attribute was added in **vSphere API 6.7**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.StoragePolicy``. When methods return a value
    ...
    def __init__(self, config):
        ...
        operations = {
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).build(),
