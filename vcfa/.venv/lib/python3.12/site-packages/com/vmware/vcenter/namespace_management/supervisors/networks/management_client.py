...
class NetworkBackingEnum(Enum):
    ...
    the Supervisor for the management network.
    ...
    deprecated, use :attr:`NetworkBackingEnum.NETWORK_SEGMENT` instead.

    .. deprecated:: vSphere API 8.0.3.0
        This class attribute is deprecated as of **vSphere API 8.0.3.0**.
...
class ProxySettingsSource(Enum):
    ...
    Supervisor settings will be kept in sync.

    """
    CLUSTER_CONFIGURED = None
    """
    Proxy settings will be configured at the Supervisor level.

    """
    NONE = None
    """
    No proxy settings will be applied to the Supervisor.
...
class Network(VapiStruct):
    ...
    Load Balancers, etc. should be reachable on this network.
    ...
    def __init__(self,
        ...
        :param backing: 
            ...
            uplink to the management network.
            This attribute was added in **vSphere API 8.0.0.1**.
...
class NetworkBacking(VapiStruct):
    ...
    _validator_list = [
        UnionValidator(
            'backing',
            {
                ...
                'NETWORK_SEGMENT' : [('network_segment', False)],
            }
        ),
    ]
    ...
    def __init__(self,
        ...
        :param backing: Selects the backing used for a management network.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param network_segment: The Backing Network Segment.
