...
VMware Cloud on AWS is not supported. 9.0 - vSphere 9.0.0.0
...
class Links(VapiInterface):
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ssl_certificate: The full SSL certificate of the target node encoded as PEM string.
                This attribute was added in **vSphere API 9.0.0.0**.
                if None no certificate is passed.
    ...
    class CertificateInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ssl_thumbprint: The SHA-256 thumbprint of the SSL certificate for the destination
                PSC endpoint.
            :type  ssl_certificate: :class:`str` or ``None``
            :param ssl_certificate: The full PEM encoded leaf certificate string in cert chain of the
                destination PSC endpoint.
                This attribute was added in **vSphere API 9.0.0.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnverifiedPeer'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).build(),
