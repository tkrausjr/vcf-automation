...
class Providers(VapiInterface):
    ...
    class Type(Enum):
        """
        The ``Providers.Type`` class contains the types of providers.
    ...
    class Health(Enum):
        ...
        WARNING = None
        """
        Operating normally, but there is an issue that requires attention.

        """
        ERROR = None
        """
        There is a critical issue that requires attention.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: Health status of the provider
                This attribute was added in **vSphere API 7.0.2.0**.
            """
    ...
    class NativeProviderInfo(VapiStruct):
        ...
        describe details of a native provider.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param details: Details regarding the health status of the provider. 
                ...
                attribute will provide actionable descriptions of the issues.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  constraints: :class:`Providers.Constraints` or ``None``
            :param constraints: The constraints on the provider.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param native_info: Native provider information
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class FilterSpec(VapiStruct):
        ...
        results when listing providers.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param health: Provider health status.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None or empty, the result will not be filtered by provider
                health status.
            """
    ...
    class NativeProviderCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param key_derivation_key: Key used to derive data encryption keys. Base64 encoded.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class CreateSpec(VapiStruct):
        ...
        desired configuration for a new provider.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param native_spec: Native provider create spec.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class NativeProviderUpdateSpec(VapiStruct):
        ...
        new back-up is suggested after any update.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class ExportSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param password: Password used to encrypt the exported configuration.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class Location(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  url: :class:`str`
            :param url: Provider configuration download URL
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class ExportResult(VapiStruct):
        ...
        :func:`Providers.export` operation.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param type: Type of provider export result
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  location: :class:`Providers.Location`
            :param location: Location of the exported configuration
                This attribute was added in **vSphere API 7.0.2.0**.
                This attribute is optional and it is only relevant when the value
    ...
    class ImportSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param config: Configuration to import.
                ...
                in the future.
            :type  password: :class:`str` or ``None``
            :param password: Password to decrypt the configuration to import.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None or empty, configuration to import must be unencrypted.
            :type  constraints: :class:`Providers.ConstraintsSpec` or ``None``
            :param constraints: Constraints to impose on the imported provider
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class ImportResult(VapiStruct):
        ...
        :func:`Providers.import_provider` operation.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param export_time: Time when the provider was exported
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  constraints: :class:`Providers.Constraints` or ``None``
            :param constraints: The constraints on the provider.
                This attribute was added in **vSphere API 7.0.2.0**.
...
class _ProvidersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        export_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/crypto-manager/kms/providers?action=export',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        import_provider_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/crypto-manager/kms/providers?action=import',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
