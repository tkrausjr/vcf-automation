...
class Hosts(VapiInterface):
    ...
    class RegisterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param host_id: The host's identifier.
    ...
    def register_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``Host.Sgx.Register``.
        """
...
class _HostsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        register_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/confidential-computing/sgx/hosts?action=register',
        ...
        operations = {
            'register$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
