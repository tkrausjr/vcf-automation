...
class Tpm(VapiInterface):
    ...
    class Summary(VapiStruct):
        """
        The ``Tpm.Summary`` class contains information that summarizes a TPM.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            """
            :type  tpm: :class:`str`
            :param tpm: A unique identifier for the TPM instance.
            ...
            :param major_version: The TPM major version number.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  minor_version: :class:`long`
            :param minor_version: The TPM minor version number.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param banks: The list of the PCR banks of the TPM device.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.major_version = major_version
            self.minor_version = minor_version
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param major_versions: The TPM major version number.
                This attribute was added in **vSphere API 8.0.0.1**.
