...
class Zones(VapiInterface):
    ...
    """
    The resource type for consumption-domain zones.
    ...
    class ListItem(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  zone: :class:`str`
            :param zone: Identifier of the zone.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param info: Information about the zone.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.zone = zone
            self.info = info
    ...
    class FilterSpec(VapiStruct):
        ...
        results when listing configured zones, see :func:`Zones.list`.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    def list(self,
        ...
        where the zones need to match :class:`Zones.FilterSpec`.
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
