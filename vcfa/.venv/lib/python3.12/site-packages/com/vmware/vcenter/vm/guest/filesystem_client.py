...
class FileErrorDetails(VapiStruct):
    ...
    def __init__(self,
        ...
        :param file_path: The file path associated with the error.
            This attribute was added in **vSphere API 7.0.2.0**.
        """
        self.reason = reason
...
class Files(VapiInterface):
    ...
    class FilesystemFamily(Enum):
        ...
        WINDOWS = None
        """
        The guest OS is a Windows variant.
    ...
    class Type(Enum):
        """
        The ``Files.Type`` class defines the valid types of files.
        This enumeration was added in **vSphere API 7.0.2.0**.
    ...
    class LastIterationStatus(Enum):
        ...
        fill the page. The iterator has returned at least 1 result.
    ...
    class WindowsFileAttributesInfo(VapiStruct):
        ...
        file attributes specific to Windows Guest operating systems.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param hidden: The file is hidden.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  read_only: :class:`bool`
            :param read_only: The file is read-only.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  created: :class:`datetime.datetime`
            :param created: The date and time the file was created.
                This attribute was added in **vSphere API 7.0.2.0**.
            """
            self.hidden = hidden
    ...
    class PosixFileAttributesInfo(VapiStruct):
        ...
        file attributes specific to Posix Guest operating systems.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class FileAttributesInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param last_modified: The date and time the file was last modified.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  last_accessed: :class:`datetime.datetime`
            :param last_accessed: The date and time the file was last accessed.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param filesystem_family: The type of guest filesystem.
                This attribute was added in **vSphere API 7.0.2.0**.
            :type  win_attributes: :class:`Files.WindowsFileAttributesInfo`
            :param win_attributes: Windows-specific file information.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param posix_attributes: Posix-specific file information.
                This attribute was added in **vSphere API 7.0.2.0**.
                This attribute is optional and it is only relevant when the value
    ...
    class WindowsFileAttributesUpdateSpec(VapiStruct):
        ...
        that can be changed for a Windows file.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class PosixFileAttributesUpdateSpec(VapiStruct):
        ...
        can be changed for a Posix file.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class FileAttributesUpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param windows: Windows-specific file update information.
                This attribute was added in **vSphere API 7.0.2.0**.
                Set if the guest operating system is Windows.
            :type  posix: :class:`Files.PosixFileAttributesUpdateSpec` or ``None``
            :param posix: Posix-specific file update information.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class Info(VapiStruct):
        ...
        operating system. Returned by :func:`Files.get`.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param attributes: Attributes of a file.
                This attribute was added in **vSphere API 7.0.2.0**.
            """
            self.type = type
            self.size = size
    ...
    class Summary(VapiStruct):
        ...
        operating system returned by a :func:`Files.list` method.
        This class was added in **vSphere API 7.0.2.0**.
    ...
    class IterationSpec(VapiStruct):
        ...
        into pages when listing files. See :func:`Files.list`).
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param index: Which result to start the list with. If this value exceeds the
                number of results, an empty list will be returned.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class FilterSpec(VapiStruct):
        ...
        results when listing files (see :func:`Files.list`).
        This class was added in **vSphere API 7.0.2.0**.
...
class Transfers(VapiInterface):
    ...
    class PosixFileAttributesCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param owner_id: The owner ID. If this property is not specified when passing a
                ...
                the user who invoked the file transfer operation.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param permissions: The file permissions in chmod(2) format. If this property is not
                ...
                permissions. This attribute is interpreted as octal.
                This attribute was added in **vSphere API 7.0.2.0**.
                Defaults to 0644.
            """
            self.owner_id = owner_id
    ...
    class FileCreationAttributes(VapiStruct):
        ...
        used when transferring a file into the guest.
        This class was added in **vSphere API 7.0.2.0**.
        ...
        def __init__(self,
            ...
            :param windows: Windows-specific file creation information.
                This attribute was added in **vSphere API 7.0.2.0**.
            ...
            :param posix: Posix-specific file creation information.
                This attribute was added in **vSphere API 7.0.2.0**.
                If None, the behavior is equivalent to a
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param attributes: Details about the file to be transferred into the guest.
                This attribute was added in **vSphere API 7.0.2.0**.
...
class _DirectoriesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/directories?action=create',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/directories?action=delete',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        move_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/directories?action=move',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        create_temporary_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/directories?action=createTemporary',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'create_temporary': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _FilesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        move_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files?action=move',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files?action=update',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files/{path}?action=delete',
            path_variables={
                'vm': 'vm',
                'path': 'path',
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files/{path}?action=get',
            path_variables={
                'vm': 'vm',
                'path': 'path',
            },
        ...
        create_temporary_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files?action=createTemporary',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem/files?action=list',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        operations = {
            ...
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _TransfersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/vm/{vm}/guest/filesystem?action=create',
            path_variables={
                'vm': 'vm',
            },
            query_parameters={
        ...
        operations = {
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
