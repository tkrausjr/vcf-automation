...
class ClusterSupervisorServices(VapiInterface):
    ...
    Supervisor Service on the vSphere Supervisors.
    This class was added in **vSphere API 7.0.3.0**.

    .. deprecated:: vSphere API 9.0.0.0
        This class is deprecated as of **vSphere API 9.0.0.0**.  Use
        :class:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices`
        instead. 
    """
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class ConfigStatus(Enum):
        ...
        YAML content has been applied successfully to the cluster)
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.ConfigStatus is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class CreateSpec(VapiStruct):
        ...
        required to create a Supervisor Service on a vSphere Supervisor.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param service_config: A generic key-value map for additional configuration parameters
                ...
                "registryPassword" for the registry credentials.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param yaml_service_config: A set of additional configuration parameters to be applied during
                ...
                when installing a Supervisor Service in the vSphere Supervisor.
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.CreateSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class SetSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param yaml_service_config: A set of additional configuration parameters to be applied during
                ...
                when upgrading a Supervisor Service in the vSphere Supervisor.
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.SetSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.version = version
            self.service_config = service_config
            self.yaml_service_config = yaml_service_config
            VapiStruct.__init__(self)
    ...
    class Message(VapiStruct):
        ...
        about the Supervisor Service configuration on a vSphere Supervisor.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.Message is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
        ...
        class MessageSeverity(Enum):
            ...
            def __init__(self, string):
                ...
                """
                warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.Message.MessageSeverity is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
                Enum.__init__(string)
    ...
    class Info(VapiStruct):
        ...
        information about a Supervisor Service on the vSphere Supervisor.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param yaml_service_config: The configuration parameters applied on this Supervisor Service,
                ...
                including the ``serviceConfig``.
                This attribute was added in **vSphere API 8.0.0.1**.
                If None, the Supervisor Service has no configuration applied.
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.Info is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param current_version: The current version for the Supervisor Service.
                ...
                If None, there is no version installed for the Supervisor Service.
            """
            warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.Summary is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.supervisor_service = supervisor_service
            self.desired_version = desired_version
            self.config_status = config_status
            self.current_version = current_version
    ...
    def create(self,
        ...
        .. deprecated:: vSphere API 9.0.0.0
            ...
            :func:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices.create`
            instead.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the cluster on which to install the service.
        ...
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.create is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        .. deprecated:: vSphere API 9.0.0.0
            This method is deprecated as of **vSphere API 9.0.0.0**. Use
            :func:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices.list`
            instead.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the cluster from which to list the service
            summaries.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            ...
            specified cluster.
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.list is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        .. deprecated:: vSphere API 9.0.0.0
            This method is deprecated as of **vSphere API 9.0.0.0**. Use
            :func:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices.get`
            instead.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the cluster from which to get the service
            information.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        :type  supervisor_service: :class:`str`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            ...
            on the specified cluster.
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.get is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def delete(self,
        ...
        be orphaned if users don't clean or migrate them. 
        ...
        .. deprecated:: vSphere API 9.0.0.0
            This method is deprecated as of **vSphere API 9.0.0.0**. Use
            :func:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices.delete`
            instead.

        :type  cluster: :class:`str`
        :param cluster: Identifier for the cluster backing this Supervisor.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        :type  supervisor_service: :class:`str`
        :param supervisor_service: Identifier for the Supervisor Service.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            ...
            on the specified cluster.
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.delete is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def set(self,
        ...
        .. deprecated:: vSphere API 9.0.0.0
            This method is deprecated as of **vSphere API 9.0.0.0**. Use
            :func:`com.vmware.vcenter.namespace_management.supervisors_client.SupervisorServices.set`
            instead.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            ...
            on the specified cluster.
        """
        warn('com.vmware.vcenter.namespace_management.supervisor_services.ClusterSupervisorServices.set is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
...
class Versions(VapiInterface):
    ...
    class State(Enum):
        ...
        this state, all operations on the version should work as normal.
        ...
        version cannot be created on the vSphere Supervisor clusters.
    ...
    class ContentType(Enum):
        ...
        describes the format of Supervisor Service version definition.
        This enumeration was added in **vSphere API 7.0.3.0**.
        ...
        document that follows the vSphere application service format.

        """
        CARVEL_APPS_YAML = None
        """
        The Supervisor Service version definition is provided as inline YAML
        document that follows the Carvel application package format.
        ...
        """
        The Supervisor Service version definition is provided as inline YAML
        document that follows a plain Kubernetes YAML format.
    ...
    class CreateSpec(VapiStruct):
        ...
        :attr:`Versions.CreateSpec.vsphere_spec` must be :class:`set`.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class CustomCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param content: Inline content that contains all service definition of the version,
                ...
                a plain Kubernetes YAML format.
                This attribute was added in **vSphere API 7.0.3.0**.
    ...
    class VsphereCreateSpec(VapiStruct):
        ...
        identifier, display name and description information.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            :param accept_eula: Whether or not the End User License Agreement (EULA) that is
                ...
                Service version can be created.
                This attribute was added in **vSphere API 7.0.3.0**.
    ...
    class CarvelCreateSpec(VapiStruct):
        ...
        format (Package and PackageMetadata resources should be declared).
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  display_name: :class:`str`
            :param display_name: The human readable name of the Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  description: :class:`str` or ``None``
            :param description: A human-readable description of the Supervisor Service version.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param content_type: The content type of ``content``.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param trust_verified: If true, the Supervisor Service version is from trusted provider
                and the trust is verified.
                This attribute was added in **vSphere API 7.0.3.0**.
            :type  state: :class:`Versions.State`
            :param state: The current ``Versions.State`` of the version.
                This attribute was added in **vSphere API 7.0.3.0**.
            ...
            :param registered_by_default: If ``true``, this Supervisor Service version has been registered on
                ...
                service version has been registered by an administrator.
    ...
    def create(self,
        ...
        definition information for the version.
        This method was added in **vSphere API 7.0.3.0**.
    ...
    def deactivate(self,
        ...
        that this method should be called before deleting the version.
        This method was added in **vSphere API 7.0.3.0**.
    ...
    def activate(self,
        ...
        ``Versions.State`` of the version to ``ACTIVATED`` state.
        This method was added in **vSphere API 7.0.3.0**.
    ...
    def delete(self,
        ...
        not delete the ``supervisor_service`` instance automatically.
        This method was added in **vSphere API 7.0.3.0**.
...
class _VersionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        deactivate_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/vcenter/namespace-management/supervisor-services/{supervisorService}/versions/{version}?action=deactivate',
            path_variables={
                'supervisor_service': 'supervisorService',
                'version': 'version',
            },
        ...
        activate_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/vcenter/namespace-management/supervisor-services/{supervisorService}/versions/{version}?action=activate',
            path_variables={
                'supervisor_service': 'supervisorService',
                'version': 'version',
            },
