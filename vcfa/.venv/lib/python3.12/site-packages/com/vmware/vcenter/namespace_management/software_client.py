...
class Clusters(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param upgrade_prechecks: Detailed information about Supervisor upgrade pre-checks.
    ...
    class UpgradeStatus(VapiStruct):
        ...
        def __init__(self,
            ...
            :param components: Information about control plane components' upgrade status.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None, the cluster upgrade is not in progress.
            """
            self.desired_version = desired_version
...
class _ClustersStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        upgrade_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/software/clusters/{cluster}?action=upgrade',
        ...
        upgrade_multiple_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/namespace-management/software/clusters?action=upgradeMultiple',
        ...
        operations = {
            'upgrade': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
