...
class IpFamily(Enum):
    """
    The ``IpFamily`` class defines the Ip address family.
...
NetworkType._set_values({
    'STANDARD_PORTGROUP': NetworkType('STANDARD_PORTGROUP'),
    'DISTRIBUTED_PORTGROUP': NetworkType('DISTRIBUTED_PORTGROUP'),
})
...
class CertificateInfo(VapiStruct):
    ...
    certificate for a management vCenter server.
    ...
    def __init__(self,
        ...
        :param ssl_certificate: PEM-encoded SSL certificate of the management vCenter server.
            This attribute was added in **vSphere API 9.0.0.0**.
            If None, empty ssl certificate is assumed.
        """
...
class ConnectionSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param hostname: IP Address or DNS of the vCenter.
            This attribute was added in **vSphere API 6.7.1**.
        ...
        :param ssl_thumbprint: SHA1 hash of the server SSL certificate.
            This attribute was added in **vSphere API 6.7.1**.
            ...
            .. deprecated:: vSphere API 9.0.0.0
                ...
                this attribute is deprecated please use ``sslCertificate``
                instead.
        :type  ssl_certificate: :class:`str` or ``None``
        :param ssl_certificate: PEM-encoded server SSL certificate of vCenter. Note:
            ``sslThumbprint`` and ``sslCertificate`` parameters are mutually
            exclusive, and should never be used simultaneously.
            This attribute was added in **vSphere API 9.0.0.0**.
            If None, empty ssl certificate is assumed.
...
class CredentialsSpec(VapiStruct):
    ...
    vCenter server managing the VCHA nodes.
    This class was added in **vSphere API 6.7.1**.
...
class IpSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ip_family: Family of the IP address to configure the interface.
            This attribute was added in **vSphere API 6.7.1**.
        ...
        :param default_gateway: The IP address of the Gateway for this interface.
            This attribute was added in **vSphere API 6.7.1**.
...
class Ipv4Spec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param address: IPV4 address to be used to configure the interface.
            This attribute was added in **vSphere API 6.7.1**.
        :type  subnet_mask: :class:`str` or ``None``
        :param subnet_mask: The subnet mask for the interface.
            This attribute was added in **vSphere API 6.7.1**.
        ...
        :param prefix: The CIDR prefix for the interface.
            This attribute was added in **vSphere API 6.7.1**.
...
class Ipv6Spec(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  address: :class:`str`
        :param address: IPv6 address to be used to configure the interface.
            This attribute was added in **vSphere API 6.7.1**.
...
class PlacementInfo(VapiStruct):
    ...
    populate all attributes except biosUuid.
    This class was added in **vSphere API 6.7.1**.
    ...
    def __init__(self,
        ...
        :param vm_name: The virtual machine name of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
        :type  datacenter: :class:`str`
        :param datacenter: The identifier of the datacenter of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param datacenter_name: The name of the datacenter of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
        :type  host: :class:`str`
        :param host: The identifier of the host of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param host_name: The name of the host of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
        :type  cluster: :class:`str` or ``None``
        :param cluster: The identifier of the cluster of which ``host`` is member.
            This attribute was added in **vSphere API 6.7.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param cluster_name: The name of the cluster of which ``host`` is member.
            This attribute was added in **vSphere API 6.7.1**.
            If None, ``host`` is a standalone host.
        ...
        :param ha_network_name: The name of the Network object used for the HA network.
            This attribute was added in **vSphere API 6.7.1**.
            If None, the information is currently unavailable or the haNetwork
            is not configured.
        :type  ha_network_type: :class:`NetworkType` or ``None``
        :param ha_network_type: The type of the Network object used for the HA network.
            This attribute was added in **vSphere API 6.7.1**.
            If None, the information is currently unavailable or the haNetwork
            is not configured.
        ...
        :param storage: The storage information of the VCHA node.
            This attribute was added in **vSphere API 6.7.1**.
        :type  bios_uuid: :class:`str` or ``None``
        :param bios_uuid: BIOS UUID for the node.
            This attribute was added in **vSphere API 6.7.1**.
...
class PlacementSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param folder: The identifier of the folder to deploy the VCHA node to.
            This attribute was added in **vSphere API 6.7.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param host: The identifier of the host to deploy the VCHA node to.
            This attribute was added in **vSphere API 6.7.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ``HostSystem:VCenter``. When methods return a value of this class
        ...
        :param ha_network_type: The type of the Network object used by the HA network.
            ...
            :attr:`PlacementSpec.ha_network_type` attribute is ignored.
            This attribute was added in **vSphere API 6.7.1**.
        ...
        :param storage: The storage specification to deploy the VCHA node to.
            This attribute was added in **vSphere API 6.7.1**.
...
class Cluster(VapiInterface):
    ...
    class Type(Enum):
        ...
        the customer should clone the passive and witness virtual machines.
    ...
    class ClusterMode(Enum):
        ...
        node is enabled and automatic failover is allowed.

        """
        DISABLED = None
        """
        VCHA Cluster is disabled. State replication between the Active and Passive
        node is disabled and automatic failover is not allowed.

        """
        MAINTENANCE = None
        """
        VCHA Cluster is in maintenance mode. State replication between the Active
        and Passive node is enabled but automatic failover is not allowed.
    ...
    ClusterState._set_values({
        ...
        'ISOLATED': ClusterState('ISOLATED'),
    })
    ...
    class NodeRole(Enum):
        ...
        the role of Active vCenter Server upon failover.

        """
        WITNESS = None
        """
        Node is having a role of Witness. In this role, node acts as a quorum node
        for avoiding the classic split-brain problem.
    ...
    ConfigState._set_values({
        ...
        'NOTCONFIGURED': ConfigState('NOTCONFIGURED'),
        'INVALID': ConfigState('INVALID'),
        'PREPARED': ConfigState('PREPARED'),
    })
    ...
    class IpFamily(Enum):
        """
        The ``Cluster.IpFamily`` class defines the IP address family.
        This enumeration was added in **vSphere API 6.7.1**.
    ...
    class ActiveSpec(VapiStruct):
        ...
        Active Node of the VCHA cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param ha_ip: IP specification for the HA network.
                This attribute was added in **vSphere API 6.7.1**.
            """
            self.ha_network_type = ha_network_type
            self.ha_network = ha_network
    ...
    class PassiveSpec(VapiStruct):
        ...
        Passive Node of the VCHA cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param placement: Contains the placement configuration of the node.
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param failover_ip: IP specification for the management network.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class WitnessSpec(VapiStruct):
        ...
        Witness Node of the VCHA cluster.
        This class was added in **vSphere API 6.7.1**.
    ...
    class DeploySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param deployment: Contains the deployment type.
                This attribute was added in **vSphere API 6.7.1**.
            :type  active: :class:`Cluster.ActiveSpec`
            :param active: Contains the active node's network configuration.
                This attribute was added in **vSphere API 6.7.1**.
            :type  passive: :class:`Cluster.PassiveSpec`
            :param passive: Contains the passive node's placement configuration.
                This attribute was added in **vSphere API 6.7.1**.
            :type  witness: :class:`Cluster.WitnessSpec`
            :param witness: Contains the witness node's placement configuration.
                This attribute was added in **vSphere API 6.7.1**.
            """
    ...
    class NodeRuntimeInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param state: Last known state of the node.
                ...
                required to populate :attr:`Cluster.NodeRuntimeInfo.state`.
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param role: Last known role of the node.
                The active node's management vCenter server credentials are not
                required to populate :attr:`Cluster.NodeRuntimeInfo.role`.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then information is unavailable or the passive and witness
                nodes are not cloned yet.
            ...
            :param placement: Placement information of the node.
                ...
                :attr:`Cluster.NodeRuntimeInfo.placement`.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class Ipv4Info(VapiStruct):
        ...
        information of the configured network interface.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            """
            :type  address: :class:`str`
            :param address: IP address of the configured network interface.
                This attribute was added in **vSphere API 6.7.1**.
            :type  subnet_mask: :class:`str`
            :param subnet_mask: The subnet mask of the interface.
                This attribute was added in **vSphere API 6.7.1**.
            :type  prefix: :class:`long` or ``None``
            :param prefix: The CIDR prefix of the interface.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class IpInfo(VapiStruct):
        """
        The ``Cluster.IpInfo`` class contains attributes related to an ip.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param ip_family: Family of the ip.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class NodeInfo(VapiStruct):
        ...
        the active and passive nodes in the cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param failover_ip: Failover IP address that this node will assume after the failover
                ...
                failover IP address.
                The active node's management vCenter server credentials are not
                required to populate :attr:`Cluster.NodeInfo.failover_ip`.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then it will assume the public IP address of the Active
                vCenter Server.
            ...
            :param ha_ip: VCHA Cluster network configuration of the node. All cluster
                ...
                The active node's management vCenter server credentials are not
                required to populate this :attr:`Cluster.NodeInfo.ha_ip`.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class WitnessInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ha_ip: VCHA Cluster network configuration of the node. All cluster
                ...
                happens over this network.
                The active node's management vCenter server credentials are not
                required to populate :attr:`Cluster.WitnessInfo.ha_ip`.
                This attribute was added in **vSphere API 6.7.1**.
            :type  runtime: :class:`Cluster.NodeRuntimeInfo` or ``None``
            :param runtime: Runtime information for the node in the VCHA Cluster.
                The active node's management vCenter server credentials are
                required to populate some attributes of
                :attr:`Cluster.WitnessInfo.runtime`.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class ErrorCondition(VapiStruct):
        ...
        def __init__(self,
            ...
            :param error: Contains an error condition.
                This attribute was added in **vSphere API 6.7.1**.
            :type  recommendation: :class:`com.vmware.vapi.std_client.LocalizableMessage` or ``None``
            :param recommendation: Contains a recommendation on handling the error condition.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class Info(VapiStruct):
        ...
        information of the three nodes in a VCHA Cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param config_state: Configuration state of the VCHA cluster.
                The active node's management vCenter server credentials are not
                required to populate this attribute.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable.
            :type  node1: :class:`Cluster.NodeInfo` or ``None``
            :param node1: Node configuration information for the VCHA cluster.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable.
            :type  node2: :class:`Cluster.NodeInfo` or ``None``
            :param node2: Node configuration information for the VCHA cluster.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable or the node is not
                cloned yet.
            :type  witness: :class:`Cluster.WitnessInfo` or ``None``
            :param witness: Node configuration information for the VCHA cluster.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable or the node is not
                cloned yet.
            :type  mode: :class:`Cluster.ClusterMode` or ``None``
            :param mode: Operational mode of the VCHA Cluster.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable or the node is not
                cloned yet.
            :type  health_state: :class:`Cluster.ClusterState` or ``None``
            :param health_state: Last known state of the VCHA Cluster.
                This attribute was added in **vSphere API 6.7.1**.
                If None, then the information is unavailable or the node is not
                cloned yet.
            ...
            :param manual_failover_allowed: Specifies if manual failover is allowed.
                This attribute was added in **vSphere API 6.7.1**.
            ...
            :param auto_failover_allowed: Specifies if automatic failover is allowed.
                This attribute was added in **vSphere API 6.7.1**.
    ...
    class NodeVmInfo(VapiStruct):
        ...
        Virtual Machine of a node of a VCHA cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            """
            :type  vm: :class:`str`
            :param vm: The identifier of the virtual machine of the VCHA node.
                This attribute was added in **vSphere API 6.7.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    class VmInfo(VapiStruct):
        ...
        Machines of passive and witness nodes of a VCHA cluster.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param passive: The virtual machine information of the passive node.
                This attribute was added in **vSphere API 6.7.1**.
            :type  witness: :class:`Cluster.NodeVmInfo`
            :param witness: The virtual machine information of the witness node.
                This attribute was added in **vSphere API 6.7.1**.
            """
            self.passive = passive
            self.witness = witness
    ...
    def undeploy_task(self,
        ...
        the VCHA cluster specific information is removed.
        This method was added in **vSphere API 6.7.1**.
...
class Operations(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        list of currently active VCHA operations.
        This class was added in **vSphere API 6.7.1**.
        ...
        def __init__(self,
            ...
            :param disabled: Identifiers of the operations that are current disabled. These
                ...
                :attr:`Operations.CLUSTER_GET_OP`.
                This attribute was added in **vSphere API 6.7.1**.
                When clients pass a value of this class as a parameter, the
            ...
            :param active: Identifiers of the operations that are currently running. These
                ...
                :attr:`Operations.CLUSTER_UNDEPLOY_OP`.
                This attribute was added in **vSphere API 6.7.1**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``com.vmware.vapi.operation``. When methods return a value of this
    ...
    def __init__(self, config):
        ...
        operations = {
            'deploy$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnverifiedPeer'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'failover$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'undeploy$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnverifiedPeer'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
