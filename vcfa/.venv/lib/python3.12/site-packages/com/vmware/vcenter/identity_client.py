...
class FederationType(Enum):
    ...
    paths for, vCenter Server identity providers configuration.
    ...
    """
    vCenter Server federated directly to the external identity provider.

    """
    INDIRECT_FEDERATION = None
    """
    vCenter Server federated indirectly to the external identity provider, by
    means of an intermediary federation broker.

    """
    VMWARE_SSO_FEDERATION = None
    """
    vCenter Server federated by VMWARE SSO
...
FederationType._set_values({
    ...
    'VMWARE_SSO_FEDERATION': FederationType('VMWARE_SSO_FEDERATION'),
})
...
class Providers(VapiInterface):
    ...
    class IdmProtocol(Enum):
        ...
        communication protocols to the identity management endpoints.
        This enumeration was added in **vSphere API 7.0.0.0**.
        ...
        SCIM = None
        """
        SCIM V1.1 protocol based identity management endpoints

        """
        SCIM2_0 = None
        """
        SCIM V2.0 protocol based identity management endpoints
    ...
    class Oauth2AuthenticationMethod(Enum):
        ...
        types of OAuth2 authentication methods.
        This enumeration was added in **vSphere API 7.0.0.0**.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param domain_names: Set of fully qualified domain names to trust when federating with
                ...
                are also provided in the tokens.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            ...
            :param federation_type: The type of the identity provider
    ...
    class Info(VapiStruct):
        ...
        _validator_list = [
            ...
            UnionValidator(
                'idm_protocol',
                {
                    'REST' : [('idm_endpoints', False)],
                    'SCIM' : [('idm_endpoints', False)],
                    'SCIM2_0' : [('idm_endpoints', False)],
                    'LDAP' : [('active_directory_over_ldap', False)],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            :param oauth2: OAuth2 Info
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oauth2`.
            :type  oidc: :class:`Providers.OidcInfo`
            :param oidc: OIDC Info
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oidc`.
            :type  is_default: :class:`bool`
            ...
            :param idm_protocol: Communication protocol to the identity management endpoints.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  idm_endpoints: :class:`list` of :class:`str`
            :param idm_endpoints: Identity management endpoints.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
            ...
            :param active_directory_over_ldap: Identity management configuration.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param oauth2: OAuth2 CreateSpec
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oauth2`.
            :type  oidc: :class:`Providers.OidcCreateSpec`
            :param oidc: OIDC CreateSpec
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oidc`.
            ...
            :param domain_names: Set of fully qualified domain names to trust when federating with
                ...
                only be validated if the user belongs to one of these domains, and
                any domain-qualified groups in the tokens will be filtered to
                include only those groups that belong to one of these domains.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param oauth2: OAuth2 UpdateSpec
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oauth2`.
            :type  oidc: :class:`Providers.OidcUpdateSpec`
            :param oidc: OIDC UpdateSpec
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``configTag`` is :attr:`Providers.ConfigType.Oidc`.
            :type  org_ids: :class:`set` of :class:`str` or ``None``
            ...
            :param auth_query_params: key/value pairs that are to be appended to the authEndpoint
                ...
                map is empty, deletes all params.
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, leaves value unchanged.
            :type  idm_protocol: :class:`Providers.IdmProtocol` or ``None``
    ...
    class Oauth2Summary(VapiStruct):
        ...
        about an OAuth2 identity provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param auth_endpoint: Authentication/authorization endpoint of the provider
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  token_endpoint: :class:`str`
            :param token_endpoint: Token endpoint of the provider
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    class Oauth2Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param claim_map: The map used to transform an OAuth2 claim to a corresponding claim
                ...
                the key and a vCenter Server group as value.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param authentication_method: Authentication method used by the provider
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  auth_query_params: :class:`dict` of :class:`str` and :class:`list` of :class:`str`
            :param auth_query_params: 
    ...
    class Oauth2CreateSpec(VapiStruct):
        ...
        create an OAuth2 identity provider.
        This class was added in **vSphere API 7.0.0.0**.
    ...
    class Oauth2UpdateSpec(VapiStruct):
        ...
        update the OAuth2 identity provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param client_secret: Shared secret between identity provider and client
                This attribute was added in **vSphere API 7.0.0.0**.
                If None, leaves value unchanged.
    ...
    class OidcSummary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param logout_endpoint: The endpoint to use for terminating the user's session at the
                ...
                metadata information provided by the OIDC discovery endpoint.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  auth_endpoint: :class:`str`
    ...
    class ActiveDirectoryOverLdap(VapiStruct):
        ...
        def __init__(self,
            ...
            :param user_name: User name to connect to the active directory server.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  password: :class:`str`
            :param password: Password to connect to the active directory server.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param cert_chain: SSL certificate chain in base64 encoding.
                This attribute was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
