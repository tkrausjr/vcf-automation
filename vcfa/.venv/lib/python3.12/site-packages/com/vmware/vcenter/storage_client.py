...
class Policies(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.storage.policies'
    """
    ...
    class FilterSpec(VapiStruct):
        ...
        results when listing the storage policies (see :func:`Policies.list`)
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param policies: Identifiers of storage policies that can match the filter.
    ...
    class CompatibilityInfo(VapiStruct):
        ...
        datastores compatible with a specific storage policy.
        This class was added in **vSphere API 6.7**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).build(),
            ...
            'check_compatibility': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).build(),
