...
class Providers(VapiInterface):
    ...
    Key Providers that handoff to key servers.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        """
        The ``Providers.Health`` class defines the possible health states.
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class ServerInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param health: The connection status health of the server.
            ...
            :param client_trust_server: Whether this client trusts the server.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  server_trust_client: :class:`bool`
            :param server_trust_client: Whether the server trusts this client.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  name: :class:`str`
            :param name: Name of the server.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.ServerInfo is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
    ...
    class Status(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  health: :class:`Providers.Health`
            :param health: The health of the provider.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  details: :class:`list` of :class:`com.vmware.vapi.std_client.LocalizableMessage`
            ...
            :param servers: Health of the key servers.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.Status is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.details = details
    ...
    class Server(VapiStruct):
        ...
        def __init__(self,
            ...
            :param address: The server's address.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.Server is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.name = name
    ...
    class KmipServerCreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KmipServerCreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.servers = servers
    ...
    class KeyServerCreateSpec(VapiStruct):
        ...
        describe the desired configuration for the key server.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param kmip_server: Configuration information for Key Management Interoperability
                Protocol (KMIP) based key server.
                This attribute was added in **vSphere API 7.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``type`` is :attr:`Providers.KeyServerCreateSpec.Type.KMIP`.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerCreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.type = type
        ...
        class Type(Enum):
            ...
            def __init__(self, string):
                ...
                """
                warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerCreateSpec.Type is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
                Enum.__init__(string)
    ...
    class CreateSpec(VapiStruct):
        ...
        desired configuration for a new Key Provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param key_server: Key server associated with this Provider.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class KmipServerUpdateSpec(VapiStruct):
        ...
        describe new configuration for KMIP based key server.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KmipServerUpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.servers = servers
            self.username = username
            VapiStruct.__init__(self)
    ...
    class KeyServerUpdateSpec(VapiStruct):
        ...
        describe new configuration for an existing key server.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerUpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.type = type
            self.description = description
            self.proxy_server = proxy_server
            self.connection_timeout = connection_timeout
        ...
        class Type(Enum):
            ...
            def __init__(self, string):
                ...
                :param string: String value for the :class:`Type` instance.
                """
                warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerUpdateSpec.Type is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
                Enum.__init__(string)
    ...
    class UpdateSpec(VapiStruct):
        ...
        new configuration for an existing provider.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.UpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.master_key_id = master_key_id
            self.key_server = key_server
            VapiStruct.__init__(self)
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param provider: Name of the provider. 
                ...
                ``com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Provider``.
            :type  health: :class:`Providers.Health`
            :param health: Health of the provider in the cluster.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.provider = provider
            self.health = health
            VapiStruct.__init__(self)
    ...
    class KmipServerInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KmipServerInfo is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.servers = servers
            self.username = username
            VapiStruct.__init__(self)
    ...
    class KeyServerInfo(VapiStruct):
        ...
        current configuration of a key server.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerInfo is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.type = type
            self.description = description
            self.proxy_server = proxy_server
            self.connection_timeout = connection_timeout
        ...
        class Type(Enum):
            """
            The ``Providers.KeyServerInfo.Type`` class list the key server types.
            This enumeration was added in **vSphere API 7.0.0.0**.
            ...
            def __init__(self, string):
                ...
                :param string: String value for the :class:`Type` instance.
                """
                warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.KeyServerInfo.Type is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
                Enum.__init__(string)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: Status of the provider in the cluster.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.Providers.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.master_key_id = master_key_id
            self.key_server = key_server
            self.status = status
            VapiStruct.__init__(self)
    ...
    def list_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ReadKMSTrust``.
    ...
    def create_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ManageKMSTrust``.
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``System.View``.
        """
...
class ServiceStatus(VapiInterface):
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.ServiceStatus is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Health(Enum):
        ...
        def __init__(self, string):
            ...
            :param string: String value for the :class:`Health` instance.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.ServiceStatus.Health is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param details: Details regarding the health of the service. 
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.trust_authority_clusters.kms.ServiceStatus.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.health = health
            self.details = details
            VapiStruct.__init__(self)
    ...
    def __init__(self, config):
        ...
        operations = {
            'list$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'create$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
