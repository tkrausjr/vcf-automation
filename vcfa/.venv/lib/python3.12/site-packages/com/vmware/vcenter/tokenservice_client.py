...
class TokenExchange(VapiInterface):
    ...
    .. deprecated:: vSphere API 7.0.2.0
        This class is deprecated as of **vSphere API 7.0.2.0**.
    """
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.tokenservice.TokenExchange is deprecated as of release vSphere API 7.0.2.0.', DeprecationWarning)
    ...
    class ExchangeSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param actor_token_type: An identifier, that indicates the type of the security token in the
                ...
                present.
            """
            warn('com.vmware.vcenter.tokenservice.TokenExchange.ExchangeSpec is deprecated as of release vSphere API 7.0.2.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param refresh_token: A refresh token can be issued in cases where the client of the
                ...
                if not needed for specific case of exchange.
            """
            warn('com.vmware.vcenter.tokenservice.TokenExchange.Info is deprecated as of release vSphere API 7.0.2.0.', DeprecationWarning)
    ...
    def exchange(self,
        ...
        .. deprecated:: vSphere API 7.0.2.0
            This method is deprecated as of **vSphere API 7.0.2.0**.
        ...
        """
        warn('com.vmware.vcenter.tokenservice.TokenExchange.exchange is deprecated as of release vSphere API 7.0.2.0.', DeprecationWarning)
    ...
    def __init__(self, config):
        ...
        operations = {
            'exchange': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidRequest'), []).add(type.ReferenceType(__name__, 'InvalidRequest'), []).add(type.ReferenceType(__name__, 'InvalidGrant'), []).add(type.ReferenceType(__name__, 'InvalidScope'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
