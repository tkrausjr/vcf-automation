...
class Tickets(VapiInterface):
    ...
    console tickets.
    This class was added in **vSphere API 7.0.0.2**.
    """
    ...
    class Type(Enum):
        """
        The ``Tickets.Type`` class defines the types of console tickets.
        This enumeration was added in **vSphere API 7.0.0.2**.
        ...
        This class attribute was added in **vSphere API 7.0.0.2**.
    ...
    class CreateSpec(VapiStruct):
        ...
        virtual machine console ticket.
        This class was added in **vSphere API 7.0.0.2**.
        ...
        def __init__(self,
            ...
            :param type: The type of virtual machine console ticket
                This attribute was added in **vSphere API 7.0.0.2**.
            """
            self.type = type
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ticket: Console ticket URI
                This attribute was added in **vSphere API 7.0.0.2**.
            """
            self.ticket = ticket
            VapiStruct.__init__(self)
    ...
    def create(self,
        ...
        be acquired only when the VM is turned on.
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
