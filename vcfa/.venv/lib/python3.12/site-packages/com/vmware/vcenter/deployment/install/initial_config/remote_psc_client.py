...
class Thumbprint(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vcenter.deployment.install.initial_config.remote_psc.thumbprint'
    """
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.deployment.install.initial_config.remote_psc.Thumbprint is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class RemoteSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param address: The IP address or DNS resolvable name of the remote PSC.
            ...
            """
            warn('com.vmware.vcenter.deployment.install.initial_config.remote_psc.Thumbprint.RemoteSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            on exception.
        """
        warn('com.vmware.vcenter.deployment.install.initial_config.remote_psc.Thumbprint.get is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
