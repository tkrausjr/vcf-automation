...
class Services(VapiInterface):
    ...
    of the Key Provider Service in vCenter.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.kms.Services is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Summary(VapiStruct):
        ...
        registered Key Provider Service instance.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Key Provider
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Key Provider
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
    ...
    class CreateSpec(VapiStruct):
        ...
        registering a Key Provider Service instance to the environment.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param trust_authority_cluster: The cluster specifies the Trust Authority Cluster this Key Provider
                ...
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.CreateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.address = address
            self.trusted_ca = trusted_ca
            self.group = group
            self.trust_authority_cluster = trust_authority_cluster
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ReadTrustedHosts``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def create(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.create is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``TrustedAdmin.ManageTrustedHosts``.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.kms.Services.delete is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class _ServicesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vcenter/trusted-infrastructure/kms/services?action=query',
