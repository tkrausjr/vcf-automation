...
class IPAssignment(VapiStruct):
    ...
    various functions in a Supervisor Kubernetes Cluster.
    ...
    def __init__(self,
        ...
        :param ranges: :attr:`IPAssignment.ranges` lists the available IP addresses that
            can be consumed by Supervisor to run the cluster.
            This attribute was added in **vSphere API 8.0.0.1**.
        """
    ...
    class Assignment(Enum):
        ...
        applicable on NSX networks.

        """
        NODE = None
        """
        :attr:`IPAssignment.Assignment.NODE` represents IP ranges that is allocated
        to nodes for both the control plane and Kubernetes Clusters. This
        assignment is currently only applicable on VDS networks.
...
class IPManagement(VapiStruct):
    ...
    def __init__(self,
        ...
        :param dhcp_enabled: :attr:`IPManagement.dhcp_enabled` If set true, configures IP
            ...
            corresponding :attr:`IPManagement.ip_assignments` are set.
            This attribute was added in **vSphere API 8.0.0.1**.
        ...
        :param ip_assignments: :attr:`IPManagement.ip_assignments` are a list of roles that can be
            ...
            is specified, these assignments must be on the same subnet.
            This attribute was added in **vSphere API 8.0.0.1**.
...
Ipv4Cidr._set_binding_type(type.StructType(
    'com.vmware.vcenter.namespace_management.networks.ipv4_cidr', {
        'address': type.StringType(),
...
class Services(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ntp: :attr:`Services.ntp` describes NTP servers running on this network
            that networked applications can use for synchronizing time.
            This attribute was added in **vSphere API 8.0.0.1**.
