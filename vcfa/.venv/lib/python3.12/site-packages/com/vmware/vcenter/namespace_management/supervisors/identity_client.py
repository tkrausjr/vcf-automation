...
class Domains(VapiInterface):
    """
    The ``Domains`` class provides methods to configure an Identity domain on
    Supervisor that acts as an OIDC provider.
    This class was added in **vSphere API 9.0.0.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.vcenter.namespace_management.supervisors.identity.domains'
    """
    ...
    class Summary(VapiStruct):
        """
        The ``Domains.Summary`` class provides an overview of an identity domain
        registered for a Supervisor.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param domain: The immutable identifier of an identity domain generated when an
                identity domain is configured for a Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.identity.domain``. When
                methods return a value of this class as a return value, the
                attribute will be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.identity.domain``.
            :type  display_name: :class:`str`
            :param display_name: A name to be used for the given identity domain. This name will be
                displayed in the vCenter UI.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.domain = domain
    ...
    Summary._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.identity.domains.summary', {
            'domain': type.IdType(resource_types='com.vmware.vcenter.namespace_management.identity.domain'),
    ...
    class ListResult(VapiStruct):
        """
        The ``Domains.ListResult`` class represents the result of a
        :func:`Domains.list` method.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  domains: :class:`list` of :class:`Domains.Summary`
            :param domains: List of Summary.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
    ...
    ListResult._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.identity.domains.list_result', {
            'domains': type.ListType(type.ReferenceType(__name__, 'Domains.Summary')),
        },
        ListResult,
        False,
        None))
    ...
    class Info(VapiStruct):
        """
        The ``Domains.Info`` class provides details about an OIDC domain configured
        with a Supervisor.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :type  domain: :class:`str`
            :param domain: The immutable identifier of an identity domain generated when an
                federation domain is registered for a Supervisor.
                This attribute was added in **vSphere API 9.0.0.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.vcenter.namespace_management.identity.domain``. When
            ...
            :param callback_url: The URL used by the Identity Provider to redirect users back to the
                Supervisor after authentication. This URL will be used in the
                registration of the Supervisor with the Identity Provider to act as
                an OAuth 2.0 client.
                This attribute was added in **vSphere API 9.0.0.0**.
            """
            self.domain = domain
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.identity.domains.info', {
            'domain': type.IdType(resource_types='com.vmware.vcenter.namespace_management.identity.domain'),
            'display_name': type.StringType(),
            'callback_url': type.StringType(),
        },
        Info,
        False,
        None))
    ...
    def get(self,
        ...
        """
        Returns information about an identity domain configured for a
        Supervisor.
        This method was added in **vSphere API 9.0.0.0**.

        :type  supervisor: :class:`str`
        :param supervisor: identifier for the Supervisor for which the identity domain is
            being read.
            The parameter must be an identifier for the resource type:
            ``com.vmware.vcenter.namespace_management.supervisor.Supervisor``.
        :type  domain: :class:`str`
        :param domain: identifier for the supervisor identity domain that is being read.
            The parameter must be an identifier for the resource type:
            ``com.vmware.vcenter.namespace_management.identity.domain``.
        :rtype: :class:`Domains.Info`
        :return: An {#link Info} representing the requested supervisor identity
            domain.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the given identity domain or Supervisor cannot be found.
    ...
    def list(self,
        ...
        """
        List the identity domains configured for a given Supervisor.
        This method was added in **vSphere API 9.0.0.0**.

        :type  supervisor: :class:`str`
        :param supervisor: the Supervisor for which identity domains are being listed.
            The parameter must be an identifier for the resource type:
            ``com.vmware.vcenter.namespace_management.supervisor.Supervisor``.
        :rtype: :class:`Domains.ListResult`
        :return: A list of {#link Summary} with details about the identity domains
...
class Providers(VapiInterface):
    ...
    class Summary(VapiStruct):
        ...
        provider configured for the given Supervisor.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param provider: The immutable identifier of an identity provider generated when an
                identity provider is registered for a Supervisor.
            ...
            :param display_name: A name to be used for the given identity provider. This name will
                be displayed in the vCenter UI.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
    ...
    class Info(VapiStruct):
        ...
        _canonical_to_pep_names = {
                                ...
                                'client_ID': 'client_id',
                                'credentials_exchange_JWT_authenticator': 'credentials_exchange_jwt_authenticator',
                                }
        ...
        def __init__(self,
                     ...
                     credentials_exchange_jwt_authenticator=None,
                     allow_credentials_exchange=None,
                    ):
            """
            :type  provider: :class:`str`
            :param provider: The immutable identifier of an identity provider generated when an
            ...
            :param username_claim: The claim from the upstream identity provider ID token or user info
                endpoint to inspect to obtain the username for the given user.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param groups_claim: The claim from the upstream identity provider ID token or user info
                endpoint to inspect to obtain the groups for the given user.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param client_id: The clientID is the OAuth 2.0 client ID registered in the upstream
                identity provider and used by the Supervisor.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param certificate_authority_data: The certificate authority data holds the trusted roots to be used
                to establish HTTPS connections with the identity provider.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param additional_scopes: Additional scopes to be requested in tokens issued by this identity
                provider. The 'openid' scope will always be requested.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param additional_authorize_parameters: Any additional parameters to be sent to the upstream identity
                ...
                in to leverage that organization.
                This attribute was added in **vSphere API 8.0.0.1**.
                If None, no additional parameters will be sent to the upstream
                identity provider.
            :type  credentials_exchange_jwt_authenticator: :class:`str` or ``None``
            :param credentials_exchange_jwt_authenticator: Name of the 'JWTAuthenticator' Supervisor object created when
                :attr:`Providers.Info.allow_credentials_exchange` is set to
                ``true``.
                This attribute was added in **vSphere API 9.0.0.0**.
                if None, no 'JWTAuthenticator' object created on the Supervisor.
            :type  allow_credentials_exchange: :class:`bool` or ``None``
            :param allow_credentials_exchange: If ``true`` client can exchange an identity provider issued ID
                token for an mTLS client ceritificate key pair by using the
                Supervisor 'TokenCredentialRequest' API.
                This attribute was added in **vSphere API 9.0.0.0**.
            ...
            self.credentials_exchange_jwt_authenticator = credentials_exchange_jwt_authenticator
            self.allow_credentials_exchange = allow_credentials_exchange
            VapiStruct.__init__(self)
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.vcenter.namespace_management.supervisors.identity.providers.info', {
            ...
            'credentials_exchange_JWT_authenticator': type.OptionalType(type.StringType()),
            'allow_credentials_exchange': type.OptionalType(type.BooleanType()),
        },
        Info,
        False,
        None))
    ...
    class CreateSpec(VapiStruct):
        ...
        identity provider for use with a Supervisor.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param client_secret: The OAuth 2.0 client secret to be used by the Supervisor when
                authenticating to the upstream identity provider.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  certificate_authority_data: :class:`str` or ``None``
            ...
            :param additional_authorize_parameters: Any additional parameters to be sent to the upstream identity
                ...
                identity provider.
            :type  allow_credentials_exchange: :class:`bool` or ``None``
            :param allow_credentials_exchange: Enables a client to exchange an identity provider issued ID token
                for an mTLS client certificate key pair using the Supervisor
                'TokenCredentialRequest' API. Note: Supervisor only supports public
                OAuth 2.0 clients, which do not require client secrets.
                This attribute was added in **vSphere API 9.0.0.0**.
                Defaults to ``false`` if None.
            """
            self.display_name = display_name
    ...
    class SetSpec(VapiStruct):
        ...
        of an upstream identity provider for use with a Supervisor.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param unset_username_claim: This represents the intent of the change to
                ...
                :attr:`Providers.UpdateSpec.username_claim`, if any.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param unset_groups_claim: This represents the intent of the change to
                ...
                changed to the value specified in
                :attr:`Providers.UpdateSpec.groups_claim`, if any.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    def create(self,
        ...
        only a single identity provider can be created.
        This method was added in **vSphere API 8.0.0.1**.
...
class _DomainsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vcenter/namespace-management/supervisors/{supervisor}/identity/domains/{domain}',
            path_variables={
                'supervisor': 'supervisor',
                'domain': 'domain',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vcenter/namespace-management/supervisors/{supervisor}/identity/domains',
            path_variables={
                'supervisor': 'supervisor',
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType(__name__, 'Domains.Info'),
            ...
            'list': {
                ...
                'output_type': type.ReferenceType(__name__, 'Domains.ListResult'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.vcenter.namespace_management.supervisors.identity.domains',
