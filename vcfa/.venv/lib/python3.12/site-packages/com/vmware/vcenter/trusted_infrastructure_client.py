...
class StsPrincipal(VapiStruct):
    ...
    def __init__(self,
        ...
        :param type: The type of the principal (user or group).
            This attribute was added in **vSphere API 7.0.0.0**.
        """
        self.id = id
        self.type = type
...
class X509CertChain(VapiStruct):
    ...
    def __init__(self,
        ...
        :param cert_chain: Certificate chain in base64 format
            This attribute was added in **vSphere API 7.0.0.0**.
        """
...
class TrustAuthorityClusters(VapiInterface):
    ...
    Trust Authority Cluster and vice versa.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class State(Enum):
        ...
        ENABLE = None
        """
        The :class:`TrustAuthorityClusters` is enabled.
        ...
        DISABLE = None
        """
        The :class:`TrustAuthorityClusters` is disabled.
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.State is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            Enum.__init__(string)
    ...
    class Summary(VapiStruct):
        ...
        :class:`TrustAuthorityClusters` id and state.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param cluster: Identifies the cluster.
                This attribute was added in **vSphere API 7.0.0.0**.
            ...
            :param state: The state of the :class:`TrustAuthorityClusters`.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.Summary is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class FilterSpec(VapiStruct):
        ...
        for identifying a :class:`TrustAuthorityClusters`.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.FilterSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.cluster = cluster
            self.state = state
            VapiStruct.__init__(self)
    ...
    class UpdateSpec(VapiStruct):
        ...
        for update of a :class:`TrustAuthorityClusters`.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.UpdateSpec is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.state = state
            VapiStruct.__init__(self)
    ...
    class Info(VapiStruct):
        ...
        retrieving the :class:`TrustAuthorityClusters` info.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param state: The state of the cluster.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
            self.cluster = cluster
            self.state = state
            VapiStruct.__init__(self)
    ...
    def update_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires ``TrustedAdmin.ManageTrustedHosts``.
        """
    ...
    def get(self,
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def list(self,
        ...
        :class:`TrustAuthorityClusters.FilterSpec`.
        This method was added in **vSphere API 7.0.0.0**.
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.TrustAuthorityClusters.list is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
...
class Principal(VapiInterface):
    ...
    sign the tokens used by vCenter for authentication.
    This class was added in **vSphere API 7.0.0.0**.
    ...
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        warn('com.vmware.vcenter.trusted_infrastructure.Principal is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    class Info(VapiStruct):
        ...
        and certificates used by this vCenter to retrieve tokens.
        This class was added in **vSphere API 7.0.0.0**.
        ...
        def __init__(self,
            ...
            :param issuer: The service which created and signed the security token.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  principal: :class:`StsPrincipal`
            :param principal: The principal used by this vCenter instance to retrieve tokens.
                Currently this is the vCenter solution user.
                This attribute was added in **vSphere API 7.0.0.0**.
            :type  name: :class:`str`
            :param name: The user-friednly name of the vCenter.
                This attribute was added in **vSphere API 7.0.0.0**.
            """
            warn('com.vmware.vcenter.trusted_infrastructure.Principal.Info is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
    ...
    def get(self):
        ...
        """
        warn('com.vmware.vcenter.trusted_infrastructure.Principal.get is deprecated as of release vSphere API 8.0.3.0.', DeprecationWarning)
