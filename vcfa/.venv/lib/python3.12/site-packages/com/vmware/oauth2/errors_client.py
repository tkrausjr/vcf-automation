...
class Error(VapiError):
    ...
    class Type(Enum):
        ...
        invalid_client = None
        """
        Discriminator for the :class:`InvalidClient` type.
        This class attribute was added in **vSphere API 8.0.3.0**.

        """
        unauthorized_client = None
        """
        Discriminator for the :class:`UnauthorizedClient` type.
        This class attribute was added in **vSphere API 8.0.3.0**.

        """
        unsupported_grant_type = None
        """
        Discriminator for the :class:`UnsupportedGrantType` type.
        This class attribute was added in **vSphere API 8.0.3.0**.

        """
        invalid_target = None
        """
        Discriminator for the :class:`InvalidTarget` type
        This class attribute was added in **vSphere API 8.0.3.0**.
