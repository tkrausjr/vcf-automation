...
class AuthenticationInfo(VapiStruct):
    ...
    SchemeType._set_values({
        'SESSIONLESS': SchemeType('SESSIONLESS'),
        'SESSION_AWARE': SchemeType('SESSION_AWARE'),
    })
...
class Component(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.authentication.component'
    """
...
class Package(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.authentication.package'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Service(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.authentication.service'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Source(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.authentication.source'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        **Note:** this class is restricted for **VMware internal use only**.
        ...
        def __init__(self,
            ...
            :param filepath: Absolute file path of the authentication metadata file that has the
                authentication information about one component element. This is the
                path to the file in the server's filesystem.
                This attribute is optional and it is only relevant when the value
                of ``type`` is
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            is not a valid JSON file or if the format of the authentication
...
class _ComponentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/component',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/component/{componentId}',
            path_variables={
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/component/{componentId}/fingerprint',
            path_variables={
                'component_id': 'componentId',
            },
            query_parameters={
...
class _PackageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/package',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/package/{packageId}',
            path_variables={
...
class _ServiceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/service',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/service/{serviceId}',
            path_variables={
...
class _SourceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/authentication/source',
            path_variables={
            },
            query_parameters={
            },
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/vapi/metadata/authentication/source/{sourceId}',
            path_variables={
                'source_id': 'sourceId',
            },
            query_parameters={
        ...
        reload_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/authentication/source?action=reload',
            path_variables={
            },
            query_parameters={
            },
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/authentication/source?action=fingerprint',
            path_variables={
            },
            query_parameters={
            },
