...
class Operation(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.authentication.service.operation'
    """
...
class _OperationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/service/{serviceId}/operation',
            path_variables={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/authentication/service/{serviceId}/operation/{operationId}',
            path_variables={
                'service_id': 'serviceId',
