...
class Error(VapiError):
    ...
    Type._set_values({
        ...
        'ALREADY_IN_DESIRED_STATE': Type('ALREADY_IN_DESIRED_STATE'),
        'CANCELED': Type('CANCELED'),
        'CONCURRENT_CHANGE': Type('CONCURRENT_CHANGE'),
        'FEATURE_IN_USE': Type('FEATURE_IN_USE'),
        'INTERNAL_SERVER_ERROR': Type('INTERNAL_SERVER_ERROR'),
        'INVALID_ARGUMENT': Type('INVALID_ARGUMENT'),
        'INVALID_ELEMENT_CONFIGURATION': Type('INVALID_ELEMENT_CONFIGURATION'),
        'INVALID_ELEMENT_TYPE': Type('INVALID_ELEMENT_TYPE'),
        'INVALID_REQUEST': Type('INVALID_REQUEST'),
        'NOT_ALLOWED_IN_CURRENT_STATE': Type('NOT_ALLOWED_IN_CURRENT_STATE'),
        'NOT_FOUND': Type('NOT_FOUND'),
        'OPERATION_NOT_FOUND': Type('OPERATION_NOT_FOUND'),
        'RESOURCE_BUSY': Type('RESOURCE_BUSY'),
        'RESOURCE_IN_USE': Type('RESOURCE_IN_USE'),
        'RESOURCE_INACCESSIBLE': Type('RESOURCE_INACCESSIBLE'),
        'SERVICE_UNAVAILABLE': Type('SERVICE_UNAVAILABLE'),
        'TIMED_OUT': Type('TIMED_OUT'),
        'UNABLE_TO_ALLOCATE_RESOURCE': Type('UNABLE_TO_ALLOCATE_RESOURCE'),
        'UNAUTHENTICATED': Type('UNAUTHENTICATED'),
        'UNAUTHORIZED': Type('UNAUTHORIZED'),
        'UNEXPECTED_INPUT': Type('UNEXPECTED_INPUT'),
        'UNSUPPORTED': Type('UNSUPPORTED'),
        'UNVERIFIED_PEER': Type('UNVERIFIED_PEER'),
    })
