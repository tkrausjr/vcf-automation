...
class ConstantInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param documentation: English language documentation for the constant element. It can
            ...
            tags).
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the constant element.
...
ConstantInfo._set_binding_type(type.StructType(
    'com.vmware.vapi.metadata.metamodel.constant_info', {
        ...
        'documentation': type.StringType(),
        'lifecycle': type.OptionalType(type.ReferenceType('com.vmware.vapi.metadata_client', 'LifecycleInfo')),
    },
    ConstantInfo,
    False,
    None))
...
class ElementValue(VapiStruct):
    ...
    Type._set_values({
        ...
        'STRUCTURE_REFERENCE': Type('STRUCTURE_REFERENCE'),
        'STRUCTURE_REFERENCE_LIST': Type('STRUCTURE_REFERENCE_LIST'),
    })
...
class EnumerationInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the enumeration element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class EnumerationValueInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the enumeration value.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class ErrorInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param structure_id: Identifier for the structure element corresponding to the error
            ...
            the resource type: ``com.vmware.vapi.structure``.
        :type  documentation: :class:`str`
        :param documentation: The English language documentation for the error element. It can
            contain HTML markup and Javadoc tags.
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the error element contained in an
            operation element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
...
class FieldInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param metadata: Generic metadata elements for the field element. The key in the
            ...
            keys in the :class:`dict`.
        :type  documentation: :class:`str`
        :param documentation: English language documentation for the field element. It can
            contain HTML markup and Javadoc tags.
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the field element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class OperationInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  documentation: :class:`str`
        :param documentation: English language documentation for the operation element. It can
            contain HTML markup and Javadoc tags.
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the operation element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class ServiceInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the service element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class StructureInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :type  lifecycle: :class:`com.vmware.vapi.metadata_client.LifecycleInfo`
        :param lifecycle: Lifecycle information for the structure element.
            **Warning:** this attribute is part of a new feature in
            development. It may be changed at any time and may not have all
            supported functionality implemented.
            This attribute is optional because it was added in a newer version
...
class Type(VapiStruct):
    ...
    * Generic type instantiation: The language infrastructure also provides
    ...
    BuiltinType._set_values({
        ...
        'SECRET': BuiltinType('SECRET'),
        'DATE_TIME': BuiltinType('DATE_TIME'),
        'ID': BuiltinType('ID'),
        'URI': BuiltinType('URI'),
        'ANY_ERROR': BuiltinType('ANY_ERROR'),
        'DYNAMIC_STRUCTURE': BuiltinType('DYNAMIC_STRUCTURE'),
...
class Component(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.component'
    """
...
class Enumeration(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.enumeration'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class MetadataIdentifier(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.metadata_identifier'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Package(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.package'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Resource(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.resource'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Service(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.service'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Source(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.source'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if the type of the source specified in
            :attr:`com.vmware.vapi.metadata_client.SourceCreateSpec.type` is
            invalid.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if the file specified in
            :attr:`com.vmware.vapi.metadata_client.SourceCreateSpec.filepath`
            is not a valid JSON file or if the format of the metamodel metadata
            in the JSON file is invalid.
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            if the URI specified in
            :attr:`com.vmware.vapi.metadata_client.SourceCreateSpec.address` is
            unreachable or if there is a transport protocol or message protocol
            mismatch between the client and the server or if the remote server
            do not have classes present in
            :mod:`com.vmware.vapi.metadata.metamodel_client` module.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the file specified in
            :attr:`com.vmware.vapi.metadata_client.SourceCreateSpec.filepath`
            does not exist.
...
class Structure(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.structure'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _ComponentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/component',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/component/{componentId}',
            path_variables={
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/component/{componentId}/fingerprint',
            path_variables={
                'component_id': 'componentId',
            },
            query_parameters={
...
class _EnumerationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/enumeration',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/enumeration/{enumerationId}',
            path_variables={
...
class _PackageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/package',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/package/{packageId}',
            path_variables={
...
class _ResourceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/resource',
            path_variables={
            },
            query_parameters={
            },
...
class _ServiceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/service',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/service/{serviceId}',
            path_variables={
...
class _SourceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/metamodel/source',
            path_variables={
            },
            query_parameters={
            },
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/vapi/metadata/metamodel/source/{sourceId}',
            path_variables={
                'source_id': 'sourceId',
            },
            query_parameters={
        ...
        reload_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/metamodel/source?action=reload',
            path_variables={
            },
            query_parameters={
            },
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/metamodel/source?action=fingerprint',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
...
class _StructureStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/structure',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/structure/{structureId}',
            path_variables={
