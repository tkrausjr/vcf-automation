...
"""
The ``com.vmware.vapi.metadata.routing_client`` module provides classes that
...
class OperationInfo(VapiStruct):
    ...
    For an explanation of containment within operations, see
    :class:`com.vmware.vapi.metadata.routing.service_client.Operation`
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    def __init__(self,
        ...
        :param routing_info: The routing information assigned for this operation. 
            
            For an explanation of routing information, see :class:`RoutingInfo`
        """
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    def __init__(self,
        ...
        :param id_types: This is map of specifically predefined resource types in the
            ...
            be routed, because their ids contain VC server guid. 
            
            Example: Content Library Sessions are considered transient objects
            that do not need to be persisted in the IS. 
            
            Routing ini file must contain section: [types]
            com.vmware.content.DownloadSession=positioned 
            
            The map therefore will contain:
            {{"com.vmware.content.DownloadSession", "positioned"}} Note: This
            should not be final solution. To avoid duplication, currently this
...
class Component(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.routing.component'
    """
...
class Package(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.routing.package'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Service(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.routing.service'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            If type of the source specified in
...
class _ComponentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/component',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/component/{componentId}',
            path_variables={
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/component/{componentId}/fingerprint',
            path_variables={
                'component_id': 'componentId',
            },
            query_parameters={
...
class _PackageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/package',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/package/{packageId}',
            path_variables={
...
class _ServiceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/service',
            path_variables={
            },
            query_parameters={
            },
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/service/{serviceId}',
            path_variables={
...
class _SourceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/routing/source',
            path_variables={
            },
            query_parameters={
            },
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/vapi/metadata/routing/source/{sourceId}',
            path_variables={
                'source_id': 'sourceId',
            },
            query_parameters={
        ...
        reload_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/routing/source?action=reload',
            path_variables={
            },
            query_parameters={
            },
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/routing/source?action=fingerprint',
            path_variables={
            },
            query_parameters={
            },
