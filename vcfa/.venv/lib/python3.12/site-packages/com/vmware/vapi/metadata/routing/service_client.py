...
"""
The ``com.vmware.vapi.metadata.routing.service_client`` module provides classes
to retrieve routing information for operation elements.
...
class Operation(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.routing.service.operation'
    """
...
class _OperationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/service/{serviceId}/operation',
            path_variables={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/routing/service/{serviceId}/operation/{operationId}',
            path_variables={
                'service_id': 'serviceId',
