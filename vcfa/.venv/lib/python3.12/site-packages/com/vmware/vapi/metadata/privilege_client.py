...
class Source(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.privilege.source'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            is not a valid JSON file or if the format of the privilege metadata
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.InvalidArgument` 
            ...
            :mod:`com.vmware.vapi.metadata.privilege_client` module.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            if the file specified in
            :attr:`com.vmware.vapi.metadata_client.SourceCreateSpec.filepath`
            does not exist.
...
class _SourceStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/privilege/source',
            path_variables={
            },
            query_parameters={
            },
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/vapi/metadata/privilege/source/{sourceId}',
            path_variables={
                'source_id': 'sourceId',
            },
            query_parameters={
        ...
        reload_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/privilege/source?action=reload',
            path_variables={
            },
            query_parameters={
            },
        ...
        fingerprint_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/vapi/metadata/privilege/source?action=fingerprint',
            path_variables={
            },
            query_parameters={
            },
