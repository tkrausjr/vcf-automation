...
class AuthenticationScheme(VapiStruct):
    ...
    * Request timestamp: This includes the ``created`` and ``expires`` timestamp of
    ...
    }`` vAPI runtime provide convenient factory methods that take SAML holder of
    key token and private key to create the security context that conforms to the
...
class LocalizableMessage(VapiStruct):
    ...
    def __init__(self,
        ...
        :param localized: Localized string value as per request requirements.
...
class LocalizationParam(VapiStruct):
    ...
    def __init__(self,
        ...
        :param s: :class:`str` value associated with the parameter.
        ...
        :param i: :class:`int` value associated with the parameter.
    ...
    DateTimeFormat._set_values({
        'SHORT_DATE': DateTimeFormat('SHORT_DATE'),
        'MED_DATE': DateTimeFormat('MED_DATE'),
        'LONG_DATE': DateTimeFormat('LONG_DATE'),
        'FULL_DATE': DateTimeFormat('FULL_DATE'),
        'SHORT_TIME': DateTimeFormat('SHORT_TIME'),
        'MED_TIME': DateTimeFormat('MED_TIME'),
        'LONG_TIME': DateTimeFormat('LONG_TIME'),
        'FULL_TIME': DateTimeFormat('FULL_TIME'),
        'SHORT_DATE_TIME': DateTimeFormat('SHORT_DATE_TIME'),
        'MED_DATE_TIME': DateTimeFormat('MED_DATE_TIME'),
        'LONG_DATE_TIME': DateTimeFormat('LONG_DATE_TIME'),
        'FULL_DATE_TIME': DateTimeFormat('FULL_DATE_TIME'),
    })
