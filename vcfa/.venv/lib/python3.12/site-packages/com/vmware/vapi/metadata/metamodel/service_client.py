...
class Hidden(VapiInterface):
    ...
    **Note:** this class is restricted for **VMware internal use only**.
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.service.hidden'
    """
...
class Operation(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.vapi.metadata.metamodel.service.operation'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _HiddenStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/service-hidden',
            path_variables={
            },
            query_parameters={
            },
...
class _OperationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/service/{serviceId}/operation',
            path_variables={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/vapi/metadata/metamodel/service/{serviceId}/operation/{operationId}',
            path_variables={
                'service_id': 'serviceId',
