...
class Policy(VapiInterface):
    ...
    class Config(VapiStruct):
        ...
        def __init__(self,
            ...
            :param auto_stage: Automatically stage the latest update if available.
                This attribute was added in **vSphere API 6.7**.
            :type  certificate_check: :class:`bool` or ``None``
            :param certificate_check: Indicates whether certificates will be checked during patching. 
                
                Warning: Setting this attribute to false will result in an insecure
                connection to update repository which can potentially put the
                appliance security at risk.
                This attribute was added in **vSphere API 6.7**.
                certificateCheck If None the certificate checks are enabled.
            """
            self.custom_url = custom_url
            self.username = username
    ...
    Config._set_binding_type(type.StructType(
        'com.vmware.appliance.update.policy.config', {
            ...
            'check_schedule': type.ListType(type.ReferenceType(__name__, 'Policy.Time')),
            'auto_stage': type.BooleanType(),
            'certificate_check': type.OptionalType(type.BooleanType()),
        },
        Config,
        False,
        None))
...
class Pending(VapiInterface):
    ...
    SourceType._set_values({
        'LAST_CHECK': SourceType('LAST_CHECK'),
        'LOCAL': SourceType('LOCAL'),
        'LOCAL_AND_ONLINE': SourceType('LOCAL_AND_ONLINE'),
    })
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param staged: Is the update staged
                This attribute was added in **vSphere API 6.7**.
            :type  knowledge_base: :class:`str`
            :param knowledge_base: URL for the knowledge base article describing this update.
                This attribute was added in **vSphere API 6.7**.
            :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param description: Description of the update. The short information what this update
                is. E.g. "Update2 for vCenter Server Appliance 6.5"
    ...
    class UpgradeableComponent(VapiStruct):
        """
        The ``Pending.UpgradeableComponent`` class describes component update
        information
        ...
        def __init__(self,
            ...
            :param component: Name of the upgradeable component. Component is a service or a
                group of services providing asynchronous lifecycle
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  affected_services: :class:`list` of :class:`str`
            :param affected_services: List of services affected as part of the update.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  version: :class:`str`
            :param version: Version in form of X.Y.Z.P. e.g. 6.5.1.5400
                This attribute was added in **vSphere API 6.7**.
    ...
    UpgradeableComponent._set_binding_type(type.StructType(
        'com.vmware.appliance.update.pending.upgradeable_component', {
            'component': type.StringType(),
            'affected_services': type.ListType(type.StringType()),
            'version': type.IdType(resource_types='com.vmware.appliance.update.pending'),
            'name': type.StringType(),
            'description': type.ReferenceType('com.vmware.vapi.std_client', 'LocalizableMessage'),
            'priority': type.ReferenceType(__name__, 'CommonInfo.Priority'),
    ...
    class Question(VapiStruct):
        ...
        InputType._set_values({
            'PLAIN_TEXT': InputType('PLAIN_TEXT'),
    ...
    def list(self,
             source_type,
             url=None,
             enable_list_major_upgrade_versions=None,
             ):
        """
        ...
        :type  enable_list_major_upgrade_versions: :class:`bool` or ``None``
        :param enable_list_major_upgrade_versions: checks and lists if there are eligible major version upgrades
            available. Possible values are true and false
            when set to true it allows listing of across version upgrade When
            not specified lists only minor updates available
        ...
        return self._invoke('list',
                            ...
                            'url': url,
                            'enable_list_major_upgrade_versions': enable_list_major_upgrade_versions,
                            })
    ...
    def get(self,
        ...
        :param component: Name of the upgradeable component
    ...
    def list_upgradeable_components(self,
                                    version,
                                    ):
        """
        List of all upgradeable components eligible for update within specified
        version. An upgradeable component can be upgraded to new version
        individually without upgrading the whole vCenter to it.
        This method was added in **vSphere API 8.0.0.1**.

        :type  version: :class:`str`
        :param version: specific version to check eligible updates
            The parameter must be an identifier for the resource type:
            ``com.vmware.appliance.update.pending``.
        :rtype: :class:`list` of :class:`Pending.UpgradeableComponent`
        :return: List of the upgradeable component info
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            Generic error
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            source is not found
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized` 
            session is not authorized to perform this operation
        """
        return self._invoke('list_upgradeable_components',
                            {
                            'version': version,
                            })
    ...
    def stage_and_install(self,
        ...
        :param user_data: map of user provided data with IDs
            ...
            ``com.vmware.applicance.update.pending.dataitem``.
        :type  component: :class:`str` or ``None``
        :param component: upgradeable component to be staged and installed
            This parameter was added in **vSphere API 8.0.0.1**.
            This parameter is optional because it was added in a newer version
            than its parent node.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
    ...
    def rollback(self):
        """
        Starts the update rollback operation such that the vCenter is reverted
        to a state before update installation. It will remove any changes done
        by update-install operation on the vCenter. 
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param staging_complete: Is staging complete
                This attribute was added in **vSphere API 6.7**.
            :type  component: :class:`str` or ``None``
            :param component: Staged Component name.
                This attribute was added in **vSphere API 8.0.0.1**.
                if None the staged update is for full patch if :class:`set` staged
                update is an upgradeable component which can be updated
                individually without vc update
            :type  version: :class:`str`
            :param version: Version in form of X.Y.Z.P. e.g. 6.5.1.5400
                This attribute was added in **vSphere API 6.7**.
                When clients pass a value of this class as a parameter, the
...
class _PendingStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_input_type = type.StructType('operation-input', {
            ...
            'enable_list_major_upgrade_versions': type.OptionalType(type.BooleanType()),
        })
        list_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
        ...
        # properties for list_upgradeable_components operation
        list_upgradeable_components_input_type = type.StructType('operation-input', {
            'version': type.IdType(resource_types='com.vmware.appliance.update.pending'),
        })
        list_upgradeable_components_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
            'com.vmware.vapi.std.errors.not_found':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'),
        ...
        list_upgradeable_components_input_value_validator_list = [
        ]
        list_upgradeable_components_output_validator_list = [
        ]
        list_upgradeable_components_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/appliance/update/pending/{version}/components',
            path_variables={
                'version': 'version',
            },
             header_parameters={
        ...
        rollback_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/appliance/update/pending?action=rollback',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            ...
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'list_upgradeable_components': {
                'input_type': list_upgradeable_components_input_type,
                'output_type': type.ListType(type.ReferenceType(__name__, 'Pending.UpgradeableComponent')),
                'errors': list_upgradeable_components_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': list_upgradeable_components_input_value_validator_list,
                'output_validator_list': list_upgradeable_components_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'precheck': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'stage': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'rollback': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
        ...
        rest_metadata = {
            ...
            'get': get_rest_metadata,
            'list_upgradeable_components': list_upgradeable_components_rest_metadata,
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
