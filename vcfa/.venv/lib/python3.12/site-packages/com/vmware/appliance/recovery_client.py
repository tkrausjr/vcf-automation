...
class Restore(VapiInterface):
    ...
    class Metadata(VapiStruct):
        ...
        def __init__(self,
            ...
            :param sso_login_required: Is SSO login required for the vCenter server.
                This attribute was added in **vSphere API 6.7**.
    ...
    def __init__(self, config):
        ...
        operations = {
            'validate': {
                ...
                'errors': validate_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
                'input_value_validator_list': validate_input_value_validator_list,
                'output_validator_list': validate_output_validator_list,
                'task_type': TaskType.NONE,
            },
