...
class Domains(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.dns.domains'
    """
...
class Hostname(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.dns.hostname'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    TestStatus._set_values({
        'orange': TestStatus('orange'),
        'green': TestStatus('green'),
        'red': TestStatus('red'),
    })
...
class Servers(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.dns.servers'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
