...
class Ipv4(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param configurable: The specified network interface is configurable or not.
                This attribute was added in **vSphere API 6.7**.
            :type  mode: :class:`Ipv4.Mode`
            :param mode: The Address assignment mode.
                This attribute was added in **vSphere API 6.7**.
...
class Ipv6(VapiInterface):
    ...
    class Origin(Enum):
        """
        The ``Ipv6.Origin`` class defines IPv6 address origin values.
        This enumeration was added in **vSphere API 6.7**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  dhcp: :class:`bool`
            :param dhcp: DHCP is on.
                This attribute was added in **vSphere API 6.7**.
            :type  autoconf: :class:`bool`
            :param autoconf: Stateless Address Autoconfiguration (SLAAC) is on.
                This attribute was added in **vSphere API 6.7**.
            :type  addresses: :class:`list` of :class:`Ipv6.AddressInfo`
            :param addresses: List of addresses with their origins and statuses.
                This attribute was added in **vSphere API 6.7**.
            :type  default_gateway: :class:`str`
            :param default_gateway: The default gateway for static IP address assignment. This
                configures the global IPv6 default gateway on the appliance with
                ...
                This attribute was added in **vSphere API 6.7**.
            :type  configurable: :class:`bool`
            :param configurable: Is NIC configurable or not.
                This attribute was added in **vSphere API 6.7**.
            """
            self.dhcp = dhcp
            self.autoconf = autoconf
    ...
    def __init__(self, config):
        ...
        operations = {
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'set': {
                ...
                'output_type': type.VoidType(),
                'errors': set_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': set_input_value_validator_list,
                'output_validator_list': set_output_validator_list,
                'task_type': TaskType.NONE,
            },
