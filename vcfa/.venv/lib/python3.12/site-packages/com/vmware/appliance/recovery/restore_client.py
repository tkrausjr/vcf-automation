...
class Job(VapiInterface):
    ...
    class RestoreRequest(VapiStruct):
        ...
        def __init__(self,
            ...
            :param parts: List of standalone parts to restore. Only parts with the
                :attr:`com.vmware.appliance.recovery.backup_client.Parts.Part.standalone`
                flag set to ``true`` can be included.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None entire VCSA will be restored.
            ...
            :param sso_admin_user_name: Administrators Username for SSO.
            ...
            :param sso_admin_user_password: The password for SSO admin user.
                This attribute was added in **vSphere API 6.7**.
                If None SSO authentication will not be used. If the vCenter Server
                is a management node or an embedded node, authentication is
                required.
            :type  ignore_warnings: :class:`bool` or ``None``
            :param ignore_warnings: The flag to ignore warnings during restore
                This attribute was added in **vSphere API 6.7**.
    ...
    class RestoreJobStatus(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  parts: :class:`list` of :class:`str` or ``None``
            :param parts: List of standalone parts requested for restore. Only parts with the
                :attr:`com.vmware.appliance.recovery.backup_client.Parts.Part.standalone`
                flag set to ``true`` can be included.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None entire VCSA restore was requested.
            """
            self.state = state
            self.messages = messages
    ...
    def create(self,
        ...
        """
        Initiate restore. If parts field is set in RestoreRequest, only
        specified parts will be restored instead of entire VCSA.
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'FeatureInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
