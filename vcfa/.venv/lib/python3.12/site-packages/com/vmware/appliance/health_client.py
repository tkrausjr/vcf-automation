...
class Database(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: Database health status
        ...
        class Status(Enum):
            ...
            DEGRADED = None
            """
            The database has issues but the impact on vCenter Server is low.
    ...
    class Message(VapiStruct):
        ...
        def __init__(self,
            ...
            :param message: Message describing the issue with the database.
                This attribute was added in **vSphere API 7.0.0.1**.
            """
