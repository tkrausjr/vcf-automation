...
class Profiles(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param fips_enforced: Indicates if FIPS 140-3 compliance is enforced for the TLS Profile.
                ...
                enforced, non FIPS validated TLS features wont be in effect.
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class ListItem(VapiStruct):
        ...
        profile name and their TLS configuration.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param profile: Defines the standard profile name.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param info: Contains information about the TLS Profile configuration.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
    ...
    class ListResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param profiles: Defines the list of available standard TLS Profiles.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
