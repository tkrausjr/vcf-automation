...
class Proxy(VapiInterface):
    """
    The ``Proxy`` class provides methods Proxy configuration.
    This class was added in **vSphere API 6.7**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.proxy'
    """
    ...
    class Config(VapiStruct):
        """
        The ``Proxy.Config`` class defines proxy configuration.
        This class was added in **vSphere API 6.7**.
    ...
    class TestResult(VapiStruct):
        ...
        operation done on a proxy server.
        This class was added in **vSphere API 6.7**.
...
class NoProxy(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.no_proxy'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def set(self,
        ...
        proxy (even if they are not explicitly configured).
        This method was added in **vSphere API 6.7**.
...
class Interfaces(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.networking.interfaces'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'firewall': 'com.vmware.appliance.networking.firewall_client.StubFactory',
