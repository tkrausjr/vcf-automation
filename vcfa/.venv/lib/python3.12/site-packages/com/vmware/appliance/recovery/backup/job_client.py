...
class Details(VapiInterface):
    ...
    class Type(Enum):
        """
        The ``Details.Type`` class defines the type of backup job.
    ...
    Type._set_values({
        ...
        'MANUAL': Type('MANUAL'),
        'LOCAL_BACKUP': Type('LOCAL_BACKUP'),
    })
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param duration: Time in seconds since the backup job was started or the time it
                took to complete the backup job.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param size: Size of the backup data transferred to remote location.
                This attribute was added in **vSphere API 6.7**.
                This attribute is optional and it is only relevant when the value
                of ``CommonInfo#status`` is one of
                :attr:`com.vmware.cis.task_client.Status.SUCCEEDED`,
            ...
            :param build: Information about the build of the appliance.
    ...
    class FilterSpec(VapiStruct):
        ...
        results when listing backup jobs details (see :func:`Details.list`).
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param jobs: Identifiers of backup jobs that can match the filter.
                This attribute was added in **vSphere API 6.7**.
                When clients pass a value of this class as a parameter, the
    ...
    class BuildInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param version_name: Appliance product type, for example 6.8.2 GA
                This attribute was added in **vSphere API 6.7.2**.
            :type  version: :class:`str`
            :param version: Appliance version, for example 6.8.2.10000
                This attribute was added in **vSphere API 6.7.2**.
            :type  build_number: :class:`str`
            :param build_number: Build Number of the appliance
                This attribute was added in **vSphere API 6.7.2**.
            """
