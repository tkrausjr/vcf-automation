...
class Configs(VapiInterface):
    ...
    def __init__(self, config):
        ...
        """
        warn('com.vmware.appliance.infraprofile.Configs is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class ValidationStatus(Enum):
        ...
        def __init__(self, string):
            ...
            """
            warn('com.vmware.appliance.infraprofile.Configs.ValidationStatus is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class ProfileInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.appliance.infraprofile.Configs.ProfileInfo is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.name = name
            self.info = info
            VapiStruct.__init__(self)
    ...
    class ProfilesSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.appliance.infraprofile.Configs.ProfilesSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class ImportProfileSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param profile_spec: The profile specification, if any
                ...
                import profilespec.
            """
            warn('com.vmware.appliance.infraprofile.Configs.ImportProfileSpec is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    class ValidationResult(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            warn('com.vmware.appliance.infraprofile.Configs.ValidationResult is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
            self.status = status
            self.notifications = notifications
            VapiStruct.__init__(self)
    ...
    def list(self):
        ...
        """
        warn('com.vmware.appliance.infraprofile.Configs.list is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
    ...
    def export(self,
        ...
        :param spec:             information to export the profile.
        :rtype: :class:`str`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires ``Infraprofile.Read``.
        """
        warn('com.vmware.appliance.infraprofile.Configs.export is deprecated as of release vSphere API 9.0.0.0.', DeprecationWarning)
...
class _ConfigsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        export_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/appliance/infraprofile/configs?action=export',
        ...
        validate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/appliance/infraprofile/configs?action=validate',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        import_profile_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/appliance/infraprofile/configs?action=import',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'import_profile$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
