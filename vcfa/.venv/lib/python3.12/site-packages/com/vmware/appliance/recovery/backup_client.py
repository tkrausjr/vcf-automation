...
class LocationSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        :param location: Backup location URL.
...
class Job(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.recovery.backup.job'
    """
    ...
    ReturnStatus._set_values({
        'FAIL': ReturnStatus('FAIL'),
        'WARNING': ReturnStatus('WARNING'),
        'OK': ReturnStatus('OK'),
    })
    ...
    LocationType._set_values({
        ...
        'FTPS': LocationType('FTPS'),
        'HTTPS': LocationType('HTTPS'),
        'SCP': LocationType('SCP'),
    ...
    BackupRestoreProcessState._set_values({
        'FAILED': BackupRestoreProcessState('FAILED'),
        'INPROGRESS': BackupRestoreProcessState('INPROGRESS'),
        'NONE': BackupRestoreProcessState('NONE'),
        'SUCCEEDED': BackupRestoreProcessState('SUCCEEDED'),
    })
    ...
    class BackupRequest(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  fast_backup: :class:`bool` or ``None``
            :param fast_backup: Option to enable Postgres DB/ VCDB fast backup
                If None backup will proceed at slow rate
            """
            self.parts = parts
    ...
    BackupRequest._set_binding_type(type.StructType(
        'com.vmware.appliance.recovery.backup.job.backup_request', {
            ...
            'fast_backup': type.OptionalType(type.BooleanType()),
        },
        BackupRequest,
        False,
        None))
...
class Parts(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.recovery.backup.parts'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class Part(VapiStruct):
        ...
        def __init__(self,
            ...
            :param standalone: This flag will be ``true`` if this part can be restored
                independently of an entire VCSA restore
...
class Schedules(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.recovery.backup.schedules'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class DayOfWeek(Enum):
        ...
        :attr:`Schedules.RecurrenceInfo.days`.
    ...
    class CreateSpec(VapiStruct):
        ...
        information, encryption password and enable flag.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param parts: List of optional parts to be backed up. Use the :func:`Parts.list`
                method to get information about the supported parts.
                This attribute was added in **vSphere API 6.7**.
...
class SystemName(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.appliance.recovery.backup.system_name'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'FeatureInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'run': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'FeatureInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
