...
class Archive(VapiInterface):
    """
    The ``Archive`` class provides methods to get the backup information.
    ...
    class Info(VapiStruct):
        """
        The ``Archive.Info`` class represents backup archive information.
        This class was added in **vSphere API 6.7**.
        ...
        def __init__(self,
            ...
            :param version: The version of the appliance represented by the backup.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param comment: Custom comment added by the user for this backup.
                This attribute was added in **vSphere API 6.7**.
            """
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  timestamp: :class:`datetime.datetime`
            :param timestamp: Time when this backup was started.
                This attribute was added in **vSphere API 6.7**.
            :type  version: :class:`str`
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param max_results: Limit result to a max count of most recent backups.
                This attribute was added in **vSphere API 6.7**.
