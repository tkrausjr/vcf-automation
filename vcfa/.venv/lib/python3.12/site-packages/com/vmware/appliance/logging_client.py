...
class Forwarding(VapiInterface):
    ...
    class Config(VapiStruct):
        ...
        forwarding to remote logging servers.
        This class was added in **vSphere API 6.7**.
    ...
    class ConnectionStatus(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  hostname: :class:`str`
            :param hostname: FQDN or IP address of the configured remote logging servers.
                This attribute was added in **vSphere API 6.7**.
            :type  state: :class:`Forwarding.ConnectionStatus.State`
            :param state: State of the configured remote logging server.
                This attribute was added in **vSphere API 6.7**.
        ...
        class State(Enum):
            ...
            that a remote logging server can be in.
            This enumeration was added in **vSphere API 6.7**.
    ...
    def test(self,
        ...
        is a diagnostic log test message from vCenter Server."
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'UnableToAllocateResource'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
