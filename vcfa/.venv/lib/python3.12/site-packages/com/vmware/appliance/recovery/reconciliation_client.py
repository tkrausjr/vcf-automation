...
class Job(VapiInterface):
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param sso_admin_user_password: Password for SSO admin user.
                This attribute was added in **vSphere API 6.7**.
                If None SSO authentication will not be used. If the vCenter Server
                is a management node or an embedded node, authentication is
                required.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param target: Identifier of the target resource the operation modifies.
                This attribute was added in **vSphere API 6.7**.
            ...
            :param error: Description of the error if the operation status is "FAILED".
                ...
                included in the result of the operation (see Info#result).
            ...
            :param messages: A list of localized messages.
                This attribute was added in **vSphere API 6.7**.
            :type  progress: :class:`long`
            :param progress: The progress of the job as a percentage.
                This attribute was added in **vSphere API 6.7**.
            """
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'FeatureInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
