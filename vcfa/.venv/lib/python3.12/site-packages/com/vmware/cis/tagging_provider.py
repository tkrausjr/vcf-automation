...
#
# vAPI skeleton file for package com.vmware.cis.tagging.
#---------------------------------------------------------------------------
...
class Category(VapiInterface):
    ...
    def __init__(self, error_types=None):
        VapiInterface.__init__(self, CategorySkeleton,
    ...
    def create(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_provider.AlreadyExists` 
            if the :attr:`Category.CreateSpec.name` provided in the
            ``create_spec`` is the name of an already existing category.
        :raise: :class:`com.vmware.vapi.std.errors_provider.InvalidArgument` 
    ...
    def revoke_propagating_permissions(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('revoke_propagating_permissions', 'Category'))
...
class Tag(VapiInterface):
    ...
    def __init__(self, error_types=None):
        VapiInterface.__init__(self, TagSkeleton,
                               error_types=error_types)
    ...
    def revoke_propagating_permissions(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('revoke_propagating_permissions', 'Tag'))
...
class TagAssociation(VapiInterface):
    ...
    def __init__(self, error_types=None):
        VapiInterface.__init__(self, TagAssociationSkeleton,
                               error_types=error_types)
    ...
    class BatchResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  error_messages: :class:`list` of :class:`com.vmware.vapi.std_provider.LocalizableMessage`
    ...
    BatchResult._set_binding_type(type.StructType(
        'com.vmware.cis.tagging.tag_association.batch_result', {
            ...
            'error_messages': type.ListType(type.ReferenceType('com.vmware.vapi.std_provider', 'LocalizableMessage')),
        },
        BatchResult,
        False,
        None))
    ...
    class TagToObjects(VapiStruct):
        ...
        def __init__(self,
            ...
            :param tag_id: The identifier of the tag.
                ...
                class as a return value, the attribute will be an identifier for
                the resource type: ``com.vmware.cis.tagging.Tag``.
            :type  object_ids: :class:`list` of :class:`com.vmware.vapi.std_provider.DynamicID`
    ...
    TagToObjects._set_binding_type(type.StructType(
        'com.vmware.cis.tagging.tag_association.tag_to_objects', {
            ...
            'object_ids': type.ListType(type.ReferenceType('com.vmware.vapi.std_provider', 'DynamicID')),
        },
        TagToObjects,
        False,
        None))
    ...
    class ObjectToTags(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  object_id: :class:`com.vmware.vapi.std_provider.DynamicID`
    ...
    ObjectToTags._set_binding_type(type.StructType(
        'com.vmware.cis.tagging.tag_association.object_to_tags', {
            'object_id': type.ReferenceType('com.vmware.vapi.std_provider', 'DynamicID'),
    ...
    def attach_multiple_tags_to_object(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('attach_multiple_tags_to_object', 'TagAssociation'))
    ...
    def attach_tag_to_multiple_objects(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('attach_tag_to_multiple_objects', 'TagAssociation'))
    ...
    def detach_multiple_tags_from_object(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('detach_multiple_tags_from_object', 'TagAssociation'))
    ...
    def detach_tag_from_multiple_objects(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('detach_tag_from_multiple_objects', 'TagAssociation'))
    ...
    def list_attached_objects(self,
        ...
        :param tag_id: The identifier of the input tag.
            The parameter must be an identifier for the resource type:
            ``com.vmware.cis.tagging.Tag``.
        :rtype: :class:`list` of :class:`com.vmware.vapi.std_provider.DynamicID`
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('list_attached_objects', 'TagAssociation'))
    ...
    def list_attached_objects_on_tags(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('list_attached_objects_on_tags', 'TagAssociation'))
    ...
    def list_attached_tags(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('list_attached_tags', 'TagAssociation'))
    ...
    def list_attached_tags_on_objects(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('list_attached_tags_on_objects', 'TagAssociation'))
    ...
    def list_attachable_tags(self,
        ...
        """
        raise NotImplementedError('Method %s in class %s is not implemented' %
                                  ('list_attachable_tags', 'TagAssociation'))




class CategorySkeleton(ApiInterfaceSkeleton):
    def __init__(self, impl, error_types):
        ...
        create_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'AlreadyExists'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'InvalidArgument'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
        ]
        ...
        delete_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        list_used_categories_error_list = []
        ...
        remove_from_used_by_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
        ]
        ...
        revoke_propagating_permissions_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
        ]
        ...
        operations = {
            ...
            'list_used_categories': {
                ...
                'output_type': type.ListType(type.IdType()),
                'errors': list_used_categories_error_list,
            ...
            'add_to_used_by': {
                ...
                'output_type': type.VoidType(),
                'errors': add_to_used_by_error_list,
            ...
            'remove_from_used_by': {
                ...
                'output_type': type.VoidType(),
                'errors': remove_from_used_by_error_list,
            ...
            'revoke_propagating_permissions': {
                ...
                'output_type': type.VoidType(),
                'errors': revoke_propagating_permissions_error_list,
...
class TagSkeleton(ApiInterfaceSkeleton):
    def __init__(self, impl, error_types):
        ...
        list_tags_for_category_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
        ]
        ...
        operations = {
            ...
            'list_used_tags': {
                ...
                'output_type': type.ListType(type.IdType()),
                'errors': list_used_tags_error_list,
            ...
            'list_tags_for_category': {
                ...
                'output_type': type.ListType(type.IdType()),
                'errors': list_tags_for_category_error_list,
        ...
        ApiInterfaceSkeleton.__init__(self,
                                      iface_name='com.vmware.cis.tagging.tag',
                                      impl=impl,
                                      operations=operations,
                                      error_types=error_types)


class TagAssociationSkeleton(ApiInterfaceSkeleton):
    def __init__(self, impl, error_types):
        ...
        attach_multiple_tags_to_object_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        attach_tag_to_multiple_objects_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        detach_multiple_tags_from_object_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        detach_tag_from_multiple_objects_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        list_attached_objects_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'NotFound'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        list_attached_objects_on_tags_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        list_attached_tags_on_objects_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        list_attachable_tags_error_list = [
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthorized'),
            type.ReferenceType('com.vmware.vapi.std.errors_provider', 'Unauthenticated'),
        ]
        ...
        operations = {
            ...
            'attach_multiple_tags_to_object': {
                ...
                'errors': attach_multiple_tags_to_object_error_list,
            ...
            'attach_tag_to_multiple_objects': {
                ...
                'output_type': type.ReferenceType(__name__, 'TagAssociation.BatchResult'),
                'errors': attach_tag_to_multiple_objects_error_list,
            ...
            'detach_multiple_tags_from_object': {
                ...
                'output_type': type.ReferenceType(__name__, 'TagAssociation.BatchResult'),
                'errors': detach_multiple_tags_from_object_error_list,
            ...
            'detach_tag_from_multiple_objects': {
                ...
                'output_type': type.ReferenceType(__name__, 'TagAssociation.BatchResult'),
                'errors': detach_tag_from_multiple_objects_error_list,
            ...
            'list_attached_objects': {
                ...
                'output_type': type.ListType(type.ReferenceType('com.vmware.vapi.std_provider', 'DynamicID')),
                'errors': list_attached_objects_error_list,
            ...
            'list_attached_objects_on_tags': {
                ...
                'errors': list_attached_objects_on_tags_error_list,
            ...
            'list_attached_tags': {
                ...
                'output_type': type.ListType(type.IdType()),
                'errors': list_attached_tags_error_list,
            ...
            'list_attached_tags_on_objects': {
                ...
                'errors': list_attached_tags_on_objects_error_list,
            ...
            'list_attachable_tags': {
                ...
                'output_type': type.ListType(type.IdType()),
                'errors': list_attachable_tags_error_list,
