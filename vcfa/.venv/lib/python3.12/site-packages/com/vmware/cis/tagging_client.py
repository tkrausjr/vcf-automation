...
class Category(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.cis.tagging.category'
    """
...
class Tag(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.cis.tagging.tag'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class TagAssociation(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.cis.tagging.tag_association'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class BatchResult(VapiStruct):
        ...
        the same method on several tags or objects in a single invocation.
        This class was added in **vSphere API 6.5**.
        ...
        def __init__(self,
            ...
            :param success: This is true if the batch method completed without any errors.
                ...
                This attribute was added in **vSphere API 6.5**.
            :type  error_messages: :class:`list` of :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param error_messages: The :class:`list` of error messages.
                This attribute was added in **vSphere API 6.5**.
            """
    ...
    class TagToObjects(VapiStruct):
        ...
        def __init__(self,
            ...
            :param object_ids: The identifiers of the related objects.
                This attribute was added in **vSphere API 6.5**.
            """
            self.tag_id = tag_id
    ...
    class ObjectToTags(VapiStruct):
        ...
        def __init__(self,
            ...
            :param tag_ids: The identifiers of the related tags.
                This attribute was added in **vSphere API 6.5**.
                When clients pass a value of this class as a parameter, the
    ...
    def attach_multiple_tags_to_object(self,
        ...
        privilege on each tag.
        This method was added in **vSphere API 6.5**.
    ...
    def list_attached_tags_on_objects(self,
        ...
        contain those tags for which you have the read privilege.
        This method was added in **vSphere API 6.5**.
...
class _CategoryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/category',
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/cis/tagging/category/{categoryId}',
            path_variables={
        ...
        list_used_categories_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/category?action=list-used-categories',
            path_variables={
            },
            query_parameters={
            },
            dispatch_parameters={
                'action': 'list-used-categories',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        add_to_used_by_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/category/{categoryId}?action=add-to-used-by',
            path_variables={
                'category_id': 'categoryId',
            },
            query_parameters={
        ...
        remove_from_used_by_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/category/{categoryId}?action=remove-from-used-by',
            path_variables={
                'category_id': 'categoryId',
            },
            query_parameters={
        ...
        revoke_propagating_permissions_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/category/{categoryId}?action=revoke-propagating-permissions',
            path_variables={
                'category_id': 'categoryId',
            },
            query_parameters={
            ...
            dispatch_parameters={
                'action': 'revoke-propagating-permissions',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
...
class _TagStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/cis/tagging/tag/{tagId}',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        list_used_tags_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag?action=list-used-tags',
            path_variables={
            },
            query_parameters={
            },
            dispatch_parameters={
                'action': 'list-used-tags',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        list_tags_for_category_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag?action=list-tags-for-category',
            path_variables={
            },
            query_parameters={
            },
        ...
        add_to_used_by_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag/{tagId}?action=add-to-used-by',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        remove_from_used_by_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag/{tagId}?action=remove-from-used-by',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        revoke_propagating_permissions_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag/{tagId}?action=revoke-propagating-permissions',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
...
class _TagAssociationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        attach_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association/{tagId}?action=attach',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        attach_multiple_tags_to_object_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=attach-multiple-tags-to-object',
            path_variables={
            },
            query_parameters={
            },
            dispatch_parameters={
                'action': 'attach-multiple-tags-to-object',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        attach_tag_to_multiple_objects_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association/{tagId}?action=attach-tag-to-multiple-objects',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
            ...
            dispatch_parameters={
                'action': 'attach-tag-to-multiple-objects',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        detach_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association/{tagId}?action=detach',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        detach_multiple_tags_from_object_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=detach-multiple-tags-from-object',
            path_variables={
            },
            query_parameters={
            },
            dispatch_parameters={
                'action': 'detach-multiple-tags-from-object',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        detach_tag_from_multiple_objects_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association/{tagId}?action=detach-tag-from-multiple-objects',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
            ...
            dispatch_parameters={
                'action': 'detach-tag-from-multiple-objects',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        list_attached_objects_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association/{tagId}?action=list-attached-objects',
            path_variables={
                'tag_id': 'tagId',
            },
            query_parameters={
        ...
        list_attached_objects_on_tags_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=list-attached-objects-on-tags',
            path_variables={
            },
            query_parameters={
            },
        ...
        list_attached_tags_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=list-attached-tags',
            path_variables={
            },
            query_parameters={
            },
        ...
        list_attached_tags_on_objects_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=list-attached-tags-on-objects',
            path_variables={
            },
            query_parameters={
            },
        ...
        list_attachable_tags_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/cis/tagging/tag-association?action=list-attachable-tags',
            path_variables={
            },
            query_parameters={
            },
            dispatch_parameters={
                'action': 'list-attachable-tags',
            },
            header_parameters={
            },
            dispatch_header_parameters={
        ...
        operations = {
            'attach': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'attach_multiple_tags_to_object': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'list_attached_objects_on_tags': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
