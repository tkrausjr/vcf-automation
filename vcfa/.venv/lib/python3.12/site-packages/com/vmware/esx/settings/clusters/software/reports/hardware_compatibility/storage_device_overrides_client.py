...
class ComplianceStatus(VapiInterface):
    ...
    class ComplianceAction(Enum):
        ...
        compliance status overrides for a storage device.
        ...
        compatibility issues if any, and treat the drive as compliant with Broadcom
        Compatibility Guide (BCG)

        """
        FLAG_AS_INCOMPATIBLE = None
        """
        Specifying this override for a storage device would flag the drive as
        non-compliant with Broadcom Compatibility Guide (BCG)
    ...
    class Service(Enum):
        ...
        services that have service specific Broadcom Compatibility Guide
        certification
    ...
    class Key(VapiStruct):
        ...
        device for which this override must be applied to.
        This class was added in **vSphere API 7.0.2.1**.
        ...
        def __init__(self,
            ...
            :param model: This attribute was added in **vSphere API 7.0.2.1**.
            :type  vendor: :class:`str`
            :param vendor: This attribute was added in **vSphere API 7.0.2.1**.
            :type  capacity: :class:`long`
            :param capacity: This attribute was added in **vSphere API 7.0.2.1**.
            :type  part_number: :class:`str` or ``None``
            :param part_number: storage device part number
            ...
            :param firmware_version: storage device firmware version
                This attribute was added in **vSphere API 7.0.2.1**.
                If None the override is applied to the entries with an unknown
                firmware version.
            :type  driver_name: :class:`str` or ``None``
            :param driver_name: Driver name of this storage device if applicable/available.
            ...
            :param driver_version: Driver version of this storage device if applicable/available.
                This attribute was added in **vSphere API 8.0.0.1**.
                This attribute will be None if there is no driver associated with
                the device.
            :type  release: :class:`str` or ``None``
            :param release: vSphere release that an override must be applied to.
                This attribute was added in **vSphere API 7.0.2.1**.
            ...
            :param validated_features_in_use: Validated features for which this override applies If a service is
                ...
                taken to be in use by the service.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class ReclassificationSpec(VapiStruct):
        ...
        overall set of overrides applicable to a given storage device
        This class was added in **vSphere API 7.0.2.1**.
        ...
        def __init__(self,
            ...
            :param override: Compliance status override for the stroage device.
                This attribute was added in **vSphere API 7.0.2.1**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        to the compatibility overrides for storage devices in a cluster.
        This class was added in **vSphere API 7.0.2.1**.
    ...
    def update_task(self,
        ...
        method is invoked.
        This method was added in **vSphere API 7.0.2.1**.
...
class VcgEntries(VapiInterface):
    """
    This class provides methods to manage Broadcom Compatibility Guide (BCG)
    product overrides for storage devices in a cluster.
    This class was added in **vSphere API 7.0.2.1**.
    """
    ...
    class Key(VapiStruct):
        ...
        for which this override must be applied to.
        This class was added in **vSphere API 7.0.2.1**.
    ...
    class ProductSelectionSpec(VapiStruct):
        ...
        the storage device and the corresponding Broadcom Compatibility Guide (BCG)
        product override that must be applied to the specified device.
        This class was added in **vSphere API 7.0.2.1**.
        ...
        def __init__(self,
            ...
            :param vcg_product: Broadcom Compatibility Guide (BCG) product selection that must be
                applied to the specified storage device.
                This attribute was added in **vSphere API 7.0.2.1**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        compatibility overrides for storage devices in a cluster.
        This class was added in **vSphere API 7.0.2.1**.
        ...
        def __init__(self,
            ...
            :param product_selections: List of Broadcom Compatibility Guide (BCG) overrides to be applied
                for the storage devices in a cluster.
                This attribute was added in **vSphere API 7.0.2.1**.
            """
    ...
    def update_task(self,
        ...
        """
        Updates the storage device Broadcom Compatibility Guide (BCG) product
    ...
    def __init__(self, config):
        ...
        operations = {
            'update$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
