...
#
# vAPI stub file for package com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.
#---------------------------------------------------------------------------

"""
The
``com.vmware.esx.settings.clusters.software.drafts.software.alternative_images_client``
module provides classes to manage alternative images for the given draft.
...
class DisplayName(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.display_name'
    """
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.display_name.info', {
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.display_name.set_spec', {
            'display_name': type.StringType(),
        },
        SetSpec,
        False,
...
class SelectionCriteria(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.selection_criteria'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _DisplayNameStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/display-name',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.display_name',
...
class _SelectionCriteriaStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/selection-criteria',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.selection_criteria',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'software': 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software_client.StubFactory',
    }
