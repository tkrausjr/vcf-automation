...
class LastComplianceResult(VapiInterface):
    ...
    available check compliance result for the cluster.
    This class was added in **vSphere API 8.0.1.0**.
    """
...
class RecentTasks(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        finished task will be returned.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param check_compliance: The ID of the last check-compliance task to be executed.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.cis.task``. When methods return a value of this class
                ...
                resource type: ``com.vmware.cis.task``.
            :type  precheck: :class:`str` or ``None``
            :param precheck: The ID of the last precheck task to be executed.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.cis.task``. When methods return a value of this class
            ...
            :param draft_tasks: Map of draft IDs to the latest tasks executed for that draft.
                This attribute was added in **vSphere API 8.0.1.0**.
            ...
            :param apply: The ID of the last apply task to be executed.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.cis.task``. When methods return a value of this class
