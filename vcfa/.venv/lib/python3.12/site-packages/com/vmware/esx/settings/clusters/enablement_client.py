...
class Configuration(VapiInterface):
    ...
    is managed using desired configuration platform semantics.
...
class Software(VapiInterface):
    ...
    class CheckType(Enum):
        ...
        manage any vSAN witness hosts in the cluster.
...
class _SoftwareStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/software?action=check',
