...
class AffectedBaselineInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param baseline: Name of the baseline affected.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  id: :class:`long`
        :param id: Identifier of the baseline affected.
            This attribute was added in **vSphere API 7.0.3.0**.
        ...
        :param affected_updates: Updates (bulletins) affected. They key is identifier of the update
            (bulletin). The value is summary of the update (bulletin).
            This attribute was added in **vSphere API 7.0.3.0**.
...
class AffectedDesiredStateInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param cluster_name: 
            ...
            Since now we have standalone host, we use {#member entityName}
            {#member entityId} to better describe name/id of either cluster or
            standalone host. 
            ...
            .. deprecated:: vSphere API 8.0.0.1
                This attribute is deprecated as of **vSphere API 8.0.0.1**.
        :type  cluster_id: :class:`str`
        :param cluster_id: Identifier of the cluster the affected desired state belongs to.
            This attribute was added in **vSphere API 7.0.3.0**.
            ...
            .. deprecated:: vSphere API 8.0.0.1
                This attribute is deprecated as of **vSphere API 8.0.0.1**. Use
                {#member entityId} instead
        :type  entity_name: :class:`str`
        :param entity_name: Name of the entity the affected desired state belongs to.
        ...
        :param entity_id: Identifier of the entity the affected desired state belongs to.
            This attribute was added in **vSphere API 8.0.0.1**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ``ManagedEntity``. When methods return a value of this class as a
            ...
            .. deprecated:: vSphere API 9.0.0.0
                This attribute is deprecated as of **vSphere API 9.0.0.0**.
        :type  software_spec_name: :class:`str`
        :param software_spec_name: Name of the affected software specification.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  software_spec: :class:`str`
        :param software_spec: Identifier of the affected software specification.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ...
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  entity_names: :class:`set` of :class:`str`
        :param entity_names: Names of the entities the affected software specification
            associates with.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  entities: :class:`set` of :class:`str`
        :param entities: Identifiers of the entities the affected software specification
            associates with.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the
            ...
            resource type: ``ManagedEntity``.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  affected_base_image: :class:`BaseImageVersion` or ``None``
        :param affected_base_image: Affected base image of the desired state.
            This attribute was added in **vSphere API 7.0.3.0**.
        ...
        :param affected_addon: Affected addon of the desired state. The key is name of addon.
            Note: there is at most one addon affected.
            This attribute was added in **vSphere API 7.0.3.0**.
            When clients pass a value of this class as a parameter, the key in
            the attribute :class:`dict` must be an identifier for the resource
        ...
        self.software_spec_name = software_spec_name
...
AffectedDesiredStateInfo._set_binding_type(type.StructType(
    'com.vmware.esx.settings.depots.affected_desired_state_info', {
        ...
        'entity_id': type.OptionalType(type.IdType()),
        'software_spec_name': type.OptionalType(type.StringType()),
        'software_spec': type.OptionalType(type.IdType()),
        'entity_names': type.OptionalType(type.SetType(type.StringType())),
        'entities': type.OptionalType(type.SetType(type.IdType())),
...
class UpdateSummary(VapiStruct):
    ...
    def __init__(self,
        ...
        :param summary: Summary of the update (bulletin).
            This attribute was added in **vSphere API 7.0.3.0**.
        """
...
class BaseImageVersion(VapiStruct):
    ...
    def __init__(self,
        ...
        :param display_name: Human readable name of the base image.
            This attribute was added in **vSphere API 7.0.3.0**.
...
class AddonVersion(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  version: :class:`str`
        :param version: Version of the addon.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  display_version: :class:`str`
        :param display_version: Human readable version of the addon.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.version = version
        self.display_version = display_version
...
class AddonSummary(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  display_name: :class:`str`
        :param display_name: Human readable name of the addon.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  vendor: :class:`str`
        :param vendor: Vendor of the addon.
            This attribute was added in **vSphere API 7.0.3.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
        ...
        :param versions: Different versions of the addon.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.display_name = display_name
        self.vendor = vendor
...
class HardwareSupportPackageVersion(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  version: :class:`str`
        :param version: Version of the HSP.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.version = version
        VapiStruct.__init__(self)
...
class HardwareSupportPackageSummary(VapiStruct):
    ...
    def __init__(self,
        ...
        :param versions: Different versions of the HSP.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.versions = versions
        VapiStruct.__init__(self)
...
class ComponentSummary(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  display_name: :class:`str`
        :param display_name: Human readable name of the component.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  versions: :class:`list` of :class:`ComponentVersion`
        :param versions: Different versions of the component.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.display_name = display_name
        self.versions = versions
...
class VibInfo(VapiStruct):
    """
    The ``VibInfo`` class contains fields that describe the information of a
    VIB.
    ...
    def __init__(self,
        ...
        """
        :type  software_tags: :class:`list` of :class:`str`
        :param software_tags: List of software tags that may be used for information or filtering
            This attribute was added in **vSphere API 9.0.0.0**.
        """
        self.software_tags = software_tags
        VapiStruct.__init__(self)


VibInfo._set_binding_type(type.StructType(
    'com.vmware.esx.settings.depots.vib_info', {
        'software_tags': type.ListType(type.StringType()),
    },
    VibInfo,
    False,
    None))
...
class SolutionComponentSummary(VapiStruct):
    """
    The ``SolutionComponentSummary`` class contains fields that describe the
    ...
    def __init__(self,
                 release_date=None,
                 version=None,
                 vib_informations=None,
                ):
        """
        :type  release_date: :class:`datetime.datetime`
        :param release_date: Release date of the component.
            This attribute was added in **vSphere API 9.0.0.0**.
        :type  version: :class:`ComponentVersion`
        :param version: Version of the component.
            This attribute was added in **vSphere API 9.0.0.0**.
        :type  vib_informations: (:class:`dict` of :class:`str` and :class:`VibInfo`) or ``None``
        :param vib_informations: All the VIBs contained in the component of the metadata bundle. The
            key is ID of the VIB.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the key in
            the attribute :class:`dict` must be an identifier for the resource
            type: ``com.vmware.esx.settings.vib``. When methods return a value
            of this class as a return value, the key in the attribute
            :class:`dict` will be an identifier for the resource type:
            ``com.vmware.esx.settings.vib``.
            This attribute is optional because it was added in a newer version
            than its parent node.
        """
        self.release_date = release_date
        self.version = version
        self.vib_informations = vib_informations
        VapiStruct.__init__(self)


SolutionComponentSummary._set_binding_type(type.StructType(
    'com.vmware.esx.settings.depots.solution_component_summary', {
        'release_date': type.DateTimeType(),
        'version': type.ReferenceType(__name__, 'ComponentVersion'),
        'vib_informations': type.OptionalType(type.MapType(type.IdType(), type.ReferenceType(__name__, 'VibInfo'))),
    },
...
class SolutionVersion(VapiStruct):
    ...
    def __init__(self,
        ...
        :param version: Version of the solution.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  display_version: :class:`str`
        :param display_version: Human readable version of the solution.
            This attribute was added in **vSphere API 7.0.3.0**.
        """
        self.version = version
        self.display_version = display_version
...
class SolutionSummary(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  display_name: :class:`str`
        :param display_name: Human readable name of the solution.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  versions: :class:`list` of :class:`SolutionVersion`
        :param versions: Different versions of the solution.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  components: (:class:`dict` of :class:`str` and :class:`SolutionComponentSummary`) or ``None``
        :param components: All the components contained in the solution of the metadata
            bundle. The key is ID of component.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the key in
            the attribute :class:`dict` must be an identifier for the resource
            type: ``com.vmware.esx.settings.component``. When methods return a
...
SolutionSummary._set_binding_type(type.StructType(
    'com.vmware.esx.settings.depots.solution_summary', {
        ...
        'components': type.OptionalType(type.MapType(type.IdType(), type.ReferenceType(__name__, 'SolutionComponentSummary'))),
    },
    SolutionSummary,
    False,
    None))
...
class MetadataInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param file_name: File name of the metadata bundle.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  base_images: :class:`list` of :class:`BaseImageVersion` or ``None``
        :param base_images: All the base images contained in the metadata bundle.
            This attribute was added in **vSphere API 7.0.3.0**.
...
class Offline(VapiInterface):
    ...
    class AuthenticationSpec(VapiStruct):
        """
        The ``Offline.AuthenticationSpec`` class contains attributes that describe
        the authentication to be used for connecting to the remote depot.  method.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        _validator_list = [
            UnionValidator(
                'method',
                {
                    'HEADER_AUTH' : [('authentication_key', True), ('authentication_value', True)],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            """
            :type  method: :class:`Offline.AuthenticationSpec.AuthenticationMethod`
            :param method: Specifies what method of authentication (HEADER_AUTH) is to be used
                when connecting to remote depot.
                This attribute was added in **vSphere API 9.0.0.0**.
            :type  authentication_key: :class:`str`
            :param authentication_key: Specifies the authentication key to be used during the
                :func:`Offline.create` PULL method.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``method`` is
                :attr:`Offline.AuthenticationSpec.AuthenticationMethod.HEADER_AUTH`.
            :type  authentication_value: :class:`str`
            :param authentication_value: Specifies the authentication value of the authentication key to be
                used during the :func:`Offline.create` PULL method.
                This attribute was added in **vSphere API 9.0.0.0**.
                This attribute is optional and it is only relevant when the value
                of ``method`` is
                :attr:`Offline.AuthenticationSpec.AuthenticationMethod.HEADER_AUTH`.
        ...
        class AuthenticationMethod(Enum):
            """
            The ``Offline.AuthenticationSpec.AuthenticationMethod`` class defines the
            possible methods of authentication supported when connecting to the remote
            depot.
            ...
            HEADER_AUTH = None
            """
            HEADER_AUTH is intended to be used when connecting to a remote depot
        ...
        AuthenticationMethod._set_values({
            'HEADER_AUTH': AuthenticationMethod('HEADER_AUTH'),
        })
        AuthenticationMethod._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.depots.offline.authentication_spec.authentication_method',
            AuthenticationMethod))

    AuthenticationSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.offline.authentication_spec', {
            'method': type.ReferenceType(__name__, 'Offline.AuthenticationSpec.AuthenticationMethod'),
            'authentication_key': type.OptionalType(type.StringType()),
            'authentication_value': type.OptionalType(type.StringType()),
        },
        AuthenticationSpec,
        False,
        None))
    ...
    class CreateSpec(VapiStruct):
        ...
        _validator_list = [
            UnionValidator(
                'source_type',
                {
                    'PULL' : [('authentication_spec', False), ('location', True)],
                    'PUSH' : [('file_id', True)],
                }
            ),
        ]
        ...
        def __init__(self,
            ...
            """
            :type  authentication_spec: :class:`Offline.AuthenticationSpec` or ``None``
            :param authentication_spec: Describe the authentication to be used for connecting to the remote
                depot.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, no authentication will be done.
            ...
            :param ownerdata: Private data saved by the :attr:`Offline.Info.owner` of the depot.
                It is opaque to vLCM.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, no ownerdata will be saved.
            """
            self.authentication_spec = authentication_spec
    ...
    CreateSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.offline.create_spec', {
            'authentication_spec': type.OptionalType(type.ReferenceType(__name__, 'Offline.AuthenticationSpec')),
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param owner: Name of the user creating the depot.
                This attribute was added in **vSphere API 7.0.3.0**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            :type  ownerdata: :class:`str` or ``None``
    ...
    class HostCredentials(VapiStruct):
        ...
        def __init__(self,
            ...
            :param ssl_certificate: Specifies the sslCertificate of the host to be used during
                :func:`Offline.create_from_host` method PEM format of the host's
                SSL certificate.
                This attribute was added in **vSphere API 9.0.0.0**.
    ...
    class DeleteSpec(VapiStruct):
        """
        The ``Offline.DeleteSpec`` class contains the information for depot delete
        or flush operation.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            :param force: Whether to forcibly delete the depot. When it is set, the depot
                data are removed from vCenter regardless of whether they are in use
                or not. Thus, keep in mind the need to add the depot content that
                is used by desired images or baselines before running any operation
                on these desired images or baselines; otherwise, operations will
                fail with depot content missing related errors. 
                
                The suggested workflow is to try to delete without force. After
                understanding what will be affected and how to recover the related
                depot content, delete forcibly.
                This attribute was added in **vSphere API 9.0.0.0**.
                If None, will not perform forcible deletion.
            """
            self.force = force
            VapiStruct.__init__(self)
    ...
    DeleteSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.offline.delete_spec', {
    ...
    class DepotExtractInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param result: The information about the created offline depot. Empty
                ...
                contents are already present in VC cache
                This attribute was added in **vSphere API 7.0.2.0**.
            """
    ...
    class DeleteResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param notifications: Notifications returned by :func:`Offline.delete` method.
                This attribute was added in **vSphere API 7.0.3.0**.
    ...
    def delete(self,
        ...
        :param depot: Identifier of the depot to be removed.
            The parameter must be an identifier for the resource type:
            ``com.vmware.esx.settings.depots.offline``.
        :type  spec: :class:`Offline.DeleteSpec` or ``None``
        :param spec: The delete spec.
    ...
    def create_from_host_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.UnverifiedPeer` 
            ...
            {\\\\@term structure} that contains one of the {\\\\@term fields}
            defined in {\\\\@link com.vmware.esx.hosts.CertificateInfo}.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            if you do not have all of the privileges described as follows: 
...
class Online(VapiInterface):
    ...
    class PrecheckResult(VapiStruct):
        ...
        details of affected baselines and desired states found in
        :func:`Online.delete` or :func:`Online.flush` operation.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    class DeleteSpec(VapiStruct):
        """
        The ``Online.DeleteSpec`` class contains the information for depot delete
        or flush operation.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  force: :class:`bool` or ``None``
            :param force: Whether to forcibly delete or flush the depot. When it is set, the
                depot data are removed from vCenter regardless of whether they are
                in use or not. Thus, keep in mind the need to add the depot content
                that is used by desired images or baselines before running any
                operation on these desired images or baselines; otherwise,
                operations will fail with depot content missing related errors. 
    ...
    DeleteSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.online.delete_spec', {
            'force': type.OptionalType(type.BooleanType()),
        },
        DeleteSpec,
        False,
    ...
    class DeleteResult(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  notifications: :class:`com.vmware.esx.settings_client.Notifications` or ``None``
            :param notifications: Notifications returned by :func:`Online.delete` method.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, no notification is returned.
            """
            self.notifications = notifications
    ...
    class FlushResult(VapiStruct):
        ...
        encountered after starting the task of :func:`Online.flush` method.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            """
            :type  notifications: :class:`com.vmware.esx.settings_client.Notifications` or ``None``
            :param notifications: Notifications returned by :func:`Online.flush` method.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, no notification is returned.
            """
            self.notifications = notifications
    ...
    def delete(self,
        ...
        :param depot: Identifier of the depot to be removed.
            The parameter must be an identifier for the resource type:
            ``com.vmware.esx.settings.depots.online``.
        :type  spec: :class:`Online.DeleteSpec` or ``None``
        :param spec: Spec for depot deletion operation.
            This parameter was added in **vSphere API 9.0.0.0**.
            This parameter is optional because it was added in a newer version
            than its parent node.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
    ...
    def flush_task(self,
        ...
        :param depot: Identifier of the depot to be removed.
            ...
            ``com.vmware.esx.settings.depots.online``.
        :type  spec: :class:`Online.DeleteSpec` or ``None``
        :param spec: Spec for depot flushing operation.
            This parameter was added in **vSphere API 9.0.0.0**.
            This parameter is optional because it was added in a newer version
            than its parent node.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
...
class Umds(VapiInterface):
    ...
    class DeleteResult(VapiStruct):
        ...
        encountered after starting the task of :func:`Umds.delete` method.
        This class was added in **vSphere API 7.0.3.0**.
        ...
        def __init__(self,
            ...
            """
            :type  notifications: :class:`com.vmware.esx.settings_client.Notifications` or ``None``
            :param notifications: Notifications returned by :func:`Umds.delete` method.
                This attribute was added in **vSphere API 7.0.3.0**.
                If None, no notification is returned.
            """
            self.notifications = notifications
...
class _OfflineStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_input_type = type.StructType('operation-input', {
            'depot': type.IdType(resource_types='com.vmware.esx.settings.depots.offline'),
            'spec': type.OptionalType(type.ReferenceType(__name__, 'Offline.DeleteSpec')),
        })
        delete_error_dict = {
            'com.vmware.vapi.std.errors.unauthenticated':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'),
        ...
        create_from_host_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/depots/offline?action=createFromHost',
            request_body_parameter='spec',
            path_variables={
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'create$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'delete': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
...
class _OnlineStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        delete_input_type = type.StructType('operation-input', {
            'depot': type.IdType(resource_types='com.vmware.esx.settings.depots.online'),
            'spec': type.OptionalType(type.ReferenceType(__name__, 'Online.DeleteSpec')),
        })
        delete_error_dict = {
            'com.vmware.vapi.std.errors.unauthenticated':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'),
        ...
        flush_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/depots/online/{depot}?action=flush',
            request_body_parameter='spec',
            path_variables={
                'depot': 'depot',
            },
        ...
        operations = {
            ...
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'set': {
                ...
                'output_type': type.VoidType(),
                'errors': set_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
                'input_value_validator_list': set_input_value_validator_list,
                'output_validator_list': set_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'delete': {
                ...
                'output_type': type.VoidType(),
                'errors': delete_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInUse'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
                'input_value_validator_list': delete_input_value_validator_list,
                'output_validator_list': delete_output_validator_list,
                'task_type': TaskType.TASK,
            },
            ...
            'update': {
                ...
                'output_type': type.VoidType(),
                'errors': update_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
                'input_value_validator_list': update_input_value_validator_list,
                'output_validator_list': update_output_validator_list,
                'task_type': TaskType.NONE,
            },
