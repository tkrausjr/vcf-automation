...
#
# vAPI stub file for package com.vmware.esx.settings.defaults.clusters.policies.
#---------------------------------------------------------------------------

"""
Copyright (c) 2019-2024 Broadcom. All Rights Reserved. Broadcom Confidential.
The term "Broadcom" refers to Broadcom Inc. and/or its subsidiaries.
...
class Apply(VapiInterface):
    ...
    applied to ESXi clusters.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.defaults.clusters.policies.apply'
    """
    ...
    class FailureAction(VapiStruct):
        ...
        Action._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.defaults.clusters.policies.apply.failure_action.action',
            Action))

    FailureAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.defaults.clusters.policies.apply.failure_action', {
    ...
    class ParallelRemediationAction(VapiStruct):
        ...
        def __init__(self,
            ...
            :param max_hosts: Maximum number of hosts that can be remediated in parallel Setting
                ...
                guarantee maxHosts to be remediated in parallel.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
    ...
    ParallelRemediationAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.defaults.clusters.policies.apply.parallel_remediation_action', {
    ...
    class ConfiguredPolicySpec(VapiStruct):
        ...
        specification documents are applied to ESXi clusters.
        ...
        def __init__(self,
            ...
            :param parallel_remediation_action: Enable parallel remediation of hosts in maintenance mode. Set max
                hosts when applicable.
                This attribute was added in **vSphere API 8.0.0.1**.
                If None, parallel remediation will not happen.
            :type  enforce_quick_patch: :class:`bool` or ``None``
            :param enforce_quick_patch: Enforce quick patch on the cluster for images that support it.
                This attribute was added in **vSphere API 8.0.3.0**.
                If None, configured value would be unset.
            :type  config_manager_policy_spec: :class:`com.vmware.esx.settings.clusters.policies_client.ConfigManagerPolicySpec` or ``None``
        ...
        class PreRemediationPowerAction(Enum):
            ...
            the possible actions to be taken on VMs before entering maintenance mode.
        ...
        PreRemediationPowerAction._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.defaults.clusters.policies.apply.configured_policy_spec.pre_remediation_power_action',
            PreRemediationPowerAction))

    ConfiguredPolicySpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.defaults.clusters.policies.apply.configured_policy_spec', {
...
class _ApplyStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/defaults/clusters/policies/apply',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.defaults.clusters.policies.apply',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'Apply': Apply,
        'apply': 'com.vmware.esx.settings.defaults.clusters.policies.apply_client.StubFactory',
    }
