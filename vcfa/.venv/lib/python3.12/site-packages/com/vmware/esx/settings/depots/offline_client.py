...
#
# vAPI stub file for package com.vmware.esx.settings.depots.offline.
#---------------------------------------------------------------------------

"""
The ``com.vmware.esx.settings.depots.offline_client`` module provides classes
...
class Content(VapiInterface):
    """
    The ``Content`` class provides methods to manage offline software depots
    used during ESX lifecycle management.
    This class was added in **vSphere API 7.0.3.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.depots.offline.content'
    """
    ...
    class Info(VapiStruct):
        ...
        metadata bundles of an offline depot.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.offline.content.info', {
    ...
    def get(self,
        ...
        :return: Information of content of the imported offline software depot.
...
class _ContentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/depots/offline/{depot}/content',
            path_variables={
                'depot': 'depot',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.depots.offline.content',
