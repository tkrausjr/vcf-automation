...
class ComplianceStatusDetail(Enum):
    ...
    for compliance with respect to target Broadcom Compatibility Guide (BCG)
    ...
    user to mark the system as compliant

    """
    USER_FLAGGED = None
    """
    When a server or device's HCL compliance status has been overridden by the
    user to mark the system as non-compliant
...
class Service(Enum):
    ...
    have solution specific Broadcom Compatibility Guide certification
    ...
    VSAN = None
    """
    VSAN Service for mapping to features.
...
class ComplianceStatus(Enum):
    ...
    COMPATIBLE = None
    """
    Target hardware is compliant with Broadcom Compatibility Guide (BCG)

    """
    INCOMPATIBLE = None
    """
    Target hardware is not (recognizably) compliant with Broadcom Compatibility
    Guide (BCG)
    ...
    UNAVAILABLE = None
    """
    Target hardware compliance with Broadcom Compatibility Guide (BCG) cannot
    be determined.
...
class FirmwareVersionMatchingCriteria(Enum):
    ...
    EXACT = None
    """
    Firmware version is matched to exact version specified

    """
    MINIMUM = None
    """
    Firmware version is matched to be at least minimum version specified
...
class ImageHostDetails(VapiStruct):
    """
    The ``ImageHostDetails`` class contains details about the image and the
    list of hosts on which it will be applied.
    ...
    def __init__(self,
        ...
        """
        :type  image: :class:`com.vmware.esx.settings_client.ImageInfo` or ``None``
        :param image: This attribute was added in **vSphere API 9.0.0.0**.
            None for the default image.
        :type  hosts: :class:`set` of :class:`str`
        :param hosts: This attribute was added in **vSphere API 9.0.0.0**.
...
ImageHostDetails._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.software.reports.image_host_details', {
        'image': type.OptionalType(type.ReferenceType('com.vmware.esx.settings_client', 'ImageInfo')),
        'hosts': type.SetType(type.IdType()),
    },
    ImageHostDetails,
    False,
    None))
...
class ImageDriverFirmwareDetails(VapiStruct):
    """
    The ``ImageDriverFirmwareDetails`` class contains details about the target
    image, driver and firmware versions for a given PCI device.
    This class was added in **vSphere API 9.0.0.0**.
    ...
    def __init__(self,
                 image_host_details=None,
                 target=None,
                ):
        """
        :type  image_host_details: :class:`ImageHostDetails`
        :param image_host_details: This attribute was added in **vSphere API 9.0.0.0**.
        :type  target: :class:`DriverFirmwareVersion`
        :param target: This attribute was added in **vSphere API 9.0.0.0**.
        """
        self.image_host_details = image_host_details
        self.target = target
        VapiStruct.__init__(self)


ImageDriverFirmwareDetails._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.software.reports.image_driver_firmware_details', {
        'image_host_details': type.ReferenceType(__name__, 'ImageHostDetails'),
        'target': type.ReferenceType(__name__, 'DriverFirmwareVersion'),
    },
    ImageDriverFirmwareDetails,
    False,
    None))
...
class PciDeviceConstraint(VapiStruct):
    ...
    firmware versions and the set of validated features supported
    ...
    def __init__(self,
        ...
        :param firmware_version: Certified Firmware Version.
        ...
        :param supported_features: Map of solutions and the corresponding features that the device is
            certified for in the Broadcom Compatibility Guide If map is empty,
...
class StorageDeviceConstraint(VapiStruct):
    ...
    and/or firmware versions and the set of validated features supported
    This class was added in **vSphere API 8.0.0.1**.
    ...
    def __init__(self,
        ...
        :param driver_name: Certified Driver Name.
            ...
            the device
        :type  driver_version: :class:`str` or ``None``
        :param driver_version: Certified Driver Version.
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute will be None If there is no driver certification for
            the device
        :type  supported_features: :class:`dict` of :class:`Service` and :class:`set` of :class:`str`
...
class PciDeviceComplianceInfo(VapiStruct):
    ...
    def __init__(self,
                 ...
                 host_info=None,
                 target=None,
                 default_image_host_details=None,
                 alternative_image_driver_fw_details=None,
        ...
        :type  target: :class:`DriverFirmwareVersion`
        :param target: Driver and Firmware Version from default image Specification.
        :type  default_image_host_details: :class:`ImageHostDetails`
        :param default_image_host_details: This attribute contains information about the default image and the
            hosts on which it will be applied.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  alternative_image_driver_fw_details: :class:`dict` of :class:`str` and :class:`ImageDriverFirmwareDetails`
        :param alternative_image_driver_fw_details: This attribute contains target driver and firmware information for
            every alternative image that will be applied on its corresponding
            host.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the key in
            the attribute :class:`dict` must be an identifier for the resource
        ...
        :param validated_features_in_use: Validated features in use on this device If Service is set but
            ...
            device is configured to use a feature it is not certified.
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        ...
        :param constraints: List of Supported Driver and Firmware Version combination and
            corresponding supportedFeatures from Broadcom Compatibility Guide
            (BCG) listing for the given vSphere version
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  compatibility_guide_link: :class:`str` or ``None``
        :param compatibility_guide_link: Provides link to the Broadcom Compatibility Guide for further
            information on the compatibility.
            If None there is no Broadcom Compatibility link available as this
            is device used by VSAN.
        ...
        self.target = target
        self.default_image_host_details = default_image_host_details
        self.alternative_image_driver_fw_details = alternative_image_driver_fw_details
...
PciDeviceComplianceInfo._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.software.reports.pci_device_compliance_info', {
        ...
        'target': type.ReferenceType(__name__, 'DriverFirmwareVersion'),
        'default_image_host_details': type.OptionalType(type.ReferenceType(__name__, 'ImageHostDetails')),
        'alternative_image_driver_fw_details': type.OptionalType(type.MapType(type.IdType(), type.ReferenceType(__name__, 'ImageDriverFirmwareDetails'))),
...
class StorageDeviceCompatibility(VapiStruct):
    ...
    def __init__(self,
        ...
        :param status: Compliance status of the storage device, when computed based on
            this Broadcom Compatibility Guide (BCG) listing.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  compatible_versions: :class:`list` of :class:`str` or ``None``
        :param compatible_versions: List of vSphere Versions compatible for this storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param supported_firmware_versions: List of minimum firmware versions supported from Broadcom
            Compatibility Guide (BCG) listing for the given vSphere version.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param constraints: List of Supported Firmware Versions and corresponding supported
            features from Broadcom Compatibility Guide (BCG) listing for the
            given vSphere version.
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  vcg_product: :class:`str`
        :param vcg_product: Identifier of the Broadcom Compatibility Guide (BCG) listing for
            the product.
            This attribute was added in **vSphere API 7.0.2.1**.
            When clients pass a value of this class as a parameter, the
        ...
        :type  model: :class:`str`
        :param model: Model name of the storage device as listed in the Broadcom
            Compatibility Guide (BCG) listing. This may not be the same as the
            :attr:`StorageDeviceInfo.model`
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  partner: :class:`str`
        :param partner: OEM partner name of the storage device as listed in the Broadcom
            Compatibility Guide (BCG) listing.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  compatibility_guide_link: :class:`str`
        :param compatibility_guide_link: Provides link to the Broadcom Compatibility Guide (BCG) listing for
            further information on the compatibility.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  used_for_compliance: :class:`bool`
        :param used_for_compliance: Flag to indicate whether this Broadcom Compatibility Guide (BCG)
            listing was used to compute the overall compatibility of the
            storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  user_selected: :class:`bool`
        :param user_selected: Flag to indicate if the user has selected this Broadcom
            Compatibility Guide (BCG) listing to be considered to compute the
            overall compatibility of the storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  notifications: :class:`com.vmware.esx.settings_client.Notifications` or ``None``
        :param notifications: Broadcom Compatibility Guide (BCG) listing specific notifications
            describing the compliance result.
            This attribute was added in **vSphere API 7.0.2.1**.
            This attribute will be None if there are no notifications
        """
        self.status = status
...
class StorageDeviceComplianceInfo(VapiStruct):
    ...
    the compliance information of a storage device.
    This class was added in **vSphere API 7.0.2.1**.
    ...
    def __init__(self,
                 ...
                 host_info=None,
                 default_image_host_details=None,
                 alternative_image_host_details=None,
                 firmware_version=None,
                 validated_features_in_use=None,
                 driver_name=None,
                 driver_version=None,
        ...
        :param storage_device_info: Information of the storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param status: Compliance status of the storage device. When there are multiple
            possible Broadcom Compatibility Guide (BCG) matches for the storage
        ...
        :param detail: Detailed compliance status of the storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        :type  host_info: :class:`dict` of :class:`str` and :class:`com.vmware.esx.settings_client.HostInfo`
        :param host_info: Affected List of Host IDs where this device is found.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param default_image_host_details: This attribute contains information about the default image and the
            ...
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  alternative_image_host_details: :class:`dict` of :class:`str` and :class:`ImageHostDetails`
        :param alternative_image_host_details: Specifies the alternative Image ID and its corresponding details
            along with hosts for a given storage device.
            This attribute was added in **vSphere API 9.0.0.0**.
            When clients pass a value of this class as a parameter, the key in
            the attribute :class:`dict` must be an identifier for the resource
            type: ``com.vmware.esx.settings.image``. When methods return a
            ...
            than its parent node.
        :type  firmware_version: :class:`str` or ``None``
        :param firmware_version: Firmware version on the storage device.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param validated_features_in_use: Validated Features in use on the storage device If Service is set
            ...
            than its parent node.
        :type  driver_name: :class:`str` or ``None``
        :param driver_name: Driver name on the storage device
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute will be None if there is no driver associated with
            the device.
        :type  driver_version: :class:`str` or ``None``
        :param driver_version: Driver Version on the storage device
            This attribute was added in **vSphere API 8.0.0.1**.
            This attribute will be None if there is no driver associated with
            the device.
        ...
        self.host_info = host_info
        self.default_image_host_details = default_image_host_details
        self.alternative_image_host_details = alternative_image_host_details
        self.firmware_version = firmware_version
        self.validated_features_in_use = validated_features_in_use
        self.driver_name = driver_name
        self.driver_version = driver_version
...
StorageDeviceComplianceInfo._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.software.reports.storage_device_compliance_info', {
        ...
        'host_info': type.MapType(type.IdType(), type.ReferenceType('com.vmware.esx.settings_client', 'HostInfo')),
        'default_image_host_details': type.OptionalType(type.ReferenceType(__name__, 'ImageHostDetails')),
        'alternative_image_host_details': type.OptionalType(type.MapType(type.IdType(), type.ReferenceType(__name__, 'ImageHostDetails'))),
        'firmware_version': type.OptionalType(type.StringType()),
        'validated_features_in_use': type.OptionalType(type.MapType(type.ReferenceType(__name__, 'Service'), type.SetType(type.StringType()))),
        'driver_name': type.OptionalType(type.StringType()),
        'driver_version': type.OptionalType(type.StringType()),
...
class StorageDeviceCompliance(VapiStruct):
    ...
    def __init__(self,
        ...
        :param status: Overall compliance status of storage devices in the cluster with
            respect to all hosts in the cluster.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param compatible_devices: Lists compliance information for storage devices found to be
            compliant with Broadcom Compatibility Guide (BCG) during the last
            check method. 
            ...
            that there were changes made after the last check method
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        :param incompatible_devices: Lists compliance information for storage devices found to be
            non-compliant with Broadcom Compatibility Guide (BCG) during the
            last check method. 
...
class CheckResult(VapiStruct):
    ...
    def __init__(self,
        ...
        :param updated_since_last_check: Flag to indicate if there were any hardware compatibility overrides
            were performed after the last check method.
            This attribute was added in **vSphere API 7.0.2.1**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        ...
        :param base_image_version: Target default base image version E.g., version =
            BaseImageSpec->Version
            :attr:`com.vmware.esx.settings_client.BaseImageSpec.version` class
        :type  has_alternative_images: :class:`bool`
        :param has_alternative_images: Boolean flag to indicate that desired state contains alternative
            images or not. If set to true, it signifies the desired state
            contains alternative images. If unset or set to false, it signifies
        ...
        :param storage_device_compliance: Compliance result for storage devices in all the hosts of the
            cluster. Currently only includes SAS/SATA storage devices.
            This attribute was added in **vSphere API 7.0.2.1**.
        ...
        self.has_alternative_images = has_alternative_images
...
CheckResult._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.software.reports.check_result', {
        ...
        'has_alternative_images': type.OptionalType(type.BooleanType()),
...
class ApplyImpact(VapiInterface):
    ...
    def get(self,
        ...
        :param spec:             Specification for how much information should be returned.
...
class HardwareCompatibility(VapiInterface):
    ...
    class ComplianceStatus(Enum):
        ...
        COMPATIBLE = None
        """
        Target hardware is compliant with BCG/HCL. This includes (from the
        :class:`ComplianceStatusDetail`: 
        ...
        * USER_OVERRIDE
        ...
        INCOMPATIBLE = None
        """
        Target hardware is not (recognizably) compliant with BCG/HCL This includes
        (from the :class:`ComplianceStatusDetail`): 
        ...
        * NONCOMPLIANCE_MUTED
        ...
        UNAVAILABLE = None
        """
        Target hardware compliance with BCG/HCL cannot be determined This includes
        (from the :class:`ComplianceStatusDetail`): 
    ...
    class ApplyResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param notifications: Notifications providing additional information for
                ...
                notifications in ``LastApplyResult.ApplyStatus``.
                This attribute was added in **vSphere API 7.0.2.1**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
...
class _HardwareCompatibilityStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/reports/hardware-compatibility?action=check',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
