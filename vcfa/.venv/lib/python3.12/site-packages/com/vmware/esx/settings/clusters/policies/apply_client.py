...
#
# vAPI stub file for package com.vmware.esx.settings.clusters.policies.apply.
#---------------------------------------------------------------------------

"""
The ``com.vmware.esx.settings.clusters.policies.apply_client`` module provides
classes to manage policies that affect application of desired state
configuration and software for an ESXi cluster. Copyright (c) 2019-2024
Broadcom. All Rights Reserved. Broadcom Confidential. The term "Broadcom"
refers to Broadcom Inc. and/or its subsidiaries. Copyright (c) 2019-2024
Broadcom. All Rights Reserved. Broadcom Confidential. The term "Broadcom"
...
class Effective(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.policies.apply.effective'
    """
    ...
    class FailureAction(VapiStruct):
        ...
        Action._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.clusters.policies.apply.effective.failure_action.action',
            Action))

    FailureAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.policies.apply.effective.failure_action', {
    ...
    class ParallelRemediationAction(VapiStruct):
        ...
        def __init__(self,
            ...
            :param max_hosts: Maximum number of hosts that can be remediated in parallel. Setting
                :attr:`com.vmware.esx.settings.clusters.policies_client.Apply.ParallelRemediationAction.max_hosts`
                does not guarantee maxHosts to be remediated in parallel.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
    ...
    ParallelRemediationAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.policies.apply.effective.parallel_remediation_action', {
    ...
    class EffectivePolicySpec(VapiStruct):
        ...
        configuration specification documents are applied to an ESXi cluster.
        ...
        def __init__(self,
            ...
            :param parallel_remediation_action: Enable parallel remediation of hosts in maintenance mode.
                This attribute was added in **vSphere API 8.0.0.1**.
                This attribute is optional because it was added in a newer version
                than its parent node.
        ...
        PreRemediationPowerAction._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.clusters.policies.apply.effective.effective_policy_spec.pre_remediation_power_action',
            PreRemediationPowerAction))

    EffectivePolicySpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.policies.apply.effective.effective_policy_spec', {
    ...
    def get(self,
        ...
        has been configured for the cluster.
        ...
        :return: The effective policies that impact the apply method on this
            cluster.
...
class _EffectiveStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/policies/apply/effective',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.policies.apply.effective',
