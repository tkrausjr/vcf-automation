...
class DocumentStructure(Enum):
    ...
    organized by the host's BIOS UUID.
    ...
    in the object are organized by BIOS UUID.
...
class SettingCompliance(VapiStruct):
    ...
    in an ESXi host setting. This structure describes a change in configuration
    value(set) or addition of configuration or deletion of configuration. When
    used to describe addition or deletion of a setting, if the setting is an
    instance in an array without an instance ID, the whole instance object is
    populated in target or current, respectively. When used to describe a drift
    in primitive type, current and target values are populated when applicable.
    This class was added in **vSphere API 8.0.1.0**.
    ...
    _validator_list = [
        UnionValidator(
            'type',
            {
                'REFERENCE' : [('reference_current', False), ('reference_target', False)],
                'PRIMITIVE' : [],
                'OBJECT' : [],
                'ARRAY_OF_OBJECTS' : [],
                'ARRAY_OF_PRIMITIVES' : [],
    ...
    def __init__(self,
        ...
        :param path: Full path to the setting within the desired document.
            This attribute was added in **vSphere API 8.0.1.0**.
        :type  display_path: :class:`list` of :class:`str` or ``None``
        :param display_path: A list of the display names for components of the value provided by
            :attr:`SettingCompliance.path` attribute.
            This attribute was added in **vSphere API 9.0.0.0**.
            This field is None if the display names cannot be computed.
        :type  current: :class:`str` or ``None``
        :param current: Value of setting on the ESXi host.
            This attribute was added in **vSphere API 8.0.1.0**.
            This field is None if there is no host value to report.
        ...
        :param target: Value of setting in the desired document.
            ...
            report.
        :type  type: :class:`SettingCompliance.Type` or ``None``
        :param type: The data type of the property in document pointed by {#path}.
            This attribute was added in **vSphere API 9.0.0.0**.
            This field is None if the data type of the property is not
            available in the drift provided by the ESXi host.
        :type  reference_current: :class:`str` or ``None``
        :param reference_current: Value of the reference configuration on the ESXi host encoded as
            JSON.
            This attribute was added in **vSphere API 9.0.0.0**.
            This field is None if host does not have reference configuration.
        :type  reference_target: :class:`str` or ``None``
        :param reference_target: Value of the reference configuration in the desired state encoded
            as JSON.
            This attribute was added in **vSphere API 9.0.0.0**.
            This field is None if desired state does not have reference
            configuration.
        """
        self.path = path
    ...
    class Type(Enum):
        """
        The ``SettingCompliance.Type`` class contains the possible data types of
        the property in drift.
        ...
        PRIMITIVE = None
        """
        The property in drift is of primitive data type.

        """
        OBJECT = None
        """
        The property in drift is of type object.

        """
        ARRAY_OF_OBJECTS = None
        """
        The property in drift is of array of object data type.

        """
        REFERENCE = None
        """
        The drift is in reference configuration.

        """
        ARRAY_OF_PRIMITIVES = None
        """
        The property in drift is of array of primitive data type.
    ...
    Type._set_values({
        ...
        'OBJECT': Type('OBJECT'),
        'ARRAY_OF_OBJECTS': Type('ARRAY_OF_OBJECTS'),
        'REFERENCE': Type('REFERENCE'),
        'ARRAY_OF_PRIMITIVES': Type('ARRAY_OF_PRIMITIVES'),
    })
    Type._set_binding_type(type.EnumType(
        'com.vmware.esx.settings.clusters.configuration.setting_compliance.type',
        Type))

SettingCompliance._set_binding_type(type.StructType(
    'com.vmware.esx.settings.clusters.configuration.setting_compliance', {
        'path': type.StringType(),
        'display_path': type.OptionalType(type.ListType(type.StringType())),
        'current': type.OptionalType(type.StringType()),
        'target': type.OptionalType(type.StringType()),
        'type': type.OptionalType(type.ReferenceType(__name__, 'SettingCompliance.Type')),
        'reference_current': type.OptionalType(type.StringType()),
        'reference_target': type.OptionalType(type.StringType()),
    },
    SettingCompliance,
    False,
    None))
...
class HostResult(VapiStruct):
    ...
    def __init__(self,
        ...
        :param summary: Summary of check compliance operation on the host.
            This attribute was added in **vSphere API 8.0.1.0**.
        ...
        :param errors: List of validation errors returned by the host. This is only set
            for a specific HostStatus ERROR case.
            This attribute was added in **vSphere API 8.0.1.0**.
        ...
        :param host_compliance: This field provides compliance results for the host if the
            ...
            is populated only if HostStatus is OK.
            This attribute was added in **vSphere API 8.0.1.0**.
...
class ClusterCompliance(VapiStruct):
    ...
    def __init__(self,
        ...
        :param failed_hosts: Identifiers of hosts where the operation failed.
            This attribute was added in **vSphere API 8.0.1.0**.
            When clients pass a value of this class as a parameter, the
            attribute must contain identifiers for the resource type:
            ``HostSystem``. When methods return a value of this class as a
        ...
        :param skipped_hosts: Identifiers of hosts where the operation was skipped. i.e
            ...
            resource type: ``HostSystem``.
        :type  end_time: :class:`datetime.datetime`
        :param end_time: CheckCompliance completion time.
            This attribute was added in **vSphere API 8.0.1.0**.
        """
...
class DependencyError(VapiStruct):
    ...
    def __init__(self,
        ...
        :param required_value: The dependency required by a union tag.
...
class DetailedValidationError(VapiStruct):
    ...
    def __init__(self,
        ...
        :param pattern: The pattern the property is required to match.
            This attribute was added in **vSphere API 8.0.2.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is one of
        ...
        :param property_name: The name of the property that holds the instance ID.
            This attribute was added in **vSphere API 8.0.2.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is
            :attr:`DetailedValidationError.ErrorType.MISSING_INSTANCE_ID`.
        :type  maximum_length: :class:`long`
        :param maximum_length: The maximum length allowed for a string or array property.
            This attribute was added in **vSphere API 8.0.2.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is one of
        ...
        :param minimum_length: The minimum length allowed for a string or array property.
            This attribute was added in **vSphere API 8.0.2.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is one of
        ...
        :param path: The JSON-pointer to the configuration key in the profile section
            where the instance/key needs to be added.
            This attribute was added in **vSphere API 8.0.2.0**.
            This attribute is optional and it is only relevant when the value
            of ``type`` is one of
            :attr:`DetailedValidationError.ErrorType.MISSING_REQUIRED_PROFILE_INSTANCE`
    ...
    class ErrorType(Enum):
        ...
        of errors related to property validation.
        ...
        GENERIC = None
        """
        A generic error. Check the ``message`` property for more information.

        """
        ADDITIONAL_PROPERTY = None
        """
        A property that is not specified in the schema was found.
        ...
        INVALID_TYPE = None
        """
        The value of a property is not the expected type.

        """
        MAX_STRING_LENGTH = None
        """
        The length of a string is larger than the maximum allowed.

        """
        MIN_STRING_LENGTH = None
        """
        The length of a string is smaller than the minimum allowed.
        ...
        """
        A property that is dependent on another property is invalid.
        ...
        """
        The length of an array is larger than the maximum allowed.

        """
        MIN_ARRAY_LENGTH = None
        """
        The length of an array is smaller than the minimum allowed.

        """
        MAX_VALUE = None
        """
        The value of a numeric property is larger than the maximum allowed.

        """
        MIN_VALUE = None
        """
        The value of a numeric property is smaller than the minimum allowed.

        """
        PATTERN_MISMATCH = None
        """
        The value of a string property does not match the allowed pattern.
        ...
        """
        The property is only valid for mutable default configurations.

        """
        HOST_SPECIFIC_IN_PROFILE = None
        """
        The property is host-specific, but was found in the profile section.
        ...
        """
        An instance does not have the required ID property.

        """
        EMPTY_PROPERTY = None
        """
        An object or array property is empty.
        ...
        """
        The property contains a placeholder that must be replaced.

        """
        PROPERTY_NAME_MISMATCH = None
        """
        A property name does not match the required pattern.
        ...
        exist in the profile section.

        """
        HOST_SPECIFIC_KEY_IN_OVERRIDE = None
        """
        A host-specific configuration was found in the host-override section.
...
class HostPrecheckResult(VapiStruct):
    ...
    def __init__(self,
        ...
        :param status: This field represents the status of the precheck request for this
            ...
            This attribute was added in **vSphere API 8.0.1.0**.
        :type  summary: :class:`com.vmware.vapi.std_client.LocalizableMessage`
        :param summary: Summarizing precheck operation on the host.
            This attribute was added in **vSphere API 8.0.1.0**.
        :type  validation_errors: :class:`list` of :class:`ValidationError` or ``None``
        :param validation_errors: This field represents the validation errors if the desired
            configuration specified is not valid.
...
class ImportResult(VapiStruct):
    ...
    def __init__(self,
        ...
        :param status: This attribute was added in **vSphere API 8.0.1.0**.
...
class ConfigurationSpec(VapiStruct):
    ...
    def __init__(self,
        ...
        """
        :type  spec: :class:`str`
        :param spec: Desired configuration document
            This attribute was added in **vSphere API 8.0.1.0**.
        """
        self.spec = spec
        VapiStruct.__init__(self)
...
class ReferenceHostInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param status: The current status of the reference host.
            This attribute was added in **vSphere API 8.0.3.0**.
        :type  host: :class:`str`
        :param host: The ID of the reference host.
            This attribute was added in **vSphere API 8.0.3.0**.
            When clients pass a value of this class as a parameter, the
            attribute must be an identifier for the resource type:
            ``HostSystem``. When methods return a value of this class as a
        ...
        :type  name: :class:`str`
        :param name: The name of the reference host.
            This attribute was added in **vSphere API 8.0.3.0**.
            This attribute is optional and it is only relevant when the value
            of ``status`` is one of :attr:`ReferenceHostInfo.Status.OK` or
            :attr:`ReferenceHostInfo.Status.DISCONNECTED`.
        :type  summary: :class:`com.vmware.vapi.std_client.LocalizableMessage`
        :param summary: A summary of the reference host status.
            This attribute was added in **vSphere API 8.0.3.0**.
        """
        self.status = status
        self.host = host
...
class SchemaResult(VapiStruct):
    ...
    def __init__(self,
        ...
        :param source: The source of this schema.
            This attribute was added in **vSphere API 8.0.3.0**.
            This attribute is optional because it was added in a newer version
            than its parent node.
        :type  schema: :class:`str`
        :param schema: The configuration schema associated with the cluster.
            This attribute was added in **vSphere API 8.0.1.0**.
        ...
        :param reference_host: If the source of this schema was a reference, this field will be
            populated with the current status of the host.
            This attribute was added in **vSphere API 8.0.3.0**.
            This attribute is optional and it is only relevant when the value
...
class AuditRecords(VapiInterface):
    ...
    the configuration actions performed on a cluster in vCenter Server.
    This class was added in **vSphere API 8.0.2.0**.
    """
    ...
    class OperationType(VapiStruct):
        ...
        represent all possible config manager operations.
        This class was added in **vSphere API 8.0.2.0**.
        ...
        :func:`com.vmware.esx.settings.clusters_client.Configuration.apply`
        ...
        :func:`com.vmware.esx.settings.clusters_client.Configuration.precheck`
        ...
        """
        Represents Configmanager Draft List :func:`Drafts.list`

        """
        DRAFT_CREATE = "Draft-Create"
        """
        Represents Configmanager Draft Create :func:`Drafts.create`

        """
        DRAFT_IMPORT_FROM_HOST = "Draft-ImportFromHost"
        """
        Represents Configmanager Draft Import from host
        :mod:`com.vmware.esx.settings.clusters.configuration_client`

        """
        DRAFT_GET = "Draft-Get"
        """
        Represents Configmanager Draft Get :func:`Drafts.get`
        ...
        """
        Represents Configmanager Draft Update :func:`Drafts.update`
        ...
        """
        Represents Configmanager Draft Delete :func:`Drafts.delete`

        """
        DRAFT_APPLY = "Draft-Apply"
        """
        Represents Configmanager Draft Apply :func:`Drafts.apply`

        """
        DRAFT_GET_SCHEMA = "Draft-GetSchema"
        """
        Represents Configmanager Draft Get Schema :func:`Drafts.get_schema`

        """
        OPERATIONS = ["Import", "Export", "Remediate", "Checkcompliance", "Precheck", "Transition-Enable", "Draft-List", "Draft-Create", "Draft-ImportFromHost", "Draft-Get", "Draft-ExportConfig", "Draft-Update", "Draft-ShowChanges", "Draft-CheckCompliance", "Draft-Precheck", "Draft-Delete", "Draft-Apply", "Draft-GetSchema"]
        """
        Represents all audit enabled config manager operations
    ...
    class FilterSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param usernames: List of audit records that match the given users
                This attribute was added in **vSphere API 8.0.2.0**.
            ...
            :param time_period: List of audit records that match the given start time i.e. occurred
                ...
                time i.e. before the :attr:`AuditRecords.TimePeriod.end`
                This attribute was added in **vSphere API 8.0.2.0**.
                This attribute is optional and it is only relevant when the value
                of ``timeDuration`` is
        ...
        class Timeframe(Enum):
            ...
            THREE_MONTHS = None
            """
            To indicate last 3 months audit records

            """
            SIX_MONTHS = None
            """
            To indicate last 6 months audit records

            """
            YEAR = None
            """
            To indicate last 1 year audit records
    ...
    class OperationDetails(VapiStruct):
        ...
        def __init__(self,
            ...
            :param task_id: TaskId of the operation
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
            ...
            :param draft_id: Draft ID of the draft operation
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.draft``. When methods return a value of
            ...
            :param cancelled: Indicates if the operation was cancelled
                This attribute was added in **vSphere API 8.0.2.0**.
        ...
        def __init__(self,
            ...
            :param operation: Name of the operation which can be one of 
                ...
                * Draft-GetSchema
                ...
                ``Draft-Precheck``, ``Draft-Delete``, ``Draft-Apply``, or
                ``Draft-GetSchema``. When methods return a value of this class as a
                return value, the attribute will be one of ``Import``, ``Export``,
                ``Remediate``, ``Checkcompliance``, ``Precheck``,
                ``Transition-Enable``, ``Draft-List``, ``Draft-Create``,
                ``Draft-ImportFromHost``, ``Draft-Get``, ``Draft-ExportConfig``,
                ``Draft-Update``, ``Draft-ShowChanges``, ``Draft-CheckCompliance``,
                ``Draft-Precheck``, ``Draft-Delete``, ``Draft-Apply``, or
                ``Draft-GetSchema``.
            ...
            :param status: Status of the operation :attr:`AuditRecords.Info.operation`
                This attribute was added in **vSphere API 8.0.2.0**.
...
class Drafts(VapiInterface):
    ...
    class Metadata(VapiStruct):
        ...
        def __init__(self,
            ...
            :param parent_id: The identifier of the parent commit.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
            ...
            :param owner: Owner of the configuration draft.
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  state: :class:`Drafts.State`
            :param state: State of the configuration draft.
                This attribute was added in **vSphere API 8.0.2.0**.
            ...
            :param creation_time: Creation time of the configuration draft.
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  modified_time: :class:`datetime.datetime`
            :param modified_time: Last modified time of the configuration draft.
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  precheck_task: :class:`str` or ``None``
            :param precheck_task: The ID of the precheck task that was last run for this draft.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.cis.task``. When methods return a value of this class
    ...
    class ValidationErrors(VapiStruct):
        ...
        def __init__(self,
            ...
            :param errors: Localized error message describing the validation error.
                This attribute was added in **vSphere API 8.0.2.0**.
            """
            self.display_path = display_path
            self.errors = errors
    ...
    class ValidationDetails(VapiStruct):
        ...
        related to the draft configuration.
        This class was added in **vSphere API 8.0.2.0**.
    ...
    class ModificationInfo(VapiStruct):
        ...
        modification to a property in the configuration.
        This class was added in **vSphere API 8.0.2.0**.
    ...
    class DeletionInfo(VapiStruct):
        ...
        that was deleted from the draft configuration.
        This class was added in **vSphere API 8.0.2.0**.
    ...
    class ChangeDetails(VapiStruct):
        ...
        in the draft when compared against the current desired document.
        This class was added in **vSphere API 8.0.2.0**.
        ...
        def __init__(self,
            ...
            :param modified_properties: Captures the properties that were added/modified in this draft. The
                ...
                the corresponding property in the desired document.
                This attribute was added in **vSphere API 8.0.2.0**.
    ...
    class ConflictPropertyInfo(VapiStruct):
        ...
        changes that have been committed by other users.
        This class was added in **vSphere API 8.0.2.0**.
    ...
    class ConflictDetails(VapiStruct):
        ...
        def __init__(self,
            ...
            :param properties: Map of properties in the current draft that were changed and
                ...
                configuration document since this draft was created.
                This attribute was added in **vSphere API 8.0.2.0**.
            """
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param metadata: Metadata about the configuration draft.
                This attribute was added in **vSphere API 8.0.2.0**.
            ...
            :param host_id_to_uuid: Map of host IDs to BIOS UUIDs.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``HostSystem``. When methods return a value of this class as
    ...
    class CreateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param config: The initial configuration for the draft.
                This attribute was added in **vSphere API 8.0.2.0**.
    ...
    class UpdateSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param expected_revision: When supplied, this revision value will be compared against the
                ...
                This attribute was added in **vSphere API 8.0.2.0**.
            :type  config: :class:`str`
            :param config: The new cluster configuration for this draft, encoded as JSON.
                This attribute was added in **vSphere API 8.0.2.0**.
            """
    ...
    class ApplyResult(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  commit: :class:`str`
            :param commit: The ID of the commit created for this operation.
                This attribute was added in **vSphere API 8.0.2.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
    ...
    class ChangedProperty(VapiStruct):
        ...
        that is different in this draft from the committed configuration.
        This class was added in **vSphere API 8.0.2.0**.
    ...
    def create(self,
        ...
        current commit ID for the cluster.
        This method was added in **vSphere API 8.0.2.0**.
        ...
        :rtype: :class:`str`
        :return:             The return value will be an identifier for the resource type:
    ...
    def import_from_host_task(self,
        ...
        localized error message if the import operation failed.
        This method was added in **vSphere API 8.0.2.0**.
        ...
        :param cluster: Identifier of the cluster.
            ...
            ``ClusterComputeResource``.
        :type  draft: :class:`str`
        :param draft:             The parameter must be an identifier for the resource type:
            ``com.vmware.esx.settings.draft``.
        :type  host: :class:`str`
    ...
    def update(self,
        ...
        and the update will go through.
        This method was added in **vSphere API 8.0.2.0**.
    ...
    def check_compliance_task(self,
        ...
        configuration specified in the draft.
        This method was added in **vSphere API 8.0.2.0**.
    ...
    def delete(self,
        ...
        """
        Delete this draft. Any changes will be abandoned.
        This method was added in **vSphere API 8.0.2.0**.
    ...
    def apply(self,
        ...
        called with the new desired state.
        This method was added in **vSphere API 8.0.2.0**.
...
class _DraftsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        import_from_host_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=importFromHost',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        get_schema_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=getSchema',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        export_config_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=exportConfig',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=update',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
        ...
        show_changes_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=showChanges',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        check_compliance_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=checkCompliance',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        precheck_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=precheck',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        apply_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration/drafts/{draft}?action=apply',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
        ...
        operations = {
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ConcurrentChange'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'check_compliance$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'apply': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'get': {
                ...
                'output_type': type.ReferenceType(__name__, 'SchemaResult'),
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
