...
class Software(VapiInterface):
    ...
    class CheckType(Enum):
        ...
        standalone VIBs (VIBs which are not part of any component).
        ...
        """
        Perform host's software specification existence check.

        """
        VSAN_WITNESS_ELIGIBILITY = None
        """
        Perform vSAN witness check to verify if the standalone host acting as a
        vSAN witness can be managed with a software image.
...
class _SoftwareStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/enablement/software?action=check',
        ...
        operations = {
            ...
            'check$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
