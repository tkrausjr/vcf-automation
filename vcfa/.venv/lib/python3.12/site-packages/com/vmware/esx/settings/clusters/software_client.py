...
class AlternativeImages(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.alternative_images'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    ListResult._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.alternative_images.list_result', {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            ...
            will give more details about the failure.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no cluster associated with ``cluster`` or no
            alternative image associated with ``image`` in the system.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            If the caller is not authenticated.
    ...
    def list(self,
        ...
        """
        Returns a list of image info of the alternative images for a given
        cluster.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :return: ListResult Image info of all the alternative images for a given
            cluster.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is unknown internal error. The accompanying error message
            will give more details about the failure.
...
class Drafts(VapiInterface):
    ...
    class SourceType(Enum):
        ...
        version. Recommendations can be generated using
        :func:`Recommendations.generate`.
        ...
        to that stored recommended image content. 
        
        Recommendations can be generated using :func:`Recommendations.generate`.

        """
        SPECIFIED_BASE_IMAGE_RECOMMENDATION = None
        """
        Content is from recommended image specification based on a specified base
        image version. Recommendations can be generated using
        :func:`Recommendations.generate`.
...
class Recommendations(VapiInterface):
    ...
    class FilterSpec(VapiStruct):
        ...
        on a specified base image version.
...
class SoftwareSpecMetadata(VapiInterface):
    """
    The ``SoftwareSpecMetadata`` class provides information about the software
    specification in the repository.
    This class was added in **vSphere API 9.0.0.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.software_spec_metadata'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
        ...
        :param config: Configuration to be used for creating the stub.
        """
        VapiInterface.__init__(self, config, _SoftwareSpecMetadataStub)
        self._VAPI_OPERATION_IDS = {}
    ...
    def get(self,
        ...
        """
        Returns the software specification metadata in the repository that is
        ...
        :param cluster: Identifier of the cluster.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        :rtype: :class:`com.vmware.esx.settings_client.SoftwareSpecMetadata`
        :return: software specification metadata in the repository that is assigned
            to the cluster.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is unknown internal error. The accompanying error message
            will give more details about the failure.
...
class Solutions(VapiInterface):
    ...
    class UpdateSolutionsSpec(VapiStruct):
        """
        The ``Solutions.UpdateSolutionsSpec`` class contains attributes that
        describe solutions registered in the software specification.
        This class was added in **vSphere API 9.0.0.0**.
        ...
        def __init__(self,
            ...
            """
            :type  solutions: :class:`dict` of :class:`str` and :class:`com.vmware.esx.settings_client.SolutionSpec`
    ...
    UpdateSolutionsSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.solutions.update_solutions_spec', {
            'solutions': type.MapType(type.IdType(), type.ReferenceType('com.vmware.esx.settings_client', 'SolutionSpec')),
        },
        UpdateSolutionsSpec,
        False,
        None))
    ...
    def update_task(self,
        ...
        """
        Updates the components registered for the specified solutions in the
        desired software specification. The task will update all the solutions
        specified here in a single operation. It updates specified solutions
        while leaving other existing solutions intact; without removing them.
        Solutions constraints would be validated with the current desired
        software specification before it is committed as new desired spec. The
        result of this operation can be queried by calling the
        cis/tasks/{task-id} where the task-id is the response of this
        operation.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param cluster: Identifier of the cluster.
            The parameter must be an identifier for the resource type:
            ``ClusterComputeResource``.
        :type  spec: :class:`Solutions.UpdateSolutionsSpec`
        :param spec: registered solutions specification.
        :rtype: :class:  `vmware.vapi.stdlib.client.task.Task`
        :return: Task instance
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is unknown internal error. The accompanying error message
...
class _AlternativeImagesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/alternative-images/{image}',
            path_variables={
                'cluster': 'cluster',
                'image': 'image',
            },
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/alternative-images',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.alternative_images',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _DraftsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        commit_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}?action=commit',
        ...
        validate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}?action=validate',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        scan_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}?action=scan',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        import_software_spec_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/drafts?action=import-software-spec',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        operations = {
            'commit$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'import_software_spec': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
...
class _EffectiveComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_with_removed_components_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/effective-components?with-removed-components',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
...
class _RecommendationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        generate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/recommendations?action=generate',
        ...
        operations = {
            'generate$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ConcurrentChange'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
...
class _SoftwareSpecMetadataStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for get operation
        get_input_type = type.StructType('operation-input', {
            'cluster': type.IdType(resource_types='ClusterComputeResource'),
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/software-spec-metadata',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType('com.vmware.esx.settings_client', 'SoftwareSpecMetadata'),
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.software_spec_metadata',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _SolutionsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        update_input_type = type.StructType('operation-input', {
            'cluster': type.IdType(resource_types='ClusterComputeResource'),
            'spec': type.ReferenceType(__name__, 'Solutions.UpdateSolutionsSpec'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'SoftwareSpecMetadata': SoftwareSpecMetadata,
        'Solutions': Solutions,
        'alternative_images': 'com.vmware.esx.settings.clusters.software.alternative_images_client.StubFactory',
