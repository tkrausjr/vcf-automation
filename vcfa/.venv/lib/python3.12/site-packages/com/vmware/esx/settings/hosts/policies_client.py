...
#
# vAPI stub file for package com.vmware.esx.settings.hosts.policies.
#---------------------------------------------------------------------------

"""
The ``com.vmware.esx.settings.hosts.policies_client`` module provides classes
...
class Apply(VapiInterface):
    ...
    applied to an ESXi host.
    This class was added in **vSphere API 8.0.0.1**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.hosts.policies.apply'
    """
    ...
    class FailureAction(VapiStruct):
        ...
        class Action(Enum):
            ...
            when entering maintenance mode fails on an ESXi host.
        ...
        Action._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.hosts.policies.apply.failure_action.action',
            Action))

    FailureAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.hosts.policies.apply.failure_action', {
    ...
    class ConfiguredPolicySpec(VapiStruct):
        ...
        specification documents are applied to an ESXi host.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param enable_quick_boot: Enable Quick Boot during remediation of the host.
                This attribute was added in **vSphere API 8.0.0.1**.
                If None, configured value would be unset.
            """
        ...
        class PreRemediationPowerAction(Enum):
            ...
            the possible actions to take, before entering maintenance mode.
            This enumeration was added in **vSphere API 8.0.0.1**.
        ...
        PreRemediationPowerAction._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.hosts.policies.apply.configured_policy_spec.pre_remediation_power_action',
            PreRemediationPowerAction))

    ConfiguredPolicySpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.hosts.policies.apply.configured_policy_spec', {
...
class _ApplyStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/hosts/{host}/policies/apply',
            path_variables={
                'host': 'host',
            },
            query_parameters={
        ...
        operations = {
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.hosts.policies.apply',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        'Apply': Apply,
        'apply': 'com.vmware.esx.settings.hosts.policies.apply_client.StubFactory',
    }
