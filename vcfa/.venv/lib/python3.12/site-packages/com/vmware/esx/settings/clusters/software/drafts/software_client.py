...
class AlternativeImages(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    CreateSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.create_spec', {
    ...
    ListResult._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.list_result', {
    ...
    def delete(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no cluster associated with ``cluster`` or no draft
            associated with ``draft`` or no alternative image associated with
            ``image`` in the system.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
...
class RemovedComponents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.removed_components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _AlternativeImagesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
        ...
        delete_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _EffectiveComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_with_removed_components_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/effective-components?with-removed-components',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
...
class _RemovedComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/removed-components/{component}',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'component': 'component',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/removed-components',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.removed_components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'alternative_images': 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images_client.StubFactory',
    }
