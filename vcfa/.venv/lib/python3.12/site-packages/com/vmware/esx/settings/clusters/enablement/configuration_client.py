...
class Transition(VapiInterface):
    ...
    class Source(Enum):
        ...
        FILE = None
        """
        This indicates that desired configuration originated from a file.
    ...
    class Hints(VapiStruct):
        ...
        guidelines throughout the transition process.
        ...
        def __init__(self,
            ...
            :param requires_reference_host: This hint indicates whether a reference host is required to
                ...
                of the reference host, or status of the reference host.
    ...
    class ReferenceHost(VapiStruct):
        ...
        reference host information used by the transition process.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param host_info: Host Info for Reference host.
                This attribute was added in **vSphere API 8.0.1.0**.
            """
            self.host = host
    ...
    class State(VapiStruct):
        ...
        def __init__(self,
            ...
            :param author: Author of transition.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  start_time: :class:`datetime.datetime`
            :param start_time: The start time of the transition process.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  modified_time: :class:`datetime.datetime`
            :param modified_time: Last modified time of the transition process.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  source: :class:`Transition.Source`
            :param source: Source of reference configuration.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  host: :class:`Transition.ReferenceHost`
            :param host: Reference host.
                This attribute was added in **vSphere API 8.0.1.0**.
                This attribute is optional and it is only relevant when the value
                of ``source`` is :attr:`Transition.Source.HOST`.
            :type  filename: :class:`str`
            :param filename: Filename of the imported configuration.
                This attribute was added in **vSphere API 8.0.1.0**.
                This attribute is optional and it is only relevant when the value
    ...
    class Info(VapiStruct):
        ...
        status of transition process in the cluster.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param status: Status of transition on a cluster.
                This attribute was added in **vSphere API 8.0.1.0**.
        ...
        class Status(Enum):
            ...
            the desired configuration management platform.
            ...
            :attr:`Transition.State.author` has already started transition.

            """
            NOT_STARTED = None
            """
            Transition has not started on the cluster.
            ...
            STARTED = None
            """
            Transition has started on the cluster.
    ...
    class EligibilityResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: Status of eligibility checks performed on a cluster.
                This attribute was added in **vSphere API 8.0.1.0**.
        ...
        class Status(Enum):
            ...
            status codes describing the result of eligibility checks.
            This enumeration was added in **vSphere API 8.0.1.0**.
    ...
    class FileSpec(VapiStruct):
        ...
        the file being imported during transition process.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param config: Configuration from the imported file.
                This attribute was added in **vSphere API 8.0.1.0**.
            """
            self.filename = filename
            self.config = config
    ...
    class ValidateResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param compliance: Cluster Compliance result.
                This attribute was added in **vSphere API 8.0.1.0**.
                This attribute is optional and it is only relevant when the value
        ...
        class Status(Enum):
            ...
            codes describing the result of validating configuration draft.
            This enumeration was added in **vSphere API 8.0.1.0**.
            ...
            INVALID = None
            """
            This indicates that the configuration draft is invalid.

            """
            VALID = None
            """
            This indicates that the configuration draft is valid.
    ...
    class EnableResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param status: Status of enabling configmanager on a cluster.
                This attribute was added in **vSphere API 8.0.1.0**.
        ...
        class Status(Enum):
            ...
            ERROR = None
            """
            Failed to enable ConfigManager on the cluster.
            ...
            SUCCESS = None
            """
            ConfigMnager enabled on the cluster.

            """
            SUCCESS_APPLY_INITIATED = None
            """
            ConfigMnager enabled on the cluster and remediation was initiated.
    ...
    def import_from_file(self,
        ...
        provide localized error message if the import operation failed.
        This method was added in **vSphere API 8.0.1.0**.
    ...
    def precheck_task(self,
        ...
        rebooted or put in maintenanceMode.
        This method was added in **vSphere API 8.0.1.0**.
    ...
    def enable_task(self,
        ...
        will contain descriptive error messages.
        This method was added in **vSphere API 8.0.1.0**.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires
              ``VcIntegrity.ClusterConfiguration.Remediate`` and
...
class _TransitionStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        check_eligibility_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=checkEligibility',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        cancel_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=cancel',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        import_from_file_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=importFromFile',
        ...
        import_from_host_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=importFromHost',
        ...
        export_config_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=exportConfig',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        export_schema_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=exportSchema',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        validate_config_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=validateConfig',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        precheck_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=precheck',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        enable_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/enablement/configuration/transition?action=enable',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        operations = {
            ...
            'cancel': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
