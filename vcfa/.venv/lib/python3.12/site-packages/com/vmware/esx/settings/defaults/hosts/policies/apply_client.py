...
#
# vAPI stub file for package com.vmware.esx.settings.defaults.hosts.policies.apply.
#---------------------------------------------------------------------------

"""
The ``com.vmware.esx.settings.defaults.hosts.policies.apply_client`` module
provides classes to manage the policies that affect application of desired
state configuration and software for ESXi hosts. Copyright (c) 2019-2023
VMware, Inc. All rights reserved. -- VMware Confidential Copyright (c)
2019-2023 VMware, Inc. All rights reserved. -- VMware Confidential
...
class Effective(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.defaults.hosts.policies.apply.effective'
    """
    ...
    class FailureAction(VapiStruct):
        ...
        class Action(Enum):
            ...
            taken when entering maintenance mode fails on an ESXi host.
        ...
        Action._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.defaults.hosts.policies.apply.effective.failure_action.action',
            Action))

    FailureAction._set_binding_type(type.StructType(
        'com.vmware.esx.settings.defaults.hosts.policies.apply.effective.failure_action', {
    ...
    class EffectivePolicySpec(VapiStruct):
        ...
        configuration specification documents are applied to ESXi hosts.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param enable_quick_boot: Enable Quick Boot during remediation of an ESXi host.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
        ...
        PreRemediationPowerAction._set_binding_type(type.EnumType(
            'com.vmware.esx.settings.defaults.hosts.policies.apply.effective.effective_policy_spec.pre_remediation_power_action',
            PreRemediationPowerAction))

    EffectivePolicySpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.defaults.hosts.policies.apply.effective.effective_policy_spec', {
...
class _EffectiveStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/defaults/hosts/policies/apply/effective',
            path_variables={
            },
            query_parameters={
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.defaults.hosts.policies.apply.effective',
