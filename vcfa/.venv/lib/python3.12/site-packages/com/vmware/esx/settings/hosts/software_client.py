...
class AddOn(VapiInterface):
    ...
    specification for a given standalone host.
...
class Commits(VapiInterface):
    ...
    class ApplyStatusType(Enum):
        ...
        APPLIED = None
        """
        Commit has been applied to the host.

        """
        NOT_APPLIED = None
        """
        Commit hasn't been applied to the host.
...
class Components(VapiInterface):
    ...
    specification for a standalone ESX host.
    This class was added in **vSphere API 8.0.0.1**.
    """
...
class Drafts(VapiInterface):
    ...
    class SourceType(Enum):
        ...
        """
        Content is from recommended image specification based on latest base image
        patch or update of the current series. For example, a host's current
        ...
        possible. Let's say in this example, depot manager has 8.0 patch a and 8.0
    ...
    def create(self,
        ...
        deleted, when the draft is committed successfully.
        This method was added in **vSphere API 8.0.0.1**.
    ...
    def scan_task(self,
        ...
        the response of this operation.
        This method was added in **vSphere API 8.0.0.1**.
...
class SoftwareSpecMetadata(VapiInterface):
    ...
    specification from the repository.
    This class was added in **vSphere API 9.0.0.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.hosts.software.software_spec_metadata'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Solutions(VapiInterface):
    ...
    solution specifications for an ESX host.
    This class was added in **vSphere API 8.0.0.1**.
    """
...
class _DraftsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        commit_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software/drafts/{draft}?action=commit',
        ...
        validate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software/drafts/{draft}?action=validate',
            path_variables={
                'host': 'host',
                'draft': 'draft',
            },
        ...
        scan_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software/drafts/{draft}?action=scan',
            path_variables={
                'host': 'host',
                'draft': 'draft',
            },
        ...
        import_software_spec_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software/drafts?action=import-software-spec',
            request_body_parameter='spec',
            path_variables={
                'host': 'host',
            },
        ...
        operations = {
            'commit$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _EffectiveComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_with_removed_components_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/hosts/{host}/software/effective-components?with-removed-components',
            path_variables={
                'host': 'host',
            },
            query_parameters={
...
class _RecommendationsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        generate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software/recommendations?action=generate',
            path_variables={
                'host': 'host',
            },
            query_parameters={
        ...
        operations = {
            'generate$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ConcurrentChange'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _SoftwareSpecMetadataStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/hosts/{host}/software/software-spec-metadata',
            path_variables={
                'host': 'host',
            },
            query_parameters={
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.hosts.software.software_spec_metadata',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'set$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
