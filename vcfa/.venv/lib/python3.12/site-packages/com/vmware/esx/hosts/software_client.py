...
class InstalledComponents(VapiInterface):
    ...
    class InstalledComponentInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  platforms: :class:`set` of :class:`str`
            :param platforms: Platforms the component belongs to. Example: host, vmdpu0, vmdpu1,
                ...
    ...
    InstalledComponentInfo._set_binding_type(type.StructType(
        'com.vmware.esx.hosts.software.installed_components.installed_component_info', {
            ...
            'platforms': type.OptionalType(type.SetType(type.StringType())),
        },
    ...
    def __init__(self, config):
        ...
        operations = {
            'list': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InternalServerError'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
