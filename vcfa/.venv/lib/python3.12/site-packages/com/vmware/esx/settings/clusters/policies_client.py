...
refers to Broadcom Inc. and/or its subsidiaries. Copyright 2020-2021, 2023
VMware, Inc. All rights reserved. VMware Confidential Copyright 2023 VMware,
...
class ConfigManagerPolicySpecResetInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param to: The values of the
            com.vmware.esx.settings.clusters.policies.Apply.ConfigManagerPolicySpec
            for when the configured value is reset.
            This attribute was added in **vSphere API 8.0.3.0**.
        """
        self.from_ = from_
        self.to = to
    ...
    def __init__(self, config):
        ...
        operations = {
            ...
            'set': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
