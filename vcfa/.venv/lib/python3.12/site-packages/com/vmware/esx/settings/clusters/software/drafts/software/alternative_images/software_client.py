...
#
# vAPI stub file for package com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.
#---------------------------------------------------------------------------

"""
The
``com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software_client``
...
class AddOn(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.add_on'
    """
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            ...
            associated with ``draft`` or no image associated with ``image`` in
            the system or no add-on specification is set.
...
class BaseImage(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.base_image'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class Components(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    UpdateSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.components.update_spec', {
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no cluster associated with ``cluster`` or no draft
            associated with ``draft`` or no image associated with ``image`` or
            no component associated with ``component`` in the system.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            If the caller is not authenticated.
...
class EffectiveComponents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.effective_components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class HardwareSupport(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.hardware_support'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no cluster associated with ``cluster`` or no draft
            associated with ``draft`` or no image associated with ``image`` in
            the system or no Hardware Support Package (HSP) is set.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
...
class RemovedComponents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.removed_components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class _AddOnStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/add-on',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.add_on',
...
class _BaseImageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/base-image',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.base_image',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _ComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/components/{component}',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/components',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _EffectiveComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/effective-components',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        list_with_removed_components_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/effective-components?with-removed-components',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.effective_components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _HardwareSupportStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/hardware-support',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.hardware_support',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _RemovedComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/removed-components/{component}',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/software/alternative-images/{image}/software/removed-components',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.software.alternative_images.software.removed_components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
