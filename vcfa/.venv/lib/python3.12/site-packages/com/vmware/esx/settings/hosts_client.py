...
class Configuration(VapiInterface):
    ...
    class ExtractResult(VapiStruct):
        """
        The ``Configuration.ExtractResult`` class defines the information about
        current configuration extracted from a ESXi host.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param config: Current configuration of ESXi host encoded as JSON.
    ...
    def extract(self,
        ...
        """
        Extracts the current configuration document from the ESXi host and
        returns it in a serialized JSON format.
        ...
        :return: The result contains the current configuration of the ESXi host
            encoded as JSON.
...
class DepotOverrides(VapiInterface):
    ...
    are only used by ESXs for lifecycle operations.
    This class was added in **vSphere API 8.0.1.0**.
    """
    ...
    class Depot(VapiStruct):
        ...
        particular depot override for a given host.
        This class was added in **vSphere API 8.0.1.0**.
...
class Software(VapiInterface):
    ...
    class StageStatus(VapiStruct):
        ...
        class Status(Enum):
            ...
            the desired software specification to a host.
            This enumeration was added in **vSphere API 8.0.0.1**.
    ...
    class ApplyStatus(VapiStruct):
        ...
        class Status(Enum):
            ...
            the desired software specification to host.
            This enumeration was added in **vSphere API 8.0.0.1**.
    ...
    class StageResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param commit: The identifier of the commit used to fetch the desired software
                document to be staged to a host.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
    ...
    class ApplyResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :type  commit: :class:`str`
            :param commit: The identifier of the commit used to fetch the desired software
                document to be applied to host.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.hosts.software.info', {
    ...
    def get(self,
        ...
        Image Host, the specification will contain Default Image In case of
        Composite Image Host, the specification will contain Default Image +
        Alternative Images
    ...
    def stage_task(self,
        ...
        """
        Stages the desired software document associated with the given host. 
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``HostSystem`` referenced by the parameter ``host``
              requires ``VcIntegrity.lifecycleSoftwareRemediation.Write``.
        """
    ...
    def apply_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``HostSystem`` referenced by the parameter ``host``
              requires ``VcIntegrity.lifecycleSoftwareRemediation.Write`` and
              ``VcIntegrity.lifecycleHealth.Read``.
        """
    ...
    def check_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires
              ...
              ``VcIntegrity.lifecycleHealth.Read``.
            * The resource ``HostSystem`` referenced by the parameter ``host``
              requires ``VcIntegrity.lifecycleSoftwareRemediation.Read`` and
              ``VcIntegrity.lifecycleHealth.Read``.
        """
    ...
    def get_display_name(self,
        ...
        repository that is assigned to the host.
...
class _ConfigurationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        extract_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/configuration?action=extract',
            path_variables={
                'host': 'host',
            },
            query_parameters={
...
class _DepotOverridesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        add_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/depot-overrides?action=add',
        ...
        remove_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/depot-overrides?action=remove',
            request_body_parameter='depot',
            path_variables={
                'host': 'host',
            },
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'add': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'remove': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
...
class _SoftwareStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        scan_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software?action=scan',
            path_variables={
                'host': 'host',
            },
            query_parameters={
        ...
        export_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software?action=export',
        ...
        stage_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software?action=stage',
            request_body_parameter='spec',
            path_variables={
                'host': 'host',
            },
        ...
        apply_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software?action=apply',
            request_body_parameter='spec',
            path_variables={
                'host': 'host',
            },
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/hosts/{host}/software?action=check',
            request_body_parameter='spec',
            path_variables={
                'host': 'host',
            },
        ...
        get_display_name_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/hosts/{host}/software/display-name',
            path_variables={
                'host': 'host',
            },
            query_parameters={
        ...
        operations = {
            'scan$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'stage$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
            ...
            'apply$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
