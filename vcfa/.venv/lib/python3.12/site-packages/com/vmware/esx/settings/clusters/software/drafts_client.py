...
#
# vAPI stub file for package com.vmware.esx.settings.clusters.software.drafts.
#---------------------------------------------------------------------------
...
class DisplayName(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.clusters.software.drafts.display_name'
    """
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.display_name.info', {
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.drafts.display_name.set_spec', {
            'display_name': type.StringType(),
        },
        SetSpec,
        False,
...
class _DisplayNameStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/drafts/{draft}/display-name',
            path_variables={
                'cluster': 'cluster',
                'draft': 'draft',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.clusters.software.drafts.display_name',
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'software': 'com.vmware.esx.settings.clusters.software.drafts.software_client.StubFactory',
    }
