...
class _CompatibilityDataStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/hcl/compatibility-data?action=download',
            path_variables={
            },
            query_parameters={
            },
        ...
        operations = {
            'get': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
