...
#
# vAPI stub file for package com.vmware.esx.settings.repository.software.drafts.alternative_images.
#---------------------------------------------------------------------------

"""
The
``com.vmware.esx.settings.repository.software.drafts.alternative_images_client``
module provides classes to manage alternative image's software for the given
draft.
...
class AddOn(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.add_on'
    """
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no draft associated with ``draft`` or no image
    ...
    def set(self,
        ...
        """
        Sets the OEM add-on specification of the alternative image. It will
        overwrite the existing OEM add-on specification if one already exists.
        This method was added in **vSphere API 9.0.0.0**.
    ...
    def delete(self,
        ...
        """
        Deletes the OEM add-on specification of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
            If there is no draft associated with ``draft`` in the system or no
            add-on specification is set.
        :raise: :class:`com.vmware.vapi.std.errors_client.ServiceUnavailable` 
            If the service is not available.
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthenticated` 
            if the caller is not authenticated.
...
class BaseImage(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.base_image'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def get(self,
        ...
        """
        Returns the base-image specification of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
...
class Components(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    class UpdateSpec(VapiStruct):
        ...
        to update list of components of the alternative image.
        This class was added in **vSphere API 9.0.0.0**.
    ...
    UpdateSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.repository.software.drafts.alternative_images.components.update_spec', {
    ...
    def set(self,
        ...
        """
        Set the component version for a given component of the alternative
        image. This will overwrite any existing version for the given
        component.
        This method was added in **vSphere API 9.0.0.0**.
    ...
    def delete(self,
        ...
        """
        Deletes the given component of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
    ...
    def update(self,
        ...
        """
        Updates the list of components of the alternative image. This allows
        set and/or delete of multiple components in a batch operation.
        This method was added in **vSphere API 9.0.0.0**.
...
class DisplayName(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.display_name'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.repository.software.drafts.alternative_images.display_name.info', {
    ...
    SetSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.repository.software.drafts.alternative_images.display_name.set_spec', {
            'display_name': type.StringType(),
        },
        SetSpec,
        False,
    ...
    def get(self,
        ...
        :return: Info Display name info of the alternative image.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is unknown internal error. The accompanying error message
            will give more details about the failure.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
    ...
    def set(self,
        ...
        """
        Sets the display name of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param spec: Display name spec of the alternative image.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is some unknown internal error. The accompanying error
            message will give more details about the failure.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
...
class EffectiveComponents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.effective_components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    FilterSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.repository.software.drafts.alternative_images.effective_components.filter_spec', {
...
class HardwareSupport(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.hardware_support'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def set(self,
        ...
        """
        Sets the Hardware Support Package (HSP) of the alternative image. It
        will overwrite the existing Hardware Support Package (HSP)
    ...
    def delete(self,
        ...
        """
        Deletes the Hardware Support Package (HSP) of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
...
class RemovedComponents(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.removed_components'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
...
class SelectionCriteria(VapiInterface):
    """
    The ``SelectionCriteria`` class provides methods to configure the selection
    ...
    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.repository.software.drafts.alternative_images.selection_criteria'
    """
    Identifier of the service in canonical form.
    """
    def __init__(self, config):
    ...
    def set(self,
        ...
        """
        Sets the selection criteria of the alternative image.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :param image: Identifier of the alternative image.
            The parameter must be an identifier for the resource type:
            ``com.vmware.esx.settings.image``.
        :type  spec: :class:`com.vmware.esx.settings_client.ImageSelectionSpec`
        :param spec: Selection criteria that needs to be configured.
        :raise: :class:`com.vmware.vapi.std.errors_client.Error` 
            If there is unknown internal error. The accompanying error message
            will give more details about the failure.
        :raise: :class:`com.vmware.vapi.std.errors_client.NotFound` 
...
class _AddOnStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/add-on',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.add_on',
...
class _BaseImageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/base-image',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.base_image',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _ComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/components/{component}',
            path_variables={
                'draft': 'draft',
                'image': 'image',
                'component': 'component',
        ...
        update_rest_metadata = OperationRestMetadata(
            http_method='PATCH',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/components',
            request_body_parameter='spec',
            path_variables={
                'draft': 'draft',
                'image': 'image',
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _DisplayNameStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/display-name',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.display_name',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _EffectiveComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/effective-components',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.effective_components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _HardwareSupportStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/hardware-support',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.hardware_support',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _RemovedComponentsStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/removed-components/{component}',
            path_variables={
                'draft': 'draft',
                'image': 'image',
                'component': 'component',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/removed-components',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.removed_components',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
...
class _SelectionCriteriaStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/repository/software/drafts/{draft}/alternative-images/{image}/selection-criteria',
            path_variables={
                'draft': 'draft',
                'image': 'image',
            },
        ...
        set_input_type = type.StructType('operation-input', {
            'draft': type.IdType(resource_types='com.vmware.esx.settings.draft'),
            'image': type.IdType(resource_types='com.vmware.esx.settings.image'),
            'spec': type.ReferenceType('com.vmware.esx.settings_client', 'ImageSelectionSpec'),
        })
        set_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.repository.software.drafts.alternative_images.selection_criteria',
            config=config, operations=operations, rest_metadata=rest_metadata,
            is_vapi_rest=True)
