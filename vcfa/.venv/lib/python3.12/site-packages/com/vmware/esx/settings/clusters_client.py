...
class Configuration(VapiInterface):
    ...
    class ApplySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param commit: The minimum commit identifier of the desired configuration to be
                used during the :func:`Configuration.apply` method.
            ...
            :param hosts: The specific hosts within the cluster to be considered during the
                :func:`Configuration.apply` method.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the
    ...
    class ApplyResult(VapiStruct):
        ...
        the result of an :func:`Configuration.apply` method.
        This class was added in **vSphere API 8.0.1.0**.
        ...
        def __init__(self,
            ...
            :param host_info: Information of the hosts in this cluster to which the desired
                ...
                :attr:`Configuration.ApplyResult.commit` should be applied to.
                This attribute was added in **vSphere API 8.0.1.0**.
            ...
            :param host_status: Status of the hosts in this cluster to which the desired
                ...
                :attr:`Configuration.ApplyResult.skipped_hosts`.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``HostSystem``. When methods return a value of this class as
    ...
    class Metadata(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  id: :class:`str`
            :param id: The identifier of the commit.
                This attribute was added in **vSphere API 8.0.1.0**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
            ...
            :param author: Author of the configuration commit.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  creation_time: :class:`datetime.datetime`
            :param creation_time: Creation time of the configuration commit.
                This attribute was added in **vSphere API 8.0.1.0**.
            """
            self.id = id
            self.author = author
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param metadata: Metadata about the configuration commit.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  host_info: :class:`dict` of :class:`str` and :class:`com.vmware.esx.settings_client.HostInfo`
    ...
    class ImportSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  config: :class:`str`
            :param config: The cluster configuration, encoded as JSON.
                This attribute was added in **vSphere API 8.0.1.0**.
            :type  description: :class:`str` or ``None``
            :param description: A description of this version of the configuration.
                This attribute was added in **vSphere API 8.0.1.0**.
            """
            self.config = config
    ...
    def get(self,
        ...
        properties available for a the cluster.
    ...
    def validate_task(self,
        ...
        .. deprecated:: vSphere API 8.0.2.0
            This method is deprecated as of **vSphere API 8.0.2.0**.  The
            desired cluster configuration is validated as part of
    ...
    def precheck_task(self,
        ...
        results will also be specified in the result.
        This method was added in **vSphere API 8.0.1.0**.
    ...
    def import_config_task(self,
        ...
        .. deprecated:: vSphere API 8.0.2.0
            This method is deprecated as of **vSphere API 8.0.2.0**.  Use
...
class InstalledImages(VapiInterface):
    ...
    bundle running on group of ESXi hosts in a cluster
    ...
    class InstalledImage(VapiStruct):
        ...
        def __init__(self,
            ...
            :param software_info: Software image installed on group of hosts
                This attribute was added in **vSphere API 8.0.3.0**.
            :type  host_list: :class:`set` of :class:`str`
            :param host_list: List of hosts having the same software image
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``HostSystem``. When methods return a value of this class as a
    ...
    class ImageCategories(VapiStruct):
        ...
        describing software image categorized on pre-defined criteria.
        This class was added in **vSphere API 8.0.3.0**.
        ...
        def __init__(self,
            ...
            :param is_highest_and_widely_used_image_equal: Boolean flag indicating if most widely used image and highest
                ...
                otherwise it will contain different value.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param most_widely_used_image: This image category contains the software image that is most
                prevalent among the hosts in the cluster.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param host_image_list: This list will contain software image running on hosts in the
                cluster excluding “highestVersionedImage” and “mostWidelyUsedImage”
                This attribute was added in **vSphere API 8.0.3.0**.
    ...
    class InstalledImageInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param uniform_image: If this flag is set, it means all hosts in cluster are running the
                ...
                hosts “imageCategories” fields will be filled.
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param status: Execution status of the task. If it's not SUCCESS then the
                ...
                of this class can be inspected for more information.
                This attribute was added in **vSphere API 8.0.3.0**.
            :type  successful_hosts: :class:`list` of :class:`str`
            :param successful_hosts: List of Hosts for which software image has extracted
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``HostSystem``. When methods return a value of this class as a
            ...
            :param failed_hosts: List of hosts for which no software image has extracted
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``HostSystem``. When methods return a value of this class as a
            ...
            :param host_notifications: Notifications stating any error or orphaned vibs etc on Hosts
                This attribute was added in **vSphere API 8.0.3.0**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``HostSystem``. When methods return a value of this class as
            ...
            :param orphaned_vibs: Information about the orphaned vibs available on the hosts
                ...
                vibs formats are orphaned vibs name(version).
                This attribute was added in **vSphere API 8.0.3.0**.
            ...
            :param notifications: Various notifications received and segregated based on operation
                ...
                EXTRACT_INSTALLED_IMAGE key can be inspected.
                This attribute was added in **vSphere API 8.0.3.0**.
            """
        ...
        class OperationType(Enum):
            ...
            can be managed with single software image
        ...
        class Status(Enum):
            ...
            was successful or whether some issue occurred during its execution.
            This enumeration was added in **vSphere API 8.0.3.0**.
            ...
            is running a base image version < 7.0.2.
            ...
            #notifications attribute of the InstalledImageInfo class.

            """
            SUCCESS = None
            """
            Indicates the extract installed images task completed without error.
    ...
    def extract_task(self,
        ...
        installed images on all the hosts.
...
class Software(VapiInterface):
    ...
    ExportSpec._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.export_spec', {
            ...
            'export_only_default_image': type.OptionalType(type.BooleanType()),
        },
        ExportSpec,
        False,
        None))
    ...
    class StageSpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param commit: The minimum commit identifier of the desired software document to
                be used during the :func:`Software.stage` method.
    ...
    class ApplySpec(VapiStruct):
        ...
        def __init__(self,
            ...
            :param accept_eula: Accept the VMware End User License Agreement (EULA) before starting
                the :func:`Software.apply` method. 
    ...
    class StageStatus(VapiStruct):
        ...
        status of a :func:`Software.stage` method.
        This class was added in **vSphere API 8.0.0.1**.
    ...
    class ApplyStatus(VapiStruct):
        ...
        class Status(Enum):
            ...
            """
            The method is being scheduled for retry.
            This class attribute was added in **vSphere API 7.0.2.1**.
    ...
    class StageResult(VapiStruct):
        ...
        result of a :func:`Software.stage` method.
        This class was added in **vSphere API 8.0.0.1**.
        ...
        def __init__(self,
            ...
            :param commit: The identifier of the commit used to fetch the desired software
                document to be staged to all hosts within the cluster.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.esx.settings.commit``. When methods return a value of
            ...
            :param host_info: Information of the hosts in this cluster to which the desired
                ...
                :attr:`Software.StageResult.commit` should be staged to.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``HostSystem``. When methods return a value of this class as
            ...
            :param host_status: Status of the hosts in this cluster to which the desired software
                ...
                :attr:`Software.StageResult.skipped_hosts`.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the key in
                the attribute :class:`dict` must be an identifier for the resource
                type: ``HostSystem``. When methods return a value of this class as
            ...
            :param skipped_hosts: Hosts in this cluster that were skipped by the
                ...
                compliant, or are previously staged shall be skipped.
                This attribute was added in **vSphere API 8.0.0.1**.
                When clients pass a value of this class as a parameter, the
                attribute must contain identifiers for the resource type:
                ``HostSystem``. When methods return a value of this class as a
            ...
            :param notifications: Notifications providing additional information for
                ...
                exclusive with the notifications in ``Software.StageStatus``.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class ApplyResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param notifications: Notifications providing additional information for
                ...
                exclusive with the notifications in ``Software.ApplyStatus``.
                This attribute was added in **vSphere API 7.0.2.1**.
                This attribute is optional because it was added in a newer version
                than its parent node.
            """
    ...
    class CheckInfo(VapiStruct):
        ...
        def __init__(self,
            ...
            :param originator: The service that performed the check.
    ...
    class CheckIssue(VapiStruct):
        """
        The ``Software.CheckIssue`` class contains attributes that describe a
        particular check issue.
    ...
    class CheckStatus(VapiStruct):
        ...
        def __init__(self,
            ...
            :param check_issues: List of :class:`Software.CheckIssue`s that the check reported.
                This attribute was added in **vSphere API 7.0.2.0**.
    ...
    class Info(VapiStruct):
        """
        The ``Software.Info`` class contains information about the display name of
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.clusters.software.info', {
    ...
    def get(self,
        ...
        """
        Returns the complete desired software specification. In case of Single
        Image Cluster, the specification will contain Default Image In case of
        Composite Image Cluster, the specification will contain Default Image +
        Alternative Images
    ...
    def get_default_image(self,
        ...
        """
        Returns the default image. In case of Single Image Cluster, get API
        result == getDefaultImage API result In case of Composite Image
        Cluster, this API could be used to get only the Default Image
        ...
        """
        return self._invoke('get_default_image',
                            {
                            'cluster': cluster,
                            })
    ...
    def apply_task(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires
              ``VcIntegrity.lifecycleSoftwareRemediation.Write`` and
    ...
    def check_task(self,
        ...
        document across all hosts in the cluster. 
        
        Checks if all hosts in the cluster are in a good state to be updated
        with the desired software document. If ``commit`` attribute is
        :class:`set` it implies the minimum commit that the check method should
        use, however if subsequent commits have been made to the desired state
        document the check method will use the most recent desired state
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * Method execution requires
              ``VcIntegrity.lifecycleSoftwareRemediation.Read`` and
              ``VcIntegrity.lifecycleHealth.Read``.
            * The resource ``ClusterComputeResource`` referenced by the
              parameter ``cluster`` requires
              ``VcIntegrity.lifecycleSoftwareRemediation.Read`` and
    ...
    def get_display_name(self,
        ...
        """
        Returns the display name of the software specification in the
        repository that is assigned to the cluster.
        This method was added in **vSphere API 9.0.0.0**.
        ...
        :return: display name of the software specification in the repository that
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``ClusterComputeResource`` referenced by the
              ...
              ``VcIntegrity.lifecycleSoftwareSpecification.Read``.
        """
        return self._invoke('get_display_name',
                            {
                            'cluster': cluster,
                            })
class _ConfigurationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        apply_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=apply',
        ...
        check_compliance_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=checkCompliance',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        validate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=validate',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        precheck_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=precheck',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        import_config_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=importConfig',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        export_config_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/configuration?action=exportConfig',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        operations = {
            ...
            'apply$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'check_compliance$task': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
            ...
            'export_config': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
...
class _DepotOverridesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        add_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/depot-overrides?action=add',
        ...
        remove_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/depot-overrides?action=remove',
            request_body_parameter='depot',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        operations = {
            ...
            'add': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).build(),
...
class _InstalledImagesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        extract_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/installed-images?action=extract',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
...
class _SoftwareStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        # properties for get_default_image operation
        get_default_image_input_type = type.StructType('operation-input', {
            'cluster': type.IdType(resource_types='ClusterComputeResource'),
        })
        get_default_image_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
            'com.vmware.vapi.std.errors.not_found':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'),
        ...
        get_default_image_input_value_validator_list = [
        ]
        get_default_image_output_validator_list = [
        ]
        get_default_image_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software?image=default',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        scan_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software?action=scan',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        export_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software?action=export',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        stage_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software?action=stage',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        apply_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software?action=apply',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        check_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/esx/settings/clusters/{cluster}/software?action=check',
            request_body_parameter='spec',
            path_variables={
                'cluster': 'cluster',
            },
        ...
        # properties for get_display_name operation
        get_display_name_input_type = type.StructType('operation-input', {
            'cluster': type.IdType(resource_types='ClusterComputeResource'),
        })
        get_display_name_error_dict = {
            'com.vmware.vapi.std.errors.error':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'),
            'com.vmware.vapi.std.errors.not_found':
                type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'),
        ...
        get_display_name_input_value_validator_list = [
        ]
        get_display_name_output_validator_list = [
        ]
        get_display_name_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/clusters/{cluster}/software/display-name',
            path_variables={
                'cluster': 'cluster',
            },
            query_parameters={
        ...
        operations = {
            ...
            'get_default_image': {
                'input_type': get_default_image_input_type,
                'output_type': type.ReferenceType('com.vmware.esx.settings_client', 'SoftwareInfo'),
                'errors': get_default_image_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': get_default_image_input_value_validator_list,
                'output_validator_list': get_default_image_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'scan$task': {
            ...
            'apply$task': {
                ...
                'output_type': type.IdType(resource_types='com.vmware.cis.TASK'),
                'errors': apply_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyInDesiredState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'TimedOut'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).build(),
                'input_value_validator_list': apply_input_value_validator_list,
                'output_validator_list': [],
                'task_type': TaskType.TASK_ONLY,
            },
            ...
            'get_display_name': {
                'input_type': get_display_name_input_type,
                'output_type': type.ReferenceType(__name__, 'Software.Info'),
                'errors': get_display_name_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ServiceUnavailable'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': get_display_name_input_value_validator_list,
                'output_validator_list': get_display_name_output_validator_list,
                'task_type': TaskType.NONE,
            },
        }
        rest_metadata = {
            'get': get_rest_metadata,
            'get_default_image': get_default_image_rest_metadata,
            'scan': scan_rest_metadata,
            'export': export_rest_metadata,
            'stage': stage_rest_metadata,
            'apply': apply_rest_metadata,
            'check': check_rest_metadata,
            'get_display_name': get_display_name_rest_metadata,
        }
        ApiInterfaceStub.__init__(
...
class StubFactory(StubFactoryBase):
    _attrs = {
        ...
        'vms': 'com.vmware.esx.settings.clusters.vms_client.StubFactory',
    }
