...
class ApplyImpact(VapiInterface):
    ...
    class HostImpact(VapiStruct):
        ...
        def __init__(self,
            ...
            :param impact: Impact of steps performed during the apply method.
                This attribute was added in **vSphere API 8.0.0.1**.
            ...
            :param host_info: Information of the host.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.impact = impact
            self.commit = commit
...
class LastApplyResult(VapiInterface):
    ...
    class ApplyStatus(VapiStruct):
        ...
        class Status(Enum):
            ...
            desired software specification to a standalone host.
    ...
    class ApplyResult(VapiStruct):
        ...
        def __init__(self,
            ...
            :param notifications: Notifications providing additional information for
                ...
                in ``LastApplyResult.ApplyStatus``.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.status = status
            self.commit = commit
    ...
    def get(self,
        ...
        software document to the standalone ESXi host.
        This method was added in **vSphere API 8.0.0.1**.
...
class LastCheckResult(VapiInterface):
    ...
    class CheckIssue(VapiStruct):
        ...
        def __init__(self,
            ...
            """
            :type  description: :class:`com.vmware.vapi.std_client.LocalizableMessage`
            :param description: Description of the issue encountered.
                This attribute was added in **vSphere API 8.0.0.1**.
            :type  resolution: :class:`com.vmware.vapi.std_client.LocalizableMessage` or ``None``
            :param resolution: Possible resolution for the issue.
                This attribute was added in **vSphere API 8.0.0.1**.
    ...
    class CheckStatus(VapiStruct):
        ...
        def __init__(self,
            ...
            :param check_issues: The issues encountered while running this check.
                This attribute was added in **vSphere API 8.0.0.1**.
            """
            self.check = check
            self.status = status
    ...
    class EntityCheckResult(VapiStruct):
        ...
        class EntityType(Enum):
            ...
            entities on which checks can be performed.
            This enumeration was added in **vSphere API 8.0.0.1**.
