...
#
# vAPI stub file for package com.vmware.esx.settings.depots.umds.
#---------------------------------------------------------------------------

"""
The ``com.vmware.esx.settings.depots.umds_client`` module provides classes to
...
class Content(VapiInterface):
    """
    The ``Content`` class provides methods to manage the UMDS depot used during
    ESX lifecycle management.
    This class was added in **vSphere API 7.0.3.0**.
    """

    _VAPI_SERVICE_ID = 'com.vmware.esx.settings.depots.umds.content'
    """
    ...
    class Info(VapiStruct):
        ...
        matadata bundles of the UMDS depot.
        This class was added in **vSphere API 7.0.3.0**.
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.esx.settings.depots.umds.content.info', {
    ...
    def get(self):
        ...
        :return: Information of content of the imported UMDS depot.
...
class _ContentStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/esx/settings/depots/umds/content',
            path_variables={
            },
            query_parameters={
            },
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.esx.settings.depots.umds.content',
