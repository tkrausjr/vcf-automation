...
class CertVerificationStatus(Enum):
    """
    The ``CertVerificationStatus`` class defines the certificate verification
    status of a library item. Currently applicable only to ovf item type
    ...
    NOT_AVAILABLE = None
    """
    Existing library item which can not be verified. Applying security policy
    to an existing library may result in this status for items.

    """
    VERIFIED = None
    """
    Item has been fully validated during importing or file syncing.

    """
    INTERNAL = None
    """
    The Item is cloned/created through vCenter.

    """
    VERIFICATION_FAILURE = None
    """
    Item's certificate or manifest validation failed.

    """
    VERIFICATION_IN_PROGRESS = None
    """
    Item certificate verification is in progress.
    ...
    def __init__(self, string):
        ...
        :param string: String value for the :class:`CertVerificationStatus` instance.
        """
        Enum.__init__(string)

CertVerificationStatus._set_values({
    'NOT_AVAILABLE': CertVerificationStatus('NOT_AVAILABLE'),
    'VERIFIED': CertVerificationStatus('VERIFIED'),
    'INTERNAL': CertVerificationStatus('INTERNAL'),
    'VERIFICATION_FAILURE': CertVerificationStatus('VERIFICATION_FAILURE'),
    'VERIFICATION_IN_PROGRESS': CertVerificationStatus('VERIFICATION_IN_PROGRESS'),
    'UNTRUSTED': CertVerificationStatus('UNTRUSTED'),
})
CertVerificationStatus._set_binding_type(type.EnumType(
    'com.vmware.content.library.item.cert_verification_status',
...
TransferStatus._set_values({
    'WAITING_FOR_TRANSFER': TransferStatus('WAITING_FOR_TRANSFER'),
    'TRANSFERRING': TransferStatus('TRANSFERRING'),
    'READY': TransferStatus('READY'),
...
class CertificateVerificationInfo(VapiStruct):
    """
    Currently, this field will available only in following cases 1. This item
    belongs to a secure content library 2. The item if of type ovf.
    ...
    def __init__(self,
        ...
        """
        :type  status: :class:`CertVerificationStatus`
        :param status: The certificate verification status of item.
            This attribute was added in **vSphere API 7.0.3.0**.
        :type  cert_chain: :class:`list` of :class:`str` or ``None``
        :param cert_chain: A certificate in base64 encoding.
            This attribute was added in **vSphere API 7.0.3.0**.
...
CertificateVerificationInfo._set_binding_type(type.StructType(
    'com.vmware.content.library.item.certificate_verification_info', {
        'status': type.ReferenceType(__name__, 'CertVerificationStatus'),
        'cert_chain': type.OptionalType(type.ListType(type.StringType())),
    },
    ...
    def __init__(self,
        ...
        :param uri: Transfer endpoint URI. The supported URI schemes are: ``http``,
            ...
            * ds:///vmfs/volumes/uuid/path
            ...
            When the transfer endpoint is a datastore location, the server can
            import the file directly from the storage backing without the
            overhead of streaming over HTTP.
        ...
        :param ssl_certificate_thumbprint: Thumbprint of the expected SSL certificate for this endpoint. Only
            ...
            The specified sslCertificateThumbprint will not be checked for SSL
            certificate validation if {TransferEndpoint#sslCertificate} is also
            :class:`set`.
            If None, standard certificate validation is performed.
        :type  ssl_certificate: :class:`str` or ``None``
        :param ssl_certificate: PEM encoded SSL Certificate for this endpoint. Only used for HTTPS
            connections. If set, the remote endpoint's SSL certificate is only
            accepted if it matches this, and no other certificate validation is
            performed.
...
class UpdateSessionModel(VapiStruct):
    ...
    def __init__(self,
        ...
        :param preview_info: A preview of the files currently being uploaded in the session.
            ...
            :attr:`UpdateSessionModel.State.ACTIVE`.
            This attribute was added in **vSphere API 6.8**.
...
class Changes(VapiInterface):
    """
    The ``Changes`` class provides methods to get a history of the content
    ...
    _VAPI_SERVICE_ID = 'com.vmware.content.library.item.changes'
    """
    ...
    def __init__(self, config):
        ...
        """
        VapiInterface.__init__(self, config, _ChangesStub)
        self._VAPI_OPERATION_IDS = {}

    class Summary(VapiStruct):
        """
        The ``Changes.Summary`` class contains commonly used information about a
        library item change.
        This class was added in **vSphere API 6.9.1**.
        ...
        def __init__(self,
            ...
            :param time: The date and time when the item content was changed.
                This attribute was added in **vSphere API 6.9.1**.
            :type  user: :class:`str` or ``None``
            :param user: The user who made the content change.
                This attribute was added in **vSphere API 6.9.1**.
                This attribute will be None if the user could not be determined.
            :type  short_message: :class:`str` or ``None``
            :param short_message: The short message describing the content change. The message is
                truncated to the first 80 characters or first non-leading newline
                character, whichever length is shorter.
                This attribute was added in **vSphere API 6.9.1**.
                This attribute will be None if a message was not provided when the
                item content was changed.
            """
    ...
    Summary._set_binding_type(type.StructType(
        'com.vmware.content.library.item.changes.summary', {
            ...
            'short_message': type.OptionalType(type.StringType()),
        },
        Summary,
        False,
        None))
    ...
    class Info(VapiStruct):
        """
        The ``Changes.Info`` class contains information about a library item
        change.
        This class was added in **vSphere API 6.9.1**.
        ...
        def __init__(self,
            ...
            :param message: The full message describing the content change.
                This attribute was added in **vSphere API 6.9.1**.
                This attribute will be None if a message was not provided when the
                item content was changed.
            """
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.content.library.item.changes.info', {
            'time': type.DateTimeType(),
            'user': type.OptionalType(type.StringType()),
    ...
    def list(self,
        ...
        """
        Returns commonly used information about the content changes made to a
        library item.
        ...
        :rtype: :class:`list` of :class:`Changes.Summary`
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unauthorized`
            ...
            * The resource ``com.vmware.content.library.Item`` referenced by
              the parameter ``library_item`` requires ``System.Read``.
        """
...
class File(VapiInterface):
    ...
    class ChecksumAlgorithm(Enum):
        ...
        This class attribute was added in **vSphere API 6.8**.
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param version: The version of this file; incremented when a new copy of the file
                is uploaded.
            :type  file_download_endpoint: :class:`str` or ``None``
            :param file_download_endpoint: The URL endpoint that can be used to download the file. 
                
                Eg URL:
                https://{vc}/cls/static/{libraryId}/{itemId}/{fileName}?version={version}
                :attr:`File.Info.version` query param in the URL specifies the
                latest version of the file present in storage. When URL is hit with
                version query param, the file version specified in version query
                param is downloaded. The download will fail with 404 not found
                error if the specified version is no longer present in storage. If
                URL is hit without version query param, the latest file version
                present in storage is downloaded. 
                
                It is expected to provide API session i.e. vmware-api-session-id in
                header while using the URL to download the file.
                vmware-api-session-id can be obtained from
                com.vmware.cis.Session#create() method Eg: wget
                --header="vmware-api-session-id: {sessionId}" fileDownloadEndpoint
                This attribute was added in **vSphere API 9.0.0.0**.
                None if the file is not present in storage i.e
                :attr:`File.Info.cached` is False or library item is of VMTX
                Template type (as download of VMTX template is not supported
                currently)
            """
            ...
            self.cached = cached
            self.version = version
            self.file_download_endpoint = file_download_endpoint
            VapiStruct.__init__(self)
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.content.library.item.file.info', {
            ...
            'file_download_endpoint': type.OptionalType(type.URIType()),
        },
        Info,
        False,
        None))
    ...
    def get(self,
        ...
        :raise: :class:`com.vmware.vapi.std.errors_client.Unsupported` 
            if :attr:`File.Info.file_download_endpoint` URI cannot be
            constructed for the file due to unsupported characters in file
            name.
...
class _ChangesStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{item}/changes',
            path_variables={
                'library_item': 'item',
            },
             header_parameters={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{item}/changes/{version}',
            path_variables={
                'library_item': 'item',
                'version': 'version',
            },
        ...
        operations = {
            'list': {
                ...
                'output_type': type.ListType(type.ReferenceType(__name__, 'Changes.Summary')),
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).build(),
            ...
            'get': {
                ...
                'output_type': type.ReferenceType(__name__, 'Changes.Info'),
        ...
        ApiInterfaceStub.__init__(
            self, iface_name='com.vmware.content.library.item.changes',
...
class _DownloadSessionStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/download-session',
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/download-session/{downloadSessionId}',
            path_variables={
        ...
        keep_alive_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/download-session/{downloadSessionId}?action=keep-alive',
            path_variables={
                'download_session_id': 'downloadSessionId',
            },
            query_parameters={
        ...
        cancel_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/download-session/{downloadSessionId}?action=cancel',
            path_variables={
                'download_session_id': 'downloadSessionId',
            },
            query_parameters={
        ...
        fail_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/download-session/{downloadSessionId}?action=fail',
            path_variables={
                'download_session_id': 'downloadSessionId',
            },
            query_parameters={
        ...
        operations = {
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).build(),
            ...
            'keep_alive': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
...
class _FileStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{libraryItemId}/file?name',
            path_variables={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{libraryItemId}/file',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
        ...
        operations = {
            'get': {
                ...
                'errors': get_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unsupported'), []).build(),
                'input_value_validator_list': get_input_value_validator_list,
                'output_validator_list': get_output_validator_list,
                'task_type': TaskType.NONE,
            },
...
class _StorageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{libraryItemId}/storage?file_name',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/{libraryItemId}/storage',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
...
class _UpdateSessionStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session',
            request_body_parameter='create_spec',
            path_variables={
            },
            query_parameters={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/update-session/{updateSessionId}',
            path_variables={
        ...
        complete_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}?action=complete',
            path_variables={
                'update_session_id': 'updateSessionId',
            },
            query_parameters={
        ...
        keep_alive_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}?action=keep-alive',
            path_variables={
                'update_session_id': 'updateSessionId',
            },
            query_parameters={
        ...
        cancel_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}?action=cancel',
            path_variables={
                'update_session_id': 'updateSessionId',
            },
            query_parameters={
        ...
        fail_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}?action=fail',
            path_variables={
                'update_session_id': 'updateSessionId',
            },
            query_parameters={
        ...
        operations = {
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceBusy'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).build(),
