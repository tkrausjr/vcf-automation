...
class File(VapiInterface):
    ...
    _VAPI_SERVICE_ID = 'com.vmware.content.library.item.downloadsession.file'
    """
    ...
    PrepareStatus._set_values({
        'UNPREPARED': PrepareStatus('UNPREPARED'),
        'PREPARE_REQUESTED': PrepareStatus('PREPARE_REQUESTED'),
        'PREPARING': PrepareStatus('PREPARING'),
    ...
    EndpointType._set_values({
        'HTTPS': EndpointType('HTTPS'),
        'DIRECT': EndpointType('DIRECT'),
    })
...
class _FileStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/download-session/{downloadSessionId}/file',
            path_variables={
        ...
        prepare_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/download-session/{downloadSessionId}/file?action=prepare',
            path_variables={
                'download_session_id': 'downloadSessionId',
            },
            query_parameters={
        ...
        get_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item/download-session/{downloadSessionId}/file?file_name',
            path_variables={
                'download_session_id': 'downloadSessionId',
            },
            query_parameters={
        ...
        operations = {
            ...
            'prepare': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
