...
class ItemModel(VapiStruct):
    ...
    def __init__(self,
        ...
        :param security_compliance: Shows the security compliance of :class:`ItemModel`.
...
class SourceInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param source_library: Identifier of the published library.
...
class StateInfo(VapiStruct):
    """
    The :class:`StateInfo` class provides the information about the state of a
    content library.
    ...
    def __init__(self,
        ...
        """
        :type  state: :class:`StateInfo.State`
        :param state: The state (ACTIVE, MAINTENANCE) of this library. 
    ...
    class State(Enum):
        """
        The ``StateInfo.State`` class defines the state of a LibraryModel. 
        
        The state of a library can be used to determine if the library is in
        maintenance or not. The library is moved to Maintenance state when it is
        under storage migration.
        ...
        ACTIVE = None
        """
        This is default library state when library is created. The library is fully
        functional when in this state.

        """
        MAINTENANCE = None
        """
        This is the library state when library is in migration. Library content
        will be inaccessible and operations mutating library content will be
        disallowed when in this state.
    ...
    State._set_binding_type(type.EnumType(
        'com.vmware.content.library.state_info.state',
        State))

StateInfo._set_binding_type(type.StructType(
    'com.vmware.content.library.state_info', {
        'state': type.OptionalType(type.ReferenceType(__name__, 'StateInfo.State')),
    },
    StateInfo,
    False,
    None))
...
class SubscriptionInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param ssl_certificate: An optional SSL certificate for the remote endpoint. 
            
            If this value is defined the SSL certificate will be verified by
            comparing it to this sslCertificate. When specified, the standard
            certificate chain validation behavior is not used. If this value is
            None {SubscriptionInfo#sslThumbprint} will be used for SSL
            certificate validation. The certificate chain is validated normally
            if this value and {SubscriptionInfo#sslThumbprint} is None.
            This attribute was added in **vSphere API 9.0.0.0**.
            This attribute is optional for the ``create`` method. It will not
            be present in the return value of the ``get`` or ``list`` methods.
            It is optional for the ``update`` method.
...
class Item(VapiInterface):
    ...
    class DestinationSpec(VapiStruct):
        ...
        the library item to a specific subscription.
        This class was added in **vSphere API 6.7.2**.
    ...
    def publish(self,
        ...
        all subscriptions of the library.
...
class Subscriptions(VapiInterface):
    ...
    information of the subscribers of a published library.
    This class was added in **vSphere API 6.7.2**.
    """
    ...
    class CreateSpecNewSubscribedLibrary(VapiStruct):
        ...
        information required to create a new subscribed library.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            """
            :type  name: :class:`str`
            :param name: Name of the subscribed library.
                This attribute was added in **vSphere API 6.7.2**.
            :type  description: :class:`str` or ``None``
            :param description: Description of the subscribed library.
                This attribute was added in **vSphere API 6.7.2**.
    ...
    class CreateSpecVcenter(VapiStruct):
        ...
        subscription exists or will be created.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param hostname: The hostname of the subscribed library's vCenter Server.
                This attribute was added in **vSphere API 6.7.2**.
    ...
    class CreateSpecPlacement(VapiStruct):
        ...
        virtual machine template library items of the subscribed library.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param host: Host onto which the virtual machine template should be placed. If
                ...
                specified, ``host`` must be a member of ``cluster``.
                This attribute was added in **vSphere API 6.7.2**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
    ...
    class CreateSpecSubscribedLibrary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param target: Specifies whether the target subscribed library should be newly
                created or an existing subscribed library should be used.
                This attribute was added in **vSphere API 6.7.2**.
            ...
            :param placement: Placement specification for the virtual machine template library
                items on the subscribed library.
                This attribute was added in **vSphere API 6.7.2**.
                This attribute is currently required. In future, if this is None,
    ...
    class CreateSpec(VapiStruct):
        ...
        create a new subscription of the published library.
        This class was added in **vSphere API 6.7.2**.
    ...
    class Summary(VapiStruct):
        ...
        def __init__(self,
            ...
            :param subscription: Identifier of the subscription.
                ...
                ``com.vmware.content.library.Subscriptions``.
            :type  subscribed_library: :class:`str`
            :param subscribed_library: Identifier of the subscribed library.
                This attribute was added in **vSphere API 6.7.2**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``com.vmware.content.Library``. When methods return a value of this
            ...
            :param subscribed_library_name: Name of the subscribed library.
                This attribute was added in **vSphere API 6.7.2**.
    ...
    class UpdateSpecPlacement(VapiStruct):
        ...
        library. Existing items will not be moved.
        This class was added in **vSphere API 6.7.2**.
        ...
        def __init__(self,
            ...
            :param cluster: Cluster onto which the virtual machine template should be placed.
                ...
                recommended that this attribute be None.
                This attribute was added in **vSphere API 6.7.2**.
                When clients pass a value of this class as a parameter, the
                attribute must be an identifier for the resource type:
                ``ClusterComputeResource:VCenter``. When methods return a value of
...
class _ItemStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        copy_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/{sourceLibraryItemId}?action=copy',
        ...
        list_rest_metadata = OperationRestMetadata(
            http_method='GET',
            url_template='/content/library/item?library_id',
            path_variables={
            },
            query_parameters={
            },
        ...
        find_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item?action=find',
        ...
        publish_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/{libraryItemId}?action=publish',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
        ...
        operations = {
            'copy': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
            ...
            'create': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).build(),
            ...
            'update': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).build(),
...
class _SubscribedItemStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        evict_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/subscribed-item/{libraryItemId}?action=evict',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
        ...
        sync_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/subscribed-item/{libraryItemId}?action=sync',
            path_variables={
                'library_item_id': 'libraryItemId',
            },
            query_parameters={
        ...
        operations = {
            'evict': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementConfiguration'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
    ...
    def __init__(self, config):
        ...
        operations = {
            'create': {
                ...
                'errors': create_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'AlreadyExists'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'ResourceInaccessible'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': create_input_value_validator_list,
                'output_validator_list': create_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'delete': {
                ...
                'output_type': type.VoidType(),
                'errors': delete_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': delete_input_value_validator_list,
                'output_validator_list': delete_output_validator_list,
                'task_type': TaskType.NONE,
            },
            'list': {
                ...
                'errors': list_error_dict,
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Error'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidElementType'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthenticated'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).build(),
                'input_value_validator_list': list_input_value_validator_list,
                'output_validator_list': list_output_validator_list,
                'task_type': TaskType.NONE,
            },
