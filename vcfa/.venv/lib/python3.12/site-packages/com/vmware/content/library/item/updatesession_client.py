...
class CertificateInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param self_signed: Whether the certificate is self-signed.
            This attribute was added in **vSphere API 6.8**.
        :type  x509: :class:`str`
...
class PreviewInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param state: Indicates the state of the preview of the update session.
            This attribute was added in **vSphere API 6.8**.
        ...
        :param warnings: The list of warnings raised for this update session. Any warning
            ...
            update session during session complete operation.
            This attribute was added in **vSphere API 6.8**.
    ...
    class State(Enum):
        ...
        this case the state will transition to ``PREPARING``.
        ...
        applicable metadata files in the session have been fully uploaded.
...
class PreviewWarningInfo(VapiStruct):
    ...
    def __init__(self,
        ...
        :param type: The warning type raised during preview of the update session.
            This attribute was added in **vSphere API 6.8**.
...
class WarningBehavior(VapiStruct):
    ...
    is raised during the update session.
    This class was added in **vSphere API 6.8**.
...
class File(VapiInterface):
    ...
    * adding a new file to the library item.
    ...
    def validate(self,
        ...
        identifier and ensures all necessary files are received. 
        
        In the case where a file is missing, this method will return its name
        in the :attr:`File.ValidationResult.missing_files` set. The user can
        add the missing files and try re-validating. For other type of errors,
    ...
    def remove(self,
        ...
        The file will only be effectively removed when the update session is
        completed.
...
class _FileStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        validate_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}/file?action=validate',
            path_variables={
        ...
        add_rest_metadata = OperationRestMetadata(
            http_method='POST',
            url_template='/content/library/item/update-session/{updateSessionId}/file',
            request_body_parameter='file_spec',
            path_variables={
                'update_session_id': 'updateSessionId',
            },
            query_parameters={
        ...
        remove_rest_metadata = OperationRestMetadata(
            http_method='DELETE',
            url_template='/content/library/item/update-session/{updateSessionId}/file/{fileName}',
            path_variables={
                'update_session_id': 'updateSessionId',
                'file_name': 'fileName',
            },
        ...
        operations = {
            ...
            'add': {
                ...
                'throws_clause': ThrowsClauseBuilder().add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'InvalidArgument'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotFound'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'Unauthorized'), []).add(type.ReferenceType('com.vmware.vapi.std.errors_client', 'NotAllowedInCurrentState'), []).build(),
